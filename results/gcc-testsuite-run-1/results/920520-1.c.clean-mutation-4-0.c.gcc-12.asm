  ...
  10:	c7 00 79 00 00 00    	mov    DWORD PTR [rax],0x79
  16:	90                   	nop
  17:	5d                   	pop    rbp
  18:	c3                   	ret    
  ...
  43:	83 f8 7f             	cmp    eax,0x7f
  46:	74 18                	je     60 <bugger+0x47>
  48:	83 f8 7f             	cmp    eax,0x7f
  4b:	7f 1c                	jg     69 <bugger+0x50>
  4d:	83 f8 4b             	cmp    eax,0x4b
  50:	74 05                	je     57 <bugger+0x3e>
  52:	83 f8 5a             	cmp    eax,0x5a
  55:	75 12                	jne    69 <bugger+0x50>
  57:	c7 45 f4 0f 00 00 00 	mov    DWORD PTR [rbp-0xc],0xf
  5e:	eb 11                	jmp    71 <bugger+0x58>
  60:	c7 45 f4 0a 00 00 00 	mov    DWORD PTR [rbp-0xc],0xa
  67:	eb 08                	jmp    71 <bugger+0x58>
  69:	c7 45 f4 63 00 00 00 	mov    DWORD PTR [rbp-0xc],0x63
  70:	90                   	nop
