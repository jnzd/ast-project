  ...
  65:	b8 93 93 a9 4b       	mov    eax,0x4ba99393
  ...
  88:	c7 45 e4 3a ae 84 2f 	mov    DWORD PTR [rbp-0x1c],0x2f84ae3a
  ...
  bf:	be 61 b8 18 4f       	mov    esi,0x4f18b861
 ...
 129:	ba ba 84 c7 06       	mov    edx,0x6c784ba
 12e:	be 43 17 76 30       	mov    esi,0x30761743
 133:	b8 00 00 00 00       	mov    eax,0x0
 138:	e8 00 00 00 00       	call   13d <main+0xbd>
 13d:	48 83 c4 40          	add    rsp,0x40
 141:	b8 8d 4e 8a 38       	mov    eax,0x388a4e8d
 146:	c9                   	leave
 147:	c3                   	ret
