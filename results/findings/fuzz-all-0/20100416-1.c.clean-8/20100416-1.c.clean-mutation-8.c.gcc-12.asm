  ...
  12:	c7 45 fc 40 00 00 00 	mov    DWORD PTR [rbp-0x4],0x40
  19:	c7 45 f8 2b 00 00 00 	mov    DWORD PTR [rbp-0x8],0x2b
  ...
  5d:	c7 45 fc 49 00 00 00 	mov    DWORD PTR [rbp-0x4],0x49
  ...
  80:	be 2a 00 00 00       	mov    esi,0x2a
  85:	bf 8d ff ff ff       	mov    edi,0xffffff8d
  ...
  bc:	b8 46 00 00 00       	mov    eax,0x46
  c1:	c9                   	leave  
  c2:	c3                   	ret    
