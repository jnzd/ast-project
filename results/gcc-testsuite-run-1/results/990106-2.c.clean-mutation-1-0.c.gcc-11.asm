  ...
  29:	b8 23 00 00 00       	mov    eax,0x23
  ...
  3b:	83 45 fc 55          	add    DWORD PTR [rbp-0x4],0x55
  ...
  5d:	c7 45 f8 4d 00 00 00 	mov    DWORD PTR [rbp-0x8],0x4d
  ...
  71:	bf 73 00 00 00       	mov    edi,0x73
