   ...
   c:	c7 45 f8 5d 00 00 00 	mov    DWORD PTR [rbp-0x8],0x5d
  ...
  4e:	83 7d fc c3          	cmp    DWORD PTR [rbp-0x4],0xffffffc3
  52:	75 06                	jne    5a <main+0x5a>
  54:	83 7d f8 70          	cmp    DWORD PTR [rbp-0x8],0x70
  58:	74 05                	je     5f <main+0x5f>
  5a:	e8 00 00 00 00       	call   5f <main+0x5f>
  5f:	b8 4d 00 00 00       	mov    eax,0x4d
  64:	c9                   	leave  
  65:	c3                   	ret    
