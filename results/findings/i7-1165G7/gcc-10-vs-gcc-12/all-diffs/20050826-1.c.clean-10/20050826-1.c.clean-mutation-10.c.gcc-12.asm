  ...
  34:	48 c7 45 f8 7a 00 00 	mov    QWORD PTR [rbp-0x8],0x7a
  3b:	00 
  ...
  49:	48 05 c7 00 00 00    	add    rax,0xc7
  ...
  76:	ba c0 08 00 00       	mov    edx,0x8c0
  7b:	be 1b 00 00 00       	mov    esi,0x1b
  80:	48 8d 05 00 00 00 00 	lea    rax,[rip+0x0]        # 87 <foo+0x19>
  87:	48 89 c7             	mov    rdi,rax
  8a:	e8 00 00 00 00       	call   8f <foo+0x21>
  8f:	c6 05 00 00 00 00 42 	mov    BYTE PTR [rip+0x0],0x42        # 96 <foo+0x28>
  ...
  de:	b8 2c 00 00 00       	mov    eax,0x2c
  e3:	5d                   	pop    rbp
  e4:	c3                   	ret    
