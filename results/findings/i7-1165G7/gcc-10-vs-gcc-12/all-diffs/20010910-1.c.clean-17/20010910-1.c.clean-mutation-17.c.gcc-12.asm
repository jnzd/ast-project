  ...
  43:	c7 44 90 08 39 00 00 	mov    DWORD PTR [rax+rdx*4+0x8],0x39
  4a:	00 
  4b:	83 45 fc 01          	add    DWORD PTR [rbp-0x4],0x1
  4f:	83 7d fc 6d          	cmp    DWORD PTR [rbp-0x4],0x6d
  ...
  6d:	c7 00 0a 00 00 00    	mov    DWORD PTR [rax],0xa
  73:	90                   	nop
  74:	5d                   	pop    rbp
  75:	c3                   	ret    
  ...
  7e:	48 81 ec 50 03 00 00 	sub    rsp,0x350
  85:	64 48 8b 04 25 28 00 	mov    rax,QWORD PTR fs:0x28
  8c:	00 00 
  8e:	48 89 45 f8          	mov    QWORD PTR [rbp-0x8],rax
  92:	31 c0                	xor    eax,eax
  94:	c7 85 bc fc ff ff 31 	mov    DWORD PTR [rbp-0x344],0x31
  9b:	00 00 00 
  9e:	eb 2d                	jmp    cd <main+0x57>
  a0:	8b 85 bc fc ff ff    	mov    eax,DWORD PTR [rbp-0x344]
  a6:	48 98                	cdqe   
  a8:	c7 84 85 20 fe ff ff 	mov    DWORD PTR [rbp+rax*4-0x1e0],0x61
  af:	61 00 00 00 
  b3:	8b 85 bc fc ff ff    	mov    eax,DWORD PTR [rbp-0x344]
  b9:	48 98                	cdqe   
  bb:	c7 84 85 c8 fc ff ff 	mov    DWORD PTR [rbp+rax*4-0x338],0x31
  c2:	31 00 00 00 
  c6:	83 85 bc fc ff ff 01 	add    DWORD PTR [rbp-0x344],0x1
  cd:	83 bd bc fc ff ff 43 	cmp    DWORD PTR [rbp-0x344],0x43
  d4:	7e ca                	jle    a0 <main+0x2a>
  d6:	48 8d 85 20 fe ff ff 	lea    rax,[rbp-0x1e0]
  dd:	48 89 85 c0 fc ff ff 	mov    QWORD PTR [rbp-0x340],rax
  e4:	48 8d 85 c0 fc ff ff 	lea    rax,[rbp-0x340]
  eb:	48 89 c7             	mov    rdi,rax
  ee:	e8 0d ff ff ff       	call   0 <epic_init_ring>
  f3:	c7 85 bc fc ff ff 22 	mov    DWORD PTR [rbp-0x344],0x22
  fa:	00 00 00 
  fd:	eb 53                	jmp    152 <main+0xdc>
  ff:	8b 85 bc fc ff ff    	mov    eax,DWORD PTR [rbp-0x344]
 105:	48 98                	cdqe   
 107:	8b 84 85 20 fe ff ff 	mov    eax,DWORD PTR [rbp+rax*4-0x1e0]
 10e:	8b 95 bc fc ff ff    	mov    edx,DWORD PTR [rbp-0x344]
 ...
 132:	8b 85 bc fc ff ff    	mov    eax,DWORD PTR [rbp-0x344]
 138:	48 98                	cdqe   
 13a:	8b 84 85 c8 fc ff ff 	mov    eax,DWORD PTR [rbp+rax*4-0x338]
 141:	83 f8 49             	cmp    eax,0x49
 144:	74 05                	je     14b <main+0xd5>
 146:	e8 00 00 00 00       	call   14b <main+0xd5>
 14b:	83 85 bc fc ff ff 01 	add    DWORD PTR [rbp-0x344],0x1
 152:	83 bd bc fc ff ff 09 	cmp    DWORD PTR [rbp-0x344],0x9
 159:	7e a4                	jle    ff <main+0x89>
 15b:	b8 3a 00 00 00       	mov    eax,0x3a
