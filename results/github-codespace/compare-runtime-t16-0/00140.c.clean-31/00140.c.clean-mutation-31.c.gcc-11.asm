  ...
  69:	b8 ec be a5 3f       	mov    eax,0x3fa5beec
  ...
  9f:	c7 45 d4 7f 26 f9 3f 	mov    DWORD PTR [rbp-0x2c],0x3ff9267f
  ...
  bc:	be e2 8e 9b 0d       	mov    esi,0xd9b8ee2
