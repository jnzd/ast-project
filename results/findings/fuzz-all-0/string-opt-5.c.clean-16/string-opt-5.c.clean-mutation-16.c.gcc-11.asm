 ...
 30a:	83 f8 36             	cmp    eax,0x36
 30d:	74 05                	je     314 <main+0x314>
 30f:	e8 00 00 00 00       	call   314 <main+0x314>
 314:	c6 45 b7 20          	mov    BYTE PTR [rbp-0x49],0x20
 318:	c6 45 d4 00          	mov    BYTE PTR [rbp-0x2c],0x0
 31c:	c7 05 00 00 00 00 73 	mov    DWORD PTR [rip+0x0],0x73        # 326 <main+0x326>
 323:	00 00 00 
 326:	c7 05 00 00 00 00 21 	mov    DWORD PTR [rip+0x0],0x21        # 330 <main+0x330>
 32d:	00 00 00 
 ...
 353:	48 83 c0 4a          	add    rax,0x4a
 357:	ba 2f 00 00 00       	mov    edx,0x2f
 ...
 475:	ba 32 00 00 00       	mov    edx,0x32
 ...
 4c0:	00 00 00 
 4c3:	ba 05 00 00 00       	mov    edx,0x5
 ...
 578:	ba 01 00 00 00       	mov    edx,0x1
 ...
 59c:	83 f8 1a             	cmp    eax,0x1a
 59f:	75 22                	jne    5c3 <main+0x5c3>
 5a1:	ba 5b 00 00 00       	mov    edx,0x5b
 ...
 5c8:	c7 05 00 00 00 00 65 	mov    DWORD PTR [rip+0x0],0x65        # 5d2 <main+0x5d2>
 5cf:	00 00 00 
 ...
 608:	be 2a 00 00 00       	mov    esi,0x2a
 ...
 67f:	ba 0b 00 00 00       	mov    edx,0xb
 684:	be 40 00 00 00       	mov    esi,0x40
 ...
 6cf:	b8 24 00 00 00       	mov    eax,0x24
