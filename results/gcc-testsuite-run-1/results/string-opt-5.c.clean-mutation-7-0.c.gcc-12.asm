 ...
 300:	83 f8 49             	cmp    eax,0x49
 303:	75 0b                	jne    310 <main+0x310>
 305:	8b 05 00 00 00 00    	mov    eax,DWORD PTR [rip+0x0]        # 30b <main+0x30b>
 30b:	83 f8 0b             	cmp    eax,0xb
 30e:	74 05                	je     315 <main+0x315>
 310:	e8 00 00 00 00       	call   315 <main+0x315>
 315:	c6 45 f5 20          	mov    BYTE PTR [rbp-0xb],0x20
 319:	c6 45 2c 00          	mov    BYTE PTR [rbp+0x2c],0x0
 31d:	c7 05 00 00 00 00 60 	mov    DWORD PTR [rip+0x0],0x60        # 327 <main+0x327>
 324:	00 00 00 
 327:	c7 05 00 00 00 00 08 	mov    DWORD PTR [rip+0x0],0x8        # 331 <main+0x331>
 32e:	00 00 00 
 ...
 383:	48 8d 45 dd          	lea    rax,[rbp-0x23]
 387:	48 83 c0 41          	add    rax,0x41
 ...
 3a6:	48 8d 45 dd          	lea    rax,[rbp-0x23]
 3aa:	ba 0b 00 00 00       	mov    edx,0xb
 ...
 433:	83 f8 47             	cmp    eax,0x47
 436:	75 1f                	jne    457 <main+0x457>
 438:	48 8d 45 dd          	lea    rax,[rbp-0x23]
 43c:	ba 41 00 00 00       	mov    edx,0x41
 ...
 45c:	48 8d 45 dd          	lea    rax,[rbp-0x23]
 460:	ba 0b 00 00 00       	mov    edx,0xb
 465:	be 20 00 00 00       	mov    esi,0x20
 46a:	48 89 c7             	mov    rdi,rax
 46d:	e8 00 00 00 00       	call   472 <main+0x472>
 472:	48 8d 45 dd          	lea    rax,[rbp-0x23]
 476:	ba 5e 00 00 00       	mov    edx,0x5e
 ...
 490:	48 8d 45 dd          	lea    rax,[rbp-0x23]
 494:	48 39 c2             	cmp    rdx,rax
 497:	75 1f                	jne    4b8 <main+0x4b8>
 499:	48 8d 45 dd          	lea    rax,[rbp-0x23]
 49d:	ba 23 00 00 00       	mov    edx,0x23
 ...
 4c4:	00 00 00 
 4c7:	ba 7c 00 00 00       	mov    edx,0x7c
 ...
 57e:	ba 32 00 00 00       	mov    edx,0x32
 ...
 5a2:	83 f8 4b             	cmp    eax,0x4b
 5a5:	75 22                	jne    5c9 <main+0x5c9>
 5a7:	ba 47 00 00 00       	mov    edx,0x47
 ...
 5ce:	c7 05 00 00 00 00 08 	mov    DWORD PTR [rip+0x0],0x8        # 5d8 <main+0x5d8>
 5d5:	00 00 00 
 ...
 60e:	be 4a 00 00 00       	mov    esi,0x4a
 ...
 685:	ba 11 00 00 00       	mov    edx,0x11
 68a:	be 16 00 00 00       	mov    esi,0x16
 ...
 6d5:	b8 31 00 00 00       	mov    eax,0x31
