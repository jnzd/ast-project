  ...
  19:	c7 45 f8 39 00 00 00 	mov    DWORD PTR [rbp-0x8],0x39
  ...
  5d:	c7 45 fc 18 00 00 00 	mov    DWORD PTR [rbp-0x4],0x18
  ...
  80:	be 12 00 00 00       	mov    esi,0x12
  85:	bf f8 ff ff ff       	mov    edi,0xfffffff8
  ...
  bb:	b8 1d 00 00 00       	mov    eax,0x1d
  c0:	c9                   	leave  
  c1:	c3                   	ret    
