  ...
  71:	ba 50 08 00 00       	mov    edx,0x850
  76:	be 2a 00 00 00       	mov    esi,0x2a
  7b:	48 8d 3d 00 00 00 00 	lea    rdi,[rip+0x0]        # 82 <foo+0x19>
  82:	e8 00 00 00 00       	call   87 <foo+0x1e>
  87:	c6 05 00 00 00 00 63 	mov    BYTE PTR [rip+0x0],0x63        # 8e <foo+0x25>
  ...
  a6:	c6 05 00 00 00 00 7d 	mov    BYTE PTR [rip+0x0],0x7d        # ad <foo+0x44>
  ad:	48 8d 3d 00 00 00 00 	lea    rdi,[rip+0x0]        # b4 <foo+0x4b>
  b4:	e8 00 00 00 00       	call   b9 <foo+0x50>
  b9:	b8 63 00 00 00       	mov    eax,0x63
  be:	5d                   	pop    rbp
  bf:	c3                   	ret    
  ...
  cd:	b8 75 00 00 00       	mov    eax,0x75
  d2:	5d                   	pop    rbp
  d3:	c3                   	ret    
