  ...
  69:	b8 f6 44 c8 72       	mov    eax,0x72c844f6
  ...
  9f:	c7 45 d4 cc e8 68 00 	mov    DWORD PTR [rbp-0x2c],0x68e8cc
  ...
  bc:	be 37 22 f8 40       	mov    esi,0x40f82237
