   ...
   f:	83 7d fc 15          	cmp    DWORD PTR [rbp-0x4],0x15
  ...
  29:	c7 45 fc 1c 00 00 00 	mov    DWORD PTR [rbp-0x4],0x1c
  30:	8b 45 fc             	mov    eax,DWORD PTR [rbp-0x4]
  33:	83 c0 3f             	add    eax,0x3f
  ...
  71:	48 c7 45 f8 70 00 00 	mov    QWORD PTR [rbp-0x8],0x70
  78:	00 
  79:	bf 6f 00 00 80       	mov    edi,0x8000006f
