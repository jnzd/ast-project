  ...
  69:	b8 33 c2 8c 0a       	mov    eax,0xa8cc233
  ...
  9f:	c7 45 d4 57 88 ec 09 	mov    DWORD PTR [rbp-0x2c],0x9ec8857
  ...
  bc:	be 87 a2 1d 0d       	mov    esi,0xd1da287
