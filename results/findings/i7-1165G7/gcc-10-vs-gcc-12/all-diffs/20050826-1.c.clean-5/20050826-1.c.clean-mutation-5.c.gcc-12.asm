  ...
  34:	48 c7 45 f8 3f 00 00 	mov    QWORD PTR [rbp-0x8],0x3f
  3b:	00 
  ...
  49:	48 05 2f 01 00 00    	add    rax,0x12f
  ...
  76:	ba 28 09 00 00       	mov    edx,0x928
  7b:	be 6b 00 00 00       	mov    esi,0x6b
  80:	48 8d 05 00 00 00 00 	lea    rax,[rip+0x0]        # 87 <foo+0x19>
  87:	48 89 c7             	mov    rdi,rax
  8a:	e8 00 00 00 00       	call   8f <foo+0x21>
  8f:	c6 05 00 00 00 00 64 	mov    BYTE PTR [rip+0x0],0x64        # 96 <foo+0x28>
  ...
  de:	b8 1e 00 00 00       	mov    eax,0x1e
  e3:	5d                   	pop    rbp
  e4:	c3                   	ret    
