  ...
  69:	b8 44 34 69 14       	mov    eax,0x14693444
  ...
  9f:	c7 45 d4 5f ce a2 2d 	mov    DWORD PTR [rbp-0x2c],0x2da2ce5f
  ...
  d6:	be c5 a7 38 4f       	mov    esi,0x4f38a7c5
 ...
 140:	ba f9 bc 29 63       	mov    edx,0x6329bcf9
 145:	be 40 41 c5 15       	mov    esi,0x15c54140
 14a:	b8 00 00 00 00       	mov    eax,0x0
 14f:	e8 00 00 00 00       	call   154 <main+0xd0>
 154:	48 83 c4 40          	add    rsp,0x40
 158:	b8 1e 11 06 31       	mov    eax,0x3106111e
