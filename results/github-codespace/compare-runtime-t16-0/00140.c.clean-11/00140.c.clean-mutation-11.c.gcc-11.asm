  ...
  69:	b8 36 b7 d4 2a       	mov    eax,0x2ad4b736
  ...
  9f:	c7 45 d4 cb 0f d9 63 	mov    DWORD PTR [rbp-0x2c],0x63d90fcb
  ...
  bc:	be b9 13 c4 00       	mov    esi,0xc413b9
