   ...
   c:	c7 45 f8 02 00 00 00 	mov    DWORD PTR [rbp-0x8],0x2
  ...
  4e:	83 7d fc c9          	cmp    DWORD PTR [rbp-0x4],0xffffffc9
  52:	75 06                	jne    5a <main+0x5a>
  54:	83 7d f8 0b          	cmp    DWORD PTR [rbp-0x8],0xb
  58:	74 05                	je     5f <main+0x5f>
  5a:	e8 00 00 00 00       	call   5f <main+0x5f>
  5f:	b8 61 00 00 00       	mov    eax,0x61
  64:	c9                   	leave  
  65:	c3                   	ret    
