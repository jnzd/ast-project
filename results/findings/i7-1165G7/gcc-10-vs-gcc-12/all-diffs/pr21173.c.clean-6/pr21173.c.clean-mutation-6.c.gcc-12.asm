  ...
  5e:	83 7d fc 11          	cmp    DWORD PTR [rbp-0x4],0x11
  ...
  83:	c7 45 fc 7f 00 00 00 	mov    DWORD PTR [rbp-0x4],0x7f
  ...
  b2:	83 7d fc 2c          	cmp    DWORD PTR [rbp-0x4],0x2c
  b6:	7e d4                	jle    8c <main+0x24>
  b8:	b8 22 00 00 00       	mov    eax,0x22
  bd:	c9                   	leave  
  be:	c3                   	ret    
