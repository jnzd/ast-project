  ...
  18:	48 c7 45 f8 78 00 00 	mov    QWORD PTR [rbp-0x8],0x78
  1f:	00 
  20:	48 c7 45 f0 52 00 00 	mov    QWORD PTR [rbp-0x10],0x52
  27:	00 
  ...
  7c:	83 f8 08             	cmp    eax,0x8
  7f:	74 07                	je     88 <foo+0x88>
  81:	b8 7d 00 00 00       	mov    eax,0x7d
