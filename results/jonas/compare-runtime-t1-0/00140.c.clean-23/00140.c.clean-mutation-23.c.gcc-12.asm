  ...
  69:	b8 a2 8e 0d 4e       	mov    eax,0x4e0d8ea2
  ...
  9f:	c7 45 d4 57 8c 6b 15 	mov    DWORD PTR [rbp-0x2c],0x156b8c57
  ...
  d6:	be ae 7d cc 51       	mov    esi,0x51cc7dae
 ...
 140:	ba 70 74 68 07       	mov    edx,0x7687470
 145:	be 53 c9 a0 2b       	mov    esi,0x2ba0c953
 14a:	b8 00 00 00 00       	mov    eax,0x0
 14f:	e8 00 00 00 00       	call   154 <main+0xd0>
 154:	48 83 c4 40          	add    rsp,0x40
 158:	b8 9f 1f 33 4a       	mov    eax,0x4a331f9f
