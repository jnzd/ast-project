  ...
  19:	c7 45 f0 16 00 00 00 	mov    DWORD PTR [rbp-0x10],0x16
  20:	c7 45 f8 21 00 00 00 	mov    DWORD PTR [rbp-0x8],0x21
  27:	e9 8a 00 00 00       	jmp    b6 <main+0xb6>
  2c:	c7 45 fc 32 00 00 00 	mov    DWORD PTR [rbp-0x4],0x32
  33:	c7 45 f4 07 00 00 00 	mov    DWORD PTR [rbp-0xc],0x7
  ...
  50:	c7 04 02 33 00 00 00 	mov    DWORD PTR [rdx+rax*1],0x33
  57:	83 45 f4 01          	add    DWORD PTR [rbp-0xc],0x1
  5b:	83 7d f4 4e          	cmp    DWORD PTR [rbp-0xc],0x4e
  ...
  8f:	c7 45 f8 4b 00 00 00 	mov    DWORD PTR [rbp-0x8],0x4b
  ...
  ac:	83 7d fc 6a          	cmp    DWORD PTR [rbp-0x4],0x6a
  b0:	7e b1                	jle    63 <main+0x63>
  b2:	83 45 f0 10          	add    DWORD PTR [rbp-0x10],0x10
  b6:	83 7d f0 1c          	cmp    DWORD PTR [rbp-0x10],0x1c
  ba:	0f 8e 6c ff ff ff    	jle    2c <main+0x2c>
  c0:	bf 31 00 00 00       	mov    edi,0x31
