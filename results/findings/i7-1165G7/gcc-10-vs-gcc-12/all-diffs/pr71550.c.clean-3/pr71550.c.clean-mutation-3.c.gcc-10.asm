  ...
  40:	c7 45 fc 3c 00 00 00 	mov    DWORD PTR [rbp-0x4],0x3c
  ...
  7d:	83 f8 38             	cmp    eax,0x38
  80:	76 d3                	jbe    55 <main+0x55>
  82:	83 45 fc 01          	add    DWORD PTR [rbp-0x4],0x1
  86:	83 7d fc 7b          	cmp    DWORD PTR [rbp-0x4],0x7b
  8a:	7e bd                	jle    49 <main+0x49>
  8c:	c7 45 fc 1d 00 00 00 	mov    DWORD PTR [rbp-0x4],0x1d
  93:	eb 04                	jmp    99 <main+0x99>
  95:	83 45 fc 01          	add    DWORD PTR [rbp-0x4],0x1
  99:	83 7d fc 72          	cmp    DWORD PTR [rbp-0x4],0x72
  ...
  bc:	bf 3a 00 00 00       	mov    edi,0x3a
