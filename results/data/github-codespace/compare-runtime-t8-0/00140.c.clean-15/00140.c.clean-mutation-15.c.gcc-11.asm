  ...
  69:	b8 27 7c 7a 13       	mov    eax,0x137a7c27
  ...
  9f:	c7 45 d4 82 06 54 2b 	mov    DWORD PTR [rbp-0x2c],0x2b540682
  ...
  bc:	be b7 2a b2 13       	mov    esi,0x13b22ab7
