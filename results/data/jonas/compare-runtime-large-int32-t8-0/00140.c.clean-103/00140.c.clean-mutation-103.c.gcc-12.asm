  ...
  69:	b8 b6 d0 58 7a       	mov    eax,0x7a58d0b6
  ...
  9f:	c7 45 d4 b3 27 5d 15 	mov    DWORD PTR [rbp-0x2c],0x155d27b3
  ...
  d6:	be 35 ff b4 22       	mov    esi,0x22b4ff35
 ...
 140:	ba 69 d7 b4 49       	mov    edx,0x49b4d769
 145:	be 63 5f ae 0f       	mov    esi,0xfae5f63
 14a:	b8 00 00 00 00       	mov    eax,0x0
 14f:	e8 00 00 00 00       	call   154 <main+0xd0>
 154:	48 83 c4 40          	add    rsp,0x40
 158:	b8 bc 61 e0 2b       	mov    eax,0x2be061bc
