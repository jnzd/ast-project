 ...
 1f4:	48 b8 ff ff ff ff ff 	movabs rax,0x7fffffffffffffff
 1fb:	ff ff 7f 
 1fe:	48 89 c7             	mov    rdi,rax
 201:	e8 00 00 00 00       	call   206 <main+0x11e>
 206:	be 18 00 00 00       	mov    esi,0x18
 20b:	48 b8 00 00 00 00 00 	movabs rax,0x8000000000000000
 212:	00 00 80 
 215:	48 89 c7             	mov    rdi,rax
 218:	e8 00 00 00 00       	call   21d <main+0x135>
 21d:	be 73 00 00 00       	mov    esi,0x73
 222:	48 c7 c7 ff ff ff ff 	mov    rdi,0xffffffffffffffff
 229:	e8 00 00 00 00       	call   22e <main+0x146>
 22e:	b8 23 00 00 00       	mov    eax,0x23
 233:	5d                   	pop    rbp
 234:	c3                   	ret    
