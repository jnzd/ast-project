  ...
  40:	c7 45 fc 36 00 00 00 	mov    DWORD PTR [rbp-0x4],0x36
  ...
  7d:	83 f8 3f             	cmp    eax,0x3f
  80:	76 d3                	jbe    55 <main+0x55>
  82:	83 45 fc 01          	add    DWORD PTR [rbp-0x4],0x1
  86:	83 7d fc 36          	cmp    DWORD PTR [rbp-0x4],0x36
  8a:	7e bd                	jle    49 <main+0x49>
  8c:	c7 45 fc 73 00 00 00 	mov    DWORD PTR [rbp-0x4],0x73
  93:	eb 04                	jmp    99 <main+0x99>
  95:	83 45 fc 01          	add    DWORD PTR [rbp-0x4],0x1
  99:	83 7d fc 7e          	cmp    DWORD PTR [rbp-0x4],0x7e
  ...
  bc:	bf 69 00 00 00       	mov    edi,0x69
