  ...
  69:	b8 34 ec 69 49       	mov    eax,0x4969ec34
  ...
  9f:	c7 45 d4 c8 f7 87 0b 	mov    DWORD PTR [rbp-0x2c],0xb87f7c8
  ...
  d6:	be 0a e2 6a 62       	mov    esi,0x626ae20a
 ...
 140:	ba 9f 65 74 6e       	mov    edx,0x6e74659f
 145:	be c8 50 09 5a       	mov    esi,0x5a0950c8
 14a:	b8 00 00 00 00       	mov    eax,0x0
 14f:	e8 00 00 00 00       	call   154 <main+0xd0>
 154:	48 83 c4 40          	add    rsp,0x40
 158:	b8 51 bb a2 03       	mov    eax,0x3a2bb51
