  ...
  25:	48 69 c0 a3 34 3e 32 	imul   rax,rax,0x323e34a3
  ...
  7c:	83 7d f8 31          	cmp    DWORD PTR [rbp-0x8],0x31
  80:	77 2b                	ja     ad <main+0xad>
  82:	83 7d f4 7c          	cmp    DWORD PTR [rbp-0xc],0x7c
  ...
  9d:	83 f8 53             	cmp    eax,0x53
  a0:	0f 8e 76 ff ff ff    	jle    1c <main+0x1c>
  a6:	b8 71 00 00 00       	mov    eax,0x71
