  ...
  23:	ba 39 70 e0 c0       	mov    edx,0xc0e07039
  ...
  7c:	83 7d f8 21          	cmp    DWORD PTR [rbp-0x8],0x21
  80:	77 2b                	ja     ad <main+0xad>
  82:	83 7d f4 5d          	cmp    DWORD PTR [rbp-0xc],0x5d
  ...
  9d:	83 f8 7a             	cmp    eax,0x7a
  a0:	0f 8e 76 ff ff ff    	jle    1c <main+0x1c>
  a6:	b8 5c 00 00 00       	mov    eax,0x5c
