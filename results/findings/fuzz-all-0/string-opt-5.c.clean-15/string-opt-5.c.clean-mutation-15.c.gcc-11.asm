 ...
 31d:	83 f8 43             	cmp    eax,0x43
 320:	75 0b                	jne    32d <main+0x32d>
 322:	8b 05 00 00 00 00    	mov    eax,DWORD PTR [rip+0x0]        # 328 <main+0x328>
 328:	83 f8 46             	cmp    eax,0x46
 32b:	74 05                	je     332 <main+0x332>
 32d:	e8 00 00 00 00       	call   332 <main+0x332>
 332:	c6 45 cc 20          	mov    BYTE PTR [rbp-0x34],0x20
 336:	c6 45 d2 00          	mov    BYTE PTR [rbp-0x2e],0x0
 33a:	c7 05 00 00 00 00 4b 	mov    DWORD PTR [rip+0x0],0x4b        # 344 <main+0x344>
 341:	00 00 00 
 344:	c7 05 00 00 00 00 7f 	mov    DWORD PTR [rip+0x0],0x7f        # 34e <main+0x34e>
 34b:	00 00 00 
 ...
 377:	48 83 c0 7e          	add    rax,0x7e
 37b:	ba 78 00 00 00       	mov    edx,0x78
 ...
 3d6:	ba 7d 00 00 00       	mov    edx,0x7d
 ...
 498:	ba 7d 00 00 00       	mov    edx,0x7d
 ...
 4b1:	ba 08 00 00 00       	mov    edx,0x8
 ...
 4db:	ba 28 00 00 00       	mov    edx,0x28
 ...
 502:	00 00 00 
 505:	ba 05 00 00 00       	mov    edx,0x5
 ...
 5ba:	ba 7e 00 00 00       	mov    edx,0x7e
 ...
 5de:	83 f8 66             	cmp    eax,0x66
 5e1:	75 22                	jne    605 <main+0x605>
 5e3:	ba 12 00 00 00       	mov    edx,0x12
 ...
 60a:	c7 05 00 00 00 00 10 	mov    DWORD PTR [rip+0x0],0x10        # 614 <main+0x614>
 611:	00 00 00 
 ...
 64a:	be 32 00 00 00       	mov    esi,0x32
 ...
 6c1:	ba 58 00 00 00       	mov    edx,0x58
 6c6:	be 2b 00 00 00       	mov    esi,0x2b
 ...
 711:	b8 66 00 00 00       	mov    eax,0x66
