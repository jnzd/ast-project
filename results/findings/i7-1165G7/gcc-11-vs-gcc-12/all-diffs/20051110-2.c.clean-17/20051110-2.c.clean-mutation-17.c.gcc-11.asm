  ...
  3e:	48 c1 6d f8 24       	shr    QWORD PTR [rbp-0x8],0x24
  ...
  b6:	b8 20 00 00 00       	mov    eax,0x20
  bb:	5d                   	pop    rbp
  bc:	c3                   	ret    
