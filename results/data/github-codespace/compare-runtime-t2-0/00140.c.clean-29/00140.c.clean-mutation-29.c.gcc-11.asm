  ...
  69:	b8 1b f1 e7 72       	mov    eax,0x72e7f11b
  ...
  9f:	c7 45 d4 f4 c6 37 27 	mov    DWORD PTR [rbp-0x2c],0x2737c6f4
  ...
  bc:	be da d5 59 47       	mov    esi,0x4759d5da
