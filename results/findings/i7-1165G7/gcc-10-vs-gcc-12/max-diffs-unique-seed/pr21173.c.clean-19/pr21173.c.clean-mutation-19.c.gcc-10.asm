  ...
  5b:	83 7d fc 67          	cmp    DWORD PTR [rbp-0x4],0x67
  ...
  7d:	c7 45 fc 26 00 00 00 	mov    DWORD PTR [rbp-0x4],0x26
  ...
  ac:	83 7d fc 23          	cmp    DWORD PTR [rbp-0x4],0x23
  b0:	7e d4                	jle    86 <main+0x21>
  b2:	b8 7a 00 00 00       	mov    eax,0x7a
  b7:	c9                   	leave  
  b8:	c3                   	ret    
