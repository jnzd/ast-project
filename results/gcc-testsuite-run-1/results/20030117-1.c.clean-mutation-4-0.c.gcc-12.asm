   ...
   8:	ba 1e 00 00 00       	mov    edx,0x1e
   d:	be 7b 00 00 00       	mov    esi,0x7b
  12:	bf 08 00 00 00       	mov    edi,0x8
  17:	e8 00 00 00 00       	call   1c <main+0x1c>
  1c:	83 f8 7b             	cmp    eax,0x7b
  1f:	74 05                	je     26 <main+0x26>
  21:	e8 00 00 00 00       	call   26 <main+0x26>
  26:	ba 0d 00 00 00       	mov    edx,0xd
  2b:	be 55 00 00 00       	mov    esi,0x55
  30:	bf 1a 00 00 00       	mov    edi,0x1a
  35:	e8 00 00 00 00       	call   3a <main+0x3a>
  3a:	83 f8 68             	cmp    eax,0x68
  ...
  6f:	48 69 d2 31 0c c3 30 	imul   rdx,rdx,0x30c30c31
  76:	48 c1 ea 20          	shr    rdx,0x20
  7a:	c1 fa 02             	sar    edx,0x2
