  ...
  7e:	83 7d f8 21          	cmp    DWORD PTR [rbp-0x8],0x21
  82:	77 2b                	ja     af <main+0xaf>
  84:	83 7d f4 5d          	cmp    DWORD PTR [rbp-0xc],0x5d
  ...
  9f:	83 f8 7a             	cmp    eax,0x7a
  a2:	0f 8e 74 ff ff ff    	jle    1c <main+0x1c>
  a8:	b8 5c 00 00 00       	mov    eax,0x5c
