  ...
  43:	c7 45 fc 3c 00 00 00 	mov    DWORD PTR [rbp-0x4],0x3c
  ...
  80:	83 f8 38             	cmp    eax,0x38
  83:	76 d3                	jbe    58 <main+0x58>
  85:	83 45 fc 01          	add    DWORD PTR [rbp-0x4],0x1
  89:	83 7d fc 7b          	cmp    DWORD PTR [rbp-0x4],0x7b
  8d:	7e bd                	jle    4c <main+0x4c>
  8f:	c7 45 fc 1d 00 00 00 	mov    DWORD PTR [rbp-0x4],0x1d
  96:	eb 04                	jmp    9c <main+0x9c>
  98:	83 45 fc 01          	add    DWORD PTR [rbp-0x4],0x1
  9c:	83 7d fc 72          	cmp    DWORD PTR [rbp-0x4],0x72
  ...
  bf:	bf 3a 00 00 00       	mov    edi,0x3a
