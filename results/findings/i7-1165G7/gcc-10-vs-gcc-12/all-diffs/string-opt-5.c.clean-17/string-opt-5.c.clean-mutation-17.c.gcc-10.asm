 ...
 2fc:	83 f8 42             	cmp    eax,0x42
 2ff:	75 0b                	jne    30c <main+0x30c>
 301:	8b 05 00 00 00 00    	mov    eax,DWORD PTR [rip+0x0]        # 307 <main+0x307>
 307:	83 f8 4a             	cmp    eax,0x4a
 30a:	74 05                	je     311 <main+0x311>
 30c:	e8 00 00 00 00       	call   311 <main+0x311>
 311:	c6 45 da 20          	mov    BYTE PTR [rbp-0x26],0x20
 315:	c6 45 0f 00          	mov    BYTE PTR [rbp+0xf],0x0
 319:	c7 05 00 00 00 00 16 	mov    DWORD PTR [rip+0x0],0x16        # 323 <main+0x323>
 320:	00 00 00 
 323:	c7 05 00 00 00 00 1a 	mov    DWORD PTR [rip+0x0],0x1a        # 32d <main+0x32d>
 32a:	00 00 00 
 ...
 350:	48 83 c0 65          	add    rax,0x65
 354:	ba 3a 00 00 00       	mov    edx,0x3a
 ...
 3a3:	ba 3d 00 00 00       	mov    edx,0x3d
 ...
 456:	ba 3d 00 00 00       	mov    edx,0x3d
 ...
 46c:	ba 3e 00 00 00       	mov    edx,0x3e
 ...
 4b1:	00 00 00 
 4b4:	ba 11 00 00 00       	mov    edx,0x11
 ...
 55f:	ba 2b 00 00 00       	mov    edx,0x2b
 ...
 583:	83 f8 72             	cmp    eax,0x72
 586:	75 1c                	jne    5a4 <main+0x5a4>
 588:	ba 4e 00 00 00       	mov    edx,0x4e
 ...
 5a9:	c7 05 00 00 00 00 4d 	mov    DWORD PTR [rip+0x0],0x4d        # 5b3 <main+0x5b3>
 5b0:	00 00 00 
 ...
 5e9:	be 32 00 00 00       	mov    esi,0x32
 ...
 65d:	ba 74 00 00 00       	mov    edx,0x74
 662:	be 59 00 00 00       	mov    esi,0x59
 ...
 6aa:	b8 71 00 00 00       	mov    eax,0x71
