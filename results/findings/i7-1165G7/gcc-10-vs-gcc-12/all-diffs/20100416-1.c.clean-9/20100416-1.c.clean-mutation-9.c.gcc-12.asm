  ...
  12:	c7 45 fc 5e 00 00 00 	mov    DWORD PTR [rbp-0x4],0x5e
  19:	c7 45 f8 51 00 00 00 	mov    DWORD PTR [rbp-0x8],0x51
  ...
  5d:	c7 45 fc 65 00 00 00 	mov    DWORD PTR [rbp-0x4],0x65
  ...
  80:	be 56 00 00 00       	mov    esi,0x56
  85:	bf 85 ff ff ff       	mov    edi,0xffffff85
  ...
  bc:	b8 76 00 00 00       	mov    eax,0x76
  c1:	c9                   	leave  
  c2:	c3                   	ret    
