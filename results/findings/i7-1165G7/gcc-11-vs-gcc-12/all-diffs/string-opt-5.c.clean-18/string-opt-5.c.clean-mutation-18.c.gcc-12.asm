 ...
 122:	48 8b 45 88          	mov    rax,QWORD PTR [rbp-0x78]
 ...
 2d7:	48 98                	cdqe   
 2d9:	83 e0 6f             	and    eax,0x6f
 2dc:	48 89 c1             	mov    rcx,rax
 2df:	48 8b 45 88          	mov    rax,QWORD PTR [rbp-0x78]
 ...
 300:	83 f8 54             	cmp    eax,0x54
 303:	75 0b                	jne    310 <main+0x310>
 305:	8b 05 00 00 00 00    	mov    eax,DWORD PTR [rip+0x0]        # 30b <main+0x30b>
 30b:	83 f8 5e             	cmp    eax,0x5e
 30e:	74 05                	je     315 <main+0x315>
 310:	e8 00 00 00 00       	call   315 <main+0x315>
 315:	c6 45 a9 20          	mov    BYTE PTR [rbp-0x57],0x20
 319:	c6 45 b7 00          	mov    BYTE PTR [rbp-0x49],0x0
 31d:	c7 05 00 00 00 00 6d 	mov    DWORD PTR [rip+0x0],0x6d        # 327 <main+0x327>
 324:	00 00 00 
 327:	c7 05 00 00 00 00 3e 	mov    DWORD PTR [rip+0x0],0x3e        # 331 <main+0x331>
 32e:	00 00 00 
 ...
 340:	48 98                	cdqe   
 342:	83 e0 03             	and    eax,0x3
 345:	48 89 c2             	mov    rdx,rax
 348:	48 8b 45 88          	mov    rax,QWORD PTR [rbp-0x78]
 34c:	48 8d 0c 02          	lea    rcx,[rdx+rax*1]
 350:	48 8d 45 90          	lea    rax,[rbp-0x70]
 354:	48 83 c0 18          	add    rax,0x18
 358:	ba 03 00 00 00       	mov    edx,0x3
 35d:	48 89 ce             	mov    rsi,rcx
 360:	48 89 c7             	mov    rdi,rax
 363:	e8 00 00 00 00       	call   368 <main+0x368>
 368:	48 89 c2             	mov    rdx,rax
 36b:	48 8d 45 90          	lea    rax,[rbp-0x70]
 36f:	48 83 c0 67          	add    rax,0x67
 ...
 383:	48 8d 45 90          	lea    rax,[rbp-0x70]
 ...
 3a6:	48 8d 45 90          	lea    rax,[rbp-0x70]
 3aa:	ba 53 00 00 00       	mov    edx,0x53
 ...
 45c:	48 8d 45 90          	lea    rax,[rbp-0x70]
 460:	ba 53 00 00 00       	mov    edx,0x53
 465:	be 20 00 00 00       	mov    esi,0x20
 46a:	48 89 c7             	mov    rdi,rax
 46d:	e8 00 00 00 00       	call   472 <main+0x472>
 472:	48 8d 45 90          	lea    rax,[rbp-0x70]
 ...
 490:	48 8d 45 90          	lea    rax,[rbp-0x70]
 494:	48 39 c2             	cmp    rdx,rax
 497:	75 1f                	jne    4b8 <main+0x4b8>
 499:	48 8d 45 90          	lea    rax,[rbp-0x70]
 49d:	ba 6f 00 00 00       	mov    edx,0x6f
 ...
 4c4:	00 00 00 
 4c7:	ba 62 00 00 00       	mov    edx,0x62
 ...
 57c:	ba 61 00 00 00       	mov    edx,0x61
 ...
 5a0:	83 f8 78             	cmp    eax,0x78
 5a3:	75 22                	jne    5c7 <main+0x5c7>
 5a5:	ba 16 00 00 00       	mov    edx,0x16
 ...
 5cc:	c7 05 00 00 00 00 79 	mov    DWORD PTR [rip+0x0],0x79        # 5d6 <main+0x5d6>
 5d3:	00 00 00 
 ...
 60c:	be 3d 00 00 00       	mov    esi,0x3d
 ...
 683:	ba 17 00 00 00       	mov    edx,0x17
 688:	be 4f 00 00 00       	mov    esi,0x4f
