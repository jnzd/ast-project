  ...
  61:	83 f8 39             	cmp    eax,0x39
  64:	74 05                	je     6b <main+0x6b>
  66:	e8 00 00 00 00       	call   6b <main+0x6b>
  6b:	c7 05 00 00 00 00 12 	mov    DWORD PTR [rip+0x0],0x12        # 75 <main+0x75>
  72:	00 00 00 
  ...
  c4:	c7 05 00 00 00 00 43 	mov    DWORD PTR [rip+0x0],0x43        # ce <main+0xce>
  cb:	00 00 00 
