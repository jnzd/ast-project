  ...
  65:	b8 64 dd 8b 1c       	mov    eax,0x1c8bdd64
  ...
  88:	c7 45 e4 02 00 d3 29 	mov    DWORD PTR [rbp-0x1c],0x29d30002
  ...
  bf:	be f8 ee 51 3a       	mov    esi,0x3a51eef8
 ...
 129:	ba 31 86 cb 1f       	mov    edx,0x1fcb8631
 12e:	be 6f 1f 20 11       	mov    esi,0x11201f6f
 133:	b8 00 00 00 00       	mov    eax,0x0
 138:	e8 00 00 00 00       	call   13d <main+0xbd>
 13d:	48 83 c4 40          	add    rsp,0x40
 141:	b8 3b e8 86 05       	mov    eax,0x586e83b
 146:	c9                   	leave
 147:	c3                   	ret
