  ...
  69:	b8 8a cb dd 3b       	mov    eax,0x3bddcb8a
  ...
  9f:	c7 45 d4 07 4d 2c 15 	mov    DWORD PTR [rbp-0x2c],0x152c4d07
  ...
  d6:	be 46 d8 eb 04       	mov    esi,0x4ebd846
 ...
 140:	ba e5 8d 91 3f       	mov    edx,0x3f918de5
 145:	be c2 03 18 50       	mov    esi,0x501803c2
 14a:	b8 00 00 00 00       	mov    eax,0x0
 14f:	e8 00 00 00 00       	call   154 <main+0xd0>
 154:	48 83 c4 40          	add    rsp,0x40
 158:	b8 39 ca 71 3e       	mov    eax,0x3e71ca39
