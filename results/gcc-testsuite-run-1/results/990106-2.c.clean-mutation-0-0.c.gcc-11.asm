  ...
  29:	b8 5a 00 00 00       	mov    eax,0x5a
  ...
  3b:	83 45 fc 67          	add    DWORD PTR [rbp-0x4],0x67
  ...
  5d:	c7 45 f8 13 00 00 00 	mov    DWORD PTR [rbp-0x8],0x13
  ...
  71:	bf 6d 00 00 00       	mov    edi,0x6d
