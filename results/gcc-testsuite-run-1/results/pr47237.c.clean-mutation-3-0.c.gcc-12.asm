 ...
 197:	48 8b 41 5d          	mov    rax,QWORD PTR [rcx+0x5d]
 19b:	48 8b 51 65          	mov    rdx,QWORD PTR [rcx+0x65]
 19f:	48 89 44 24 5d       	mov    QWORD PTR [rsp+0x5d],rax
 1a4:	48 89 54 24 65       	mov    QWORD PTR [rsp+0x65],rdx
 ...
 29c:	bf 3b 00 00 00       	mov    edi,0x3b
 2a1:	e8 77 fd ff ff       	call   1d <bar>
 2a6:	b8 12 00 00 00       	mov    eax,0x12
 2ab:	5d                   	pop    rbp
 2ac:	c3                   	ret    
