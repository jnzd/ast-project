  ...
  69:	b8 f5 7f 4b 18       	mov    eax,0x184b7ff5
  ...
  9f:	c7 45 d4 4c a2 6f 12 	mov    DWORD PTR [rbp-0x2c],0x126fa24c
  ...
  d6:	be e8 f5 41 24       	mov    esi,0x2441f5e8
 ...
 140:	ba b4 e6 7e 47       	mov    edx,0x477ee6b4
 145:	be 0c f9 b6 61       	mov    esi,0x61b6f90c
 14a:	b8 00 00 00 00       	mov    eax,0x0
 14f:	e8 00 00 00 00       	call   154 <main+0xd0>
 154:	48 83 c4 40          	add    rsp,0x40
 158:	b8 a4 e7 9f 73       	mov    eax,0x739fe7a4
