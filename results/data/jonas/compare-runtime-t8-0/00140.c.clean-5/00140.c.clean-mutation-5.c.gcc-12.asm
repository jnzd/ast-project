  ...
  69:	b8 b6 96 09 26       	mov    eax,0x260996b6
  ...
  9f:	c7 45 d4 28 ed f7 53 	mov    DWORD PTR [rbp-0x2c],0x53f7ed28
  ...
  d6:	be b5 3d 00 18       	mov    esi,0x18003db5
 ...
 140:	ba 5e 0f 50 66       	mov    edx,0x66500f5e
 145:	be 50 ab 2e 1a       	mov    esi,0x1a2eab50
 14a:	b8 00 00 00 00       	mov    eax,0x0
 14f:	e8 00 00 00 00       	call   154 <main+0xd0>
 154:	48 83 c4 40          	add    rsp,0x40
 158:	b8 21 5f dc 12       	mov    eax,0x12dc5f21
