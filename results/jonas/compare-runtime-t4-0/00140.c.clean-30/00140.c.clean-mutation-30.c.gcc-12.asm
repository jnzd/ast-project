  ...
  69:	b8 8e 8a 40 38       	mov    eax,0x38408a8e
  ...
  9f:	c7 45 d4 22 68 fc 42 	mov    DWORD PTR [rbp-0x2c],0x42fc6822
  ...
  d6:	be 89 76 44 26       	mov    esi,0x26447689
 ...
 140:	ba 02 99 34 31       	mov    edx,0x31349902
 145:	be a1 98 b5 35       	mov    esi,0x35b598a1
 14a:	b8 00 00 00 00       	mov    eax,0x0
 14f:	e8 00 00 00 00       	call   154 <main+0xd0>
 154:	48 83 c4 40          	add    rsp,0x40
 158:	b8 c8 1a 00 03       	mov    eax,0x3001ac8
