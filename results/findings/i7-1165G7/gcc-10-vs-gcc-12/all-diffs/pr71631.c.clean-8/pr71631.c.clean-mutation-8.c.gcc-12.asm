  ...
  3e:	c7 45 dc 7e 00 00 00 	mov    DWORD PTR [rbp-0x24],0x7e
  45:	c7 45 e0 0a 00 00 00 	mov    DWORD PTR [rbp-0x20],0xa
  4c:	8b 0d 00 00 00 00    	mov    ecx,DWORD PTR [rip+0x0]        # 52 <main+0x20>
  52:	b8 66 00 00 00       	mov    eax,0x66
  57:	99                   	cdq    
  58:	f7 f9                	idiv   ecx
  ...
  6f:	83 c0 7a             	add    eax,0x7a
  72:	89 45 ec             	mov    DWORD PTR [rbp-0x14],eax
  75:	b8 4b 00 00 00       	mov    eax,0x4b
  7a:	99                   	cdq    
  ...
  cd:	6b c0 9d             	imul   eax,eax,0xffffff9d
  ...
  ea:	83 7d f0 14          	cmp    DWORD PTR [rbp-0x10],0x14
  ...
  ff:	66 83 7d da c3       	cmp    WORD PTR [rbp-0x26],0xffc3
 104:	74 05                	je     10b <main+0xd9>
 106:	e8 00 00 00 00       	call   10b <main+0xd9>
 10b:	b8 53 00 00 00       	mov    eax,0x53
 110:	c9                   	leave  
 111:	c3                   	ret    
