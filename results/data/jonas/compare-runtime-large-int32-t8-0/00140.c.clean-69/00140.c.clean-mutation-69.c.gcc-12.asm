  ...
  69:	b8 11 0a 92 4e       	mov    eax,0x4e920a11
  ...
  9f:	c7 45 d4 2a 46 c9 2d 	mov    DWORD PTR [rbp-0x2c],0x2dc9462a
  ...
  d6:	be fc 37 5e 0f       	mov    esi,0xf5e37fc
 ...
 140:	ba ec 2c 15 67       	mov    edx,0x67152cec
 145:	be bf 8a 2d 29       	mov    esi,0x292d8abf
 14a:	b8 00 00 00 00       	mov    eax,0x0
 14f:	e8 00 00 00 00       	call   154 <main+0xd0>
 154:	48 83 c4 40          	add    rsp,0x40
 158:	b8 0e 13 28 5c       	mov    eax,0x5c28130e
