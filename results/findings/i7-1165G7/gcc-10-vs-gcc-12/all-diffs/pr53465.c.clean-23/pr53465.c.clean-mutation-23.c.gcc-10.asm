  ...
  13:	c7 45 f4 7a 00 00 00 	mov    DWORD PTR [rbp-0xc],0x7a
  1a:	c7 45 f0 17 00 00 00 	mov    DWORD PTR [rbp-0x10],0x17
  ...
  3c:	83 7d fc 1f          	cmp    DWORD PTR [rbp-0x4],0x1f
  ...
  5b:	c7 45 f4 39 00 00 00 	mov    DWORD PTR [rbp-0xc],0x39
