 ...
 2d3:	48 98                	cdqe   
 2d5:	83 e0 0f             	and    eax,0xf
 2d8:	48 89 c1             	mov    rcx,rax
 2db:	48 8b 45 b8          	mov    rax,QWORD PTR [rbp-0x48]
 ...
 307:	83 f8 31             	cmp    eax,0x31
 30a:	74 05                	je     311 <main+0x311>
 30c:	e8 00 00 00 00       	call   311 <main+0x311>
 311:	c6 45 38 20          	mov    BYTE PTR [rbp+0x38],0x20
 315:	c6 45 e9 00          	mov    BYTE PTR [rbp-0x17],0x0
 319:	c7 05 00 00 00 00 47 	mov    DWORD PTR [rip+0x0],0x47        # 323 <main+0x323>
 320:	00 00 00 
 323:	c7 05 00 00 00 00 68 	mov    DWORD PTR [rip+0x0],0x68        # 32d <main+0x32d>
 32a:	00 00 00 
 ...
 33c:	48 98                	cdqe   
 33e:	83 e0 40             	and    eax,0x40
 341:	48 89 c2             	mov    rdx,rax
 344:	48 8b 45 b8          	mov    rax,QWORD PTR [rbp-0x48]
 348:	48 8d 0c 02          	lea    rcx,[rdx+rax*1]
 34c:	48 8d 45 c0          	lea    rax,[rbp-0x40]
 350:	48 83 c0 2c          	add    rax,0x2c
 ...
 367:	48 8d 45 c0          	lea    rax,[rbp-0x40]
 36b:	48 83 c0 25          	add    rax,0x25
 36f:	48 39 c2             	cmp    rdx,rax
 372:	75 26                	jne    39a <main+0x39a>
 374:	8b 05 00 00 00 00    	mov    eax,DWORD PTR [rip+0x0]        # 37a <main+0x37a>
 37a:	83 f8 47             	cmp    eax,0x47
 37d:	75 1b                	jne    39a <main+0x39a>
 37f:	48 8d 45 c0          	lea    rax,[rbp-0x40]
 383:	48 83 c0 50          	add    rax,0x50
 ...
 39f:	48 8d 45 c0          	lea    rax,[rbp-0x40]
 3a3:	ba 23 00 00 00       	mov    edx,0x23
 ...
 4b1:	00 00 00 
 4b4:	ba 48 00 00 00       	mov    edx,0x48
 ...
 55d:	ba 05 00 00 00       	mov    edx,0x5
 ...
 581:	83 f8 50             	cmp    eax,0x50
 584:	75 1c                	jne    5a2 <main+0x5a2>
 586:	ba 34 00 00 00       	mov    edx,0x34
 ...
 5a7:	c7 05 00 00 00 00 74 	mov    DWORD PTR [rip+0x0],0x74        # 5b1 <main+0x5b1>
 5ae:	00 00 00 
 ...
 5e7:	be 3f 00 00 00       	mov    esi,0x3f
 ...
 65b:	ba 15 00 00 00       	mov    edx,0x15
 660:	be 1f 00 00 00       	mov    esi,0x1f
 ...
 6a8:	b8 50 00 00 00       	mov    eax,0x50
