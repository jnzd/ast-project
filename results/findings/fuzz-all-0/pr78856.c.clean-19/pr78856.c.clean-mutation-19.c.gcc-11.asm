  ...
  19:	c7 45 f0 0d 00 00 00 	mov    DWORD PTR [rbp-0x10],0xd
  20:	c7 45 f8 5f 00 00 00 	mov    DWORD PTR [rbp-0x8],0x5f
  27:	e9 8a 00 00 00       	jmp    b6 <main+0xb6>
  2c:	c7 45 fc 6d 00 00 00 	mov    DWORD PTR [rbp-0x4],0x6d
  33:	c7 45 f4 4a 00 00 00 	mov    DWORD PTR [rbp-0xc],0x4a
  ...
  50:	c7 04 02 23 00 00 00 	mov    DWORD PTR [rdx+rax*1],0x23
  57:	83 45 f4 01          	add    DWORD PTR [rbp-0xc],0x1
  5b:	83 7d f4 33          	cmp    DWORD PTR [rbp-0xc],0x33
  ...
  8f:	c7 45 f8 04 00 00 00 	mov    DWORD PTR [rbp-0x8],0x4
  ...
  ac:	83 7d fc 6b          	cmp    DWORD PTR [rbp-0x4],0x6b
  b0:	7e b1                	jle    63 <main+0x63>
  b2:	83 45 f0 1e          	add    DWORD PTR [rbp-0x10],0x1e
  b6:	83 7d f0 7c          	cmp    DWORD PTR [rbp-0x10],0x7c
  ba:	0f 8e 6c ff ff ff    	jle    2c <main+0x2c>
  c0:	bf 4d 00 00 00       	mov    edi,0x4d
