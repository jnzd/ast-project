  ...
  6c:	c6 05 00 00 00 00 6c 	mov    BYTE PTR [rip+0x0],0x6c        # 73 <baz+0x39>
  ...
  8c:	48 c7 05 00 00 00 00 	mov    QWORD PTR [rip+0x0],0x5b        # 97 <baz+0x5d>
  93:	5b 00 00 00 
  97:	eb 11                	jmp    aa <baz+0x70>
  99:	8b 45 fc             	mov    eax,DWORD PTR [rbp-0x4]
  9c:	eb 38                	jmp    d6 <baz+0x9c>
  9e:	c7 05 00 00 00 00 30 	mov    DWORD PTR [rip+0x0],0x30        # a8 <baz+0x6e>
  a5:	00 00 00 
 ...
 143:	83 e0 41             	and    eax,0x41
 146:	48 31 d0             	xor    rax,rdx
 149:	83 e0 4a             	and    eax,0x4a
 ...
 170:	83 e0 3c             	and    eax,0x3c
 173:	48 31 d0             	xor    rax,rdx
 176:	83 e0 49             	and    eax,0x49
 ...
 19c:	48 81 ec f0 00 00 00 	sub    rsp,0xf0
 1a3:	64 48 8b 04 25 28 00 	mov    rax,QWORD PTR fs:0x28
 1aa:	00 00 
 1ac:	48 89 45 f8          	mov    QWORD PTR [rbp-0x8],rax
 1b0:	31 c0                	xor    eax,eax
 1b2:	c7 85 10 ff ff ff 61 	mov    DWORD PTR [rbp-0xf0],0x61
 1b9:	00 00 00 
 1bc:	c7 85 14 ff ff ff 02 	mov    DWORD PTR [rbp-0xec],0x2
 1c3:	00 00 00 
 ...
 1df:	83 f8 57             	cmp    eax,0x57
 1e2:	75 0a                	jne    1ee <main+0x5a>
 1e4:	c7 85 10 ff ff ff 7c 	mov    DWORD PTR [rbp-0xf0],0x7c
 1eb:	00 00 00 
 1ee:	c7 85 18 ff ff ff 64 	mov    DWORD PTR [rbp-0xe8],0x64
 1f5:	00 00 00 
 1f8:	eb 4d                	jmp    247 <main+0xb3>
 1fa:	c7 85 1c ff ff ff 04 	mov    DWORD PTR [rbp-0xe4],0x4
 201:	00 00 00 
 204:	eb 11                	jmp    217 <main+0x83>
 206:	c7 85 14 ff ff ff 09 	mov    DWORD PTR [rbp-0xec],0x9
 20d:	00 00 00 
 210:	83 ad 1c ff ff ff 01 	sub    DWORD PTR [rbp-0xe4],0x1
 217:	83 bd 1c ff ff ff 05 	cmp    DWORD PTR [rbp-0xe4],0x5
 21e:	7f e6                	jg     206 <main+0x72>
 220:	8b 85 18 ff ff ff    	mov    eax,DWORD PTR [rbp-0xe8]
 226:	48 98                	cdqe   
 228:	48 8d 0c 85 00 00 00 	lea    rcx,[rax*4+0x0]
 22f:	00 
 230:	48 8d 15 00 00 00 00 	lea    rdx,[rip+0x0]        # 237 <main+0xa3>
 237:	8b 85 14 ff ff ff    	mov    eax,DWORD PTR [rbp-0xec]
 23d:	89 04 11             	mov    DWORD PTR [rcx+rdx*1],eax
 240:	83 85 18 ff ff ff 01 	add    DWORD PTR [rbp-0xe8],0x1
 247:	83 bd 18 ff ff ff 56 	cmp    DWORD PTR [rbp-0xe8],0x56
 24e:	7e aa                	jle    1fa <main+0x66>
 250:	c7 85 18 ff ff ff 48 	mov    DWORD PTR [rbp-0xe8],0x48
 257:	00 00 00 
 25a:	eb 1a                	jmp    276 <main+0xe2>
 25c:	8b 85 18 ff ff ff    	mov    eax,DWORD PTR [rbp-0xe8]
 262:	48 98                	cdqe   
 264:	c7 84 85 20 ff ff ff 	mov    DWORD PTR [rbp+rax*4-0xe0],0x30
 26b:	30 00 00 00 
 26f:	83 85 18 ff ff ff 01 	add    DWORD PTR [rbp-0xe8],0x1
 276:	83 bd 18 ff ff ff 00 	cmp    DWORD PTR [rbp-0xe8],0x0
 27d:	78 dd                	js     25c <main+0xc8>
 ...
 2a5:	8b 45 c4             	mov    eax,DWORD PTR [rbp-0x3c]
 2a8:	48 98                	cdqe   
 2aa:	be 2a 00 00 00       	mov    esi,0x2a
 2af:	48 89 c7             	mov    rdi,rax
 2b2:	e8 49 fd ff ff       	call   0 <foo>
 2b7:	83 c8 08             	or     eax,0x8
 ...
 2dc:	48 98                	cdqe   
 2de:	8b 95 10 ff ff ff    	mov    edx,DWORD PTR [rbp-0xf0]
 ...
 2f8:	8b 85 10 ff ff ff    	mov    eax,DWORD PTR [rbp-0xf0]
