  ...
  6f:	83 c0 02             	add    eax,0x2
  72:	89 45 ec             	mov    DWORD PTR [rbp-0x14],eax
  75:	b8 72 00 00 00       	mov    eax,0x72
  7a:	99                   	cdq    
  ...
  cd:	6b c0 b1             	imul   eax,eax,0xffffffb1
  ...
  ea:	83 7d f0 51          	cmp    DWORD PTR [rbp-0x10],0x51
  ...
  ff:	66 83 7d da ed       	cmp    WORD PTR [rbp-0x26],0xffed
 104:	74 05                	je     10b <main+0xd9>
 106:	e8 00 00 00 00       	call   10b <main+0xd9>
 10b:	b8 4f 00 00 00       	mov    eax,0x4f
 110:	c9                   	leave  
 111:	c3                   	ret    
