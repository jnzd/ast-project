  ...
  65:	b8 0b 22 08 24       	mov    eax,0x2408220b
  ...
  88:	c7 45 e4 53 56 3b 22 	mov    DWORD PTR [rbp-0x1c],0x223b5653
  ...
  bf:	be 39 6b 4b 2b       	mov    esi,0x2b4b6b39
 ...
 129:	ba a4 91 37 0b       	mov    edx,0xb3791a4
 12e:	be aa af ce 2b       	mov    esi,0x2bceafaa
 133:	b8 00 00 00 00       	mov    eax,0x0
 138:	e8 00 00 00 00       	call   13d <main+0xbd>
 13d:	48 83 c4 40          	add    rsp,0x40
 141:	b8 f1 17 f7 18       	mov    eax,0x18f717f1
 146:	c9                   	leave
 147:	c3                   	ret
