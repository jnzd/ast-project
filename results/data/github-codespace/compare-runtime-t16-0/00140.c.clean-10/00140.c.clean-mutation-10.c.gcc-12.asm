  ...
  65:	b8 9d f1 9c 79       	mov    eax,0x799cf19d
  ...
  88:	c7 45 e4 a3 b0 12 04 	mov    DWORD PTR [rbp-0x1c],0x412b0a3
  ...
  bf:	be ff 14 bc 3a       	mov    esi,0x3abc14ff
 ...
 129:	ba 89 5b c6 00       	mov    edx,0xc65b89
 12e:	be cb 73 34 21       	mov    esi,0x213473cb
 133:	b8 00 00 00 00       	mov    eax,0x0
 138:	e8 00 00 00 00       	call   13d <main+0xbd>
 13d:	48 83 c4 40          	add    rsp,0x40
 141:	b8 5a 6f d6 3d       	mov    eax,0x3dd66f5a
 146:	c9                   	leave
 147:	c3                   	ret
