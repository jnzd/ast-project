  ...
  69:	b8 42 e9 1a 6b       	mov    eax,0x6b1ae942
  ...
  9f:	c7 45 d4 f8 0a c3 17 	mov    DWORD PTR [rbp-0x2c],0x17c30af8
  ...
  d6:	be 67 5c 21 05       	mov    esi,0x5215c67
 ...
 140:	ba af 3f 5a 42       	mov    edx,0x425a3faf
 145:	be a8 76 c4 25       	mov    esi,0x25c476a8
 14a:	b8 00 00 00 00       	mov    eax,0x0
 14f:	e8 00 00 00 00       	call   154 <main+0xd0>
 154:	48 83 c4 40          	add    rsp,0x40
 158:	b8 57 c9 ec 49       	mov    eax,0x49ecc957
