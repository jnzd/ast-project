   ...
   b:	c7 45 f8 f0 ff ff ff 	mov    DWORD PTR [rbp-0x8],0xfffffff0
  ...
  39:	83 45 fc 60          	add    DWORD PTR [rbp-0x4],0x60
  ...
  5b:	c7 45 f8 1d 00 00 00 	mov    DWORD PTR [rbp-0x8],0x1d
  ...
  6f:	bf 78 00 00 00       	mov    edi,0x78
