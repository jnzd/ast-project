  ...
  21:	48 8d 45 b0          	lea    rax,[rbp-0x50]
  ...
  67:	83 f8 53             	cmp    eax,0x53
  6a:	74 05                	je     71 <main+0x71>
  6c:	e8 00 00 00 00       	call   71 <main+0x71>
  71:	c7 05 00 00 00 00 25 	mov    DWORD PTR [rip+0x0],0x25        # 7b <main+0x7b>
  78:	00 00 00 
  7b:	8b 15 00 00 00 00    	mov    edx,DWORD PTR [rip+0x0]        # 81 <main+0x81>
  81:	48 8d 45 b0          	lea    rax,[rbp-0x50]
  ...
  c7:	83 f8 1d             	cmp    eax,0x1d
  ca:	74 05                	je     d1 <main+0xd1>
  cc:	e8 00 00 00 00       	call   d1 <main+0xd1>
  d1:	c7 05 00 00 00 00 58 	mov    DWORD PTR [rip+0x0],0x58        # db <main+0xdb>
  d8:	00 00 00 
  db:	8b 15 00 00 00 00    	mov    edx,DWORD PTR [rip+0x0]        # e1 <main+0xe1>
  e1:	48 8d 45 b0          	lea    rax,[rbp-0x50]
 ...
 10c:	48 8d 45 b0          	lea    rax,[rbp-0x50]
