  ...
  69:	b8 b1 bf 34 39       	mov    eax,0x3934bfb1
  ...
  9f:	c7 45 d4 08 3e 6d 06 	mov    DWORD PTR [rbp-0x2c],0x66d3e08
  ...
  d6:	be 03 95 92 6c       	mov    esi,0x6c929503
 ...
 140:	ba 63 b5 1a 2b       	mov    edx,0x2b1ab563
 145:	be c2 33 a9 20       	mov    esi,0x20a933c2
 14a:	b8 00 00 00 00       	mov    eax,0x0
 14f:	e8 00 00 00 00       	call   154 <main+0xd0>
 154:	48 83 c4 40          	add    rsp,0x40
 158:	b8 19 1d 06 18       	mov    eax,0x18061d19
