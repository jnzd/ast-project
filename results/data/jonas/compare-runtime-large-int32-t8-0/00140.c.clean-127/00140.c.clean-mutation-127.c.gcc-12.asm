  ...
  69:	b8 bf da cd 6d       	mov    eax,0x6dcddabf
  ...
  9f:	c7 45 d4 f6 ce da 2a 	mov    DWORD PTR [rbp-0x2c],0x2adacef6
  ...
  d6:	be 84 01 0c 23       	mov    esi,0x230c0184
 ...
 140:	ba c2 81 21 0e       	mov    edx,0xe2181c2
 145:	be cb 78 95 28       	mov    esi,0x289578cb
 14a:	b8 00 00 00 00       	mov    eax,0x0
 14f:	e8 00 00 00 00       	call   154 <main+0xd0>
 154:	48 83 c4 40          	add    rsp,0x40
 158:	b8 e7 b2 7d 7f       	mov    eax,0x7f7db2e7
