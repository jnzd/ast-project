  ...
  69:	b8 58 2e db 49       	mov    eax,0x49db2e58
  ...
  9f:	c7 45 d4 fe ec 43 05 	mov    DWORD PTR [rbp-0x2c],0x543ecfe
  ...
  bc:	be 81 75 97 6a       	mov    esi,0x6a977581
