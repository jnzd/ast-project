  ...
  69:	b8 71 77 ce 18       	mov    eax,0x18ce7771
  ...
  9f:	c7 45 d4 6d 6f 65 18 	mov    DWORD PTR [rbp-0x2c],0x18656f6d
  ...
  d6:	be ff bc a6 25       	mov    esi,0x25a6bcff
 ...
 140:	ba f4 d5 82 63       	mov    edx,0x6382d5f4
 145:	be c3 86 23 44       	mov    esi,0x442386c3
 14a:	b8 00 00 00 00       	mov    eax,0x0
 14f:	e8 00 00 00 00       	call   154 <main+0xd0>
 154:	48 83 c4 40          	add    rsp,0x40
 158:	b8 8d b4 f1 38       	mov    eax,0x38f1b48d
