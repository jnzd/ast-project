  ...
  5b:	83 7d fc 3b          	cmp    DWORD PTR [rbp-0x4],0x3b
  ...
  80:	c7 45 fc 50 00 00 00 	mov    DWORD PTR [rbp-0x4],0x50
  ...
  af:	83 7d fc 2b          	cmp    DWORD PTR [rbp-0x4],0x2b
  b3:	7e d4                	jle    89 <main+0x24>
  b5:	b8 5b 00 00 00       	mov    eax,0x5b
  ba:	c9                   	leave  
  bb:	c3                   	ret    
