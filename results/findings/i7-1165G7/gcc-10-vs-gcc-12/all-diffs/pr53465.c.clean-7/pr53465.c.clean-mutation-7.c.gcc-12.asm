  ...
  13:	c7 45 f4 14 00 00 00 	mov    DWORD PTR [rbp-0xc],0x14
  1a:	c7 45 f0 54 00 00 00 	mov    DWORD PTR [rbp-0x10],0x54
  ...
  3c:	83 7d fc 2b          	cmp    DWORD PTR [rbp-0x4],0x2b
  ...
  5b:	c7 45 f4 33 00 00 00 	mov    DWORD PTR [rbp-0xc],0x33
