  ...
  61:	83 f8 46             	cmp    eax,0x46
  64:	74 05                	je     6b <main+0x6b>
  66:	e8 00 00 00 00       	call   6b <main+0x6b>
  6b:	c7 05 00 00 00 00 1d 	mov    DWORD PTR [rip+0x0],0x1d        # 75 <main+0x75>
  72:	00 00 00 
  ...
  bb:	83 f8 6a             	cmp    eax,0x6a
  be:	74 05                	je     c5 <main+0xc5>
  c0:	e8 00 00 00 00       	call   c5 <main+0xc5>
  c5:	c7 05 00 00 00 00 55 	mov    DWORD PTR [rip+0x0],0x55        # cf <main+0xcf>
  cc:	00 00 00 
