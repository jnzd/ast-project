  ...
  69:	b8 67 23 eb 2c       	mov    eax,0x2ceb2367
  ...
  9f:	c7 45 d4 d0 75 23 02 	mov    DWORD PTR [rbp-0x2c],0x22375d0
  ...
  bc:	be af 57 8a 53       	mov    esi,0x538a57af
