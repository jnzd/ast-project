   ...
   b:	c7 45 f8 b0 ff ff ff 	mov    DWORD PTR [rbp-0x8],0xffffffb0
  ...
  27:	ba 7d 00 00 00       	mov    edx,0x7d
  ...
  39:	83 45 fc 24          	add    DWORD PTR [rbp-0x4],0x24
  ...
  5b:	c7 45 f8 64 00 00 00 	mov    DWORD PTR [rbp-0x8],0x64
  ...
  6f:	bf 59 00 00 00       	mov    edi,0x59
