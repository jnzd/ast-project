  ...
  2a:	bf 29 00 00 00       	mov    edi,0x29
  ...
  4b:	83 7d ec 3f          	cmp    DWORD PTR [rbp-0x14],0x3f
  4f:	75 07                	jne    58 <foo+0x24>
  51:	b8 22 00 00 00       	mov    eax,0x22
  ...
  6e:	b8 38 00 00 00       	mov    eax,0x38
  73:	c9                   	leave  
  74:	c3                   	ret    
