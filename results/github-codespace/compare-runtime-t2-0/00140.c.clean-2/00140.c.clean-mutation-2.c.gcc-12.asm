  ...
  65:	b8 2c 7a 2c 1a       	mov    eax,0x1a2c7a2c
  ...
  88:	c7 45 e4 25 5e 94 2f 	mov    DWORD PTR [rbp-0x1c],0x2f945e25
  ...
  bf:	be 5c f5 73 19       	mov    esi,0x1973f55c
 ...
 129:	ba c6 d1 8c 59       	mov    edx,0x598cd1c6
 12e:	be b6 86 50 04       	mov    esi,0x45086b6
 133:	b8 00 00 00 00       	mov    eax,0x0
 138:	e8 00 00 00 00       	call   13d <main+0xbd>
 13d:	48 83 c4 40          	add    rsp,0x40
 141:	b8 04 4d 73 35       	mov    eax,0x35734d04
 146:	c9                   	leave
 147:	c3                   	ret
