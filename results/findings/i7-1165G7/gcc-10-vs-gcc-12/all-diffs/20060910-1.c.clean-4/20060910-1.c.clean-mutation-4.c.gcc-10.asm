  ...
  23:	c7 45 fc 12 00 00 00 	mov    DWORD PTR [rbp-0x4],0x12
  ...
  db:	b8 24 00 00 00       	mov    eax,0x24
  e0:	5d                   	pop    rbp
  e1:	c3                   	ret    
