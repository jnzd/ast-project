  ...
  67:	83 f8 39             	cmp    eax,0x39
  6a:	74 05                	je     71 <main+0x71>
  6c:	e8 00 00 00 00       	call   71 <main+0x71>
  71:	c7 05 00 00 00 00 12 	mov    DWORD PTR [rip+0x0],0x12        # 7b <main+0x7b>
  78:	00 00 00 
  ...
  d0:	c7 05 00 00 00 00 43 	mov    DWORD PTR [rip+0x0],0x43        # da <main+0xda>
  d7:	00 00 00 
