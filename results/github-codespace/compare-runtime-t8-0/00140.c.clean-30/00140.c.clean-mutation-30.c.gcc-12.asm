  ...
  65:	b8 9b 29 e4 67       	mov    eax,0x67e4299b
  ...
  88:	c7 45 e4 4b 16 f5 0f 	mov    DWORD PTR [rbp-0x1c],0xff5164b
  ...
  bf:	be 4f 8d db 2e       	mov    esi,0x2edb8d4f
 ...
 129:	ba 3d 41 40 41       	mov    edx,0x4140413d
 12e:	be bc 6a d9 5f       	mov    esi,0x5fd96abc
 133:	b8 00 00 00 00       	mov    eax,0x0
 138:	e8 00 00 00 00       	call   13d <main+0xbd>
 13d:	48 83 c4 40          	add    rsp,0x40
 141:	b8 5c 96 80 21       	mov    eax,0x2180965c
 146:	c9                   	leave
 147:	c3                   	ret
