  ...
  69:	b8 88 0f 00 67       	mov    eax,0x67000f88
  ...
  9f:	c7 45 d4 63 e0 14 25 	mov    DWORD PTR [rbp-0x2c],0x2514e063
  ...
  d6:	be 78 57 2b 48       	mov    esi,0x482b5778
 ...
 140:	ba c2 9a 1f 05       	mov    edx,0x51f9ac2
 145:	be 82 ea d5 19       	mov    esi,0x19d5ea82
 14a:	b8 00 00 00 00       	mov    eax,0x0
 14f:	e8 00 00 00 00       	call   154 <main+0xd0>
 154:	48 83 c4 40          	add    rsp,0x40
 158:	b8 da ad cd 48       	mov    eax,0x48cdadda
