  ...
  19:	83 7d fc 78          	cmp    DWORD PTR [rbp-0x4],0x78
  ...
  40:	c7 45 fc 01 00 00 00 	mov    DWORD PTR [rbp-0x4],0x1
  47:	eb 04                	jmp    4d <bar+0x19>
  49:	83 45 fc 01          	add    DWORD PTR [rbp-0x4],0x1
  4d:	83 7d fc 76          	cmp    DWORD PTR [rbp-0x4],0x76
  ...
  c3:	83 f8 49             	cmp    eax,0x49
  c6:	74 05                	je     cd <main+0x64>
  c8:	e8 00 00 00 00       	call   cd <main+0x64>
  cd:	c6 45 45 4d          	mov    BYTE PTR [rbp+0x45],0x4d
