  ...
  69:	b8 97 61 d1 09       	mov    eax,0x9d16197
  ...
  9f:	c7 45 d4 4a 8e 4d 36 	mov    DWORD PTR [rbp-0x2c],0x364d8e4a
  ...
  bc:	be 6b f9 b1 48       	mov    esi,0x48b1f96b
