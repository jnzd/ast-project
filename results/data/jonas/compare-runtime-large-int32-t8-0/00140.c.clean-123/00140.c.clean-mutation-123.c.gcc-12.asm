  ...
  69:	b8 c2 c2 11 75       	mov    eax,0x7511c2c2
  ...
  9f:	c7 45 d4 c8 29 5b 2f 	mov    DWORD PTR [rbp-0x2c],0x2f5b29c8
  ...
  d6:	be 62 c0 55 2f       	mov    esi,0x2f55c062
 ...
 140:	ba 2d 5d 20 50       	mov    edx,0x50205d2d
 145:	be 07 33 de 40       	mov    esi,0x40de3307
 14a:	b8 00 00 00 00       	mov    eax,0x0
 14f:	e8 00 00 00 00       	call   154 <main+0xd0>
 154:	48 83 c4 40          	add    rsp,0x40
 158:	b8 46 55 c9 17       	mov    eax,0x17c95546
