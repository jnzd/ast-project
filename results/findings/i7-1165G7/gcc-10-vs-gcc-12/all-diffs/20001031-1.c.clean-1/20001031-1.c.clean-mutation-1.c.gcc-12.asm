   ...
   f:	83 7d fc 1e          	cmp    DWORD PTR [rbp-0x4],0x1e
  ...
  29:	c7 45 fc 21 00 00 00 	mov    DWORD PTR [rbp-0x4],0x21
  30:	8b 45 fc             	mov    eax,DWORD PTR [rbp-0x4]
  33:	83 c0 50             	add    eax,0x50
  ...
  71:	48 c7 45 f8 40 00 00 	mov    QWORD PTR [rbp-0x8],0x40
  78:	00 
  79:	b8 3f 00 00 80       	mov    eax,0x8000003f
  ...
  b3:	bf 35 00 00 00       	mov    edi,0x35
