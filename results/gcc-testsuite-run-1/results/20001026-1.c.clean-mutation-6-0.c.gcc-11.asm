  ...
  34:	c7 85 7c ff ff ff 44 	mov    DWORD PTR [rbp-0x84],0x44
  3b:	00 00 00 
  3e:	eb 18                	jmp    58 <real_value_from_int_cst+0x58>
  40:	8b 85 7c ff ff ff    	mov    eax,DWORD PTR [rbp-0x84]
  46:	48 98                	cdqe   
  48:	48 c7 44 c5 80 9a ff 	mov    QWORD PTR [rbp+rax*8-0x80],0xffffffffffffff9a
  4f:	ff ff 
 ...
 1f0:	48 be 08 08 08 08 08 	movabs rsi,0x808080808080808
 1f7:	08 08 08 
 1fa:	48 bf 08 08 08 08 08 	movabs rdi,0x808080808080808
 201:	08 08 08 
 ...
 23b:	48 b9 08 08 08 08 08 	movabs rcx,0x808080808080808
 242:	08 08 08 
 ...
 25a:	48 8b 45 a0          	mov    rax,QWORD PTR [rbp-0x60]
 25e:	48 83 f8 21          	cmp    rax,0x21
 262:	75 05                	jne    269 <main+0x98>
 264:	e8 00 00 00 00       	call   269 <main+0x98>
 269:	b8 11 00 00 00       	mov    eax,0x11
