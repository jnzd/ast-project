  ...
  27:	ba 5e 00 00 00       	mov    edx,0x5e
  ...
  39:	83 45 fc 7d          	add    DWORD PTR [rbp-0x4],0x7d
  ...
  5b:	c7 45 f8 32 00 00 00 	mov    DWORD PTR [rbp-0x8],0x32
  ...
  6f:	bf 6b 00 00 00       	mov    edi,0x6b
