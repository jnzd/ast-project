  ...
  69:	b8 c2 ff 99 5e       	mov    eax,0x5e99ffc2
  ...
  9f:	c7 45 d4 b1 45 2d 4e 	mov    DWORD PTR [rbp-0x2c],0x4e2d45b1
  ...
  bc:	be 53 2f b6 00       	mov    esi,0xb62f53
