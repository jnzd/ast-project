  ...
  69:	b8 24 67 98 02       	mov    eax,0x2986724
  ...
  9f:	c7 45 d4 a3 5f 2b 3d 	mov    DWORD PTR [rbp-0x2c],0x3d2b5fa3
  ...
  bc:	be 09 1b 75 2b       	mov    esi,0x2b751b09
