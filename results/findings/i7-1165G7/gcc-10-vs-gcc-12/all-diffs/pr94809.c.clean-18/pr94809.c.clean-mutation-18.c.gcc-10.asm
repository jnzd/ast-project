   ...
   c:	c7 45 f4 37 00 00 00 	mov    DWORD PTR [rbp-0xc],0x37
  13:	48 c7 45 f8 7b 00 00 	mov    QWORD PTR [rbp-0x8],0x7b
  1a:	00 
  ...
  2a:	83 7d f4 1a          	cmp    DWORD PTR [rbp-0xc],0x1a
  2e:	74 05                	je     35 <main+0x35>
  30:	e8 00 00 00 00       	call   35 <main+0x35>
  35:	b8 19 00 00 00       	mov    eax,0x19
  3a:	c9                   	leave  
  3b:	c3                   	ret    
