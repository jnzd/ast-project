  ...
  65:	b8 a1 3b 58 03       	mov    eax,0x3583ba1
  ...
  88:	c7 45 e4 66 6c 45 48 	mov    DWORD PTR [rbp-0x1c],0x48456c66
  ...
  bf:	be 91 cd 36 03       	mov    esi,0x336cd91
 ...
 129:	ba c5 8c d8 66       	mov    edx,0x66d88cc5
 12e:	be 6b 8f 73 33       	mov    esi,0x33738f6b
 133:	b8 00 00 00 00       	mov    eax,0x0
 138:	e8 00 00 00 00       	call   13d <main+0xbd>
 13d:	48 83 c4 40          	add    rsp,0x40
 141:	b8 7b 8c b2 1a       	mov    eax,0x1ab28c7b
 146:	c9                   	leave
 147:	c3                   	ret
