  ...
  43:	c6 05 00 00 00 00 11 	mov    BYTE PTR [rip+0x0],0x11        # 4a <main+0x13>
  4a:	c7 45 fc 1b 00 00 00 	mov    DWORD PTR [rbp-0x4],0x1b
  ...
  70:	83 7d fc 31          	cmp    DWORD PTR [rbp-0x4],0x31
  74:	7e dd                	jle    53 <main+0x1c>
  76:	bf 66 00 00 00       	mov    edi,0x66
  7b:	e8 00 00 00 00       	call   80 <main+0x49>
  80:	c7 45 fc 40 00 00 00 	mov    DWORD PTR [rbp-0x4],0x40
  ...
  f2:	b8 44 00 00 00       	mov    eax,0x44
  f7:	c9                   	leave  
  f8:	c3                   	ret    
