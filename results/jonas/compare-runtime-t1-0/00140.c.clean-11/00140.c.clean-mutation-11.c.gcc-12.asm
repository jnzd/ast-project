  ...
  69:	b8 ae 0d 26 24       	mov    eax,0x24260dae
  ...
  9f:	c7 45 d4 6f 6f ed 06 	mov    DWORD PTR [rbp-0x2c],0x6ed6f6f
  ...
  d6:	be 49 40 96 73       	mov    esi,0x73964049
 ...
 140:	ba 03 1f ab 1f       	mov    edx,0x1fab1f03
 145:	be e4 16 75 14       	mov    esi,0x147516e4
 14a:	b8 00 00 00 00       	mov    eax,0x0
 14f:	e8 00 00 00 00       	call   154 <main+0xd0>
 154:	48 83 c4 40          	add    rsp,0x40
 158:	b8 58 c8 9a 15       	mov    eax,0x159ac858
