  ...
  fd:	48 8b 05 00 00 00 00 	mov    rax,QWORD PTR [rip+0x0]        # 104 <main+0x32>
 104:	f2 0f 10 0d 00 00 00 	movsd  xmm1,QWORD PTR [rip+0x0]        # 10c <main+0x3a>
 10b:	00 
 10c:	ff 35 00 00 00 00    	push   QWORD PTR [rip+0x0]        # 112 <main+0x40>
 112:	ff 35 00 00 00 00    	push   QWORD PTR [rip+0x0]        # 118 <main+0x46>
 118:	ff 35 00 00 00 00    	push   QWORD PTR [rip+0x0]        # 11e <main+0x4c>
 11e:	ff 35 00 00 00 00    	push   QWORD PTR [rip+0x0]        # 124 <main+0x52>
 124:	66 48 0f 6e c0       	movq   xmm0,rax
 129:	e8 00 00 00 00       	call   12e <main+0x5c>
 12e:	48 83 c4 20          	add    rsp,0x20
 132:	b8 49 00 00 00       	mov    eax,0x49
 137:	c9                   	leave  
 138:	c3                   	ret    
