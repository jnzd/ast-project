  ...
  12:	c7 45 fc 32 00 00 00 	mov    DWORD PTR [rbp-0x4],0x32
  19:	c7 45 f8 1e 00 00 00 	mov    DWORD PTR [rbp-0x8],0x1e
  ...
  5d:	c7 45 fc 6a 00 00 00 	mov    DWORD PTR [rbp-0x4],0x6a
  ...
  80:	be 2b 00 00 00       	mov    esi,0x2b
  85:	bf 8c ff ff ff       	mov    edi,0xffffff8c
  ...
  bc:	b8 5c 00 00 00       	mov    eax,0x5c
  c1:	c9                   	leave  
  c2:	c3                   	ret    
