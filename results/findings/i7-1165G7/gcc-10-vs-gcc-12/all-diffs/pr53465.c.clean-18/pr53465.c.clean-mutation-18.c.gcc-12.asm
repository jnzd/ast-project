  ...
  13:	c7 45 f4 59 00 00 00 	mov    DWORD PTR [rbp-0xc],0x59
  1a:	c7 45 f0 68 00 00 00 	mov    DWORD PTR [rbp-0x10],0x68
  ...
  3c:	83 7d fc 72          	cmp    DWORD PTR [rbp-0x4],0x72
  ...
  5b:	c7 45 f4 6c 00 00 00 	mov    DWORD PTR [rbp-0xc],0x6c
