  ...
  19:	c7 45 f0 1d 00 00 00 	mov    DWORD PTR [rbp-0x10],0x1d
  20:	c7 45 f8 4d 00 00 00 	mov    DWORD PTR [rbp-0x8],0x4d
  27:	e9 8a 00 00 00       	jmp    b6 <main+0xb6>
  2c:	c7 45 fc 79 00 00 00 	mov    DWORD PTR [rbp-0x4],0x79
  33:	c7 45 f4 09 00 00 00 	mov    DWORD PTR [rbp-0xc],0x9
  ...
  50:	c7 04 02 69 00 00 00 	mov    DWORD PTR [rdx+rax*1],0x69
  57:	83 45 f4 01          	add    DWORD PTR [rbp-0xc],0x1
  5b:	83 7d f4 2c          	cmp    DWORD PTR [rbp-0xc],0x2c
  ...
  8f:	c7 45 f8 5b 00 00 00 	mov    DWORD PTR [rbp-0x8],0x5b
  ...
  ac:	83 7d fc 66          	cmp    DWORD PTR [rbp-0x4],0x66
  b0:	7e b1                	jle    63 <main+0x63>
  b2:	83 45 f0 0c          	add    DWORD PTR [rbp-0x10],0xc
  b6:	83 7d f0 18          	cmp    DWORD PTR [rbp-0x10],0x18
  ba:	0f 8e 6c ff ff ff    	jle    2c <main+0x2c>
  c0:	bf 25 00 00 00       	mov    edi,0x25
