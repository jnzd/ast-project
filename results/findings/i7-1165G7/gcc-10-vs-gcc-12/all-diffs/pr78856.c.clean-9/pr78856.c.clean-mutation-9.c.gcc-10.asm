  ...
  19:	c7 45 f0 6f 00 00 00 	mov    DWORD PTR [rbp-0x10],0x6f
  20:	c7 45 f8 24 00 00 00 	mov    DWORD PTR [rbp-0x8],0x24
  27:	e9 8a 00 00 00       	jmp    b6 <main+0xb6>
  2c:	c7 45 fc 67 00 00 00 	mov    DWORD PTR [rbp-0x4],0x67
  33:	c7 45 f4 7e 00 00 00 	mov    DWORD PTR [rbp-0xc],0x7e
  ...
  50:	c7 04 02 6d 00 00 00 	mov    DWORD PTR [rdx+rax*1],0x6d
  57:	83 45 f4 01          	add    DWORD PTR [rbp-0xc],0x1
  5b:	83 7d f4 6d          	cmp    DWORD PTR [rbp-0xc],0x6d
  ...
  8f:	c7 45 f8 31 00 00 00 	mov    DWORD PTR [rbp-0x8],0x31
  ...
  ac:	83 7d fc 6e          	cmp    DWORD PTR [rbp-0x4],0x6e
  b0:	7e b1                	jle    63 <main+0x63>
  b2:	83 45 f0 56          	add    DWORD PTR [rbp-0x10],0x56
  b6:	83 7d f0 59          	cmp    DWORD PTR [rbp-0x10],0x59
  ba:	0f 8e 6c ff ff ff    	jle    2c <main+0x2c>
  c0:	bf 12 00 00 00       	mov    edi,0x12
