  ...
  22:	c7 45 f8 60 00 00 00 	mov    DWORD PTR [rbp-0x8],0x60
  29:	e9 8a 00 00 00       	jmp    b8 <main+0xb8>
  2e:	c7 45 fc 6a 00 00 00 	mov    DWORD PTR [rbp-0x4],0x6a
  35:	c7 45 f4 03 00 00 00 	mov    DWORD PTR [rbp-0xc],0x3
  ...
  5d:	83 7d f4 0d          	cmp    DWORD PTR [rbp-0xc],0xd
  ...
  91:	c7 45 f8 4e 00 00 00 	mov    DWORD PTR [rbp-0x8],0x4e
  ...
  ae:	83 7d fc 1e          	cmp    DWORD PTR [rbp-0x4],0x1e
  b2:	7e b1                	jle    65 <main+0x65>
  b4:	83 45 f0 25          	add    DWORD PTR [rbp-0x10],0x25
  b8:	83 7d f0 37          	cmp    DWORD PTR [rbp-0x10],0x37
