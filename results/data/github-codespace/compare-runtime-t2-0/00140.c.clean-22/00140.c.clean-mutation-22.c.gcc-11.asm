  ...
  69:	b8 bc b1 45 10       	mov    eax,0x1045b1bc
  ...
  9f:	c7 45 d4 22 9e 10 31 	mov    DWORD PTR [rbp-0x2c],0x31109e22
  ...
  bc:	be 7e d5 85 2a       	mov    esi,0x2a85d57e
