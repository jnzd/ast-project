  ...
  34:	48 c7 45 f8 56 00 00 	mov    QWORD PTR [rbp-0x8],0x56
  3b:	00 
  ...
  74:	ba 4f 08 00 00       	mov    edx,0x84f
  79:	be 1e 00 00 00       	mov    esi,0x1e
  7e:	48 8d 05 00 00 00 00 	lea    rax,[rip+0x0]        # 85 <foo+0x19>
  85:	48 89 c7             	mov    rdi,rax
  88:	e8 00 00 00 00       	call   8d <foo+0x21>
  8d:	c6 05 00 00 00 00 39 	mov    BYTE PTR [rip+0x0],0x39        # 94 <foo+0x28>
  ...
  dc:	b8 3b 00 00 00       	mov    eax,0x3b
  e1:	5d                   	pop    rbp
  e2:	c3                   	ret    
