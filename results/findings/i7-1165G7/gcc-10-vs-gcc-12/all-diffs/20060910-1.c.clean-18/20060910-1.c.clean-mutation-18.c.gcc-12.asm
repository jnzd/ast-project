  ...
  23:	c7 45 fc 54 00 00 00 	mov    DWORD PTR [rbp-0x4],0x54
  ...
  de:	b8 2b 00 00 00       	mov    eax,0x2b
  e3:	5d                   	pop    rbp
  e4:	c3                   	ret    
