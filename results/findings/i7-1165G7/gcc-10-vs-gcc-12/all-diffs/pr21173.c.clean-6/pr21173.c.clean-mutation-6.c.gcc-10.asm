   ...
   c:	c7 45 fc 21 00 00 00 	mov    DWORD PTR [rbp-0x4],0x21
  ...
  5b:	83 7d fc 11          	cmp    DWORD PTR [rbp-0x4],0x11
  ...
  7d:	c7 45 fc 7f 00 00 00 	mov    DWORD PTR [rbp-0x4],0x7f
  ...
  ac:	83 7d fc 2c          	cmp    DWORD PTR [rbp-0x4],0x2c
  b0:	7e d4                	jle    86 <main+0x21>
  b2:	b8 22 00 00 00       	mov    eax,0x22
  b7:	c9                   	leave  
  b8:	c3                   	ret    
