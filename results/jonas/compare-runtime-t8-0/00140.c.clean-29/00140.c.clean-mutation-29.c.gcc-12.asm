  ...
  69:	b8 1d a3 45 10       	mov    eax,0x1045a31d
  ...
  9f:	c7 45 d4 35 6e dc 38 	mov    DWORD PTR [rbp-0x2c],0x38dc6e35
  ...
  d6:	be 3b ee 1d 3c       	mov    esi,0x3c1dee3b
 ...
 140:	ba 34 cf ed 07       	mov    edx,0x7edcf34
 145:	be 53 cc c0 18       	mov    esi,0x18c0cc53
 14a:	b8 00 00 00 00       	mov    eax,0x0
 14f:	e8 00 00 00 00       	call   154 <main+0xd0>
 154:	48 83 c4 40          	add    rsp,0x40
 158:	b8 da 54 47 36       	mov    eax,0x364754da
