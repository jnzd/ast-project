   ...
   c:	c7 45 fc 6b 00 00 00 	mov    DWORD PTR [rbp-0x4],0x6b
  ...
  5e:	83 7d fc 1b          	cmp    DWORD PTR [rbp-0x4],0x1b
  ...
  83:	c7 45 fc 4a 00 00 00 	mov    DWORD PTR [rbp-0x4],0x4a
  ...
  b2:	83 7d fc 12          	cmp    DWORD PTR [rbp-0x4],0x12
  b6:	7e d4                	jle    8c <main+0x24>
  b8:	b8 65 00 00 00       	mov    eax,0x65
  bd:	c9                   	leave  
  be:	c3                   	ret    
