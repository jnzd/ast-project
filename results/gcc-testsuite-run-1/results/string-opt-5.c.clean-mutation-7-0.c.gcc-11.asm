 ...
 1ca:	48 98                	cdqe   
 1cc:	83 e0 34             	and    eax,0x34
 1cf:	48 89 c2             	mov    rdx,rax
 1d2:	48 8b 45 d0          	mov    rax,QWORD PTR [rbp-0x30]
 ...
 2d6:	48 98                	cdqe   
 2d8:	83 e0 1b             	and    eax,0x1b
 2db:	48 89 c1             	mov    rcx,rax
 2de:	48 8b 45 d0          	mov    rax,QWORD PTR [rbp-0x30]
 ...
 2ff:	83 f8 49             	cmp    eax,0x49
 302:	75 0b                	jne    30f <main+0x30f>
 304:	8b 05 00 00 00 00    	mov    eax,DWORD PTR [rip+0x0]        # 30a <main+0x30a>
 30a:	83 f8 0b             	cmp    eax,0xb
 30d:	74 05                	je     314 <main+0x314>
 30f:	e8 00 00 00 00       	call   314 <main+0x314>
 314:	c6 45 f5 20          	mov    BYTE PTR [rbp-0xb],0x20
 318:	c6 45 2c 00          	mov    BYTE PTR [rbp+0x2c],0x0
 31c:	c7 05 00 00 00 00 60 	mov    DWORD PTR [rip+0x0],0x60        # 326 <main+0x326>
 323:	00 00 00 
 326:	c7 05 00 00 00 00 08 	mov    DWORD PTR [rip+0x0],0x8        # 330 <main+0x330>
 32d:	00 00 00 
 ...
 33f:	48 98                	cdqe   
 341:	83 e0 35             	and    eax,0x35
 344:	48 89 c2             	mov    rdx,rax
 347:	48 8b 45 d0          	mov    rax,QWORD PTR [rbp-0x30]
 34b:	48 8d 0c 02          	lea    rcx,[rdx+rax*1]
 34f:	48 8d 45 dd          	lea    rax,[rbp-0x23]
 353:	48 83 c0 0b          	add    rax,0xb
 357:	ba 3b 00 00 00       	mov    edx,0x3b
 35c:	48 89 ce             	mov    rsi,rcx
 35f:	48 89 c7             	mov    rdi,rax
 362:	e8 00 00 00 00       	call   367 <main+0x367>
 367:	48 89 c2             	mov    rdx,rax
 36a:	48 8d 45 dd          	lea    rax,[rbp-0x23]
 36e:	48 83 c0 36          	add    rax,0x36
 ...
 382:	48 8d 45 dd          	lea    rax,[rbp-0x23]
 386:	48 83 c0 41          	add    rax,0x41
 ...
 3a5:	48 8d 45 dd          	lea    rax,[rbp-0x23]
 3a9:	ba 0b 00 00 00       	mov    edx,0xb
 ...
 432:	83 f8 47             	cmp    eax,0x47
 435:	75 1f                	jne    456 <main+0x456>
 437:	48 8d 45 dd          	lea    rax,[rbp-0x23]
 43b:	ba 41 00 00 00       	mov    edx,0x41
 ...
 45b:	48 8d 45 dd          	lea    rax,[rbp-0x23]
 45f:	ba 0b 00 00 00       	mov    edx,0xb
 464:	be 20 00 00 00       	mov    esi,0x20
 469:	48 89 c7             	mov    rdi,rax
 46c:	e8 00 00 00 00       	call   471 <main+0x471>
 471:	48 8d 45 dd          	lea    rax,[rbp-0x23]
 475:	ba 5e 00 00 00       	mov    edx,0x5e
 ...
 48c:	48 8d 55 dd          	lea    rdx,[rbp-0x23]
 490:	48 39 d0             	cmp    rax,rdx
 493:	75 1f                	jne    4b4 <main+0x4b4>
 495:	48 8d 45 dd          	lea    rax,[rbp-0x23]
 499:	ba 23 00 00 00       	mov    edx,0x23
 ...
 4c0:	00 00 00 
 4c3:	ba 7c 00 00 00       	mov    edx,0x7c
 ...
 57a:	ba 32 00 00 00       	mov    edx,0x32
 ...
 59e:	83 f8 4b             	cmp    eax,0x4b
 5a1:	75 22                	jne    5c5 <main+0x5c5>
 5a3:	ba 47 00 00 00       	mov    edx,0x47
 ...
 5ca:	c7 05 00 00 00 00 08 	mov    DWORD PTR [rip+0x0],0x8        # 5d4 <main+0x5d4>
 5d1:	00 00 00 
 ...
 60a:	be 4a 00 00 00       	mov    esi,0x4a
 ...
 681:	ba 11 00 00 00       	mov    edx,0x11
 686:	be 16 00 00 00       	mov    esi,0x16
 ...
 6d1:	b8 31 00 00 00       	mov    eax,0x31
