  ...
  69:	b8 74 34 f9 7b       	mov    eax,0x7bf93474
  ...
  9f:	c7 45 d4 0a 3f ee 26 	mov    DWORD PTR [rbp-0x2c],0x26ee3f0a
  ...
  d6:	be bd 33 f9 1f       	mov    esi,0x1ff933bd
 ...
 140:	ba 87 6f 90 39       	mov    edx,0x39906f87
 145:	be 4d a2 5b 1d       	mov    esi,0x1d5ba24d
 14a:	b8 00 00 00 00       	mov    eax,0x0
 14f:	e8 00 00 00 00       	call   154 <main+0xd0>
 154:	48 83 c4 40          	add    rsp,0x40
 158:	b8 4b 54 9b 23       	mov    eax,0x239b544b
