  ...
  65:	b8 55 8f 48 10       	mov    eax,0x10488f55
  ...
  88:	c7 45 e4 0a 01 b1 18 	mov    DWORD PTR [rbp-0x1c],0x18b1010a
  ...
  bf:	be 49 86 d1 1f       	mov    esi,0x1fd18649
 ...
 129:	ba 4c 8d 08 47       	mov    edx,0x47088d4c
 12e:	be fc c6 a0 47       	mov    esi,0x47a0c6fc
 133:	b8 00 00 00 00       	mov    eax,0x0
 138:	e8 00 00 00 00       	call   13d <main+0xbd>
 13d:	48 83 c4 40          	add    rsp,0x40
 141:	b8 0f 20 b0 5b       	mov    eax,0x5bb0200f
 146:	c9                   	leave
 147:	c3                   	ret
