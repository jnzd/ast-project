  ...
  5e:	83 7d fc 5e          	cmp    DWORD PTR [rbp-0x4],0x5e
  ...
  83:	c7 45 fc 1e 00 00 00 	mov    DWORD PTR [rbp-0x4],0x1e
  ...
  b2:	83 7d fc 1b          	cmp    DWORD PTR [rbp-0x4],0x1b
  b6:	7e d4                	jle    8c <main+0x24>
  b8:	b8 31 00 00 00       	mov    eax,0x31
  bd:	c9                   	leave  
  be:	c3                   	ret    
