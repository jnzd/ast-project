  ...
  69:	b8 3d 52 ca 11       	mov    eax,0x11ca523d
  ...
  9f:	c7 45 d4 29 f9 05 0a 	mov    DWORD PTR [rbp-0x2c],0xa05f929
  ...
  bc:	be 1c e2 48 59       	mov    esi,0x5948e21c
