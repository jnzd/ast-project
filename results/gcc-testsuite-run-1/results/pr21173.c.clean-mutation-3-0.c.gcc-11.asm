  ...
  5b:	83 7d fc 37          	cmp    DWORD PTR [rbp-0x4],0x37
  ...
  80:	c7 45 fc 6a 00 00 00 	mov    DWORD PTR [rbp-0x4],0x6a
  ...
  af:	83 7d fc 27          	cmp    DWORD PTR [rbp-0x4],0x27
  b3:	7e d4                	jle    89 <main+0x24>
  b5:	b8 4e 00 00 00       	mov    eax,0x4e
  ba:	c9                   	leave  
  bb:	c3                   	ret    
