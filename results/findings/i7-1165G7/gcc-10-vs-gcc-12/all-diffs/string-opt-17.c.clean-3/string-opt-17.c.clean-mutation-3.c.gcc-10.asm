  ...
  c4:	be 51 00 00 00       	mov    esi,0x51
  c9:	48 89 c7             	mov    rdi,rax
  cc:	e8 00 00 00 00       	call   d1 <main+0x2c>
  d1:	48 83 f8 4e          	cmp    rax,0x4e
  d5:	75 1c                	jne    f3 <main+0x4e>
  d7:	48 8d 45 c0          	lea    rax,[rbp-0x40]
  db:	ba 51 00 00 00       	mov    edx,0x51
  ...
  f8:	48 8d 45 c0          	lea    rax,[rbp-0x40]
  fc:	48 89 c7             	mov    rdi,rax
  ff:	e8 00 00 00 00       	call   104 <main+0x5f>
 104:	48 8d 45 c0          	lea    rax,[rbp-0x40]
 108:	ba 2b 00 00 00       	mov    edx,0x2b
