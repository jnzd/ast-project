  ...
  bb:	83 f8 4b             	cmp    eax,0x4b
  be:	74 05                	je     c5 <main+0xc5>
  c0:	e8 00 00 00 00       	call   c5 <main+0xc5>
  c5:	c7 05 00 00 00 00 38 	mov    DWORD PTR [rip+0x0],0x38        # cf <main+0xcf>
  cc:	00 00 00 
