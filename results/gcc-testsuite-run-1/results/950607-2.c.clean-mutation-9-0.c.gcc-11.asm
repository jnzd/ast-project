  ...
  70:	48 83 7d f8 2f       	cmp    QWORD PTR [rbp-0x8],0x2f
  75:	7e 07                	jle    7e <f+0x7e>
  77:	b8 30 00 00 00       	mov    eax,0x30
  7c:	eb 13                	jmp    91 <f+0x91>
  7e:	48 83 7d f8 28       	cmp    QWORD PTR [rbp-0x8],0x28
  83:	7f 07                	jg     8c <f+0x8c>
  85:	b8 25 00 00 00       	mov    eax,0x25
  8a:	eb 05                	jmp    91 <f+0x91>
  8c:	b8 17 00 00 00       	mov    eax,0x17
  91:	5d                   	pop    rbp
  92:	c3                   	ret    
  ...
  a0:	48 c7 45 c0 e5 ff ff 	mov    QWORD PTR [rbp-0x40],0xffffffffffffffe5
  a7:	ff 
  a8:	48 c7 45 c8 2e 00 00 	mov    QWORD PTR [rbp-0x38],0x2e
  af:	00 
  b0:	48 c7 45 d0 13 00 00 	mov    QWORD PTR [rbp-0x30],0x13
  b7:	00 
  b8:	48 c7 45 d8 a1 ff ff 	mov    QWORD PTR [rbp-0x28],0xffffffffffffffa1
  bf:	ff 
  c0:	48 c7 45 e0 f4 ff ff 	mov    QWORD PTR [rbp-0x20],0xfffffffffffffff4
  c7:	ff 
  c8:	48 c7 45 e8 de ff ff 	mov    QWORD PTR [rbp-0x18],0xffffffffffffffde
  cf:	ff 
  ...
  fc:	83 7d bc 19          	cmp    DWORD PTR [rbp-0x44],0x19
 100:	74 05                	je     107 <main+0x74>
 102:	e8 00 00 00 00       	call   107 <main+0x74>
 107:	bf 04 00 00 00       	mov    edi,0x4
