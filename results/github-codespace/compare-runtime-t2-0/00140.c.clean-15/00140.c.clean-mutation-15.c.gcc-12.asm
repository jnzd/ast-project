  ...
  65:	b8 37 f8 e4 10       	mov    eax,0x10e4f837
  ...
  88:	c7 45 e4 65 65 9e 03 	mov    DWORD PTR [rbp-0x1c],0x39e6565
  ...
  bf:	be 4a 3d 8f 45       	mov    esi,0x458f3d4a
 ...
 129:	ba 6e 4c 1f 35       	mov    edx,0x351f4c6e
 12e:	be f2 1d 24 68       	mov    esi,0x68241df2
 133:	b8 00 00 00 00       	mov    eax,0x0
 138:	e8 00 00 00 00       	call   13d <main+0xbd>
 13d:	48 83 c4 40          	add    rsp,0x40
 141:	b8 1d b4 d0 76       	mov    eax,0x76d0b41d
 146:	c9                   	leave
 147:	c3                   	ret
