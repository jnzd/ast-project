  ...
  12:	c7 45 fc 6f 00 00 00 	mov    DWORD PTR [rbp-0x4],0x6f
  19:	c7 45 f8 0d 00 00 00 	mov    DWORD PTR [rbp-0x8],0xd
  ...
  80:	be 5b 00 00 00       	mov    esi,0x5b
  85:	bf fc ff ff ff       	mov    edi,0xfffffffc
  ...
  bb:	b8 4d 00 00 00       	mov    eax,0x4d
  c0:	c9                   	leave  
  c1:	c3                   	ret    
