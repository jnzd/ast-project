  ...
  69:	b8 5e 22 ed 11       	mov    eax,0x11ed225e
  ...
  9f:	c7 45 d4 5c 60 ec 16 	mov    DWORD PTR [rbp-0x2c],0x16ec605c
  ...
  d6:	be b7 ac 6f 04       	mov    esi,0x46facb7
 ...
 140:	ba 30 a0 5e 6e       	mov    edx,0x6e5ea030
 145:	be 77 c9 52 32       	mov    esi,0x3252c977
 14a:	b8 00 00 00 00       	mov    eax,0x0
 14f:	e8 00 00 00 00       	call   154 <main+0xd0>
 154:	48 83 c4 40          	add    rsp,0x40
 158:	b8 44 4b a0 7e       	mov    eax,0x7ea04b44
