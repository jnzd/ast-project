  ...
  65:	b8 1e 86 3c 14       	mov    eax,0x143c861e
  ...
  88:	c7 45 e4 b9 b3 d5 27 	mov    DWORD PTR [rbp-0x1c],0x27d5b3b9
  ...
  bf:	be ff 23 fd 09       	mov    esi,0x9fd23ff
 ...
 129:	ba f3 31 c7 36       	mov    edx,0x36c731f3
 12e:	be bf da fd 03       	mov    esi,0x3fddabf
 133:	b8 00 00 00 00       	mov    eax,0x0
 138:	e8 00 00 00 00       	call   13d <main+0xbd>
 13d:	48 83 c4 40          	add    rsp,0x40
 141:	b8 88 ab a4 4c       	mov    eax,0x4ca4ab88
 146:	c9                   	leave
 147:	c3                   	ret
