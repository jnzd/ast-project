  ...
  70:	48 83 7d f8 19       	cmp    QWORD PTR [rbp-0x8],0x19
  75:	7e 07                	jle    7e <f+0x7e>
  77:	b8 40 00 00 00       	mov    eax,0x40
  7c:	eb 13                	jmp    91 <f+0x91>
  7e:	48 83 7d f8 68       	cmp    QWORD PTR [rbp-0x8],0x68
  83:	7f 07                	jg     8c <f+0x8c>
  85:	b8 73 00 00 00       	mov    eax,0x73
  8a:	eb 05                	jmp    91 <f+0x91>
  8c:	b8 34 00 00 00       	mov    eax,0x34
  91:	5d                   	pop    rbp
  92:	c3                   	ret    
  ...
  a0:	48 c7 45 c0 94 ff ff 	mov    QWORD PTR [rbp-0x40],0xffffffffffffff94
  a7:	ff 
  a8:	48 c7 45 c8 5d 00 00 	mov    QWORD PTR [rbp-0x38],0x5d
  af:	00 
  b0:	48 c7 45 d0 46 00 00 	mov    QWORD PTR [rbp-0x30],0x46
  b7:	00 
  b8:	48 c7 45 d8 a2 ff ff 	mov    QWORD PTR [rbp-0x28],0xffffffffffffffa2
  bf:	ff 
  c0:	48 c7 45 e0 ac ff ff 	mov    QWORD PTR [rbp-0x20],0xffffffffffffffac
  c7:	ff 
  c8:	48 c7 45 e8 bd ff ff 	mov    QWORD PTR [rbp-0x18],0xffffffffffffffbd
  cf:	ff 
  ...
  fc:	83 7d bc 14          	cmp    DWORD PTR [rbp-0x44],0x14
 100:	74 05                	je     107 <main+0x74>
 102:	e8 00 00 00 00       	call   107 <main+0x74>
 107:	bf 5a 00 00 00       	mov    edi,0x5a
