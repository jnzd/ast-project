  ...
  65:	b8 bc 0a fd 54       	mov    eax,0x54fd0abc
  ...
  88:	c7 45 e4 16 ed af 0e 	mov    DWORD PTR [rbp-0x1c],0xeafed16
  ...
  bf:	be 77 99 18 44       	mov    esi,0x44189977
 ...
 129:	ba 3a 58 a4 6e       	mov    edx,0x6ea4583a
 12e:	be 86 2f 85 02       	mov    esi,0x2852f86
 133:	b8 00 00 00 00       	mov    eax,0x0
 138:	e8 00 00 00 00       	call   13d <main+0xbd>
 13d:	48 83 c4 40          	add    rsp,0x40
 141:	b8 46 5f 4b 49       	mov    eax,0x494b5f46
 146:	c9                   	leave
 147:	c3                   	ret
