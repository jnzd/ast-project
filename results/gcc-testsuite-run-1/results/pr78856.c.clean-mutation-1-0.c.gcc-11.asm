  ...
  19:	c7 45 f0 02 00 00 00 	mov    DWORD PTR [rbp-0x10],0x2
  20:	c7 45 f8 4b 00 00 00 	mov    DWORD PTR [rbp-0x8],0x4b
  27:	e9 8a 00 00 00       	jmp    b6 <main+0xb6>
  2c:	c7 45 fc 04 00 00 00 	mov    DWORD PTR [rbp-0x4],0x4
  33:	c7 45 f4 69 00 00 00 	mov    DWORD PTR [rbp-0xc],0x69
  ...
  50:	c7 04 02 5c 00 00 00 	mov    DWORD PTR [rdx+rax*1],0x5c
  57:	83 45 f4 01          	add    DWORD PTR [rbp-0xc],0x1
  5b:	83 7d f4 3f          	cmp    DWORD PTR [rbp-0xc],0x3f
  ...
  8f:	c7 45 f8 76 00 00 00 	mov    DWORD PTR [rbp-0x8],0x76
  ...
  ac:	83 7d fc 43          	cmp    DWORD PTR [rbp-0x4],0x43
  b0:	7e b1                	jle    63 <main+0x63>
  b2:	83 45 f0 03          	add    DWORD PTR [rbp-0x10],0x3
  b6:	83 7d f0 7c          	cmp    DWORD PTR [rbp-0x10],0x7c
  ba:	0f 8e 6c ff ff ff    	jle    2c <main+0x2c>
  c0:	bf 7b 00 00 00       	mov    edi,0x7b
