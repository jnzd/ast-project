   ...
   c:	c7 45 f8 47 00 00 00 	mov    DWORD PTR [rbp-0x8],0x47
  13:	8b 45 f8             	mov    eax,DWORD PTR [rbp-0x8]
  16:	89 c2                	mov    edx,eax
  18:	b8 03 0b 2c b0       	mov    eax,0xb02c0b03
  1d:	48 0f af c2          	imul   rax,rdx
  21:	48 c1 e8 20          	shr    rax,0x20
  25:	c1 e8 06             	shr    eax,0x6
  28:	f7 d8                	neg    eax
  2a:	89 c2                	mov    edx,eax
  2c:	48 69 d2 d9 b4 9f 2c 	imul   rdx,rdx,0x2c9fb4d9
  ...
  5a:	b8 3f 00 00 00       	mov    eax,0x3f
  5f:	c9                   	leave  
  60:	c3                   	ret    
