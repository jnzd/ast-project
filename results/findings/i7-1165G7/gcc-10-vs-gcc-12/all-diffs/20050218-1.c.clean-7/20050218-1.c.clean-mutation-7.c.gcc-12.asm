  ...
  18:	48 c7 45 f8 6f 00 00 	mov    QWORD PTR [rbp-0x8],0x6f
  1f:	00 
  20:	48 c7 45 f0 3a 00 00 	mov    QWORD PTR [rbp-0x10],0x3a
  27:	00 
  ...
  7c:	83 f8 01             	cmp    eax,0x1
  7f:	74 07                	je     88 <foo+0x88>
  81:	b8 27 00 00 00       	mov    eax,0x27
