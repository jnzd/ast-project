  ...
  c7:	83 f8 3f             	cmp    eax,0x3f
  ca:	74 05                	je     d1 <main+0xd1>
  cc:	e8 00 00 00 00       	call   d1 <main+0xd1>
  d1:	c7 05 00 00 00 00 25 	mov    DWORD PTR [rip+0x0],0x25        # db <main+0xdb>
  d8:	00 00 00 
