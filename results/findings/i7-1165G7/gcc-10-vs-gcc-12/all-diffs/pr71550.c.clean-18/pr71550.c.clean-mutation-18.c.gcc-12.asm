  ...
  43:	c7 45 fc 25 00 00 00 	mov    DWORD PTR [rbp-0x4],0x25
  ...
  9c:	83 7d fc 42          	cmp    DWORD PTR [rbp-0x4],0x42
  ...
  bf:	bf 52 00 00 00       	mov    edi,0x52
