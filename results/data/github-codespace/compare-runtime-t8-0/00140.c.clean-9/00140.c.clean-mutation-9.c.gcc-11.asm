  ...
  69:	b8 6a b5 f0 0f       	mov    eax,0xff0b56a
  ...
  9f:	c7 45 d4 58 53 0c 3c 	mov    DWORD PTR [rbp-0x2c],0x3c0c5358
  ...
  bc:	be 66 0a 54 05       	mov    esi,0x5540a66
