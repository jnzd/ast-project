  ...
  65:	b8 f1 70 77 1d       	mov    eax,0x1d7770f1
  ...
  88:	c7 45 e4 2f 38 a6 08 	mov    DWORD PTR [rbp-0x1c],0x8a6382f
  ...
  bf:	be 8b fc f6 60       	mov    esi,0x60f6fc8b
 ...
 129:	ba a2 29 02 3f       	mov    edx,0x3f0229a2
 12e:	be 3e 02 8c 2e       	mov    esi,0x2e8c023e
 133:	b8 00 00 00 00       	mov    eax,0x0
 138:	e8 00 00 00 00       	call   13d <main+0xbd>
 13d:	48 83 c4 40          	add    rsp,0x40
 141:	b8 da af 86 69       	mov    eax,0x6986afda
 146:	c9                   	leave
 147:	c3                   	ret
