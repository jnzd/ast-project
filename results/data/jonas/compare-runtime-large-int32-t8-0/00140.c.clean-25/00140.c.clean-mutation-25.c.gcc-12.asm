  ...
  69:	b8 3b 85 ee 59       	mov    eax,0x59ee853b
  ...
  9f:	c7 45 d4 b9 ec 26 01 	mov    DWORD PTR [rbp-0x2c],0x126ecb9
  ...
  d6:	be fb d4 74 73       	mov    esi,0x7374d4fb
 ...
 140:	ba 4a 5d 69 40       	mov    edx,0x40695d4a
 145:	be e6 b7 f5 29       	mov    esi,0x29f5b7e6
 14a:	b8 00 00 00 00       	mov    eax,0x0
 14f:	e8 00 00 00 00       	call   154 <main+0xd0>
 154:	48 83 c4 40          	add    rsp,0x40
 158:	b8 17 9d ba 0e       	mov    eax,0xeba9d17
