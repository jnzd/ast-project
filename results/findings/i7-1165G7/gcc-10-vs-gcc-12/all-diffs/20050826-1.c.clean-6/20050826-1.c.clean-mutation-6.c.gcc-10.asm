  ...
  31:	48 c7 45 f8 56 00 00 	mov    QWORD PTR [rbp-0x8],0x56
  38:	00 
  ...
  71:	ba 4f 08 00 00       	mov    edx,0x84f
  76:	be 1e 00 00 00       	mov    esi,0x1e
  7b:	48 8d 3d 00 00 00 00 	lea    rdi,[rip+0x0]        # 82 <foo+0x19>
  82:	e8 00 00 00 00       	call   87 <foo+0x1e>
  87:	c6 05 00 00 00 00 39 	mov    BYTE PTR [rip+0x0],0x39        # 8e <foo+0x25>
  ...
  a6:	c6 05 00 00 00 00 67 	mov    BYTE PTR [rip+0x0],0x67        # ad <foo+0x44>
  ad:	48 8d 3d 00 00 00 00 	lea    rdi,[rip+0x0]        # b4 <foo+0x4b>
  b4:	e8 00 00 00 00       	call   b9 <foo+0x50>
  b9:	b8 23 00 00 00       	mov    eax,0x23
  be:	5d                   	pop    rbp
  bf:	c3                   	ret    
  ...
  cd:	b8 3b 00 00 00       	mov    eax,0x3b
  d2:	5d                   	pop    rbp
  d3:	c3                   	ret    
