  ...
  69:	b8 a7 5e 19 65       	mov    eax,0x65195ea7
  ...
  9f:	c7 45 d4 31 4d 21 0e 	mov    DWORD PTR [rbp-0x2c],0xe214d31
  ...
  d6:	be 66 d1 2e 2a       	mov    esi,0x2a2ed166
 ...
 140:	ba bb d3 d8 27       	mov    edx,0x27d8d3bb
 145:	be 45 d9 31 10       	mov    esi,0x1031d945
 14a:	b8 00 00 00 00       	mov    eax,0x0
 14f:	e8 00 00 00 00       	call   154 <main+0xd0>
 154:	48 83 c4 40          	add    rsp,0x40
 158:	b8 e1 27 16 1a       	mov    eax,0x1a1627e1
