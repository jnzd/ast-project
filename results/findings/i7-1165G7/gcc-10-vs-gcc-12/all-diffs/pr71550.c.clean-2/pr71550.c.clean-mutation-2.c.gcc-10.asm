  ...
  40:	c7 45 fc 73 00 00 00 	mov    DWORD PTR [rbp-0x4],0x73
  ...
  7d:	83 f8 0a             	cmp    eax,0xa
  80:	76 d3                	jbe    55 <main+0x55>
  82:	83 45 fc 01          	add    DWORD PTR [rbp-0x4],0x1
  86:	83 7d fc 39          	cmp    DWORD PTR [rbp-0x4],0x39
  8a:	7e bd                	jle    49 <main+0x49>
  8c:	c7 45 fc 35 00 00 00 	mov    DWORD PTR [rbp-0x4],0x35
  ...
  bc:	bf 6f 00 00 00       	mov    edi,0x6f
