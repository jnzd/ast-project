  ...
  71:	c7 05 00 00 00 00 49 	mov    DWORD PTR [rip+0x0],0x49        # 7b <main+0x7b>
  78:	00 00 00 
 ...
 10c:	48 8d 45 c0          	lea    rax,[rbp-0x40]
