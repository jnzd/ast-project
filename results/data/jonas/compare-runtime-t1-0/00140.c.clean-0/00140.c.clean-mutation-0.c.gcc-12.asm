  ...
  69:	b8 dc e0 08 74       	mov    eax,0x7408e0dc
  ...
  9f:	c7 45 d4 33 24 5f 02 	mov    DWORD PTR [rbp-0x2c],0x25f2433
  ...
  d6:	be 10 9d 33 0e       	mov    esi,0xe339d10
 ...
 140:	ba a4 1d 21 0e       	mov    edx,0xe211da4
 145:	be 69 22 d6 1d       	mov    esi,0x1dd62269
 14a:	b8 00 00 00 00       	mov    eax,0x0
 14f:	e8 00 00 00 00       	call   154 <main+0xd0>
 154:	48 83 c4 40          	add    rsp,0x40
 158:	b8 3b 3d 22 4b       	mov    eax,0x4b223d3b
