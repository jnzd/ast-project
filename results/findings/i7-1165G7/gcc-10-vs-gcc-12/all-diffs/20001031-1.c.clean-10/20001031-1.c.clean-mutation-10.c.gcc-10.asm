   ...
   f:	83 7d fc 56          	cmp    DWORD PTR [rbp-0x4],0x56
  ...
  29:	c7 45 fc 17 00 00 00 	mov    DWORD PTR [rbp-0x4],0x17
  30:	8b 45 fc             	mov    eax,DWORD PTR [rbp-0x4]
  33:	83 c0 1c             	add    eax,0x1c
  ...
  71:	48 c7 45 f8 56 00 00 	mov    QWORD PTR [rbp-0x8],0x56
  78:	00 
  79:	bf 55 00 00 80       	mov    edi,0x80000055
