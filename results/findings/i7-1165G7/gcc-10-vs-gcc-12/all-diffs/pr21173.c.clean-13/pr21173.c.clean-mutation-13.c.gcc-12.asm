   ...
   c:	c7 45 fc 4c 00 00 00 	mov    DWORD PTR [rbp-0x4],0x4c
  ...
  5e:	83 7d fc 02          	cmp    DWORD PTR [rbp-0x4],0x2
  ...
  83:	c7 45 fc 5a 00 00 00 	mov    DWORD PTR [rbp-0x4],0x5a
  ...
  b2:	83 7d fc 58          	cmp    DWORD PTR [rbp-0x4],0x58
  b6:	7e d4                	jle    8c <main+0x24>
  b8:	b8 55 00 00 00       	mov    eax,0x55
  bd:	c9                   	leave  
  be:	c3                   	ret    
