  ...
  12:	c7 45 fc 65 00 00 00 	mov    DWORD PTR [rbp-0x4],0x65
  19:	c7 45 f8 72 00 00 00 	mov    DWORD PTR [rbp-0x8],0x72
  ...
  80:	be 6d 00 00 00       	mov    esi,0x6d
  85:	bf 86 ff ff ff       	mov    edi,0xffffff86
  ...
  bc:	b8 68 00 00 00       	mov    eax,0x68
  c1:	c9                   	leave  
  c2:	c3                   	ret    
