  ...
  69:	b8 64 dd 8b 1c       	mov    eax,0x1c8bdd64
  ...
  9f:	c7 45 d4 02 00 d3 29 	mov    DWORD PTR [rbp-0x2c],0x29d30002
  ...
  bc:	be f8 ee 51 3a       	mov    esi,0x3a51eef8
