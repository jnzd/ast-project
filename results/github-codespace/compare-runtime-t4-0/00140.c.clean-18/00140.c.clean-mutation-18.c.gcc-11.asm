  ...
  69:	b8 8a 55 8a 31       	mov    eax,0x318a558a
  ...
  9f:	c7 45 d4 af 37 81 54 	mov    DWORD PTR [rbp-0x2c],0x548137af
  ...
  bc:	be a0 d3 f6 27       	mov    esi,0x27f6d3a0
