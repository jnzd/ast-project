  ...
  13:	c7 45 f4 66 00 00 00 	mov    DWORD PTR [rbp-0xc],0x66
  1a:	c7 45 f0 60 00 00 00 	mov    DWORD PTR [rbp-0x10],0x60
  ...
  3c:	83 7d fc 71          	cmp    DWORD PTR [rbp-0x4],0x71
  ...
  5b:	c7 45 f4 5a 00 00 00 	mov    DWORD PTR [rbp-0xc],0x5a
