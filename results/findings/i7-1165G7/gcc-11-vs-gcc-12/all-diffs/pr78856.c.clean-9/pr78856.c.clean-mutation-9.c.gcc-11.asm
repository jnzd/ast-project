  ...
  19:	c7 45 f0 7b 00 00 00 	mov    DWORD PTR [rbp-0x10],0x7b
  20:	c7 45 f8 36 00 00 00 	mov    DWORD PTR [rbp-0x8],0x36
  27:	e9 8a 00 00 00       	jmp    b6 <main+0xb6>
  2c:	c7 45 fc 49 00 00 00 	mov    DWORD PTR [rbp-0x4],0x49
  33:	c7 45 f4 11 00 00 00 	mov    DWORD PTR [rbp-0xc],0x11
  ...
  50:	c7 04 02 20 00 00 00 	mov    DWORD PTR [rdx+rax*1],0x20
  57:	83 45 f4 01          	add    DWORD PTR [rbp-0xc],0x1
  5b:	83 7d f4 67          	cmp    DWORD PTR [rbp-0xc],0x67
  ...
  8f:	c7 45 f8 1d 00 00 00 	mov    DWORD PTR [rbp-0x8],0x1d
  ...
  ac:	83 7d fc 67          	cmp    DWORD PTR [rbp-0x4],0x67
  b0:	7e b1                	jle    63 <main+0x63>
  b2:	83 45 f0 10          	add    DWORD PTR [rbp-0x10],0x10
  b6:	83 7d f0 4d          	cmp    DWORD PTR [rbp-0x10],0x4d
  ba:	0f 8e 6c ff ff ff    	jle    2c <main+0x2c>
  c0:	bf 58 00 00 00       	mov    edi,0x58
