   ...
   f:	83 7d fc 44          	cmp    DWORD PTR [rbp-0x4],0x44
  ...
  29:	c7 45 fc 1b 00 00 00 	mov    DWORD PTR [rbp-0x4],0x1b
  30:	8b 45 fc             	mov    eax,DWORD PTR [rbp-0x4]
  33:	83 c0 10             	add    eax,0x10
  ...
  71:	48 c7 45 f8 4a 00 00 	mov    QWORD PTR [rbp-0x8],0x4a
  78:	00 
  79:	b8 49 00 00 80       	mov    eax,0x80000049
  ...
  b3:	bf 11 00 00 00       	mov    edi,0x11
