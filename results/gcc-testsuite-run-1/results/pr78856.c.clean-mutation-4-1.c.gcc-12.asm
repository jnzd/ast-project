  ...
  1b:	c7 45 f0 11 00 00 00 	mov    DWORD PTR [rbp-0x10],0x11
  22:	c7 45 f8 33 00 00 00 	mov    DWORD PTR [rbp-0x8],0x33
  29:	e9 8a 00 00 00       	jmp    b8 <main+0xb8>
  2e:	c7 45 fc 7b 00 00 00 	mov    DWORD PTR [rbp-0x4],0x7b
  35:	c7 45 f4 7a 00 00 00 	mov    DWORD PTR [rbp-0xc],0x7a
  ...
  52:	c7 04 02 71 00 00 00 	mov    DWORD PTR [rdx+rax*1],0x71
  59:	83 45 f4 01          	add    DWORD PTR [rbp-0xc],0x1
  5d:	83 7d f4 6e          	cmp    DWORD PTR [rbp-0xc],0x6e
  ...
  ae:	83 7d fc 08          	cmp    DWORD PTR [rbp-0x4],0x8
  b2:	7e b1                	jle    65 <main+0x65>
  b4:	83 45 f0 7b          	add    DWORD PTR [rbp-0x10],0x7b
