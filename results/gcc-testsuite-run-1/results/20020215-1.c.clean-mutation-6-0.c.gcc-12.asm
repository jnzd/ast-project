  ...
  54:	66 c7 45 e0 6f 00    	mov    WORD PTR [rbp-0x20],0x6f
  5a:	48 c7 45 e8 d0 07 00 	mov    QWORD PTR [rbp-0x18],0x7d0
  61:	00 
  62:	66 c7 45 f0 16 00    	mov    WORD PTR [rbp-0x10],0x16
