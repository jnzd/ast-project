  ...
  19:	c7 45 f0 72 00 00 00 	mov    DWORD PTR [rbp-0x10],0x72
  20:	c7 45 f8 4f 00 00 00 	mov    DWORD PTR [rbp-0x8],0x4f
  27:	e9 8a 00 00 00       	jmp    b6 <main+0xb6>
  2c:	c7 45 fc 22 00 00 00 	mov    DWORD PTR [rbp-0x4],0x22
  33:	c7 45 f4 53 00 00 00 	mov    DWORD PTR [rbp-0xc],0x53
  ...
  5b:	83 7d f4 08          	cmp    DWORD PTR [rbp-0xc],0x8
  ...
  ac:	83 7d fc 4b          	cmp    DWORD PTR [rbp-0x4],0x4b
  b0:	7e b1                	jle    63 <main+0x63>
  b2:	83 45 f0 44          	add    DWORD PTR [rbp-0x10],0x44
  b6:	83 7d f0 0f          	cmp    DWORD PTR [rbp-0x10],0xf
