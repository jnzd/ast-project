  ...
  77:	b8 73 00 00 00       	mov    eax,0x73
  7c:	eb 13                	jmp    91 <f+0x91>
  7e:	48 83 7d f8 78       	cmp    QWORD PTR [rbp-0x8],0x78
  83:	7f 07                	jg     8c <f+0x8c>
  85:	b8 3a 00 00 00       	mov    eax,0x3a
  8a:	eb 05                	jmp    91 <f+0x91>
  8c:	b8 04 00 00 00       	mov    eax,0x4
  91:	5d                   	pop    rbp
  92:	c3                   	ret    
  ...
  a0:	48 c7 45 c0 b5 ff ff 	mov    QWORD PTR [rbp-0x40],0xffffffffffffffb5
  a7:	ff 
  a8:	48 c7 45 c8 7a 00 00 	mov    QWORD PTR [rbp-0x38],0x7a
  af:	00 
  b0:	48 c7 45 d0 2d 00 00 	mov    QWORD PTR [rbp-0x30],0x2d
  b7:	00 
  b8:	48 c7 45 d8 9c ff ff 	mov    QWORD PTR [rbp-0x28],0xffffffffffffff9c
  bf:	ff 
  c0:	48 c7 45 e0 e8 ff ff 	mov    QWORD PTR [rbp-0x20],0xffffffffffffffe8
  c7:	ff 
  ...
  fc:	83 7d bc 35          	cmp    DWORD PTR [rbp-0x44],0x35
 100:	74 05                	je     107 <main+0x74>
 102:	e8 00 00 00 00       	call   107 <main+0x74>
 107:	bf 72 00 00 00       	mov    edi,0x72
