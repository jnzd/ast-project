  ...
  69:	b8 af b7 6e 16       	mov    eax,0x166eb7af
  ...
  9f:	c7 45 d4 af 94 08 28 	mov    DWORD PTR [rbp-0x2c],0x280894af
  ...
  bc:	be 4e 52 a9 38       	mov    esi,0x38a9524e
