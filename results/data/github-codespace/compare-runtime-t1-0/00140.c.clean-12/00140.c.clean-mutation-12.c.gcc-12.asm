  ...
  65:	b8 8e cd d3 51       	mov    eax,0x51d3cd8e
  ...
  88:	c7 45 e4 aa bc 79 2a 	mov    DWORD PTR [rbp-0x1c],0x2a79bcaa
  ...
  bf:	be 0e 4b 51 2c       	mov    esi,0x2c514b0e
 ...
 129:	ba 82 38 d1 32       	mov    edx,0x32d13882
 12e:	be 2a 67 4a 29       	mov    esi,0x294a672a
 133:	b8 00 00 00 00       	mov    eax,0x0
 138:	e8 00 00 00 00       	call   13d <main+0xbd>
 13d:	48 83 c4 40          	add    rsp,0x40
 141:	b8 d5 78 10 1a       	mov    eax,0x1a1078d5
 146:	c9                   	leave
 147:	c3                   	ret
