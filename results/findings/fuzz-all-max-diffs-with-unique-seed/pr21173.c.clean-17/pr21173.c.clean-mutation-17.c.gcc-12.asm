  ...
  5e:	83 7d fc 25          	cmp    DWORD PTR [rbp-0x4],0x25
  ...
  83:	c7 45 fc 48 00 00 00 	mov    DWORD PTR [rbp-0x4],0x48
  ...
  b2:	83 7d fc 00          	cmp    DWORD PTR [rbp-0x4],0x0
  b6:	78 d4                	js     8c <main+0x24>
  b8:	b8 3b 00 00 00       	mov    eax,0x3b
  bd:	c9                   	leave  
  be:	c3                   	ret    
