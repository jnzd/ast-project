  ...
  19:	c7 45 f0 7a 00 00 00 	mov    DWORD PTR [rbp-0x10],0x7a
  20:	c7 45 f8 03 00 00 00 	mov    DWORD PTR [rbp-0x8],0x3
  27:	e9 8a 00 00 00       	jmp    b6 <main+0xb6>
  2c:	c7 45 fc 41 00 00 00 	mov    DWORD PTR [rbp-0x4],0x41
  33:	c7 45 f4 12 00 00 00 	mov    DWORD PTR [rbp-0xc],0x12
  ...
  50:	c7 04 02 7c 00 00 00 	mov    DWORD PTR [rdx+rax*1],0x7c
  57:	83 45 f4 01          	add    DWORD PTR [rbp-0xc],0x1
  5b:	83 7d f4 59          	cmp    DWORD PTR [rbp-0xc],0x59
  ...
  8f:	c7 45 f8 03 00 00 00 	mov    DWORD PTR [rbp-0x8],0x3
  ...
  ac:	83 7d fc 62          	cmp    DWORD PTR [rbp-0x4],0x62
  b0:	7e b1                	jle    63 <main+0x63>
  b2:	83 45 f0 24          	add    DWORD PTR [rbp-0x10],0x24
  b6:	83 7d f0 5e          	cmp    DWORD PTR [rbp-0x10],0x5e
  ba:	0f 8e 6c ff ff ff    	jle    2c <main+0x2c>
  c0:	bf 21 00 00 00       	mov    edi,0x21
