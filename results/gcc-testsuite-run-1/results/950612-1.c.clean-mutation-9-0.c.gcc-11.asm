  ...
  48:	48 83 7d f8 71       	cmp    QWORD PTR [rbp-0x8],0x71
  ...
  8f:	c7 45 fc 21 00 00 00 	mov    DWORD PTR [rbp-0x4],0x21
 ...
 17d:	bf 5c 00 00 00       	mov    edi,0x5c
