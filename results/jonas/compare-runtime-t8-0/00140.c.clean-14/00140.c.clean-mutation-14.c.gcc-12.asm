  ...
  69:	b8 c8 d9 bf 6e       	mov    eax,0x6ebfd9c8
  ...
  9f:	c7 45 d4 a0 6c 14 16 	mov    DWORD PTR [rbp-0x2c],0x16146ca0
  ...
  d6:	be b2 88 d1 2e       	mov    esi,0x2ed188b2
 ...
 140:	ba 10 ae f3 09       	mov    edx,0x9f3ae10
 145:	be b3 ff 23 14       	mov    esi,0x1423ffb3
 14a:	b8 00 00 00 00       	mov    eax,0x0
 14f:	e8 00 00 00 00       	call   154 <main+0xd0>
 154:	48 83 c4 40          	add    rsp,0x40
 158:	b8 3b ea 43 1f       	mov    eax,0x1f43ea3b
