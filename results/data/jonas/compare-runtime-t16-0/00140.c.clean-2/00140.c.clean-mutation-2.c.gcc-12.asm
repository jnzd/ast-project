  ...
  69:	b8 32 60 e1 15       	mov    eax,0x15e16032
  ...
  9f:	c7 45 d4 45 81 c8 1e 	mov    DWORD PTR [rbp-0x2c],0x1ec88145
  ...
  d6:	be 52 68 f4 59       	mov    esi,0x59f46852
 ...
 140:	ba bf 21 df 41       	mov    edx,0x41df21bf
 145:	be a6 63 9b 1b       	mov    esi,0x1b9b63a6
 14a:	b8 00 00 00 00       	mov    eax,0x0
 14f:	e8 00 00 00 00       	call   154 <main+0xd0>
 154:	48 83 c4 40          	add    rsp,0x40
 158:	b8 6e 4f 4f 6f       	mov    eax,0x6f4f4f6e
