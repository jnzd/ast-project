  ...
  25:	48 69 c0 57 86 6f 44 	imul   rax,rax,0x446f8657
  ...
  7c:	83 7d f8 10          	cmp    DWORD PTR [rbp-0x8],0x10
  80:	77 2b                	ja     ad <main+0xad>
  82:	83 7d f4 3b          	cmp    DWORD PTR [rbp-0xc],0x3b
  ...
  9d:	83 f8 3d             	cmp    eax,0x3d
  a0:	0f 8e 76 ff ff ff    	jle    1c <main+0x1c>
  a6:	b8 75 00 00 00       	mov    eax,0x75
