   ...
   c:	c7 45 f4 29 00 00 00 	mov    DWORD PTR [rbp-0xc],0x29
  13:	c7 45 f8 41 00 00 00 	mov    DWORD PTR [rbp-0x8],0x41
  1a:	eb 7b                	jmp    97 <main+0x97>
  1c:	8b 45 f4             	mov    eax,DWORD PTR [rbp-0xc]
  1f:	f7 d0                	not    eax
  21:	89 c1                	mov    ecx,eax
  23:	ba d5 41 1d d4       	mov    edx,0xd41d41d5
  ...
  7c:	83 7d f8 5c          	cmp    DWORD PTR [rbp-0x8],0x5c
  80:	77 2b                	ja     ad <main+0xad>
  82:	83 7d f4 34          	cmp    DWORD PTR [rbp-0xc],0x34
  ...
  9d:	83 f8 43             	cmp    eax,0x43
  a0:	0f 8e 76 ff ff ff    	jle    1c <main+0x1c>
  a6:	b8 48 00 00 00       	mov    eax,0x48
