  ...
  1b:	c7 45 f0 7b 00 00 00 	mov    DWORD PTR [rbp-0x10],0x7b
  22:	c7 45 f8 36 00 00 00 	mov    DWORD PTR [rbp-0x8],0x36
  29:	e9 8a 00 00 00       	jmp    b8 <main+0xb8>
  2e:	c7 45 fc 49 00 00 00 	mov    DWORD PTR [rbp-0x4],0x49
  35:	c7 45 f4 11 00 00 00 	mov    DWORD PTR [rbp-0xc],0x11
  ...
  52:	c7 04 02 20 00 00 00 	mov    DWORD PTR [rdx+rax*1],0x20
  59:	83 45 f4 01          	add    DWORD PTR [rbp-0xc],0x1
  5d:	83 7d f4 67          	cmp    DWORD PTR [rbp-0xc],0x67
  ...
  91:	c7 45 f8 1d 00 00 00 	mov    DWORD PTR [rbp-0x8],0x1d
  ...
  ae:	83 7d fc 67          	cmp    DWORD PTR [rbp-0x4],0x67
  b2:	7e b1                	jle    65 <main+0x65>
  b4:	83 45 f0 10          	add    DWORD PTR [rbp-0x10],0x10
  b8:	83 7d f0 4d          	cmp    DWORD PTR [rbp-0x10],0x4d
  bc:	0f 8e 6c ff ff ff    	jle    2e <main+0x2e>
  c2:	bf 58 00 00 00       	mov    edi,0x58
