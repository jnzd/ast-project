  ...
  69:	b8 2c 7a 2c 1a       	mov    eax,0x1a2c7a2c
  ...
  9f:	c7 45 d4 25 5e 94 2f 	mov    DWORD PTR [rbp-0x2c],0x2f945e25
  ...
  bc:	be 5c f5 73 19       	mov    esi,0x1973f55c
