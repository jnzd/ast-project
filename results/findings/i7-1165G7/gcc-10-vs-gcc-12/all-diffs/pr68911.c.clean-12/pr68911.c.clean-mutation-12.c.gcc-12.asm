  ...
  25:	b8 d5 41 1d d4       	mov    eax,0xd41d41d5
  ...
  7e:	83 7d f8 5c          	cmp    DWORD PTR [rbp-0x8],0x5c
  82:	77 2b                	ja     af <main+0xaf>
  84:	83 7d f4 34          	cmp    DWORD PTR [rbp-0xc],0x34
  ...
  9f:	83 f8 43             	cmp    eax,0x43
  a2:	0f 8e 74 ff ff ff    	jle    1c <main+0x1c>
  a8:	b8 48 00 00 00       	mov    eax,0x48
