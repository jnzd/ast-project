  ...
  af:	89 85 a8 fe ff ff    	mov    DWORD PTR [rbp-0x158],eax
  b5:	8b 8d ac fe ff ff    	mov    ecx,DWORD PTR [rbp-0x154]
  bb:	48 63 c1             	movsxd rax,ecx
  be:	48 69 c0 1f 85 eb 51 	imul   rax,rax,0x51eb851f
  c5:	48 c1 e8 20          	shr    rax,0x20
  c9:	c1 f8 03             	sar    eax,0x3
  cc:	89 ca                	mov    edx,ecx
  ce:	c1 fa 1f             	sar    edx,0x1f
  d1:	29 d0                	sub    eax,edx
  d3:	89 c2                	mov    edx,eax
  d5:	c1 e2 02             	shl    edx,0x2
  d8:	01 c2                	add    edx,eax
  da:	8d 04 95 00 00 00 00 	lea    eax,[rdx*4+0x0]
  e1:	01 c2                	add    edx,eax
  e3:	89 c8                	mov    eax,ecx
  e5:	29 d0                	sub    eax,edx
  e7:	83 f8 3a             	cmp    eax,0x3a
  ea:	7f 38                	jg     124 <main+0x124>
  ec:	83 f8 07             	cmp    eax,0x7
  ef:	0f 8c a2 01 00 00    	jl     297 <main+0x297>
  f5:	83 e8 07             	sub    eax,0x7
