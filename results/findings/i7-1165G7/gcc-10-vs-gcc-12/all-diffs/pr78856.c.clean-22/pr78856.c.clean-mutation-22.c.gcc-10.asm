  ...
  19:	c7 45 f0 3c 00 00 00 	mov    DWORD PTR [rbp-0x10],0x3c
  20:	c7 45 f8 01 00 00 00 	mov    DWORD PTR [rbp-0x8],0x1
  27:	e9 8a 00 00 00       	jmp    b6 <main+0xb6>
  2c:	c7 45 fc 0c 00 00 00 	mov    DWORD PTR [rbp-0x4],0xc
  33:	c7 45 f4 6b 00 00 00 	mov    DWORD PTR [rbp-0xc],0x6b
  ...
  ac:	83 7d fc 2f          	cmp    DWORD PTR [rbp-0x4],0x2f
  b0:	7e b1                	jle    63 <main+0x63>
  b2:	83 45 f0 77          	add    DWORD PTR [rbp-0x10],0x77
  b6:	83 7d f0 1e          	cmp    DWORD PTR [rbp-0x10],0x1e
  ba:	0f 8e 6c ff ff ff    	jle    2c <main+0x2c>
  c0:	bf 00 00 00 00       	mov    edi,0x0
