  ...
  69:	b8 72 4e ae 23       	mov    eax,0x23ae4e72
  ...
  9f:	c7 45 d4 68 54 d8 15 	mov    DWORD PTR [rbp-0x2c],0x15d85468
  ...
  bc:	be 5e a8 30 0a       	mov    esi,0xa30a85e
