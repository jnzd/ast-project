  ...
  69:	b8 15 06 3a 1d       	mov    eax,0x1d3a0615
  ...
  9f:	c7 45 d4 dc dc 09 08 	mov    DWORD PTR [rbp-0x2c],0x809dcdc
  ...
  bc:	be 4b 66 eb 1f       	mov    esi,0x1feb664b
