  ...
  1e:	00 
  1f:	c7 45 e4 26 00 00 00 	mov    DWORD PTR [rbp-0x1c],0x26
  26:	48 c7 45 f8 4a 00 00 	mov    QWORD PTR [rbp-0x8],0x4a
  2d:	00 
  ...
  5e:	48 8d 05 00 00 00 00 	lea    rax,[rip+0x0]        # 65 <main+0x65>
