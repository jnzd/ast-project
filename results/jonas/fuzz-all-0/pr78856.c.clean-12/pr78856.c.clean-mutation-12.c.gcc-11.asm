  ...
  19:	c7 45 f0 38 00 00 00 	mov    DWORD PTR [rbp-0x10],0x38
  20:	c7 45 f8 51 00 00 00 	mov    DWORD PTR [rbp-0x8],0x51
  27:	e9 8a 00 00 00       	jmp    b6 <main+0xb6>
  2c:	c7 45 fc 7f 00 00 00 	mov    DWORD PTR [rbp-0x4],0x7f
  ...
  50:	c7 04 02 74 00 00 00 	mov    DWORD PTR [rdx+rax*1],0x74
  57:	83 45 f4 01          	add    DWORD PTR [rbp-0xc],0x1
  5b:	83 7d f4 03          	cmp    DWORD PTR [rbp-0xc],0x3
  ...
  8f:	c7 45 f8 52 00 00 00 	mov    DWORD PTR [rbp-0x8],0x52
  ...
  b2:	83 45 f0 02          	add    DWORD PTR [rbp-0x10],0x2
  b6:	83 7d f0 63          	cmp    DWORD PTR [rbp-0x10],0x63
  ba:	0f 8e 6c ff ff ff    	jle    2c <main+0x2c>
  c0:	bf 0b 00 00 00       	mov    edi,0xb
