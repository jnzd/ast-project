  ...
  23:	c7 45 fc 39 00 00 00 	mov    DWORD PTR [rbp-0x4],0x39
  ...
  de:	b8 3b 00 00 00       	mov    eax,0x3b
  e3:	5d                   	pop    rbp
  e4:	c3                   	ret    
