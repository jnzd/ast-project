  ...
  23:	c7 45 fc 6e 00 00 00 	mov    DWORD PTR [rbp-0x4],0x6e
  ...
  db:	b8 75 00 00 00       	mov    eax,0x75
  e0:	5d                   	pop    rbp
  e1:	c3                   	ret    
