  ...
  20:	c7 45 f8 53 00 00 00 	mov    DWORD PTR [rbp-0x8],0x53
  27:	e9 8a 00 00 00       	jmp    b6 <main+0xb6>
  2c:	c7 45 fc 6a 00 00 00 	mov    DWORD PTR [rbp-0x4],0x6a
  33:	c7 45 f4 7d 00 00 00 	mov    DWORD PTR [rbp-0xc],0x7d
  ...
  50:	c7 04 02 13 00 00 00 	mov    DWORD PTR [rdx+rax*1],0x13
  57:	83 45 f4 01          	add    DWORD PTR [rbp-0xc],0x1
  5b:	83 7d f4 43          	cmp    DWORD PTR [rbp-0xc],0x43
  ...
  8f:	c7 45 f8 53 00 00 00 	mov    DWORD PTR [rbp-0x8],0x53
  ...
  ac:	83 7d fc 00          	cmp    DWORD PTR [rbp-0x4],0x0
  b0:	78 b1                	js     63 <main+0x63>
  b2:	83 45 f0 5b          	add    DWORD PTR [rbp-0x10],0x5b
  b6:	83 7d f0 59          	cmp    DWORD PTR [rbp-0x10],0x59
  ba:	0f 8e 6c ff ff ff    	jle    2c <main+0x2c>
  c0:	bf 03 00 00 00       	mov    edi,0x3
