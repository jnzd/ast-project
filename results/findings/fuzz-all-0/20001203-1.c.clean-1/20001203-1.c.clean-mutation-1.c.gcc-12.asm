  ...
  1b:	48 c7 45 80 0e 00 00 	mov    QWORD PTR [rbp-0x80],0xe
  22:	00 
  23:	48 c7 45 88 54 00 00 	mov    QWORD PTR [rbp-0x78],0x54
  2a:	00 
  ...
  bb:	c7 45 fc 17 00 00 00 	mov    DWORD PTR [rbp-0x4],0x17
