  ...
  65:	b8 15 06 3a 1d       	mov    eax,0x1d3a0615
  ...
  88:	c7 45 e4 dc dc 09 08 	mov    DWORD PTR [rbp-0x1c],0x809dcdc
  ...
  bf:	be 4b 66 eb 1f       	mov    esi,0x1feb664b
 ...
 129:	ba 83 6f f5 11       	mov    edx,0x11f56f83
 12e:	be 6b 36 bc 64       	mov    esi,0x64bc366b
 133:	b8 00 00 00 00       	mov    eax,0x0
 138:	e8 00 00 00 00       	call   13d <main+0xbd>
 13d:	48 83 c4 40          	add    rsp,0x40
 141:	b8 3b d0 c9 04       	mov    eax,0x4c9d03b
 146:	c9                   	leave
 147:	c3                   	ret
