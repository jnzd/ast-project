  ...
  5b:	83 7d fc 50          	cmp    DWORD PTR [rbp-0x4],0x50
  ...
  80:	c7 45 fc 10 00 00 00 	mov    DWORD PTR [rbp-0x4],0x10
  ...
  af:	83 7d fc 0d          	cmp    DWORD PTR [rbp-0x4],0xd
  b3:	7e d4                	jle    89 <main+0x24>
  b5:	b8 62 00 00 00       	mov    eax,0x62
  ba:	c9                   	leave  
  bb:	c3                   	ret    
