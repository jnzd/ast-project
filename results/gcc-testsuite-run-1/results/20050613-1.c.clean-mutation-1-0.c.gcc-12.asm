  ...
  b4:	0f 29 85 10 fe ff ff 	movaps XMMWORD PTR [rbp-0x1f0],xmm0
  bb:	c7 85 14 fe ff ff 19 	mov    DWORD PTR [rbp-0x1ec],0x19
  c2:	00 00 00 
  c5:	48 8d 85 20 fe ff ff 	lea    rax,[rbp-0x1e0]
  cc:	48 89 c7             	mov    rdi,rax
  cf:	e8 00 00 00 00       	call   d4 <main+0x8d>
  d4:	48 8d 85 80 fe ff ff 	lea    rax,[rbp-0x180]
  db:	48 89 c7             	mov    rdi,rax
  de:	e8 00 00 00 00       	call   e3 <main+0x9c>
  e3:	48 8d 85 10 fe ff ff 	lea    rax,[rbp-0x1f0]
