  ...
  34:	48 c7 45 f8 02 00 00 	mov    QWORD PTR [rbp-0x8],0x2
  3b:	00 
  ...
  74:	ba 76 08 00 00       	mov    edx,0x876
  79:	be 78 00 00 00       	mov    esi,0x78
  7e:	48 8d 05 00 00 00 00 	lea    rax,[rip+0x0]        # 85 <foo+0x19>
  85:	48 89 c7             	mov    rdi,rax
  88:	e8 00 00 00 00       	call   8d <foo+0x21>
  8d:	c6 05 00 00 00 00 15 	mov    BYTE PTR [rip+0x0],0x15        # 94 <foo+0x28>
  ...
  dc:	b8 79 00 00 00       	mov    eax,0x79
  e1:	5d                   	pop    rbp
  e2:	c3                   	ret    
