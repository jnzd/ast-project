  ...
  23:	c7 45 fc 26 00 00 00 	mov    DWORD PTR [rbp-0x4],0x26
  ...
  de:	b8 2d 00 00 00       	mov    eax,0x2d
  e3:	5d                   	pop    rbp
  e4:	c3                   	ret    
