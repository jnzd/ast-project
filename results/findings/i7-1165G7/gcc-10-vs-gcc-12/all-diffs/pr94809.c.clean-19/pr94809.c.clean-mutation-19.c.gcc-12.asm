   ...
   c:	c7 45 f4 4f 00 00 00 	mov    DWORD PTR [rbp-0xc],0x4f
  13:	48 c7 45 f8 6d 00 00 	mov    QWORD PTR [rbp-0x8],0x6d
  1a:	00 
  ...
  2e:	83 7d f4 61          	cmp    DWORD PTR [rbp-0xc],0x61
  32:	74 05                	je     39 <main+0x39>
  34:	e8 00 00 00 00       	call   39 <main+0x39>
  39:	b8 3a 00 00 00       	mov    eax,0x3a
  3e:	c9                   	leave  
  3f:	c3                   	ret    
