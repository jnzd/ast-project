  ...
  31:	48 c7 45 f8 24 00 00 	mov    QWORD PTR [rbp-0x8],0x24
  38:	00 
  ...
  46:	48 05 d2 00 00 00    	add    rax,0xd2
  ...
  73:	ba cb 08 00 00       	mov    edx,0x8cb
  78:	be 07 00 00 00       	mov    esi,0x7
  7d:	48 8d 3d 00 00 00 00 	lea    rdi,[rip+0x0]        # 84 <foo+0x19>
  84:	e8 00 00 00 00       	call   89 <foo+0x1e>
  89:	c6 05 00 00 00 00 01 	mov    BYTE PTR [rip+0x0],0x1        # 90 <foo+0x25>
  ...
  a8:	c6 05 00 00 00 00 58 	mov    BYTE PTR [rip+0x0],0x58        # af <foo+0x44>
  af:	48 8d 3d 00 00 00 00 	lea    rdi,[rip+0x0]        # b6 <foo+0x4b>
  b6:	e8 00 00 00 00       	call   bb <foo+0x50>
  bb:	b8 0b 00 00 00       	mov    eax,0xb
  c0:	5d                   	pop    rbp
  c1:	c3                   	ret    
  ...
  cf:	b8 53 00 00 00       	mov    eax,0x53
  d4:	5d                   	pop    rbp
  d5:	c3                   	ret    
