  ...
  18:	48 c7 45 f8 01 00 00 	mov    QWORD PTR [rbp-0x8],0x1
  1f:	00 
  20:	48 c7 45 f0 5e 00 00 	mov    QWORD PTR [rbp-0x10],0x5e
  27:	00 
  ...
  7c:	83 f8 0e             	cmp    eax,0xe
  7f:	74 07                	je     88 <foo+0x88>
  81:	b8 3d 00 00 00       	mov    eax,0x3d
