   ...
   f:	83 7d fc 21          	cmp    DWORD PTR [rbp-0x4],0x21
  ...
  29:	c7 45 fc 13 00 00 00 	mov    DWORD PTR [rbp-0x4],0x13
  30:	8b 45 fc             	mov    eax,DWORD PTR [rbp-0x4]
  33:	83 c0 5b             	add    eax,0x5b
  ...
  71:	48 c7 45 f8 18 00 00 	mov    QWORD PTR [rbp-0x8],0x18
  78:	00 
  79:	bf 17 00 00 80       	mov    edi,0x80000017
