  ...
  70:	48 83 7d f8 20       	cmp    QWORD PTR [rbp-0x8],0x20
  75:	7e 07                	jle    7e <f+0x7e>
  77:	b8 0c 00 00 00       	mov    eax,0xc
  7c:	eb 13                	jmp    91 <f+0x91>
  7e:	48 83 7d f8 13       	cmp    QWORD PTR [rbp-0x8],0x13
  83:	7f 07                	jg     8c <f+0x8c>
  85:	b8 43 00 00 00       	mov    eax,0x43
  8a:	eb 05                	jmp    91 <f+0x91>
  8c:	b8 58 00 00 00       	mov    eax,0x58
  91:	5d                   	pop    rbp
  92:	c3                   	ret    
  ...
  a0:	48 c7 45 c0 c1 ff ff 	mov    QWORD PTR [rbp-0x40],0xffffffffffffffc1
  a7:	ff 
  a8:	48 c7 45 c8 3b 00 00 	mov    QWORD PTR [rbp-0x38],0x3b
  af:	00 
  b0:	48 c7 45 d0 0e 00 00 	mov    QWORD PTR [rbp-0x30],0xe
  b7:	00 
  b8:	48 c7 45 d8 e0 ff ff 	mov    QWORD PTR [rbp-0x28],0xffffffffffffffe0
  bf:	ff 
  c0:	48 c7 45 e0 92 ff ff 	mov    QWORD PTR [rbp-0x20],0xffffffffffffff92
  c7:	ff 
  c8:	48 c7 45 e8 e3 ff ff 	mov    QWORD PTR [rbp-0x18],0xffffffffffffffe3
  cf:	ff 
  ...
  fc:	83 7d bc 29          	cmp    DWORD PTR [rbp-0x44],0x29
 100:	74 05                	je     107 <main+0x74>
 102:	e8 00 00 00 00       	call   107 <main+0x74>
 107:	bf 07 00 00 00       	mov    edi,0x7
