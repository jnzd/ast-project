  ...
  69:	b8 18 f1 f5 7d       	mov    eax,0x7df5f118
  ...
  9f:	c7 45 d4 e8 a7 42 13 	mov    DWORD PTR [rbp-0x2c],0x1342a7e8
  ...
  bc:	be 2b 4e 4f 23       	mov    esi,0x234f4e2b
