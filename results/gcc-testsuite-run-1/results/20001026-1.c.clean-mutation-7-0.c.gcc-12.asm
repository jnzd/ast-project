 ...
 20f:	66 0f 6f 05 00 00 00 	movdqa xmm0,XMMWORD PTR [rip+0x0]        # 217 <main+0x2d>
 216:	00 
 217:	0f 29 00             	movaps XMMWORD PTR [rax],xmm0
 21a:	0f 29 40 10          	movaps XMMWORD PTR [rax+0x10],xmm0
 21e:	0f 29 40 20          	movaps XMMWORD PTR [rax+0x20],xmm0
 222:	0f 29 40 30          	movaps XMMWORD PTR [rax+0x30],xmm0
 226:	0f 29 40 40          	movaps XMMWORD PTR [rax+0x40],xmm0
 22a:	0f 29 40 50          	movaps XMMWORD PTR [rax+0x50],xmm0
 22e:	0f 29 40 60          	movaps XMMWORD PTR [rax+0x60],xmm0
 232:	0f 29 40 70          	movaps XMMWORD PTR [rax+0x70],xmm0
 236:	48 8d 85 70 ff ff ff 	lea    rax,[rbp-0x90]
 23d:	48 89 c7             	mov    rdi,rax
 240:	b8 00 00 00 00       	mov    eax,0x0
 245:	e8 b9 fe ff ff       	call   103 <build_real_from_int_cst_1>
 24a:	48 8b 45 b0          	mov    rax,QWORD PTR [rbp-0x50]
 24e:	48 83 f8 2b          	cmp    rax,0x2b
 252:	75 05                	jne    259 <main+0x6f>
 254:	e8 00 00 00 00       	call   259 <main+0x6f>
 259:	b8 73 00 00 00       	mov    eax,0x73
 25e:	48 8b 55 f8          	mov    rdx,QWORD PTR [rbp-0x8]
 262:	64 48 2b 14 25 28 00 	sub    rdx,QWORD PTR fs:0x28
 269:	00 00 
 26b:	74 05                	je     272 <main+0x88>
 26d:	e8 00 00 00 00       	call   272 <main+0x88>
 272:	c9                   	leave  
 273:	c3                   	ret    
