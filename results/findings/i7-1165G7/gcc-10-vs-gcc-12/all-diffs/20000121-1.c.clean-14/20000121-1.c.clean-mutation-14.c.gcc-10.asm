  ...
  59:	48 8d 15 00 00 00 00 	lea    rdx,[rip+0x0]        # 60 <main+0xf>
  60:	be 4e 00 00 00       	mov    esi,0x4e
  65:	bf 39 00 00 00       	mov    edi,0x39
  6a:	e8 00 00 00 00       	call   6f <main+0x1e>
  6f:	b8 18 00 00 00       	mov    eax,0x18
  74:	5d                   	pop    rbp
  75:	c3                   	ret    
