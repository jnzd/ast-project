  ...
  1a:	c7 45 f0 2a 00 00 00 	mov    DWORD PTR [rbp-0x10],0x2a
  ...
  3c:	83 7d fc 01          	cmp    DWORD PTR [rbp-0x4],0x1
  ...
  5b:	c7 45 f4 77 00 00 00 	mov    DWORD PTR [rbp-0xc],0x77
