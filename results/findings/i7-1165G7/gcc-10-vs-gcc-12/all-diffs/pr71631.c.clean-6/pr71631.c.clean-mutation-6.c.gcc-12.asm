  ...
  3e:	c7 45 dc 2a 00 00 00 	mov    DWORD PTR [rbp-0x24],0x2a
  45:	c7 45 e0 32 00 00 00 	mov    DWORD PTR [rbp-0x20],0x32
  4c:	8b 0d 00 00 00 00    	mov    ecx,DWORD PTR [rip+0x0]        # 52 <main+0x20>
  52:	b8 1d 00 00 00       	mov    eax,0x1d
  57:	99                   	cdq    
  58:	f7 f9                	idiv   ecx
  ...
  6f:	83 c0 69             	add    eax,0x69
  72:	89 45 ec             	mov    DWORD PTR [rbp-0x14],eax
  75:	b8 4a 00 00 00       	mov    eax,0x4a
  7a:	99                   	cdq    
  ...
  cd:	6b c0 95             	imul   eax,eax,0xffffff95
  ...
  ea:	83 7d f0 72          	cmp    DWORD PTR [rbp-0x10],0x72
  ee:	75 0f                	jne    ff <main+0xcd>
  f0:	48 8d 05 00 00 00 00 	lea    rax,[rip+0x0]        # f7 <main+0xc5>
  f7:	48 89 c7             	mov    rdi,rax
  fa:	e8 00 00 00 00       	call   ff <main+0xcd>
  ff:	66 83 7d da 91       	cmp    WORD PTR [rbp-0x26],0xff91
 104:	74 05                	je     10b <main+0xd9>
 106:	e8 00 00 00 00       	call   10b <main+0xd9>
 10b:	b8 7d 00 00 00       	mov    eax,0x7d
 110:	c9                   	leave  
 111:	c3                   	ret    
