  ...
  1b:	c7 45 f0 64 00 00 00 	mov    DWORD PTR [rbp-0x10],0x64
  22:	c7 45 f8 0f 00 00 00 	mov    DWORD PTR [rbp-0x8],0xf
  29:	e9 8a 00 00 00       	jmp    b8 <main+0xb8>
  2e:	c7 45 fc 2e 00 00 00 	mov    DWORD PTR [rbp-0x4],0x2e
  35:	c7 45 f4 65 00 00 00 	mov    DWORD PTR [rbp-0xc],0x65
  ...
  52:	c7 04 02 26 00 00 00 	mov    DWORD PTR [rdx+rax*1],0x26
  59:	83 45 f4 01          	add    DWORD PTR [rbp-0xc],0x1
  5d:	83 7d f4 12          	cmp    DWORD PTR [rbp-0xc],0x12
  ...
  91:	c7 45 f8 3c 00 00 00 	mov    DWORD PTR [rbp-0x8],0x3c
  ...
  ae:	83 7d fc 71          	cmp    DWORD PTR [rbp-0x4],0x71
  b2:	7e b1                	jle    65 <main+0x65>
  b4:	83 45 f0 18          	add    DWORD PTR [rbp-0x10],0x18
  b8:	83 7d f0 00          	cmp    DWORD PTR [rbp-0x10],0x0
  bc:	0f 88 6c ff ff ff    	js     2e <main+0x2e>
  c2:	bf 4f 00 00 00       	mov    edi,0x4f
