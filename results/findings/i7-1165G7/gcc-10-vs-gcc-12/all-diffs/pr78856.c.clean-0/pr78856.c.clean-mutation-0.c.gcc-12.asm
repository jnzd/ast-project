  ...
  1b:	c7 45 f0 07 00 00 00 	mov    DWORD PTR [rbp-0x10],0x7
  22:	c7 45 f8 1c 00 00 00 	mov    DWORD PTR [rbp-0x8],0x1c
  29:	e9 8a 00 00 00       	jmp    b8 <main+0xb8>
  2e:	c7 45 fc 71 00 00 00 	mov    DWORD PTR [rbp-0x4],0x71
  35:	c7 45 f4 4f 00 00 00 	mov    DWORD PTR [rbp-0xc],0x4f
  ...
  52:	c7 04 02 02 00 00 00 	mov    DWORD PTR [rdx+rax*1],0x2
  ...
  91:	c7 45 f8 3d 00 00 00 	mov    DWORD PTR [rbp-0x8],0x3d
  ...
  ae:	83 7d fc 2b          	cmp    DWORD PTR [rbp-0x4],0x2b
  b2:	7e b1                	jle    65 <main+0x65>
  b4:	83 45 f0 0a          	add    DWORD PTR [rbp-0x10],0xa
  b8:	83 7d f0 22          	cmp    DWORD PTR [rbp-0x10],0x22
  bc:	0f 8e 6c ff ff ff    	jle    2e <main+0x2e>
  c2:	bf 32 00 00 00       	mov    edi,0x32
