  ...
  69:	b8 2e 2e ff 59       	mov    eax,0x59ff2e2e
  ...
  9f:	c7 45 d4 fc fa 8c 09 	mov    DWORD PTR [rbp-0x2c],0x98cfafc
  ...
  bc:	be e3 75 36 33       	mov    esi,0x333675e3
