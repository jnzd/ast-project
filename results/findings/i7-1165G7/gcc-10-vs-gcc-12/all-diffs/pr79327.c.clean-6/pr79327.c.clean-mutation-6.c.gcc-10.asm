  ...
  61:	83 f8 5c             	cmp    eax,0x5c
  64:	74 05                	je     6b <main+0x6b>
  66:	e8 00 00 00 00       	call   6b <main+0x6b>
  6b:	c7 05 00 00 00 00 16 	mov    DWORD PTR [rip+0x0],0x16        # 75 <main+0x75>
  72:	00 00 00 
  ...
  bb:	83 f8 63             	cmp    eax,0x63
  be:	74 05                	je     c5 <main+0xc5>
  c0:	e8 00 00 00 00       	call   c5 <main+0xc5>
  c5:	c7 05 00 00 00 00 75 	mov    DWORD PTR [rip+0x0],0x75        # cf <main+0xcf>
  cc:	00 00 00 
 ...
 11f:	b8 7a 00 00 00       	mov    eax,0x7a
