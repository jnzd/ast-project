  ...
  40:	c7 45 fc 30 00 00 00 	mov    DWORD PTR [rbp-0x4],0x30
  ...
  7d:	83 f8 50             	cmp    eax,0x50
  80:	76 d3                	jbe    55 <main+0x55>
  82:	83 45 fc 01          	add    DWORD PTR [rbp-0x4],0x1
  86:	83 7d fc 16          	cmp    DWORD PTR [rbp-0x4],0x16
  8a:	7e bd                	jle    49 <main+0x49>
  8c:	c7 45 fc 03 00 00 00 	mov    DWORD PTR [rbp-0x4],0x3
  93:	eb 04                	jmp    99 <main+0x99>
  95:	83 45 fc 01          	add    DWORD PTR [rbp-0x4],0x1
  99:	83 7d fc 67          	cmp    DWORD PTR [rbp-0x4],0x67
  ...
  bc:	bf 16 00 00 00       	mov    edi,0x16
