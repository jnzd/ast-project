  ...
  69:	b8 37 f8 e4 10       	mov    eax,0x10e4f837
  ...
  9f:	c7 45 d4 65 65 9e 03 	mov    DWORD PTR [rbp-0x2c],0x39e6565
  ...
  bc:	be 4a 3d 8f 45       	mov    esi,0x458f3d4a
