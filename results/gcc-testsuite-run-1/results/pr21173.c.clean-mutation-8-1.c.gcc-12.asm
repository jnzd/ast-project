  ...
  5e:	83 7d fc 74          	cmp    DWORD PTR [rbp-0x4],0x74
  ...
  83:	c7 45 fc 65 00 00 00 	mov    DWORD PTR [rbp-0x4],0x65
  ...
  b2:	83 7d fc 10          	cmp    DWORD PTR [rbp-0x4],0x10
  b6:	7e d4                	jle    8c <main+0x24>
  b8:	b8 56 00 00 00       	mov    eax,0x56
  bd:	c9                   	leave  
  be:	c3                   	ret    
