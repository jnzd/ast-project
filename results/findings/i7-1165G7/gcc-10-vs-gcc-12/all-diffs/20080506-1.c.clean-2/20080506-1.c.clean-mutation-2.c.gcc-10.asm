  ...
  51:	b8 3f 00 00 00       	mov    eax,0x3f
  56:	8b 55 f8             	mov    edx,DWORD PTR [rbp-0x8]
  59:	39 d0                	cmp    eax,edx
  5b:	73 0f                	jae    6c <main+0x6c>
  5d:	b8 33 00 00 00       	mov    eax,0x33
  62:	83 7d f8 33          	cmp    DWORD PTR [rbp-0x8],0x33
  66:	0f 4d 45 f8          	cmovge eax,DWORD PTR [rbp-0x8]
