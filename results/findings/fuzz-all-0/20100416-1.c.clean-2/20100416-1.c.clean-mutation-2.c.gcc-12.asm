  ...
  12:	c7 45 fc 79 00 00 00 	mov    DWORD PTR [rbp-0x4],0x79
  19:	c7 45 f8 00 00 00 00 	mov    DWORD PTR [rbp-0x8],0x0
  ...
  5d:	c7 45 fc 5a 00 00 00 	mov    DWORD PTR [rbp-0x4],0x5a
  ...
  80:	be 42 00 00 00       	mov    esi,0x42
  ...
  bc:	b8 35 00 00 00       	mov    eax,0x35
  c1:	c9                   	leave  
  c2:	c3                   	ret    
