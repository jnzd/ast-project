  ...
  69:	b8 a4 da 96 76       	mov    eax,0x7696daa4
  ...
  9f:	c7 45 d4 41 48 98 33 	mov    DWORD PTR [rbp-0x2c],0x33984841
  ...
  d6:	be 3b 5a b6 47       	mov    esi,0x47b65a3b
 ...
 140:	ba 23 66 0a 09       	mov    edx,0x90a6623
 145:	be 10 86 df 07       	mov    esi,0x7df8610
 14a:	b8 00 00 00 00       	mov    eax,0x0
 14f:	e8 00 00 00 00       	call   154 <main+0xd0>
 154:	48 83 c4 40          	add    rsp,0x40
 158:	b8 dd a0 5e 23       	mov    eax,0x235ea0dd
