  ...
  93:	00 
  94:	48 c7 45 dc 00 00 00 	mov    QWORD PTR [rbp-0x24],0x0
  9b:	00 
  9c:	48 c7 45 e4 00 00 00 	mov    QWORD PTR [rbp-0x1c],0x0
  a3:	00 
  a4:	c6 85 6f ff ff ff 69 	mov    BYTE PTR [rbp-0x91],0x69
  ab:	8b 05 00 00 00 00    	mov    eax,DWORD PTR [rip+0x0]        # b1 <main+0xb1>
  b1:	83 f8 55             	cmp    eax,0x55
