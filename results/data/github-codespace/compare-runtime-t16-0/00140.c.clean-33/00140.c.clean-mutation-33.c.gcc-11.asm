  ...
  69:	b8 97 1f 58 1a       	mov    eax,0x1a581f97
  ...
  9f:	c7 45 d4 5f 92 b1 00 	mov    DWORD PTR [rbp-0x2c],0xb1925f
  ...
  bc:	be f6 98 35 2a       	mov    esi,0x2a3598f6
