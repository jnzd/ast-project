   ...
   c:	c7 45 f4 5b 00 00 00 	mov    DWORD PTR [rbp-0xc],0x5b
  13:	c7 45 f8 6b 00 00 00 	mov    DWORD PTR [rbp-0x8],0x6b
  1a:	eb 79                	jmp    95 <main+0x95>
  1c:	8b 45 f4             	mov    eax,DWORD PTR [rbp-0xc]
  1f:	f7 d0                	not    eax
  21:	89 c2                	mov    edx,eax
  23:	48 69 d2 db 6a f0 1c 	imul   rdx,rdx,0x1cf06adb
  ...
  7a:	83 7d f8 45          	cmp    DWORD PTR [rbp-0x8],0x45
  7e:	77 2b                	ja     ab <main+0xab>
  80:	83 7d f4 07          	cmp    DWORD PTR [rbp-0xc],0x7
  ...
  9b:	83 f8 1a             	cmp    eax,0x1a
  9e:	0f 8e 78 ff ff ff    	jle    1c <main+0x1c>
  a4:	b8 17 00 00 00       	mov    eax,0x17
