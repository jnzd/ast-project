   ...
   c:	c7 45 f4 02 00 00 00 	mov    DWORD PTR [rbp-0xc],0x2
  13:	48 c7 45 f8 2b 00 00 	mov    QWORD PTR [rbp-0x8],0x2b
  1a:	00 
  ...
  2a:	83 7d f4 58          	cmp    DWORD PTR [rbp-0xc],0x58
  2e:	74 05                	je     35 <main+0x35>
  30:	e8 00 00 00 00       	call   35 <main+0x35>
  35:	b8 2e 00 00 00       	mov    eax,0x2e
  3a:	c9                   	leave  
  3b:	c3                   	ret    
