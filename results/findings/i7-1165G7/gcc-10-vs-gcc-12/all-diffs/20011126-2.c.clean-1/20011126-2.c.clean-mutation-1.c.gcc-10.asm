  ...
  97:	48 8d 3d 00 00 00 00 	lea    rdi,[rip+0x0]        # 9e <main+0x29>
  9e:	e8 5d ff ff ff       	call   0 <test>
  a3:	b8 47 00 00 00       	mov    eax,0x47
  a8:	48 8b 55 f8          	mov    rdx,QWORD PTR [rbp-0x8]
  ac:	64 48 2b 14 25 28 00 	sub    rdx,QWORD PTR fs:0x28
  b3:	00 00 
  b5:	74 05                	je     bc <main+0x47>
  b7:	e8 00 00 00 00       	call   bc <main+0x47>
  bc:	c9                   	leave  
  bd:	c3                   	ret    
