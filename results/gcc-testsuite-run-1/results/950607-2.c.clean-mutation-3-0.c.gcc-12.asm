  ...
  73:	48 83 7d f8 20       	cmp    QWORD PTR [rbp-0x8],0x20
  78:	7e 07                	jle    81 <f+0x81>
  7a:	b8 0c 00 00 00       	mov    eax,0xc
  7f:	eb 13                	jmp    94 <f+0x94>
  81:	48 83 7d f8 13       	cmp    QWORD PTR [rbp-0x8],0x13
  86:	7f 07                	jg     8f <f+0x8f>
  88:	b8 43 00 00 00       	mov    eax,0x43
  8d:	eb 05                	jmp    94 <f+0x94>
  8f:	b8 58 00 00 00       	mov    eax,0x58
  94:	5d                   	pop    rbp
  95:	c3                   	ret    
  ...
  a3:	48 c7 45 c0 c1 ff ff 	mov    QWORD PTR [rbp-0x40],0xffffffffffffffc1
  aa:	ff 
  ab:	48 c7 45 c8 3b 00 00 	mov    QWORD PTR [rbp-0x38],0x3b
  b2:	00 
  b3:	48 c7 45 d0 0e 00 00 	mov    QWORD PTR [rbp-0x30],0xe
  ba:	00 
  bb:	48 c7 45 d8 e0 ff ff 	mov    QWORD PTR [rbp-0x28],0xffffffffffffffe0
  c2:	ff 
  c3:	48 c7 45 e0 92 ff ff 	mov    QWORD PTR [rbp-0x20],0xffffffffffffff92
  ca:	ff 
  cb:	48 c7 45 e8 e3 ff ff 	mov    QWORD PTR [rbp-0x18],0xffffffffffffffe3
  d2:	ff 
  ...
  ff:	83 7d bc 29          	cmp    DWORD PTR [rbp-0x44],0x29
 103:	74 05                	je     10a <main+0x74>
 105:	e8 00 00 00 00       	call   10a <main+0x74>
 10a:	bf 07 00 00 00       	mov    edi,0x7
