  ...
  69:	b8 e2 cf 38 46       	mov    eax,0x4638cfe2
  ...
  9f:	c7 45 d4 17 da ff 16 	mov    DWORD PTR [rbp-0x2c],0x16ffda17
  ...
  d6:	be 40 5f fd 55       	mov    esi,0x55fd5f40
 ...
 140:	ba b8 be 96 02       	mov    edx,0x296beb8
 145:	be 84 31 ed 1d       	mov    esi,0x1ded3184
 14a:	b8 00 00 00 00       	mov    eax,0x0
 14f:	e8 00 00 00 00       	call   154 <main+0xd0>
 154:	48 83 c4 40          	add    rsp,0x40
 158:	b8 ef 55 29 5f       	mov    eax,0x5f2955ef
