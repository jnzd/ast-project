  ...
  25:	48 69 c0 9f 12 e4 29 	imul   rax,rax,0x29e4129f
  ...
  7c:	83 7d f8 37          	cmp    DWORD PTR [rbp-0x8],0x37
  80:	77 2b                	ja     ad <main+0xad>
  82:	83 7d f4 20          	cmp    DWORD PTR [rbp-0xc],0x20
  ...
  a6:	b8 6f 00 00 00       	mov    eax,0x6f
