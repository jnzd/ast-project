  ...
  1b:	c7 45 f0 3c 00 00 00 	mov    DWORD PTR [rbp-0x10],0x3c
  22:	c7 45 f8 01 00 00 00 	mov    DWORD PTR [rbp-0x8],0x1
  29:	e9 8a 00 00 00       	jmp    b8 <main+0xb8>
  2e:	c7 45 fc 0c 00 00 00 	mov    DWORD PTR [rbp-0x4],0xc
  35:	c7 45 f4 6b 00 00 00 	mov    DWORD PTR [rbp-0xc],0x6b
  ...
  5d:	83 7d f4 5b          	cmp    DWORD PTR [rbp-0xc],0x5b
  ...
  b4:	83 45 f0 77          	add    DWORD PTR [rbp-0x10],0x77
  b8:	83 7d f0 1e          	cmp    DWORD PTR [rbp-0x10],0x1e
  bc:	0f 8e 6c ff ff ff    	jle    2e <main+0x2e>
  c2:	bf 00 00 00 00       	mov    edi,0x0
