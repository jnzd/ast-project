  ...
  65:	b8 33 c2 8c 0a       	mov    eax,0xa8cc233
  ...
  88:	c7 45 e4 57 88 ec 09 	mov    DWORD PTR [rbp-0x1c],0x9ec8857
  ...
  bf:	be 87 a2 1d 0d       	mov    esi,0xd1da287
 ...
 129:	ba e4 22 9b 6b       	mov    edx,0x6b9b22e4
 12e:	be c3 55 02 11       	mov    esi,0x110255c3
 133:	b8 00 00 00 00       	mov    eax,0x0
 138:	e8 00 00 00 00       	call   13d <main+0xbd>
 13d:	48 83 c4 40          	add    rsp,0x40
 141:	b8 16 a6 f4 34       	mov    eax,0x34f4a616
 146:	c9                   	leave
 147:	c3                   	ret
