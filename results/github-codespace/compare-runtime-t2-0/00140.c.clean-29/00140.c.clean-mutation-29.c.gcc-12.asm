  ...
  65:	b8 1b f1 e7 72       	mov    eax,0x72e7f11b
  ...
  88:	c7 45 e4 f4 c6 37 27 	mov    DWORD PTR [rbp-0x1c],0x2737c6f4
  ...
  bf:	be da d5 59 47       	mov    esi,0x4759d5da
 ...
 129:	ba 79 da 1f 00       	mov    edx,0x1fda79
 12e:	be a5 31 03 54       	mov    esi,0x540331a5
 133:	b8 00 00 00 00       	mov    eax,0x0
 138:	e8 00 00 00 00       	call   13d <main+0xbd>
 13d:	48 83 c4 40          	add    rsp,0x40
 141:	b8 93 3b b3 69       	mov    eax,0x69b33b93
 146:	c9                   	leave
 147:	c3                   	ret
