  ...
  46:	48 05 a7 00 00 00    	add    rax,0xa7
  ...
  73:	ba a0 08 00 00       	mov    edx,0x8a0
  78:	be 01 00 00 00       	mov    esi,0x1
  7d:	48 8d 3d 00 00 00 00 	lea    rdi,[rip+0x0]        # 84 <foo+0x19>
  84:	e8 00 00 00 00       	call   89 <foo+0x1e>
  89:	c6 05 00 00 00 00 27 	mov    BYTE PTR [rip+0x0],0x27        # 90 <foo+0x25>
  ...
  a8:	c6 05 00 00 00 00 44 	mov    BYTE PTR [rip+0x0],0x44        # af <foo+0x44>
  af:	48 8d 3d 00 00 00 00 	lea    rdi,[rip+0x0]        # b6 <foo+0x4b>
  b6:	e8 00 00 00 00       	call   bb <foo+0x50>
  bb:	b8 50 00 00 00       	mov    eax,0x50
  c0:	5d                   	pop    rbp
  c1:	c3                   	ret    
  ...
  cf:	b8 4a 00 00 00       	mov    eax,0x4a
  d4:	5d                   	pop    rbp
  d5:	c3                   	ret    
