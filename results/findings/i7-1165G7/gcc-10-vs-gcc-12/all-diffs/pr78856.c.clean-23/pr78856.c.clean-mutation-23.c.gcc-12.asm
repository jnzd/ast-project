  ...
  1b:	c7 45 f0 23 00 00 00 	mov    DWORD PTR [rbp-0x10],0x23
  22:	c7 45 f8 4e 00 00 00 	mov    DWORD PTR [rbp-0x8],0x4e
  29:	e9 8a 00 00 00       	jmp    b8 <main+0xb8>
  2e:	c7 45 fc 45 00 00 00 	mov    DWORD PTR [rbp-0x4],0x45
  35:	c7 45 f4 36 00 00 00 	mov    DWORD PTR [rbp-0xc],0x36
  ...
  52:	c7 04 02 07 00 00 00 	mov    DWORD PTR [rdx+rax*1],0x7
  ...
  91:	c7 45 f8 04 00 00 00 	mov    DWORD PTR [rbp-0x8],0x4
  ...
  ae:	83 7d fc 1d          	cmp    DWORD PTR [rbp-0x4],0x1d
  b2:	7e b1                	jle    65 <main+0x65>
  b4:	83 45 f0 73          	add    DWORD PTR [rbp-0x10],0x73
  b8:	83 7d f0 6b          	cmp    DWORD PTR [rbp-0x10],0x6b
  bc:	0f 8e 6c ff ff ff    	jle    2e <main+0x2e>
  c2:	bf 02 00 00 00       	mov    edi,0x2
