  ...
  69:	b8 fd 4c 00 11       	mov    eax,0x11004cfd
  ...
  9f:	c7 45 d4 b5 d0 41 26 	mov    DWORD PTR [rbp-0x2c],0x2641d0b5
  ...
  d6:	be b3 90 36 14       	mov    esi,0x143690b3
 ...
 140:	ba b1 9f 46 54       	mov    edx,0x54469fb1
 145:	be 49 89 95 4c       	mov    esi,0x4c958949
 14a:	b8 00 00 00 00       	mov    eax,0x0
 14f:	e8 00 00 00 00       	call   154 <main+0xd0>
 154:	48 83 c4 40          	add    rsp,0x40
 158:	b8 d4 cc 00 13       	mov    eax,0x1300ccd4
