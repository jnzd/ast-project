  ...
  12:	c7 45 fc 50 00 00 00 	mov    DWORD PTR [rbp-0x4],0x50
  19:	c7 45 f8 53 00 00 00 	mov    DWORD PTR [rbp-0x8],0x53
  ...
  5d:	c7 45 fc 59 00 00 00 	mov    DWORD PTR [rbp-0x4],0x59
  ...
  80:	be 78 00 00 00       	mov    esi,0x78
  85:	bf 9e ff ff ff       	mov    edi,0xffffff9e
  ...
  bb:	b8 37 00 00 00       	mov    eax,0x37
  c0:	c9                   	leave  
  c1:	c3                   	ret    
