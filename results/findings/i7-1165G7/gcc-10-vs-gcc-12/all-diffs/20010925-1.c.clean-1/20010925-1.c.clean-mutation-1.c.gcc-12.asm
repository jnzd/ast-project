  ...
  51:	83 7d ec 2d          	cmp    DWORD PTR [rbp-0x14],0x2d
  55:	75 07                	jne    5e <foo+0x24>
  57:	b8 2f 00 00 00       	mov    eax,0x2f
