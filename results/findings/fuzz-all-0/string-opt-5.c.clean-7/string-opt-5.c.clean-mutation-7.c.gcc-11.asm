 ...
 2ff:	83 f8 76             	cmp    eax,0x76
 302:	75 0b                	jne    30f <main+0x30f>
 304:	8b 05 00 00 00 00    	mov    eax,DWORD PTR [rip+0x0]        # 30a <main+0x30a>
 30a:	83 f8 21             	cmp    eax,0x21
 30d:	74 05                	je     314 <main+0x314>
 30f:	e8 00 00 00 00       	call   314 <main+0x314>
 314:	c6 45 c8 20          	mov    BYTE PTR [rbp-0x38],0x20
 318:	c6 45 cd 00          	mov    BYTE PTR [rbp-0x33],0x0
 31c:	c7 05 00 00 00 00 74 	mov    DWORD PTR [rip+0x0],0x74        # 326 <main+0x326>
 323:	00 00 00 
 326:	c7 05 00 00 00 00 50 	mov    DWORD PTR [rip+0x0],0x50        # 330 <main+0x330>
 32d:	00 00 00 
 ...
 353:	48 83 c0 20          	add    rax,0x20
 357:	ba 77 00 00 00       	mov    edx,0x77
 ...
 3a9:	ba 22 00 00 00       	mov    edx,0x22
 ...
 45f:	ba 22 00 00 00       	mov    edx,0x22
 ...
 499:	ba 48 00 00 00       	mov    edx,0x48
 ...
 4c0:	00 00 00 
 4c3:	ba 37 00 00 00       	mov    edx,0x37
 ...
 578:	ba 5c 00 00 00       	mov    edx,0x5c
 ...
 59c:	83 f8 77             	cmp    eax,0x77
 59f:	75 22                	jne    5c3 <main+0x5c3>
 5a1:	ba 1e 00 00 00       	mov    edx,0x1e
 ...
 5c8:	c7 05 00 00 00 00 1a 	mov    DWORD PTR [rip+0x0],0x1a        # 5d2 <main+0x5d2>
 5cf:	00 00 00 
 ...
 608:	be 4c 00 00 00       	mov    esi,0x4c
 ...
 67f:	ba 41 00 00 00       	mov    edx,0x41
 684:	be 29 00 00 00       	mov    esi,0x29
 ...
 6cf:	b8 53 00 00 00       	mov    eax,0x53
