  ...
  70:	48 83 7d f8 1f       	cmp    QWORD PTR [rbp-0x8],0x1f
  75:	7e 07                	jle    7e <f+0x7e>
  77:	b8 16 00 00 00       	mov    eax,0x16
  7c:	eb 13                	jmp    91 <f+0x91>
  7e:	48 83 7d f8 5b       	cmp    QWORD PTR [rbp-0x8],0x5b
  83:	7f 07                	jg     8c <f+0x8c>
  85:	b8 33 00 00 00       	mov    eax,0x33
  8a:	eb 05                	jmp    91 <f+0x91>
  8c:	b8 2f 00 00 00       	mov    eax,0x2f
  91:	5d                   	pop    rbp
  92:	c3                   	ret    
  ...
  a0:	48 c7 45 c0 ec ff ff 	mov    QWORD PTR [rbp-0x40],0xffffffffffffffec
  a7:	ff 
  a8:	48 c7 45 c8 37 00 00 	mov    QWORD PTR [rbp-0x38],0x37
  af:	00 
  b0:	48 c7 45 d0 7c 00 00 	mov    QWORD PTR [rbp-0x30],0x7c
  b7:	00 
  b8:	48 c7 45 d8 a4 ff ff 	mov    QWORD PTR [rbp-0x28],0xffffffffffffffa4
  bf:	ff 
  c0:	48 c7 45 e0 a2 ff ff 	mov    QWORD PTR [rbp-0x20],0xffffffffffffffa2
  c7:	ff 
  c8:	48 c7 45 e8 cd ff ff 	mov    QWORD PTR [rbp-0x18],0xffffffffffffffcd
  cf:	ff 
  ...
  fc:	83 7d bc 6e          	cmp    DWORD PTR [rbp-0x44],0x6e
 100:	74 05                	je     107 <main+0x74>
 102:	e8 00 00 00 00       	call   107 <main+0x74>
 107:	bf 4f 00 00 00       	mov    edi,0x4f
