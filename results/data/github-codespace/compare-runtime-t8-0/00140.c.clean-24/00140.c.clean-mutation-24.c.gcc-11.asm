  ...
  69:	b8 03 e5 1c 75       	mov    eax,0x751ce503
  ...
  9f:	c7 45 d4 4e 02 b8 0d 	mov    DWORD PTR [rbp-0x2c],0xdb8024e
  ...
  bc:	be c5 86 bd 1b       	mov    esi,0x1bbd86c5
