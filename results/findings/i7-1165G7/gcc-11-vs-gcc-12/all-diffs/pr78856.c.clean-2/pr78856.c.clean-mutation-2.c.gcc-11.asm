  ...
  19:	c7 45 f0 6a 00 00 00 	mov    DWORD PTR [rbp-0x10],0x6a
  20:	c7 45 f8 0c 00 00 00 	mov    DWORD PTR [rbp-0x8],0xc
  27:	e9 8a 00 00 00       	jmp    b6 <main+0xb6>
  2c:	c7 45 fc 1c 00 00 00 	mov    DWORD PTR [rbp-0x4],0x1c
  33:	c7 45 f4 1c 00 00 00 	mov    DWORD PTR [rbp-0xc],0x1c
  ...
  50:	c7 04 02 16 00 00 00 	mov    DWORD PTR [rdx+rax*1],0x16
  57:	83 45 f4 01          	add    DWORD PTR [rbp-0xc],0x1
  5b:	83 7d f4 13          	cmp    DWORD PTR [rbp-0xc],0x13
  ...
  8f:	c7 45 f8 0b 00 00 00 	mov    DWORD PTR [rbp-0x8],0xb
  ...
  ac:	83 7d fc 4a          	cmp    DWORD PTR [rbp-0x4],0x4a
  b0:	7e b1                	jle    63 <main+0x63>
  b2:	83 45 f0 23          	add    DWORD PTR [rbp-0x10],0x23
  b6:	83 7d f0 14          	cmp    DWORD PTR [rbp-0x10],0x14
