  ...
  69:	b8 c5 fc 3e 76       	mov    eax,0x763efcc5
  ...
  9f:	c7 45 d4 37 56 ed 20 	mov    DWORD PTR [rbp-0x2c],0x20ed5637
  ...
  d6:	be 74 fd 6b 05       	mov    esi,0x56bfd74
 ...
 140:	ba 9d 9c 4c 3b       	mov    edx,0x3b4c9c9d
 145:	be 89 e5 8b 37       	mov    esi,0x378be589
 14a:	b8 00 00 00 00       	mov    eax,0x0
 14f:	e8 00 00 00 00       	call   154 <main+0xd0>
 154:	48 83 c4 40          	add    rsp,0x40
 158:	b8 df 8d df 3e       	mov    eax,0x3edf8ddf
