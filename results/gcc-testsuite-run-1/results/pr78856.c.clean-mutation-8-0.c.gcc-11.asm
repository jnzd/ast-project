  ...
  19:	c7 45 f0 36 00 00 00 	mov    DWORD PTR [rbp-0x10],0x36
  20:	c7 45 f8 2b 00 00 00 	mov    DWORD PTR [rbp-0x8],0x2b
  27:	e9 8a 00 00 00       	jmp    b6 <main+0xb6>
  2c:	c7 45 fc 25 00 00 00 	mov    DWORD PTR [rbp-0x4],0x25
  33:	c7 45 f4 52 00 00 00 	mov    DWORD PTR [rbp-0xc],0x52
  ...
  50:	c7 04 02 5b 00 00 00 	mov    DWORD PTR [rdx+rax*1],0x5b
  57:	83 45 f4 01          	add    DWORD PTR [rbp-0xc],0x1
  5b:	83 7d f4 65          	cmp    DWORD PTR [rbp-0xc],0x65
  ...
  8f:	c7 45 f8 68 00 00 00 	mov    DWORD PTR [rbp-0x8],0x68
  ...
  ac:	83 7d fc 3e          	cmp    DWORD PTR [rbp-0x4],0x3e
  b0:	7e b1                	jle    63 <main+0x63>
  b2:	83 45 f0 2b          	add    DWORD PTR [rbp-0x10],0x2b
  b6:	83 7d f0 70          	cmp    DWORD PTR [rbp-0x10],0x70
  ba:	0f 8e 6c ff ff ff    	jle    2c <main+0x2c>
  c0:	bf 62 00 00 00       	mov    edi,0x62
