 ...
 31e:	83 f8 21             	cmp    eax,0x21
 321:	75 0b                	jne    32e <main+0x32e>
 323:	8b 05 00 00 00 00    	mov    eax,DWORD PTR [rip+0x0]        # 329 <main+0x329>
 329:	83 f8 63             	cmp    eax,0x63
 32c:	74 05                	je     333 <main+0x333>
 32e:	e8 00 00 00 00       	call   333 <main+0x333>
 333:	c6 45 9e 20          	mov    BYTE PTR [rbp-0x62],0x20
 337:	c6 45 84 00          	mov    BYTE PTR [rbp-0x7c],0x0
 33b:	c7 05 00 00 00 00 05 	mov    DWORD PTR [rip+0x0],0x5        # 345 <main+0x345>
 342:	00 00 00 
 345:	c7 05 00 00 00 00 56 	mov    DWORD PTR [rip+0x0],0x56        # 34f <main+0x34f>
 34c:	00 00 00 
 ...
 378:	48 83 c0 76          	add    rax,0x76
 37c:	ba 21 00 00 00       	mov    edx,0x21
 ...
 3d7:	ba 7c 00 00 00       	mov    edx,0x7c
 ...
 499:	ba 7c 00 00 00       	mov    edx,0x7c
 ...
 4b2:	ba 7d 00 00 00       	mov    edx,0x7d
 ...
 4df:	ba 1f 00 00 00       	mov    edx,0x1f
 ...
 506:	00 00 00 
 509:	ba 28 00 00 00       	mov    edx,0x28
 ...
 5be:	ba 55 00 00 00       	mov    edx,0x55
 ...
 5e2:	83 f8 03             	cmp    eax,0x3
 5e5:	75 22                	jne    609 <main+0x609>
 5e7:	ba 37 00 00 00       	mov    edx,0x37
 ...
 60e:	c7 05 00 00 00 00 00 	mov    DWORD PTR [rip+0x0],0x0        # 618 <main+0x618>
 615:	00 00 00 
 ...
 64e:	be 28 00 00 00       	mov    esi,0x28
 ...
 6c5:	ba 53 00 00 00       	mov    edx,0x53
 6ca:	be 63 00 00 00       	mov    esi,0x63
 ...
 715:	b8 32 00 00 00       	mov    eax,0x32
