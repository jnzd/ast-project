  ...
  23:	c7 45 fc 59 00 00 00 	mov    DWORD PTR [rbp-0x4],0x59
  ...
  7d:	83 7d fc 3b          	cmp    DWORD PTR [rbp-0x4],0x3b
  ...
  de:	b8 56 00 00 00       	mov    eax,0x56
  e3:	5d                   	pop    rbp
  e4:	c3                   	ret    
