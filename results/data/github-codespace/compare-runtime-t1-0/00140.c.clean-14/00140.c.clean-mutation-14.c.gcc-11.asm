  ...
  69:	b8 02 64 23 03       	mov    eax,0x3236402
  ...
  9f:	c7 45 d4 4b 7b 3e 31 	mov    DWORD PTR [rbp-0x2c],0x313e7b4b
  ...
  bc:	be dd be 85 0e       	mov    esi,0xe85bedd
