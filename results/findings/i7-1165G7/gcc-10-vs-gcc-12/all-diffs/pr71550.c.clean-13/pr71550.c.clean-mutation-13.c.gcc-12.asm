  ...
  43:	c7 45 fc 30 00 00 00 	mov    DWORD PTR [rbp-0x4],0x30
  ...
  80:	83 f8 50             	cmp    eax,0x50
  83:	76 d3                	jbe    58 <main+0x58>
  85:	83 45 fc 01          	add    DWORD PTR [rbp-0x4],0x1
  89:	83 7d fc 16          	cmp    DWORD PTR [rbp-0x4],0x16
  8d:	7e bd                	jle    4c <main+0x4c>
  8f:	c7 45 fc 03 00 00 00 	mov    DWORD PTR [rbp-0x4],0x3
  96:	eb 04                	jmp    9c <main+0x9c>
  98:	83 45 fc 01          	add    DWORD PTR [rbp-0x4],0x1
  9c:	83 7d fc 67          	cmp    DWORD PTR [rbp-0x4],0x67
  ...
  bf:	bf 16 00 00 00       	mov    edi,0x16
