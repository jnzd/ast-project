  ...
  69:	b8 9f 40 fa 07       	mov    eax,0x7fa409f
  ...
  9f:	c7 45 d4 dd e9 84 25 	mov    DWORD PTR [rbp-0x2c],0x2584e9dd
  ...
  d6:	be eb 91 ce 50       	mov    esi,0x50ce91eb
 ...
 140:	ba a0 bd db 7c       	mov    edx,0x7cdbbda0
 145:	be 0c e1 55 05       	mov    esi,0x555e10c
 14a:	b8 00 00 00 00       	mov    eax,0x0
 14f:	e8 00 00 00 00       	call   154 <main+0xd0>
 154:	48 83 c4 40          	add    rsp,0x40
 158:	b8 e5 bc 9d 36       	mov    eax,0x369dbce5
