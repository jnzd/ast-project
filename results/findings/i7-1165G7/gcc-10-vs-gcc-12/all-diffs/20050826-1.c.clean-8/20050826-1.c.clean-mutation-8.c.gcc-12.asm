  ...
  34:	48 c7 45 f8 45 00 00 	mov    QWORD PTR [rbp-0x8],0x45
  3b:	00 
  ...
  49:	48 05 a2 00 00 00    	add    rax,0xa2
  ...
  76:	ba 9b 08 00 00       	mov    edx,0x89b
  7b:	be 60 00 00 00       	mov    esi,0x60
  80:	48 8d 05 00 00 00 00 	lea    rax,[rip+0x0]        # 87 <foo+0x19>
  87:	48 89 c7             	mov    rdi,rax
  8a:	e8 00 00 00 00       	call   8f <foo+0x21>
  8f:	c6 05 00 00 00 00 76 	mov    BYTE PTR [rip+0x0],0x76        # 96 <foo+0x28>
  ...
  de:	b8 6a 00 00 00       	mov    eax,0x6a
  e3:	5d                   	pop    rbp
  e4:	c3                   	ret    
