 ...
 121:	48 8b 45 88          	mov    rax,QWORD PTR [rbp-0x78]
 ...
 2fc:	83 f8 3c             	cmp    eax,0x3c
 2ff:	75 0b                	jne    30c <main+0x30c>
 301:	8b 05 00 00 00 00    	mov    eax,DWORD PTR [rip+0x0]        # 307 <main+0x307>
 307:	83 f8 2b             	cmp    eax,0x2b
 30a:	74 05                	je     311 <main+0x311>
 30c:	e8 00 00 00 00       	call   311 <main+0x311>
 311:	c6 45 f7 20          	mov    BYTE PTR [rbp-0x9],0x20
 315:	c6 45 a7 00          	mov    BYTE PTR [rbp-0x59],0x0
 319:	c7 05 00 00 00 00 44 	mov    DWORD PTR [rip+0x0],0x44        # 323 <main+0x323>
 320:	00 00 00 
 323:	c7 05 00 00 00 00 17 	mov    DWORD PTR [rip+0x0],0x17        # 32d <main+0x32d>
 32a:	00 00 00 
 ...
 350:	48 83 c0 0c          	add    rax,0xc
 354:	ba 30 00 00 00       	mov    edx,0x30
 ...
 3a3:	ba 49 00 00 00       	mov    edx,0x49
 ...
 4b1:	00 00 00 
 4b4:	ba 2d 00 00 00       	mov    edx,0x2d
 ...
 55f:	ba 7b 00 00 00       	mov    edx,0x7b
 ...
 583:	83 f8 5e             	cmp    eax,0x5e
 586:	75 1c                	jne    5a4 <main+0x5a4>
 588:	ba 21 00 00 00       	mov    edx,0x21
 ...
 5a9:	c7 05 00 00 00 00 36 	mov    DWORD PTR [rip+0x0],0x36        # 5b3 <main+0x5b3>
 5b0:	00 00 00 
 ...
 5e9:	be 4d 00 00 00       	mov    esi,0x4d
 ...
 65d:	ba 0c 00 00 00       	mov    edx,0xc
 662:	be 4c 00 00 00       	mov    esi,0x4c
 ...
 679:	75 2a                	jne    6a5 <main+0x6a5>
 67b:	8b 05 00 00 00 00    	mov    eax,DWORD PTR [rip+0x0]        # 681 <main+0x681>
 681:	83 f8 1b             	cmp    eax,0x1b
 684:	75 1f                	jne    6a5 <main+0x6a5>
 686:	48 8d 05 00 00 00 00 	lea    rax,[rip+0x0]        # 68d <main+0x68d>
 68d:	ba 07 00 00 00       	mov    edx,0x7
 692:	48 8d 35 00 00 00 00 	lea    rsi,[rip+0x0]        # 699 <main+0x699>
 699:	48 89 c7             	mov    rdi,rax
 69c:	e8 00 00 00 00       	call   6a1 <main+0x6a1>
 6a1:	85 c0                	test   eax,eax
 6a3:	74 05                	je     6aa <main+0x6aa>
 6a5:	e8 00 00 00 00       	call   6aa <main+0x6aa>
 6aa:	b8 15 00 00 00       	mov    eax,0x15
 6af:	48 8b 5d e8          	mov    rbx,QWORD PTR [rbp-0x18]
 6b3:	64 48 2b 1c 25 28 00 	sub    rbx,QWORD PTR fs:0x28
 6ba:	00 00 
 6bc:	74 05                	je     6c3 <main+0x6c3>
 6be:	e8 00 00 00 00       	call   6c3 <main+0x6c3>
 6c3:	48 8b 5d f8          	mov    rbx,QWORD PTR [rbp-0x8]
 6c7:	c9                   	leave  
 6c8:	c3                   	ret    
