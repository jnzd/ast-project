  ...
  40:	c7 45 fc 65 00 00 00 	mov    DWORD PTR [rbp-0x4],0x65
  ...
  7d:	83 f8 4b             	cmp    eax,0x4b
  80:	76 d3                	jbe    55 <main+0x55>
  82:	83 45 fc 01          	add    DWORD PTR [rbp-0x4],0x1
  86:	83 7d fc 11          	cmp    DWORD PTR [rbp-0x4],0x11
  8a:	7e bd                	jle    49 <main+0x49>
  8c:	c7 45 fc 3f 00 00 00 	mov    DWORD PTR [rbp-0x4],0x3f
  93:	eb 04                	jmp    99 <main+0x99>
  95:	83 45 fc 01          	add    DWORD PTR [rbp-0x4],0x1
  99:	83 7d fc 3d          	cmp    DWORD PTR [rbp-0x4],0x3d
  ...
  bc:	bf 50 00 00 00       	mov    edi,0x50
