  ...
  69:	b8 ae 85 4b 7c       	mov    eax,0x7c4b85ae
  ...
  9f:	c7 45 d4 5c c0 2f 00 	mov    DWORD PTR [rbp-0x2c],0x2fc05c
  ...
  d6:	be 91 bd 88 68       	mov    esi,0x6888bd91
 ...
 140:	ba 01 63 f4 40       	mov    edx,0x40f46301
 145:	be 0e 00 81 64       	mov    esi,0x6481000e
 14a:	b8 00 00 00 00       	mov    eax,0x0
 14f:	e8 00 00 00 00       	call   154 <main+0xd0>
 154:	48 83 c4 40          	add    rsp,0x40
 158:	b8 48 14 02 6b       	mov    eax,0x6b021448
