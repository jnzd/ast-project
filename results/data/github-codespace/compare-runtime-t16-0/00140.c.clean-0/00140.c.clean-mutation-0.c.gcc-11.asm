  ...
  69:	b8 a1 3b 58 03       	mov    eax,0x3583ba1
  ...
  9f:	c7 45 d4 66 6c 45 48 	mov    DWORD PTR [rbp-0x2c],0x48456c66
  ...
  bc:	be 91 cd 36 03       	mov    esi,0x336cd91
