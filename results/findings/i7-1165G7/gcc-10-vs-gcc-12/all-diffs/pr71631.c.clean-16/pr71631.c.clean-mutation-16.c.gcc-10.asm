  ...
  f6:	75 0c                	jne    104 <main+0xd2>
  f8:	48 8d 3d 00 00 00 00 	lea    rdi,[rip+0x0]        # ff <main+0xcd>
  ff:	e8 00 00 00 00       	call   104 <main+0xd2>
 104:	66 83 7d da cd       	cmp    WORD PTR [rbp-0x26],0xffcd
 109:	74 05                	je     110 <main+0xde>
 10b:	e8 00 00 00 00       	call   110 <main+0xde>
 110:	b8 7f 00 00 00       	mov    eax,0x7f
 115:	c9                   	leave  
 116:	c3                   	ret    
