  ...
  13:	c7 45 f4 5b 00 00 00 	mov    DWORD PTR [rbp-0xc],0x5b
  1a:	c7 45 f0 50 00 00 00 	mov    DWORD PTR [rbp-0x10],0x50
  ...
  3c:	83 7d fc 1c          	cmp    DWORD PTR [rbp-0x4],0x1c
  ...
  5b:	c7 45 f4 6a 00 00 00 	mov    DWORD PTR [rbp-0xc],0x6a
