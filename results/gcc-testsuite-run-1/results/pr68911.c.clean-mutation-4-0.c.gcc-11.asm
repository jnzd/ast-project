  ...
  7a:	83 7d f8 37          	cmp    DWORD PTR [rbp-0x8],0x37
  7e:	77 2b                	ja     ab <main+0xab>
  80:	83 7d f4 20          	cmp    DWORD PTR [rbp-0xc],0x20
  ...
  a4:	b8 6f 00 00 00       	mov    eax,0x6f
