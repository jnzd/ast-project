  ...
  29:	b8 5c 00 00 00       	mov    eax,0x5c
  ...
  3b:	83 45 fc 7b          	add    DWORD PTR [rbp-0x4],0x7b
  ...
  5d:	c7 45 f8 67 00 00 00 	mov    DWORD PTR [rbp-0x8],0x67
  ...
  71:	bf 4f 00 00 00       	mov    edi,0x4f
