   ...
   f:	83 7d fc 7f          	cmp    DWORD PTR [rbp-0x4],0x7f
  ...
  29:	c7 45 fc 3b 00 00 00 	mov    DWORD PTR [rbp-0x4],0x3b
  30:	8b 45 fc             	mov    eax,DWORD PTR [rbp-0x4]
  33:	83 c0 71             	add    eax,0x71
  ...
  71:	48 c7 45 f8 14 00 00 	mov    QWORD PTR [rbp-0x8],0x14
  78:	00 
  79:	bf 13 00 00 80       	mov    edi,0x80000013
