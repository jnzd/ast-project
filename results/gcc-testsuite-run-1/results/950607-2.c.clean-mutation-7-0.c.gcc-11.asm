  ...
  70:	48 83 7d f8 48       	cmp    QWORD PTR [rbp-0x8],0x48
  75:	7e 07                	jle    7e <f+0x7e>
  77:	b8 5e 00 00 00       	mov    eax,0x5e
  7c:	eb 13                	jmp    91 <f+0x91>
  7e:	48 83 7d f8 04       	cmp    QWORD PTR [rbp-0x8],0x4
  83:	7f 07                	jg     8c <f+0x8c>
  85:	b8 5a 00 00 00       	mov    eax,0x5a
  8a:	eb 05                	jmp    91 <f+0x91>
  8c:	b8 32 00 00 00       	mov    eax,0x32
  91:	5d                   	pop    rbp
  92:	c3                   	ret    
  ...
  a0:	48 c7 45 c0 f6 ff ff 	mov    QWORD PTR [rbp-0x40],0xfffffffffffffff6
  a7:	ff 
  a8:	48 c7 45 c8 5b 00 00 	mov    QWORD PTR [rbp-0x38],0x5b
  af:	00 
  b0:	48 c7 45 d0 45 00 00 	mov    QWORD PTR [rbp-0x30],0x45
  b7:	00 
  b8:	48 c7 45 d8 c7 ff ff 	mov    QWORD PTR [rbp-0x28],0xffffffffffffffc7
  bf:	ff 
  c0:	48 c7 45 e0 ed ff ff 	mov    QWORD PTR [rbp-0x20],0xffffffffffffffed
  c7:	ff 
  c8:	48 c7 45 e8 ed ff ff 	mov    QWORD PTR [rbp-0x18],0xffffffffffffffed
  cf:	ff 
  ...
  fc:	83 7d bc 1c          	cmp    DWORD PTR [rbp-0x44],0x1c
 100:	74 05                	je     107 <main+0x74>
 102:	e8 00 00 00 00       	call   107 <main+0x74>
 107:	bf 4b 00 00 00       	mov    edi,0x4b
