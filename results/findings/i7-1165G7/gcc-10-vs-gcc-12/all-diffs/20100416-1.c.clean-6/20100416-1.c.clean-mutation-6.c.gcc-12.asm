  ...
  12:	c7 45 fc 16 00 00 00 	mov    DWORD PTR [rbp-0x4],0x16
  19:	c7 45 f8 11 00 00 00 	mov    DWORD PTR [rbp-0x8],0x11
  ...
  5d:	c7 45 fc 1b 00 00 00 	mov    DWORD PTR [rbp-0x4],0x1b
  ...
  80:	be 58 00 00 00       	mov    esi,0x58
  85:	bf c3 ff ff ff       	mov    edi,0xffffffc3
  ...
  bc:	b8 56 00 00 00       	mov    eax,0x56
  c1:	c9                   	leave  
  c2:	c3                   	ret    
