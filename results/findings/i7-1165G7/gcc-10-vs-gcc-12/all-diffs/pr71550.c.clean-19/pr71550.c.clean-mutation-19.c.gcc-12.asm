  ...
  43:	c7 45 fc 36 00 00 00 	mov    DWORD PTR [rbp-0x4],0x36
  ...
  80:	83 f8 3f             	cmp    eax,0x3f
  83:	76 d3                	jbe    58 <main+0x58>
  85:	83 45 fc 01          	add    DWORD PTR [rbp-0x4],0x1
  89:	83 7d fc 36          	cmp    DWORD PTR [rbp-0x4],0x36
  8d:	7e bd                	jle    4c <main+0x4c>
  8f:	c7 45 fc 73 00 00 00 	mov    DWORD PTR [rbp-0x4],0x73
  96:	eb 04                	jmp    9c <main+0x9c>
  98:	83 45 fc 01          	add    DWORD PTR [rbp-0x4],0x1
  9c:	83 7d fc 7e          	cmp    DWORD PTR [rbp-0x4],0x7e
  ...
  bf:	bf 69 00 00 00       	mov    edi,0x69
