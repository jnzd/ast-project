 ...
 122:	48 8b 45 d0          	mov    rax,QWORD PTR [rbp-0x30]
 ...
 15b:	48 8b 45 d0          	mov    rax,QWORD PTR [rbp-0x30]
 ...
 2d7:	48 98                	cdqe   
 2d9:	83 e0 17             	and    eax,0x17
 2dc:	48 89 c1             	mov    rcx,rax
 2df:	48 8b 45 d0          	mov    rax,QWORD PTR [rbp-0x30]
 ...
 300:	83 f8 67             	cmp    eax,0x67
 303:	75 0b                	jne    310 <main+0x310>
 305:	8b 05 00 00 00 00    	mov    eax,DWORD PTR [rip+0x0]        # 30b <main+0x30b>
 30b:	83 f8 33             	cmp    eax,0x33
 30e:	74 05                	je     315 <main+0x315>
 310:	e8 00 00 00 00       	call   315 <main+0x315>
 315:	c6 45 0d 20          	mov    BYTE PTR [rbp+0xd],0x20
 319:	c6 45 57 00          	mov    BYTE PTR [rbp+0x57],0x0
 31d:	c7 05 00 00 00 00 7d 	mov    DWORD PTR [rip+0x0],0x7d        # 327 <main+0x327>
 324:	00 00 00 
 327:	c7 05 00 00 00 00 48 	mov    DWORD PTR [rip+0x0],0x48        # 331 <main+0x331>
 32e:	00 00 00 
 ...
 340:	48 98                	cdqe   
 342:	83 e0 7f             	and    eax,0x7f
 345:	48 89 c2             	mov    rdx,rax
 348:	48 8b 45 d0          	mov    rax,QWORD PTR [rbp-0x30]
 34c:	48 8d 0c 02          	lea    rcx,[rdx+rax*1]
 350:	48 8d 45 db          	lea    rax,[rbp-0x25]
 354:	48 83 c0 2d          	add    rax,0x2d
 ...
 36b:	48 8d 45 db          	lea    rax,[rbp-0x25]
 36f:	48 83 c0 70          	add    rax,0x70
 373:	48 39 c2             	cmp    rdx,rax
 376:	75 29                	jne    3a1 <main+0x3a1>
 378:	8b 05 00 00 00 00    	mov    eax,DWORD PTR [rip+0x0]        # 37e <main+0x37e>
 37e:	83 f8 64             	cmp    eax,0x64
 381:	75 1e                	jne    3a1 <main+0x3a1>
 383:	48 8d 45 db          	lea    rax,[rbp-0x25]
 387:	48 83 c0 71          	add    rax,0x71
 ...
 3a6:	48 8d 45 db          	lea    rax,[rbp-0x25]
 3aa:	ba 0d 00 00 00       	mov    edx,0xd
 ...
 45c:	48 8d 45 db          	lea    rax,[rbp-0x25]
 460:	ba 0d 00 00 00       	mov    edx,0xd
 465:	be 20 00 00 00       	mov    esi,0x20
 46a:	48 89 c7             	mov    rdi,rax
 46d:	e8 00 00 00 00       	call   472 <main+0x472>
 472:	48 8d 45 db          	lea    rax,[rbp-0x25]
 ...
 490:	48 8d 45 db          	lea    rax,[rbp-0x25]
 494:	48 39 c2             	cmp    rdx,rax
 497:	75 1f                	jne    4b8 <main+0x4b8>
 499:	48 8d 45 db          	lea    rax,[rbp-0x25]
 49d:	ba 45 00 00 00       	mov    edx,0x45
 ...
 4c4:	00 00 00 
 4c7:	ba 64 00 00 00       	mov    edx,0x64
 ...
 57c:	ba 70 00 00 00       	mov    edx,0x70
 ...
 5a0:	83 f8 51             	cmp    eax,0x51
 5a3:	75 22                	jne    5c7 <main+0x5c7>
 5a5:	ba 68 00 00 00       	mov    edx,0x68
 ...
 5cc:	c7 05 00 00 00 00 5b 	mov    DWORD PTR [rip+0x0],0x5b        # 5d6 <main+0x5d6>
 5d3:	00 00 00 
 ...
 60c:	be 14 00 00 00       	mov    esi,0x14
 ...
 683:	ba 1e 00 00 00       	mov    edx,0x1e
 688:	be 56 00 00 00       	mov    esi,0x56
 ...
 6d3:	b8 2d 00 00 00       	mov    eax,0x2d
