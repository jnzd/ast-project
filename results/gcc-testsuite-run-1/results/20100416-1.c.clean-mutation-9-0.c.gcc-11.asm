  ...
  12:	c7 45 fc 46 00 00 00 	mov    DWORD PTR [rbp-0x4],0x46
  19:	c7 45 f8 2c 00 00 00 	mov    DWORD PTR [rbp-0x8],0x2c
  ...
  5d:	c7 45 fc 0d 00 00 00 	mov    DWORD PTR [rbp-0x4],0xd
  ...
  80:	be 1a 00 00 00       	mov    esi,0x1a
  85:	bf ce ff ff ff       	mov    edi,0xffffffce
