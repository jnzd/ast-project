  ...
  65:	b8 9f 32 65 69       	mov    eax,0x6965329f
  ...
  88:	c7 45 e4 88 e6 e3 01 	mov    DWORD PTR [rbp-0x1c],0x1e3e688
  ...
  bf:	be 00 50 59 50       	mov    esi,0x50595000
 ...
 129:	ba 89 b2 fe 45       	mov    edx,0x45feb289
 12e:	be 7a b4 c4 70       	mov    esi,0x70c4b47a
 133:	b8 00 00 00 00       	mov    eax,0x0
 138:	e8 00 00 00 00       	call   13d <main+0xbd>
 13d:	48 83 c4 40          	add    rsp,0x40
 141:	b8 e8 2d e8 1a       	mov    eax,0x1ae82de8
 146:	c9                   	leave
 147:	c3                   	ret
