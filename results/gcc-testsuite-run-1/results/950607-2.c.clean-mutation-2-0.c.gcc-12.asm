  ...
  7a:	b8 73 00 00 00       	mov    eax,0x73
  7f:	eb 13                	jmp    94 <f+0x94>
  81:	48 83 7d f8 78       	cmp    QWORD PTR [rbp-0x8],0x78
  86:	7f 07                	jg     8f <f+0x8f>
  88:	b8 3a 00 00 00       	mov    eax,0x3a
  8d:	eb 05                	jmp    94 <f+0x94>
  8f:	b8 04 00 00 00       	mov    eax,0x4
  94:	5d                   	pop    rbp
  95:	c3                   	ret    
  ...
  a3:	48 c7 45 c0 b5 ff ff 	mov    QWORD PTR [rbp-0x40],0xffffffffffffffb5
  aa:	ff 
  ab:	48 c7 45 c8 7a 00 00 	mov    QWORD PTR [rbp-0x38],0x7a
  b2:	00 
  b3:	48 c7 45 d0 2d 00 00 	mov    QWORD PTR [rbp-0x30],0x2d
  ba:	00 
  bb:	48 c7 45 d8 9c ff ff 	mov    QWORD PTR [rbp-0x28],0xffffffffffffff9c
  c2:	ff 
  c3:	48 c7 45 e0 e8 ff ff 	mov    QWORD PTR [rbp-0x20],0xffffffffffffffe8
  ca:	ff 
  ...
  ff:	83 7d bc 35          	cmp    DWORD PTR [rbp-0x44],0x35
 103:	74 05                	je     10a <main+0x74>
 105:	e8 00 00 00 00       	call   10a <main+0x74>
 10a:	bf 72 00 00 00       	mov    edi,0x72
