  ...
  65:	b8 de fb 90 1b       	mov    eax,0x1b90fbde
  ...
  88:	c7 45 e4 05 98 b1 51 	mov    DWORD PTR [rbp-0x1c],0x51b19805
  ...
  bf:	be 7c da 97 29       	mov    esi,0x2997da7c
 ...
 129:	ba 40 8f c2 61       	mov    edx,0x61c28f40
 12e:	be 74 c4 bd 13       	mov    esi,0x13bdc474
 133:	b8 00 00 00 00       	mov    eax,0x0
 138:	e8 00 00 00 00       	call   13d <main+0xbd>
 13d:	48 83 c4 40          	add    rsp,0x40
 141:	b8 01 86 7e 06       	mov    eax,0x67e8601
 146:	c9                   	leave
 147:	c3                   	ret
