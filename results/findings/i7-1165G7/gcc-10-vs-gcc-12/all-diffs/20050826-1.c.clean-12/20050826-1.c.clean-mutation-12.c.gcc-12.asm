  ...
  34:	48 c7 45 f8 65 00 00 	mov    QWORD PTR [rbp-0x8],0x65
  3b:	00 
  ...
  7b:	be 48 00 00 00       	mov    esi,0x48
  ...
  de:	b8 5d 00 00 00       	mov    eax,0x5d
  e3:	5d                   	pop    rbp
  e4:	c3                   	ret    
