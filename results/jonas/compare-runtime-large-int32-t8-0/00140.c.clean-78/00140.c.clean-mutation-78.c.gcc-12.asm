  ...
  69:	b8 df 40 6c 75       	mov    eax,0x756c40df
  ...
  9f:	c7 45 d4 c9 cc 32 48 	mov    DWORD PTR [rbp-0x2c],0x4832ccc9
  ...
  d6:	be 90 cb 1b 1d       	mov    esi,0x1d1bcb90
 ...
 140:	ba eb 1e 7c 76       	mov    edx,0x767c1eeb
 145:	be f0 f9 6d 22       	mov    esi,0x226df9f0
 14a:	b8 00 00 00 00       	mov    eax,0x0
 14f:	e8 00 00 00 00       	call   154 <main+0xd0>
 154:	48 83 c4 40          	add    rsp,0x40
 158:	b8 13 2b 0f 70       	mov    eax,0x700f2b13
