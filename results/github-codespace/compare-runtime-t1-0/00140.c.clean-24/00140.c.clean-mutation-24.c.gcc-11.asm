  ...
  69:	b8 4b ff ca 3b       	mov    eax,0x3bcaff4b
  ...
  9f:	c7 45 d4 b0 3b 0c 07 	mov    DWORD PTR [rbp-0x2c],0x70c3bb0
  ...
  bc:	be d7 6f 18 29       	mov    esi,0x29186fd7
