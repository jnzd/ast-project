  ...
  43:	c7 45 fc 56 00 00 00 	mov    DWORD PTR [rbp-0x4],0x56
  ...
  80:	83 f8 06             	cmp    eax,0x6
  83:	76 d3                	jbe    58 <main+0x58>
  85:	83 45 fc 01          	add    DWORD PTR [rbp-0x4],0x1
  89:	83 7d fc 1a          	cmp    DWORD PTR [rbp-0x4],0x1a
  8d:	7e bd                	jle    4c <main+0x4c>
  8f:	c7 45 fc 55 00 00 00 	mov    DWORD PTR [rbp-0x4],0x55
  96:	eb 04                	jmp    9c <main+0x9c>
  98:	83 45 fc 01          	add    DWORD PTR [rbp-0x4],0x1
  9c:	83 7d fc 13          	cmp    DWORD PTR [rbp-0x4],0x13
  ...
  bf:	bf 22 00 00 00       	mov    edi,0x22
