  ...
  23:	c7 45 fc 57 00 00 00 	mov    DWORD PTR [rbp-0x4],0x57
  ...
  db:	b8 6c 00 00 00       	mov    eax,0x6c
  e0:	5d                   	pop    rbp
  e1:	c3                   	ret    
