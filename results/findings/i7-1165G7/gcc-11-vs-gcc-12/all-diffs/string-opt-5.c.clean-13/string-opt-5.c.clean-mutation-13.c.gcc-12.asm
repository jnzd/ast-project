 ...
 300:	83 f8 10             	cmp    eax,0x10
 303:	75 0b                	jne    310 <main+0x310>
 305:	8b 05 00 00 00 00    	mov    eax,DWORD PTR [rip+0x0]        # 30b <main+0x30b>
 30b:	83 f8 51             	cmp    eax,0x51
 30e:	74 05                	je     315 <main+0x315>
 310:	e8 00 00 00 00       	call   315 <main+0x315>
 315:	c6 45 b8 20          	mov    BYTE PTR [rbp-0x48],0x20
 319:	c6 45 c1 00          	mov    BYTE PTR [rbp-0x3f],0x0
 31d:	c7 05 00 00 00 00 3d 	mov    DWORD PTR [rip+0x0],0x3d        # 327 <main+0x327>
 324:	00 00 00 
 327:	c7 05 00 00 00 00 44 	mov    DWORD PTR [rip+0x0],0x44        # 331 <main+0x331>
 32e:	00 00 00 
 ...
 354:	48 83 c0 36          	add    rax,0x36
 358:	ba 04 00 00 00       	mov    edx,0x4
 ...
 3aa:	ba 2c 00 00 00       	mov    edx,0x2c
 ...
 460:	ba 2c 00 00 00       	mov    edx,0x2c
 ...
 476:	ba 6b 00 00 00       	mov    edx,0x6b
 ...
 49d:	ba 30 00 00 00       	mov    edx,0x30
 ...
 4c4:	00 00 00 
 4c7:	ba 29 00 00 00       	mov    edx,0x29
 ...
 57e:	ba 35 00 00 00       	mov    edx,0x35
 ...
 5a2:	83 f8 0a             	cmp    eax,0xa
 5a5:	75 22                	jne    5c9 <main+0x5c9>
 5a7:	ba 41 00 00 00       	mov    edx,0x41
 ...
 5ce:	c7 05 00 00 00 00 4f 	mov    DWORD PTR [rip+0x0],0x4f        # 5d8 <main+0x5d8>
 5d5:	00 00 00 
 ...
 60e:	be 3a 00 00 00       	mov    esi,0x3a
 ...
 685:	ba 06 00 00 00       	mov    edx,0x6
 68a:	be 12 00 00 00       	mov    esi,0x12
 ...
 6d5:	b8 3d 00 00 00       	mov    eax,0x3d
