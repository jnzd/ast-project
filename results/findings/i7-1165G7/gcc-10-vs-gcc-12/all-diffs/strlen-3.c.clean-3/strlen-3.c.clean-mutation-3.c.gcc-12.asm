   ...
   c:	c7 45 ec 45 00 00 00 	mov    DWORD PTR [rbp-0x14],0x45
  13:	8b 45 ec             	mov    eax,DWORD PTR [rbp-0x14]
  16:	83 c0 17             	add    eax,0x17
  ...
  5c:	be 6d 00 00 00       	mov    esi,0x6d
