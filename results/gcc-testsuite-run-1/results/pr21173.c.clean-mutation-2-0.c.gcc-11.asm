  ...
  5b:	83 7d fc 09          	cmp    DWORD PTR [rbp-0x4],0x9
  ...
  80:	c7 45 fc 13 00 00 00 	mov    DWORD PTR [rbp-0x4],0x13
  ...
  af:	83 7d fc 30          	cmp    DWORD PTR [rbp-0x4],0x30
  b3:	7e d4                	jle    89 <main+0x24>
  b5:	b8 04 00 00 00       	mov    eax,0x4
  ba:	c9                   	leave  
  bb:	c3                   	ret    
