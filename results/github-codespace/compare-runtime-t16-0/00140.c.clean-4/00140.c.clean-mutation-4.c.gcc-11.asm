  ...
  69:	b8 0e 90 93 5e       	mov    eax,0x5e93900e
  ...
  9f:	c7 45 d4 10 1d 38 03 	mov    DWORD PTR [rbp-0x2c],0x3381d10
  ...
  bc:	be 24 1f 71 46       	mov    esi,0x46711f24
