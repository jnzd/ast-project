   ...
   f:	83 7d fc 75          	cmp    DWORD PTR [rbp-0x4],0x75
  ...
  29:	c7 45 fc 73 00 00 00 	mov    DWORD PTR [rbp-0x4],0x73
  30:	8b 45 fc             	mov    eax,DWORD PTR [rbp-0x4]
  33:	83 c0 5e             	add    eax,0x5e
  ...
  71:	48 c7 45 f8 34 00 00 	mov    QWORD PTR [rbp-0x8],0x34
  78:	00 
  79:	b8 33 00 00 80       	mov    eax,0x80000033
