  ...
  65:	b8 fe 84 fe 27       	mov    eax,0x27fe84fe
  ...
  88:	c7 45 e4 ee 72 b7 08 	mov    DWORD PTR [rbp-0x1c],0x8b772ee
  ...
  bf:	be 0a 3d a1 27       	mov    esi,0x27a13d0a
 ...
 129:	ba 33 ac 23 62       	mov    edx,0x6223ac33
 12e:	be 70 51 55 4a       	mov    esi,0x4a555170
 133:	b8 00 00 00 00       	mov    eax,0x0
 138:	e8 00 00 00 00       	call   13d <main+0xbd>
 13d:	48 83 c4 40          	add    rsp,0x40
 141:	b8 cc 84 39 09       	mov    eax,0x93984cc
 146:	c9                   	leave
 147:	c3                   	ret
