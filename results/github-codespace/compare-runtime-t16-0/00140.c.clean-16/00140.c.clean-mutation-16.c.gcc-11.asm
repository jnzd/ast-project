  ...
  69:	b8 03 7a 06 4d       	mov    eax,0x4d067a03
  ...
  9f:	c7 45 d4 f5 3e 70 2b 	mov    DWORD PTR [rbp-0x2c],0x2b703ef5
  ...
  bc:	be b1 52 30 0c       	mov    esi,0xc3052b1
