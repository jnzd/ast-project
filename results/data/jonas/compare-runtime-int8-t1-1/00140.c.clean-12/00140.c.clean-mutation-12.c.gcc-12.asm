  ...
  69:	b8 4b 00 00 00       	mov    eax,0x4b
  ...
  9f:	c7 45 d4 2f 00 00 00 	mov    DWORD PTR [rbp-0x2c],0x2f
  ...
  d6:	be 50 00 00 00       	mov    esi,0x50
 ...
 140:	ba 37 00 00 00       	mov    edx,0x37
 145:	be 72 00 00 00       	mov    esi,0x72
