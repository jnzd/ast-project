   ...
   c:	c7 45 f4 67 00 00 00 	mov    DWORD PTR [rbp-0xc],0x67
  13:	c7 45 f8 62 00 00 00 	mov    DWORD PTR [rbp-0x8],0x62
  ...
  7c:	83 7d f8 3e          	cmp    DWORD PTR [rbp-0x8],0x3e
  80:	77 2b                	ja     ad <main+0xad>
  82:	83 7d f4 2b          	cmp    DWORD PTR [rbp-0xc],0x2b
