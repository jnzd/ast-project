   ...
   f:	83 7d fc 52          	cmp    DWORD PTR [rbp-0x4],0x52
  ...
  29:	c7 45 fc 42 00 00 00 	mov    DWORD PTR [rbp-0x4],0x42
  30:	8b 45 fc             	mov    eax,DWORD PTR [rbp-0x4]
  33:	83 c0 2b             	add    eax,0x2b
  ...
  71:	48 c7 45 f8 0e 00 00 	mov    QWORD PTR [rbp-0x8],0xe
  78:	00 
  79:	bf 0d 00 00 80       	mov    edi,0x8000000d
