  ...
  6a:	00 
  6b:	c6 45 f0 00          	mov    BYTE PTR [rbp-0x10],0x0
  6f:	90                   	nop
  70:	48 8b 45 f8          	mov    rax,QWORD PTR [rbp-0x8]
  74:	64 48 2b 04 25 28 00 	sub    rax,QWORD PTR fs:0x28
  7b:	00 00 
  7d:	74 05                	je     84 <foo+0x84>
  7f:	e8 00 00 00 00       	call   84 <foo+0x84>
  84:	c9                   	leave  
  85:	c3                   	ret    
  ...
  92:	e8 69 ff ff ff       	call   0 <foo>
  97:	c7 45 fc 30 00 00 00 	mov    DWORD PTR [rbp-0x4],0x30
  9e:	bf 2e 00 00 00       	mov    edi,0x2e
  a3:	e8 00 00 00 00       	call   a8 <main+0x22>
