  ...
  1b:	c7 45 f0 53 00 00 00 	mov    DWORD PTR [rbp-0x10],0x53
  22:	c7 45 f8 40 00 00 00 	mov    DWORD PTR [rbp-0x8],0x40
  29:	e9 8a 00 00 00       	jmp    b8 <main+0xb8>
  2e:	c7 45 fc 64 00 00 00 	mov    DWORD PTR [rbp-0x4],0x64
  35:	c7 45 f4 1f 00 00 00 	mov    DWORD PTR [rbp-0xc],0x1f
  ...
  52:	c7 04 02 1e 00 00 00 	mov    DWORD PTR [rdx+rax*1],0x1e
  59:	83 45 f4 01          	add    DWORD PTR [rbp-0xc],0x1
  5d:	83 7d f4 27          	cmp    DWORD PTR [rbp-0xc],0x27
  ...
  91:	c7 45 f8 12 00 00 00 	mov    DWORD PTR [rbp-0x8],0x12
  ...
  ae:	83 7d fc 0a          	cmp    DWORD PTR [rbp-0x4],0xa
  b2:	7e b1                	jle    65 <main+0x65>
  b4:	83 45 f0 10          	add    DWORD PTR [rbp-0x10],0x10
  b8:	83 7d f0 00          	cmp    DWORD PTR [rbp-0x10],0x0
  bc:	0f 88 6c ff ff ff    	js     2e <main+0x2e>
  c2:	bf 78 00 00 00       	mov    edi,0x78
