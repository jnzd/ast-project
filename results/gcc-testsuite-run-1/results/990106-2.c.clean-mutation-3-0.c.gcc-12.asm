  ...
  27:	ba 59 00 00 00       	mov    edx,0x59
  ...
  39:	83 45 fc 2f          	add    DWORD PTR [rbp-0x4],0x2f
  ...
  5b:	c7 45 f8 71 00 00 00 	mov    DWORD PTR [rbp-0x8],0x71
  ...
  6f:	bf 45 00 00 00       	mov    edi,0x45
