 ...
 30a:	83 f8 16             	cmp    eax,0x16
 30d:	74 05                	je     314 <main+0x314>
 30f:	e8 00 00 00 00       	call   314 <main+0x314>
 314:	c6 45 d1 20          	mov    BYTE PTR [rbp-0x2f],0x20
 318:	c6 45 d2 00          	mov    BYTE PTR [rbp-0x2e],0x0
 31c:	c7 05 00 00 00 00 73 	mov    DWORD PTR [rip+0x0],0x73        # 326 <main+0x326>
 323:	00 00 00 
 ...
 353:	48 83 c0 16          	add    rax,0x16
 357:	ba 15 00 00 00       	mov    edx,0x15
 ...
 3a9:	ba 11 00 00 00       	mov    edx,0x11
 ...
 401:	ba 0d 00 00 00       	mov    edx,0xd
 ...
 45f:	ba 11 00 00 00       	mov    edx,0x11
 ...
 475:	ba 0a 00 00 00       	mov    edx,0xa
 ...
 48c:	48 8d 55 d0          	lea    rdx,[rbp-0x30]
 490:	48 39 d0             	cmp    rax,rdx
 493:	75 1f                	jne    4b4 <main+0x4b4>
 495:	48 8d 45 d0          	lea    rax,[rbp-0x30]
 499:	ba 22 00 00 00       	mov    edx,0x22
 ...
 4c0:	00 00 00 
 4c3:	ba 25 00 00 00       	mov    edx,0x25
 ...
 578:	ba 6a 00 00 00       	mov    edx,0x6a
 ...
 59c:	83 f8 11             	cmp    eax,0x11
 59f:	75 22                	jne    5c3 <main+0x5c3>
 5a1:	ba 11 00 00 00       	mov    edx,0x11
 ...
 5c8:	c7 05 00 00 00 00 7e 	mov    DWORD PTR [rip+0x0],0x7e        # 5d2 <main+0x5d2>
 5cf:	00 00 00 
 ...
 608:	be 56 00 00 00       	mov    esi,0x56
 ...
 67f:	ba 2b 00 00 00       	mov    edx,0x2b
 684:	be 1b 00 00 00       	mov    esi,0x1b
 ...
 6cf:	b8 73 00 00 00       	mov    eax,0x73
