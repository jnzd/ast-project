  ...
  1b:	c7 45 f0 13 00 00 00 	mov    DWORD PTR [rbp-0x10],0x13
  22:	c7 45 f8 3e 00 00 00 	mov    DWORD PTR [rbp-0x8],0x3e
  29:	e9 8a 00 00 00       	jmp    b8 <main+0xb8>
  2e:	c7 45 fc 20 00 00 00 	mov    DWORD PTR [rbp-0x4],0x20
  35:	c7 45 f4 6f 00 00 00 	mov    DWORD PTR [rbp-0xc],0x6f
  ...
  91:	c7 45 f8 34 00 00 00 	mov    DWORD PTR [rbp-0x8],0x34
  ...
  ae:	83 7d fc 57          	cmp    DWORD PTR [rbp-0x4],0x57
  b2:	7e b1                	jle    65 <main+0x65>
  b4:	83 45 f0 16          	add    DWORD PTR [rbp-0x10],0x16
  b8:	83 7d f0 02          	cmp    DWORD PTR [rbp-0x10],0x2
  bc:	0f 8e 6c ff ff ff    	jle    2e <main+0x2e>
  c2:	bf 66 00 00 00       	mov    edi,0x66
