  ...
  21:	48 8d 45 90          	lea    rax,[rbp-0x70]
  ...
  67:	83 f8 43             	cmp    eax,0x43
  6a:	74 05                	je     71 <main+0x71>
  6c:	e8 00 00 00 00       	call   71 <main+0x71>
  71:	c7 05 00 00 00 00 2e 	mov    DWORD PTR [rip+0x0],0x2e        # 7b <main+0x7b>
  78:	00 00 00 
  7b:	8b 15 00 00 00 00    	mov    edx,DWORD PTR [rip+0x0]        # 81 <main+0x81>
  81:	48 8d 45 90          	lea    rax,[rbp-0x70]
 ...
 10c:	48 8d 45 90          	lea    rax,[rbp-0x70]
