  ...
  69:	b8 c9 59 80 67       	mov    eax,0x678059c9
  ...
  9f:	c7 45 d4 12 dd 4a 20 	mov    DWORD PTR [rbp-0x2c],0x204add12
  ...
  d6:	be e1 22 13 29       	mov    esi,0x291322e1
 ...
 140:	ba 0f 8e f2 78       	mov    edx,0x78f28e0f
 145:	be b7 6f c9 28       	mov    esi,0x28c96fb7
 14a:	b8 00 00 00 00       	mov    eax,0x0
 14f:	e8 00 00 00 00       	call   154 <main+0xd0>
 154:	48 83 c4 40          	add    rsp,0x40
 158:	b8 76 9d 48 02       	mov    eax,0x2489d76
