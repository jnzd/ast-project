  ...
  1b:	c7 45 f0 4d 00 00 00 	mov    DWORD PTR [rbp-0x10],0x4d
  22:	c7 45 f8 53 00 00 00 	mov    DWORD PTR [rbp-0x8],0x53
  29:	e9 8a 00 00 00       	jmp    b8 <main+0xb8>
  2e:	c7 45 fc 6a 00 00 00 	mov    DWORD PTR [rbp-0x4],0x6a
  35:	c7 45 f4 7d 00 00 00 	mov    DWORD PTR [rbp-0xc],0x7d
  ...
  52:	c7 04 02 13 00 00 00 	mov    DWORD PTR [rdx+rax*1],0x13
  59:	83 45 f4 01          	add    DWORD PTR [rbp-0xc],0x1
  5d:	83 7d f4 43          	cmp    DWORD PTR [rbp-0xc],0x43
  ...
  91:	c7 45 f8 53 00 00 00 	mov    DWORD PTR [rbp-0x8],0x53
  ...
  ae:	83 7d fc 00          	cmp    DWORD PTR [rbp-0x4],0x0
  b2:	78 b1                	js     65 <main+0x65>
  b4:	83 45 f0 5b          	add    DWORD PTR [rbp-0x10],0x5b
  b8:	83 7d f0 59          	cmp    DWORD PTR [rbp-0x10],0x59
  bc:	0f 8e 6c ff ff ff    	jle    2e <main+0x2e>
  c2:	bf 03 00 00 00       	mov    edi,0x3
