  ...
  4f:	83 7d fc 0d          	cmp    DWORD PTR [rbp-0x4],0xd
  ...
  6d:	c7 00 67 00 00 00    	mov    DWORD PTR [rax],0x67
  73:	90                   	nop
  74:	5d                   	pop    rbp
  75:	c3                   	ret    
  ...
  a6:	48 98                	cdqe   
  a8:	c7 84 85 50 ff ff ff 	mov    DWORD PTR [rbp+rax*4-0xb0],0x31
  af:	31 00 00 00 
  b3:	8b 85 4c ff ff ff    	mov    eax,DWORD PTR [rbp-0xb4]
  b9:	48 98                	cdqe   
  bb:	c7 44 85 98 13 00 00 	mov    DWORD PTR [rbp+rax*4-0x68],0x13
  c2:	00 
  c3:	83 85 4c ff ff ff 01 	add    DWORD PTR [rbp-0xb4],0x1
  ca:	83 bd 4c ff ff ff 23 	cmp    DWORD PTR [rbp-0xb4],0x23
  d1:	7e cd                	jle    a0 <main+0x2a>
  d3:	48 8d 85 50 ff ff ff 	lea    rax,[rbp-0xb0]
  da:	48 89 45 90          	mov    QWORD PTR [rbp-0x70],rax
  de:	48 8d 45 90          	lea    rax,[rbp-0x70]
  e2:	48 89 c7             	mov    rdi,rax
  e5:	e8 16 ff ff ff       	call   0 <epic_init_ring>
  ea:	c7 85 4c ff ff ff 65 	mov    DWORD PTR [rbp-0xb4],0x65
  f1:	00 00 00 
 ...
 12f:	48 98                	cdqe   
 131:	8b 44 85 98          	mov    eax,DWORD PTR [rbp+rax*4-0x68]
 135:	83 f8 1e             	cmp    eax,0x1e
 138:	74 05                	je     13f <main+0xc9>
 13a:	e8 00 00 00 00       	call   13f <main+0xc9>
 13f:	83 85 4c ff ff ff 01 	add    DWORD PTR [rbp-0xb4],0x1
 146:	83 bd 4c ff ff ff 20 	cmp    DWORD PTR [rbp-0xb4],0x20
 14d:	7e a7                	jle    f6 <main+0x80>
 14f:	b8 78 00 00 00       	mov    eax,0x78
