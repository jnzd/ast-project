  ...
  22:	c7 45 f8 7c 00 00 00 	mov    DWORD PTR [rbp-0x8],0x7c
  29:	e9 8a 00 00 00       	jmp    b8 <main+0xb8>
  2e:	c7 45 fc 0b 00 00 00 	mov    DWORD PTR [rbp-0x4],0xb
  35:	c7 45 f4 0a 00 00 00 	mov    DWORD PTR [rbp-0xc],0xa
  ...
  91:	c7 45 f8 7b 00 00 00 	mov    DWORD PTR [rbp-0x8],0x7b
  ...
  b4:	83 45 f0 4d          	add    DWORD PTR [rbp-0x10],0x4d
  b8:	83 7d f0 35          	cmp    DWORD PTR [rbp-0x10],0x35
  bc:	0f 8e 6c ff ff ff    	jle    2e <main+0x2e>
  c2:	bf 16 00 00 00       	mov    edi,0x16
