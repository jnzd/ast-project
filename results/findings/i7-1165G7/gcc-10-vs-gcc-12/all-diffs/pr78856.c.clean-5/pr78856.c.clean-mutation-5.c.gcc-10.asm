  ...
  20:	c7 45 f8 10 00 00 00 	mov    DWORD PTR [rbp-0x8],0x10
  ...
  5b:	83 7d f4 68          	cmp    DWORD PTR [rbp-0xc],0x68
  ...
  8f:	c7 45 f8 05 00 00 00 	mov    DWORD PTR [rbp-0x8],0x5
  ...
  b6:	83 7d f0 76          	cmp    DWORD PTR [rbp-0x10],0x76
