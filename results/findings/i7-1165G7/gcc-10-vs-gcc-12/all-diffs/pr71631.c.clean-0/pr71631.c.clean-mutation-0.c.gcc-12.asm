  ...
  3e:	c7 45 dc 6a 00 00 00 	mov    DWORD PTR [rbp-0x24],0x6a
  ...
  6f:	83 c0 2d             	add    eax,0x2d
  72:	89 45 ec             	mov    DWORD PTR [rbp-0x14],eax
  75:	b8 48 00 00 00       	mov    eax,0x48
  7a:	99                   	cdq    
  ...
  f1:	83 7d f0 04          	cmp    DWORD PTR [rbp-0x10],0x4
 ...
 106:	66 83 7d da bb       	cmp    WORD PTR [rbp-0x26],0xffbb
 10b:	74 05                	je     112 <main+0xe0>
 10d:	e8 00 00 00 00       	call   112 <main+0xe0>
 112:	b8 1e 00 00 00       	mov    eax,0x1e
 117:	c9                   	leave  
 118:	c3                   	ret    
