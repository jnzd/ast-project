  ...
  5e:	83 7d fc 50          	cmp    DWORD PTR [rbp-0x4],0x50
  ...
  83:	c7 45 fc 10 00 00 00 	mov    DWORD PTR [rbp-0x4],0x10
  ...
  b2:	83 7d fc 0d          	cmp    DWORD PTR [rbp-0x4],0xd
  b6:	7e d4                	jle    8c <main+0x24>
  b8:	b8 62 00 00 00       	mov    eax,0x62
  bd:	c9                   	leave  
  be:	c3                   	ret    
