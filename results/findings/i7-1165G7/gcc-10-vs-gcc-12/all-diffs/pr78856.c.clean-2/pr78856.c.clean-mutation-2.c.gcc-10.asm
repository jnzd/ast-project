  ...
  19:	c7 45 f0 45 00 00 00 	mov    DWORD PTR [rbp-0x10],0x45
  20:	c7 45 f8 43 00 00 00 	mov    DWORD PTR [rbp-0x8],0x43
  27:	e9 8a 00 00 00       	jmp    b6 <main+0xb6>
  2c:	c7 45 fc 1c 00 00 00 	mov    DWORD PTR [rbp-0x4],0x1c
  33:	c7 45 f4 60 00 00 00 	mov    DWORD PTR [rbp-0xc],0x60
  ...
  50:	c7 04 02 52 00 00 00 	mov    DWORD PTR [rdx+rax*1],0x52
  57:	83 45 f4 01          	add    DWORD PTR [rbp-0xc],0x1
  5b:	83 7d f4 31          	cmp    DWORD PTR [rbp-0xc],0x31
  ...
  8f:	c7 45 f8 38 00 00 00 	mov    DWORD PTR [rbp-0x8],0x38
  ...
  ac:	83 7d fc 0e          	cmp    DWORD PTR [rbp-0x4],0xe
  b0:	7e b1                	jle    63 <main+0x63>
  b2:	83 45 f0 45          	add    DWORD PTR [rbp-0x10],0x45
  b6:	83 7d f0 23          	cmp    DWORD PTR [rbp-0x10],0x23
  ba:	0f 8e 6c ff ff ff    	jle    2c <main+0x2c>
  c0:	bf 2c 00 00 00       	mov    edi,0x2c
