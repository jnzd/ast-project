   ...
   c:	c7 45 f4 7c 00 00 00 	mov    DWORD PTR [rbp-0xc],0x7c
  13:	c7 45 f8 1f 00 00 00 	mov    DWORD PTR [rbp-0x8],0x1f
  ...
  7a:	83 7d f8 03          	cmp    DWORD PTR [rbp-0x8],0x3
  7e:	77 2b                	ja     ab <main+0xab>
  80:	83 7d f4 25          	cmp    DWORD PTR [rbp-0xc],0x25
  ...
  9b:	83 f8 42             	cmp    eax,0x42
  9e:	0f 8e 78 ff ff ff    	jle    1c <main+0x1c>
  a4:	b8 26 00 00 00       	mov    eax,0x26
