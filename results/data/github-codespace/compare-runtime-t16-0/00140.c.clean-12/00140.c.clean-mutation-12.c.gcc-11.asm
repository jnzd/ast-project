  ...
  69:	b8 93 93 a9 4b       	mov    eax,0x4ba99393
  ...
  9f:	c7 45 d4 3a ae 84 2f 	mov    DWORD PTR [rbp-0x2c],0x2f84ae3a
  ...
  bc:	be 61 b8 18 4f       	mov    esi,0x4f18b861
