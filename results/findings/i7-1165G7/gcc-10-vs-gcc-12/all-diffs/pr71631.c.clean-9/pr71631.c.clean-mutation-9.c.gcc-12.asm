  ...
  3e:	c7 45 dc 78 00 00 00 	mov    DWORD PTR [rbp-0x24],0x78
  45:	c7 45 e0 26 00 00 00 	mov    DWORD PTR [rbp-0x20],0x26
  4c:	8b 0d 00 00 00 00    	mov    ecx,DWORD PTR [rip+0x0]        # 52 <main+0x20>
  52:	b8 76 00 00 00       	mov    eax,0x76
  57:	99                   	cdq    
  58:	f7 f9                	idiv   ecx
  ...
  6f:	83 c0 34             	add    eax,0x34
  72:	89 45 ec             	mov    DWORD PTR [rbp-0x14],eax
  75:	b8 76 00 00 00       	mov    eax,0x76
  7a:	99                   	cdq    
  ...
  cd:	6b c0 8f             	imul   eax,eax,0xffffff8f
  ...
  ea:	83 7d f0 0a          	cmp    DWORD PTR [rbp-0x10],0xa
  ...
  ff:	66 83 7d da ab       	cmp    WORD PTR [rbp-0x26],0xffab
 104:	74 05                	je     10b <main+0xd9>
 106:	e8 00 00 00 00       	call   10b <main+0xd9>
 10b:	b8 37 00 00 00       	mov    eax,0x37
 110:	c9                   	leave  
 111:	c3                   	ret    
