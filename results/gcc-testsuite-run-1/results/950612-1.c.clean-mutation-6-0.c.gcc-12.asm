   ...
   b:	83 7d fc 67          	cmp    DWORD PTR [rbp-0x4],0x67
  ...
  48:	48 83 7d f8 67       	cmp    QWORD PTR [rbp-0x8],0x67
  ...
  8f:	c7 45 fc 30 00 00 00 	mov    DWORD PTR [rbp-0x4],0x30
 ...
 183:	83 7d fc 37          	cmp    DWORD PTR [rbp-0x4],0x37
 187:	0f 8e 0e ff ff ff    	jle    9b <main+0x18>
 18d:	bf 11 00 00 00       	mov    edi,0x11
