 ...
 2fc:	83 f8 4e             	cmp    eax,0x4e
 2ff:	75 0b                	jne    30c <main+0x30c>
 301:	8b 05 00 00 00 00    	mov    eax,DWORD PTR [rip+0x0]        # 307 <main+0x307>
 307:	83 f8 3e             	cmp    eax,0x3e
 30a:	74 05                	je     311 <main+0x311>
 30c:	e8 00 00 00 00       	call   311 <main+0x311>
 311:	c6 45 11 20          	mov    BYTE PTR [rbp+0x11],0x20
 315:	c6 45 aa 00          	mov    BYTE PTR [rbp-0x56],0x0
 319:	c7 05 00 00 00 00 12 	mov    DWORD PTR [rip+0x0],0x12        # 323 <main+0x323>
 320:	00 00 00 
 323:	c7 05 00 00 00 00 5a 	mov    DWORD PTR [rip+0x0],0x5a        # 32d <main+0x32d>
 32a:	00 00 00 
 ...
 350:	48 83 c0 68          	add    rax,0x68
 354:	ba 41 00 00 00       	mov    edx,0x41
 ...
 3a3:	ba 3b 00 00 00       	mov    edx,0x3b
 ...
 456:	ba 3b 00 00 00       	mov    edx,0x3b
 ...
 46c:	ba 36 00 00 00       	mov    edx,0x36
 ...
 48d:	ba 5a 00 00 00       	mov    edx,0x5a
 ...
 4b1:	00 00 00 
 4b4:	ba 5f 00 00 00       	mov    edx,0x5f
 ...
 55d:	ba 01 00 00 00       	mov    edx,0x1
 ...
 581:	83 f8 5a             	cmp    eax,0x5a
 584:	75 1c                	jne    5a2 <main+0x5a2>
 586:	ba 04 00 00 00       	mov    edx,0x4
 ...
 5a7:	c7 05 00 00 00 00 1f 	mov    DWORD PTR [rip+0x0],0x1f        # 5b1 <main+0x5b1>
 5ae:	00 00 00 
 ...
 5e7:	be 3d 00 00 00       	mov    esi,0x3d
 ...
 65b:	ba 7f 00 00 00       	mov    edx,0x7f
 660:	be 66 00 00 00       	mov    esi,0x66
 ...
 68b:	ba 03 00 00 00       	mov    edx,0x3
 ...
 6a8:	b8 49 00 00 00       	mov    eax,0x49
