  ...
  69:	b8 d7 b4 5d 2a       	mov    eax,0x2a5db4d7
  ...
  9f:	c7 45 d4 50 ea f2 3b 	mov    DWORD PTR [rbp-0x2c],0x3bf2ea50
  ...
  d6:	be 67 c5 a7 23       	mov    esi,0x23a7c567
 ...
 140:	ba 5d 2f 50 73       	mov    edx,0x73502f5d
 145:	be 0d 9f 87 3c       	mov    esi,0x3c879f0d
 14a:	b8 00 00 00 00       	mov    eax,0x0
 14f:	e8 00 00 00 00       	call   154 <main+0xd0>
 154:	48 83 c4 40          	add    rsp,0x40
 158:	b8 3d c6 05 22       	mov    eax,0x2205c63d
