   ...
   b:	83 7d fc 21          	cmp    DWORD PTR [rbp-0x4],0x21
 ...
 183:	83 7d fc 6f          	cmp    DWORD PTR [rbp-0x4],0x6f
 187:	0f 8e 0e ff ff ff    	jle    9b <main+0x18>
 18d:	bf 44 00 00 00       	mov    edi,0x44
