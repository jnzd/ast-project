  ...
  22:	c7 45 f8 73 00 00 00 	mov    DWORD PTR [rbp-0x8],0x73
  29:	e9 8a 00 00 00       	jmp    b8 <main+0xb8>
  2e:	c7 45 fc 6e 00 00 00 	mov    DWORD PTR [rbp-0x4],0x6e
  ...
  52:	c7 04 02 4b 00 00 00 	mov    DWORD PTR [rdx+rax*1],0x4b
  59:	83 45 f4 01          	add    DWORD PTR [rbp-0xc],0x1
  5d:	83 7d f4 48          	cmp    DWORD PTR [rbp-0xc],0x48
  ...
  ae:	83 7d fc 2f          	cmp    DWORD PTR [rbp-0x4],0x2f
  b2:	7e b1                	jle    65 <main+0x65>
  b4:	83 45 f0 43          	add    DWORD PTR [rbp-0x10],0x43
  b8:	83 7d f0 5a          	cmp    DWORD PTR [rbp-0x10],0x5a
  bc:	0f 8e 6c ff ff ff    	jle    2e <main+0x2e>
  c2:	bf 14 00 00 00       	mov    edi,0x14
