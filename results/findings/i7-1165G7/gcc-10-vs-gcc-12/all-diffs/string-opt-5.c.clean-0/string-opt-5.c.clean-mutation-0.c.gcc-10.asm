 ...
 2fc:	83 f8 2b             	cmp    eax,0x2b
 2ff:	75 0b                	jne    30c <main+0x30c>
 301:	8b 05 00 00 00 00    	mov    eax,DWORD PTR [rip+0x0]        # 307 <main+0x307>
 307:	83 f8 25             	cmp    eax,0x25
 30a:	74 05                	je     311 <main+0x311>
 30c:	e8 00 00 00 00       	call   311 <main+0x311>
 311:	c6 45 ba 20          	mov    BYTE PTR [rbp-0x46],0x20
 315:	c6 45 b7 00          	mov    BYTE PTR [rbp-0x49],0x0
 319:	c7 05 00 00 00 00 58 	mov    DWORD PTR [rip+0x0],0x58        # 323 <main+0x323>
 320:	00 00 00 
 323:	c7 05 00 00 00 00 4d 	mov    DWORD PTR [rip+0x0],0x4d        # 32d <main+0x32d>
 32a:	00 00 00 
 ...
 350:	48 83 c0 40          	add    rax,0x40
 354:	ba 5a 00 00 00       	mov    edx,0x5a
 ...
 3a3:	ba 4f 00 00 00       	mov    edx,0x4f
 ...
 456:	ba 4f 00 00 00       	mov    edx,0x4f
 ...
 46c:	ba 1c 00 00 00       	mov    edx,0x1c
 ...
 48d:	ba 6e 00 00 00       	mov    edx,0x6e
 ...
 581:	83 f8 49             	cmp    eax,0x49
 584:	75 1c                	jne    5a2 <main+0x5a2>
 586:	ba 14 00 00 00       	mov    edx,0x14
 ...
 5a7:	c7 05 00 00 00 00 2c 	mov    DWORD PTR [rip+0x0],0x2c        # 5b1 <main+0x5b1>
 5ae:	00 00 00 
 ...
 5e7:	be 4b 00 00 00       	mov    esi,0x4b
 ...
 65b:	ba 18 00 00 00       	mov    edx,0x18
 660:	be 2a 00 00 00       	mov    esi,0x2a
 ...
 6a8:	b8 10 00 00 00       	mov    eax,0x10
