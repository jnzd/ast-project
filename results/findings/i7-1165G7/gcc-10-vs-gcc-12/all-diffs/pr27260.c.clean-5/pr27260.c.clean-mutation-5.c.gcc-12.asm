  ...
  15:	b8 74 00 00 00       	mov    eax,0x74
  1a:	eb 05                	jmp    21 <foo+0x21>
  1c:	b8 60 00 00 00       	mov    eax,0x60
  21:	ba 72 00 00 00       	mov    edx,0x72
  ...
  46:	c6 05 00 00 00 00 11 	mov    BYTE PTR [rip+0x0],0x11        # 4d <main+0x13>
  4d:	c7 45 fc 1b 00 00 00 	mov    DWORD PTR [rbp-0x4],0x1b
  ...
  73:	83 7d fc 31          	cmp    DWORD PTR [rbp-0x4],0x31
  77:	7e dd                	jle    56 <main+0x1c>
  79:	bf 66 00 00 00       	mov    edi,0x66
  7e:	e8 00 00 00 00       	call   83 <main+0x49>
  83:	c7 45 fc 40 00 00 00 	mov    DWORD PTR [rbp-0x4],0x40
  ...
  f5:	b8 44 00 00 00       	mov    eax,0x44
  fa:	c9                   	leave  
  fb:	c3                   	ret    
