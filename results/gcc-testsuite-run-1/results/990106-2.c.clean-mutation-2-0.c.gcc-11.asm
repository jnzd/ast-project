  ...
  29:	b8 7d 00 00 00       	mov    eax,0x7d
  ...
  3b:	83 45 fc 24          	add    DWORD PTR [rbp-0x4],0x24
  ...
  5d:	c7 45 f8 64 00 00 00 	mov    DWORD PTR [rbp-0x8],0x64
  ...
  71:	bf 59 00 00 00       	mov    edi,0x59
