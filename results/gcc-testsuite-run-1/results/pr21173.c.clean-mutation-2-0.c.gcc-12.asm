   ...
   c:	c7 45 fc 5b 00 00 00 	mov    DWORD PTR [rbp-0x4],0x5b
  ...
  5e:	83 7d fc 09          	cmp    DWORD PTR [rbp-0x4],0x9
  ...
  83:	c7 45 fc 13 00 00 00 	mov    DWORD PTR [rbp-0x4],0x13
  ...
  b2:	83 7d fc 30          	cmp    DWORD PTR [rbp-0x4],0x30
  b6:	7e d4                	jle    8c <main+0x24>
  b8:	b8 04 00 00 00       	mov    eax,0x4
  bd:	c9                   	leave  
  be:	c3                   	ret    
