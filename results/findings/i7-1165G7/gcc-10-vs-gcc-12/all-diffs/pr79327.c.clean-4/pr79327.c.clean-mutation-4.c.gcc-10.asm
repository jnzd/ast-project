  ...
  61:	83 f8 53             	cmp    eax,0x53
  64:	74 05                	je     6b <main+0x6b>
  66:	e8 00 00 00 00       	call   6b <main+0x6b>
  6b:	c7 05 00 00 00 00 25 	mov    DWORD PTR [rip+0x0],0x25        # 75 <main+0x75>
  72:	00 00 00 
  75:	8b 15 00 00 00 00    	mov    edx,DWORD PTR [rip+0x0]        # 7b <main+0x7b>
  7b:	48 8d 45 b0          	lea    rax,[rbp-0x50]
  ...
  bb:	83 f8 1d             	cmp    eax,0x1d
  be:	74 05                	je     c5 <main+0xc5>
  c0:	e8 00 00 00 00       	call   c5 <main+0xc5>
  c5:	c7 05 00 00 00 00 58 	mov    DWORD PTR [rip+0x0],0x58        # cf <main+0xcf>
  cc:	00 00 00 
  cf:	8b 15 00 00 00 00    	mov    edx,DWORD PTR [rip+0x0]        # d5 <main+0xd5>
  d5:	48 8d 45 b0          	lea    rax,[rbp-0x50]
