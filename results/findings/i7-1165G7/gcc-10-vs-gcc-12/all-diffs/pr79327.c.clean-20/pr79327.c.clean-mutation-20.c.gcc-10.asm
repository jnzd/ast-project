  ...
  61:	83 f8 44             	cmp    eax,0x44
  64:	74 05                	je     6b <main+0x6b>
  66:	e8 00 00 00 00       	call   6b <main+0x6b>
  6b:	c7 05 00 00 00 00 35 	mov    DWORD PTR [rip+0x0],0x35        # 75 <main+0x75>
  72:	00 00 00 
  ...
  bb:	83 f8 23             	cmp    eax,0x23
  be:	74 05                	je     c5 <main+0xc5>
  c0:	e8 00 00 00 00       	call   c5 <main+0xc5>
  c5:	c7 05 00 00 00 00 67 	mov    DWORD PTR [rip+0x0],0x67        # cf <main+0xcf>
  cc:	00 00 00 
