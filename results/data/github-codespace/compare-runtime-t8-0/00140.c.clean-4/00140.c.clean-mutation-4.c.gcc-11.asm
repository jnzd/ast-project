  ...
  69:	b8 e5 49 42 27       	mov    eax,0x274249e5
  ...
  9f:	c7 45 d4 36 dc f7 14 	mov    DWORD PTR [rbp-0x2c],0x14f7dc36
  ...
  bc:	be 4b d8 ab 2a       	mov    esi,0x2aabd84b
