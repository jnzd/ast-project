  ...
  43:	c6 05 00 00 00 00 32 	mov    BYTE PTR [rip+0x0],0x32        # 4a <main+0x13>
  4a:	c7 45 fc 11 00 00 00 	mov    DWORD PTR [rbp-0x4],0x11
  ...
  f2:	b8 39 00 00 00       	mov    eax,0x39
  f7:	c9                   	leave  
  f8:	c3                   	ret    
