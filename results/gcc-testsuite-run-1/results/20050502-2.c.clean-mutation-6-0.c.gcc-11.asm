   ...
   c:	c7 45 fc 55 00 00 00 	mov    DWORD PTR [rbp-0x4],0x55
  ...
  40:	c7 45 fc 1b 00 00 00 	mov    DWORD PTR [rbp-0x4],0x1b
  47:	eb 04                	jmp    4d <bar+0x19>
  49:	83 45 fc 01          	add    DWORD PTR [rbp-0x4],0x1
  4d:	83 7d fc 0f          	cmp    DWORD PTR [rbp-0x4],0xf
  ...
  c3:	83 f8 17             	cmp    eax,0x17
  c6:	74 05                	je     cd <main+0x64>
  c8:	e8 00 00 00 00       	call   cd <main+0x64>
  cd:	c6 45 43 4d          	mov    BYTE PTR [rbp+0x43],0x4d
