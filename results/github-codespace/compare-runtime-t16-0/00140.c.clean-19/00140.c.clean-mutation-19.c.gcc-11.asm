  ...
  69:	b8 4c a2 0c 42       	mov    eax,0x420ca24c
  ...
  9f:	c7 45 d4 f6 74 cd 39 	mov    DWORD PTR [rbp-0x2c],0x39cd74f6
  ...
  bc:	be 32 4c a0 13       	mov    esi,0x13a04c32
