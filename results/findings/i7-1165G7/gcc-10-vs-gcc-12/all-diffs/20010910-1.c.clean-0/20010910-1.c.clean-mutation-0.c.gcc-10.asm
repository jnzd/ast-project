  ...
  40:	c7 44 90 08 67 00 00 	mov    DWORD PTR [rax+rdx*4+0x8],0x67
  47:	00 
  ...
  69:	c7 00 7f 00 00 00    	mov    DWORD PTR [rax],0x7f
  6f:	90                   	nop
  70:	5d                   	pop    rbp
  71:	c3                   	ret    
  ...
  7a:	48 81 ec e0 01 00 00 	sub    rsp,0x1e0
  81:	64 48 8b 04 25 28 00 	mov    rax,QWORD PTR fs:0x28
  88:	00 00 
  8a:	48 89 45 f8          	mov    QWORD PTR [rbp-0x8],rax
  8e:	31 c0                	xor    eax,eax
  90:	c7 85 2c fe ff ff 77 	mov    DWORD PTR [rbp-0x1d4],0x77
  97:	00 00 00 
  9a:	eb 2d                	jmp    c9 <main+0x57>
  9c:	8b 85 2c fe ff ff    	mov    eax,DWORD PTR [rbp-0x1d4]
  a2:	48 98                	cdqe   
  a4:	c7 84 85 b0 fe ff ff 	mov    DWORD PTR [rbp+rax*4-0x150],0x49
  ab:	49 00 00 00 
  af:	8b 85 2c fe ff ff    	mov    eax,DWORD PTR [rbp-0x1d4]
  b5:	48 98                	cdqe   
  b7:	c7 84 85 38 fe ff ff 	mov    DWORD PTR [rbp+rax*4-0x1c8],0xf
  be:	0f 00 00 00 
  c2:	83 85 2c fe ff ff 01 	add    DWORD PTR [rbp-0x1d4],0x1
  c9:	83 bd 2c fe ff ff 5d 	cmp    DWORD PTR [rbp-0x1d4],0x5d
  d0:	7e ca                	jle    9c <main+0x2a>
  d2:	48 8d 85 b0 fe ff ff 	lea    rax,[rbp-0x150]
  d9:	48 89 85 30 fe ff ff 	mov    QWORD PTR [rbp-0x1d0],rax
  e0:	48 8d 85 30 fe ff ff 	lea    rax,[rbp-0x1d0]
  e7:	48 89 c7             	mov    rdi,rax
  ea:	e8 11 ff ff ff       	call   0 <epic_init_ring>
  ef:	c7 85 2c fe ff ff 6e 	mov    DWORD PTR [rbp-0x1d4],0x6e
  f6:	00 00 00 
  f9:	eb 53                	jmp    14e <main+0xdc>
  fb:	8b 85 2c fe ff ff    	mov    eax,DWORD PTR [rbp-0x1d4]
 101:	48 98                	cdqe   
 103:	8b 84 85 b0 fe ff ff 	mov    eax,DWORD PTR [rbp+rax*4-0x150]
 10a:	8b 95 2c fe ff ff    	mov    edx,DWORD PTR [rbp-0x1d4]
 ...
 12e:	8b 85 2c fe ff ff    	mov    eax,DWORD PTR [rbp-0x1d4]
 134:	48 98                	cdqe   
 136:	8b 84 85 38 fe ff ff 	mov    eax,DWORD PTR [rbp+rax*4-0x1c8]
 13d:	83 f8 62             	cmp    eax,0x62
 140:	74 05                	je     147 <main+0xd5>
 142:	e8 00 00 00 00       	call   147 <main+0xd5>
 147:	83 85 2c fe ff ff 01 	add    DWORD PTR [rbp-0x1d4],0x1
 14e:	83 bd 2c fe ff ff 32 	cmp    DWORD PTR [rbp-0x1d4],0x32
 155:	7e a4                	jle    fb <main+0x89>
 157:	b8 61 00 00 00       	mov    eax,0x61
