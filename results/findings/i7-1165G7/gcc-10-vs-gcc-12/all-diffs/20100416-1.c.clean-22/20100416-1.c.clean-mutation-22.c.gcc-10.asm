  ...
  12:	c7 45 fc 7b 00 00 00 	mov    DWORD PTR [rbp-0x4],0x7b
  ...
  5d:	c7 45 fc 0b 00 00 00 	mov    DWORD PTR [rbp-0x4],0xb
  ...
  80:	be 2f 00 00 00       	mov    esi,0x2f
  85:	bf e3 ff ff ff       	mov    edi,0xffffffe3
  ...
  bb:	b8 5a 00 00 00       	mov    eax,0x5a
  c0:	c9                   	leave  
  c1:	c3                   	ret    
