   ...
   c:	c7 45 ec 71 00 00 00 	mov    DWORD PTR [rbp-0x14],0x71
  13:	8b 45 ec             	mov    eax,DWORD PTR [rbp-0x14]
  16:	83 c0 59             	add    eax,0x59
  ...
  5c:	be 60 00 00 00       	mov    esi,0x60
