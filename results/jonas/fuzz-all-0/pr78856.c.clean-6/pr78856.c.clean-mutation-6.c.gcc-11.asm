  ...
  33:	c7 45 f4 6e 00 00 00 	mov    DWORD PTR [rbp-0xc],0x6e
  ...
  8f:	c7 45 f8 24 00 00 00 	mov    DWORD PTR [rbp-0x8],0x24
  ...
  ac:	83 7d fc 35          	cmp    DWORD PTR [rbp-0x4],0x35
  b0:	7e b1                	jle    63 <main+0x63>
  b2:	83 45 f0 40          	add    DWORD PTR [rbp-0x10],0x40
  b6:	83 7d f0 70          	cmp    DWORD PTR [rbp-0x10],0x70
  ba:	0f 8e 6c ff ff ff    	jle    2c <main+0x2c>
  c0:	bf 65 00 00 00       	mov    edi,0x65
