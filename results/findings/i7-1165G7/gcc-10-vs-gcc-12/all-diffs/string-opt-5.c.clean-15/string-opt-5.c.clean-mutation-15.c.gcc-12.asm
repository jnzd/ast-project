 ...
 31e:	83 f8 34             	cmp    eax,0x34
 321:	75 0b                	jne    32e <main+0x32e>
 323:	8b 05 00 00 00 00    	mov    eax,DWORD PTR [rip+0x0]        # 329 <main+0x329>
 329:	83 f8 05             	cmp    eax,0x5
 32c:	74 05                	je     333 <main+0x333>
 32e:	e8 00 00 00 00       	call   333 <main+0x333>
 333:	c6 45 c5 20          	mov    BYTE PTR [rbp-0x3b],0x20
 337:	c6 45 c6 00          	mov    BYTE PTR [rbp-0x3a],0x0
 33b:	c7 05 00 00 00 00 54 	mov    DWORD PTR [rip+0x0],0x54        # 345 <main+0x345>
 342:	00 00 00 
 345:	c7 05 00 00 00 00 34 	mov    DWORD PTR [rip+0x0],0x34        # 34f <main+0x34f>
 34c:	00 00 00 
 ...
 375:	48 83 c0 2b          	add    rax,0x2b
 379:	ba 1e 00 00 00       	mov    edx,0x1e
 ...
 3cb:	ba 65 00 00 00       	mov    edx,0x65
 ...
 481:	ba 65 00 00 00       	mov    edx,0x65
 ...
 497:	ba 3f 00 00 00       	mov    edx,0x3f
 ...
 4be:	ba 0f 00 00 00       	mov    edx,0xf
 ...
 4e5:	00 00 00 
 4e8:	ba 32 00 00 00       	mov    edx,0x32
 ...
 59d:	ba 65 00 00 00       	mov    edx,0x65
 ...
 5c1:	83 f8 67             	cmp    eax,0x67
 5c4:	75 22                	jne    5e8 <main+0x5e8>
 5c6:	ba 29 00 00 00       	mov    edx,0x29
 ...
 5ed:	c7 05 00 00 00 00 07 	mov    DWORD PTR [rip+0x0],0x7        # 5f7 <main+0x5f7>
 5f4:	00 00 00 
 ...
 62d:	be 04 00 00 00       	mov    esi,0x4
 ...
 6a4:	ba 04 00 00 00       	mov    edx,0x4
 ...
 6f4:	b8 60 00 00 00       	mov    eax,0x60
