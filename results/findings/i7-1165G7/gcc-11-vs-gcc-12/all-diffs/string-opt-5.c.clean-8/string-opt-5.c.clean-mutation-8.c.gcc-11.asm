 ...
 2ff:	83 f8 0f             	cmp    eax,0xf
 302:	75 0b                	jne    30f <main+0x30f>
 304:	8b 05 00 00 00 00    	mov    eax,DWORD PTR [rip+0x0]        # 30a <main+0x30a>
 30a:	83 f8 7b             	cmp    eax,0x7b
 30d:	74 05                	je     314 <main+0x314>
 30f:	e8 00 00 00 00       	call   314 <main+0x314>
 314:	c6 45 bd 20          	mov    BYTE PTR [rbp-0x43],0x20
 318:	c6 45 df 00          	mov    BYTE PTR [rbp-0x21],0x0
 31c:	c7 05 00 00 00 00 4c 	mov    DWORD PTR [rip+0x0],0x4c        # 326 <main+0x326>
 323:	00 00 00 
 326:	c7 05 00 00 00 00 55 	mov    DWORD PTR [rip+0x0],0x55        # 330 <main+0x330>
 32d:	00 00 00 
 ...
 353:	48 83 c0 06          	add    rax,0x6
 357:	ba 1f 00 00 00       	mov    edx,0x1f
 ...
 3a9:	ba 47 00 00 00       	mov    edx,0x47
 ...
 45f:	ba 47 00 00 00       	mov    edx,0x47
 ...
 475:	ba 39 00 00 00       	mov    edx,0x39
 ...
 499:	ba 1a 00 00 00       	mov    edx,0x1a
 ...
 4c0:	00 00 00 
 4c3:	ba 5b 00 00 00       	mov    edx,0x5b
 ...
 57a:	ba 2c 00 00 00       	mov    edx,0x2c
 ...
 59e:	83 f8 44             	cmp    eax,0x44
 5a1:	75 22                	jne    5c5 <main+0x5c5>
 5a3:	ba 4c 00 00 00       	mov    edx,0x4c
 ...
 5ca:	c7 05 00 00 00 00 29 	mov    DWORD PTR [rip+0x0],0x29        # 5d4 <main+0x5d4>
 5d1:	00 00 00 
 ...
 60a:	be 64 00 00 00       	mov    esi,0x64
 ...
 681:	ba 6d 00 00 00       	mov    edx,0x6d
 686:	be 7e 00 00 00       	mov    esi,0x7e
 ...
 6d1:	b8 7c 00 00 00       	mov    eax,0x7c
