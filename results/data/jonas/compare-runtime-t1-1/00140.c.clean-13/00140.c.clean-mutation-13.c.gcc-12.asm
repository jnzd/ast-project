  ...
  69:	b8 e3 4c 70 51       	mov    eax,0x51704ce3
  ...
  9f:	c7 45 d4 3b 33 b8 0b 	mov    DWORD PTR [rbp-0x2c],0xbb8333b
  ...
  d6:	be 99 24 8b 39       	mov    esi,0x398b2499
 ...
 140:	ba 9f 8a 87 50       	mov    edx,0x50878a9f
 145:	be e8 4f 24 3e       	mov    esi,0x3e244fe8
 14a:	b8 00 00 00 00       	mov    eax,0x0
 14f:	e8 00 00 00 00       	call   154 <main+0xd0>
 154:	48 83 c4 40          	add    rsp,0x40
 158:	b8 07 70 f7 1a       	mov    eax,0x1af77007
