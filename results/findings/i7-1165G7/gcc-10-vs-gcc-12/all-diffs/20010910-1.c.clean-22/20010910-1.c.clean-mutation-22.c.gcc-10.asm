   ...
   c:	c7 45 fc 77 00 00 00 	mov    DWORD PTR [rbp-0x4],0x77
  13:	eb 37                	jmp    4c <epic_init_ring+0x4c>
  15:	8b 45 fc             	mov    eax,DWORD PTR [rbp-0x4]
  18:	83 c0 3f             	add    eax,0x3f
  1b:	6b c0 38             	imul   eax,eax,0x38
  1e:	8d 50 72             	lea    edx,[rax+0x72]
  ...
  4c:	83 7d fc 0d          	cmp    DWORD PTR [rbp-0x4],0xd
  ...
  69:	c7 00 67 00 00 00    	mov    DWORD PTR [rax],0x67
  6f:	90                   	nop
  70:	5d                   	pop    rbp
  71:	c3                   	ret    
  ...
  a2:	48 98                	cdqe   
  a4:	c7 84 85 50 ff ff ff 	mov    DWORD PTR [rbp+rax*4-0xb0],0x31
  ab:	31 00 00 00 
  af:	8b 85 4c ff ff ff    	mov    eax,DWORD PTR [rbp-0xb4]
  b5:	48 98                	cdqe   
  b7:	c7 44 85 98 13 00 00 	mov    DWORD PTR [rbp+rax*4-0x68],0x13
  be:	00 
  bf:	83 85 4c ff ff ff 01 	add    DWORD PTR [rbp-0xb4],0x1
  c6:	83 bd 4c ff ff ff 23 	cmp    DWORD PTR [rbp-0xb4],0x23
  cd:	7e cd                	jle    9c <main+0x2a>
  cf:	48 8d 85 50 ff ff ff 	lea    rax,[rbp-0xb0]
  d6:	48 89 45 90          	mov    QWORD PTR [rbp-0x70],rax
  da:	48 8d 45 90          	lea    rax,[rbp-0x70]
  de:	48 89 c7             	mov    rdi,rax
  e1:	e8 1a ff ff ff       	call   0 <epic_init_ring>
  e6:	c7 85 4c ff ff ff 65 	mov    DWORD PTR [rbp-0xb4],0x65
  ed:	00 00 00 
 ...
 12b:	48 98                	cdqe   
 12d:	8b 44 85 98          	mov    eax,DWORD PTR [rbp+rax*4-0x68]
 131:	83 f8 1e             	cmp    eax,0x1e
 134:	74 05                	je     13b <main+0xc9>
 136:	e8 00 00 00 00       	call   13b <main+0xc9>
 13b:	83 85 4c ff ff ff 01 	add    DWORD PTR [rbp-0xb4],0x1
 142:	83 bd 4c ff ff ff 20 	cmp    DWORD PTR [rbp-0xb4],0x20
 149:	7e a7                	jle    f2 <main+0x80>
 14b:	b8 78 00 00 00       	mov    eax,0x78
 150:	48 8b 75 f8          	mov    rsi,QWORD PTR [rbp-0x8]
 154:	64 48 2b 34 25 28 00 	sub    rsi,QWORD PTR fs:0x28
 15b:	00 00 
