  ...
  9f:	c7 45 d4 00 00 00 00 	mov    DWORD PTR [rbp-0x2c],0x0
  ...
  bc:	be 3c 00 00 00       	mov    esi,0x3c
  ...
  f5:	ba 5e 00 00 00       	mov    edx,0x5e
  fa:	be 71 00 00 00       	mov    esi,0x71
