  ...
  69:	b8 9f 32 65 69       	mov    eax,0x6965329f
  ...
  9f:	c7 45 d4 88 e6 e3 01 	mov    DWORD PTR [rbp-0x2c],0x1e3e688
  ...
  bc:	be 00 50 59 50       	mov    esi,0x50595000
