  ...
  13:	c7 45 f4 36 00 00 00 	mov    DWORD PTR [rbp-0xc],0x36
  1a:	c7 45 f0 6a 00 00 00 	mov    DWORD PTR [rbp-0x10],0x6a
  ...
  3c:	83 7d fc 5f          	cmp    DWORD PTR [rbp-0x4],0x5f
  ...
  5b:	c7 45 f4 6b 00 00 00 	mov    DWORD PTR [rbp-0xc],0x6b
  ...
  8d:	b8 25 00 00 00       	mov    eax,0x25
  92:	5d                   	pop    rbp
  93:	c3                   	ret    
