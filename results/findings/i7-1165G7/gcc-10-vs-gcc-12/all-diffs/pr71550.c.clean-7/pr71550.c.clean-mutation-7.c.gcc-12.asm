  ...
  43:	c7 45 fc 14 00 00 00 	mov    DWORD PTR [rbp-0x4],0x14
  ...
  80:	83 f8 5f             	cmp    eax,0x5f
  83:	76 d3                	jbe    58 <main+0x58>
  85:	83 45 fc 01          	add    DWORD PTR [rbp-0x4],0x1
  89:	83 7d fc 19          	cmp    DWORD PTR [rbp-0x4],0x19
  8d:	7e bd                	jle    4c <main+0x4c>
  8f:	c7 45 fc 39 00 00 00 	mov    DWORD PTR [rbp-0x4],0x39
  96:	eb 04                	jmp    9c <main+0x9c>
  98:	83 45 fc 01          	add    DWORD PTR [rbp-0x4],0x1
  9c:	83 7d fc 1b          	cmp    DWORD PTR [rbp-0x4],0x1b
  ...
  bf:	bf 6e 00 00 00       	mov    edi,0x6e
