  ...
  1b:	c7 45 f0 55 00 00 00 	mov    DWORD PTR [rbp-0x10],0x55
  22:	c7 45 f8 6e 00 00 00 	mov    DWORD PTR [rbp-0x8],0x6e
  29:	e9 8a 00 00 00       	jmp    b8 <main+0xb8>
  2e:	c7 45 fc 3b 00 00 00 	mov    DWORD PTR [rbp-0x4],0x3b
  35:	c7 45 f4 68 00 00 00 	mov    DWORD PTR [rbp-0xc],0x68
  ...
  5d:	83 7d f4 3a          	cmp    DWORD PTR [rbp-0xc],0x3a
  ...
  91:	c7 45 f8 4c 00 00 00 	mov    DWORD PTR [rbp-0x8],0x4c
  ...
  ae:	83 7d fc 0f          	cmp    DWORD PTR [rbp-0x4],0xf
  b2:	7e b1                	jle    65 <main+0x65>
  b4:	83 45 f0 74          	add    DWORD PTR [rbp-0x10],0x74
  b8:	83 7d f0 10          	cmp    DWORD PTR [rbp-0x10],0x10
  bc:	0f 8e 6c ff ff ff    	jle    2e <main+0x2e>
  c2:	bf 4b 00 00 00       	mov    edi,0x4b
