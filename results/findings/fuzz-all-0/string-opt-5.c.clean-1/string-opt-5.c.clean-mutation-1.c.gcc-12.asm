 ...
 300:	83 f8 74             	cmp    eax,0x74
 303:	75 0b                	jne    310 <main+0x310>
 305:	8b 05 00 00 00 00    	mov    eax,DWORD PTR [rip+0x0]        # 30b <main+0x30b>
 30b:	83 f8 69             	cmp    eax,0x69
 30e:	74 05                	je     315 <main+0x315>
 310:	e8 00 00 00 00       	call   315 <main+0x315>
 315:	c6 45 d3 20          	mov    BYTE PTR [rbp-0x2d],0x20
 319:	c6 45 be 00          	mov    BYTE PTR [rbp-0x42],0x0
 31d:	c7 05 00 00 00 00 6b 	mov    DWORD PTR [rip+0x0],0x6b        # 327 <main+0x327>
 324:	00 00 00 
 327:	c7 05 00 00 00 00 43 	mov    DWORD PTR [rip+0x0],0x43        # 331 <main+0x331>
 32e:	00 00 00 
 ...
 354:	48 83 c0 21          	add    rax,0x21
 358:	ba 44 00 00 00       	mov    edx,0x44
 ...
 3aa:	ba 36 00 00 00       	mov    edx,0x36
 ...
 43c:	ba 5c 00 00 00       	mov    edx,0x5c
 ...
 460:	ba 36 00 00 00       	mov    edx,0x36
 ...
 49d:	ba 39 00 00 00       	mov    edx,0x39
 ...
 4c4:	00 00 00 
 4c7:	ba 20 00 00 00       	mov    edx,0x20
 ...
 57c:	ba 69 00 00 00       	mov    edx,0x69
 ...
 5a0:	83 f8 1f             	cmp    eax,0x1f
 5a3:	75 22                	jne    5c7 <main+0x5c7>
 5a5:	ba 39 00 00 00       	mov    edx,0x39
 ...
 60c:	be 27 00 00 00       	mov    esi,0x27
 ...
 683:	ba 5c 00 00 00       	mov    edx,0x5c
 688:	be 43 00 00 00       	mov    esi,0x43
