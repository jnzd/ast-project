   ...
   b:	83 7d fc 69          	cmp    DWORD PTR [rbp-0x4],0x69
  ...
  48:	48 83 7d f8 05       	cmp    QWORD PTR [rbp-0x8],0x5
  ...
  8f:	c7 45 fc 4e 00 00 00 	mov    DWORD PTR [rbp-0x4],0x4e
 ...
 173:	83 7d fc 29          	cmp    DWORD PTR [rbp-0x4],0x29
 177:	0f 8e 1e ff ff ff    	jle    9b <main+0x18>
 17d:	bf 13 00 00 00       	mov    edi,0x13
