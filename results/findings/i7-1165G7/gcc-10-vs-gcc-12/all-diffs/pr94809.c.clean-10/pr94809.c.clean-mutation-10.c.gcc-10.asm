   ...
   c:	c7 45 f4 6b 00 00 00 	mov    DWORD PTR [rbp-0xc],0x6b
  13:	48 c7 45 f8 06 00 00 	mov    QWORD PTR [rbp-0x8],0x6
  1a:	00 
  ...
  2a:	83 7d f4 56          	cmp    DWORD PTR [rbp-0xc],0x56
  2e:	74 05                	je     35 <main+0x35>
  30:	e8 00 00 00 00       	call   35 <main+0x35>
  35:	b8 5e 00 00 00       	mov    eax,0x5e
  3a:	c9                   	leave  
  3b:	c3                   	ret    
