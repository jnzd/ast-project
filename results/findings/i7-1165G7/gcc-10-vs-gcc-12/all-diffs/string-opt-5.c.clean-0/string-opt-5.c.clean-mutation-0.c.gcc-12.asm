 ...
 300:	83 f8 2b             	cmp    eax,0x2b
 303:	75 0b                	jne    310 <main+0x310>
 305:	8b 05 00 00 00 00    	mov    eax,DWORD PTR [rip+0x0]        # 30b <main+0x30b>
 30b:	83 f8 25             	cmp    eax,0x25
 30e:	74 05                	je     315 <main+0x315>
 310:	e8 00 00 00 00       	call   315 <main+0x315>
 315:	c6 45 ba 20          	mov    BYTE PTR [rbp-0x46],0x20
 319:	c6 45 b7 00          	mov    BYTE PTR [rbp-0x49],0x0
 31d:	c7 05 00 00 00 00 58 	mov    DWORD PTR [rip+0x0],0x58        # 327 <main+0x327>
 324:	00 00 00 
 327:	c7 05 00 00 00 00 4d 	mov    DWORD PTR [rip+0x0],0x4d        # 331 <main+0x331>
 32e:	00 00 00 
 ...
 354:	48 83 c0 40          	add    rax,0x40
 358:	ba 5a 00 00 00       	mov    edx,0x5a
 ...
 3aa:	ba 4f 00 00 00       	mov    edx,0x4f
 ...
 460:	ba 4f 00 00 00       	mov    edx,0x4f
 ...
 476:	ba 1c 00 00 00       	mov    edx,0x1c
 ...
 49d:	ba 6e 00 00 00       	mov    edx,0x6e
 ...
 4c4:	00 00 00 
 4c7:	ba 48 00 00 00       	mov    edx,0x48
 ...
 5a0:	83 f8 49             	cmp    eax,0x49
 5a3:	75 22                	jne    5c7 <main+0x5c7>
 5a5:	ba 14 00 00 00       	mov    edx,0x14
 ...
 5cc:	c7 05 00 00 00 00 2c 	mov    DWORD PTR [rip+0x0],0x2c        # 5d6 <main+0x5d6>
 5d3:	00 00 00 
 ...
 60c:	be 4b 00 00 00       	mov    esi,0x4b
 ...
 683:	ba 18 00 00 00       	mov    edx,0x18
 688:	be 2a 00 00 00       	mov    esi,0x2a
 ...
 6d3:	b8 10 00 00 00       	mov    eax,0x10
