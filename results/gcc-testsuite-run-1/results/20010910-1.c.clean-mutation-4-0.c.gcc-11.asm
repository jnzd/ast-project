  ...
  40:	c7 44 90 08 76 00 00 	mov    DWORD PTR [rax+rdx*4+0x8],0x76
  47:	00 
  48:	83 45 fc 01          	add    DWORD PTR [rbp-0x4],0x1
  4c:	83 7d fc 78          	cmp    DWORD PTR [rbp-0x4],0x78
  ...
  62:	48 2d 90 01 00 00    	sub    rax,0x190
  68:	48 01 d0             	add    rax,rdx
  6b:	c7 00 04 00 00 00    	mov    DWORD PTR [rax],0x4
  71:	90                   	nop
  72:	5d                   	pop    rbp
  73:	c3                   	ret    
  ...
  7c:	48 81 ec 20 03 00 00 	sub    rsp,0x320
  83:	64 48 8b 04 25 28 00 	mov    rax,QWORD PTR fs:0x28
  8a:	00 00 
  8c:	48 89 45 f8          	mov    QWORD PTR [rbp-0x8],rax
  90:	31 c0                	xor    eax,eax
  92:	c7 85 ec fc ff ff 7f 	mov    DWORD PTR [rbp-0x314],0x7f
  99:	00 00 00 
  9c:	eb 2d                	jmp    cb <main+0x57>
  9e:	8b 85 ec fc ff ff    	mov    eax,DWORD PTR [rbp-0x314]
  a4:	48 98                	cdqe   
  a6:	c7 84 85 10 fe ff ff 	mov    DWORD PTR [rbp+rax*4-0x1f0],0x44
  ad:	44 00 00 00 
  b1:	8b 85 ec fc ff ff    	mov    eax,DWORD PTR [rbp-0x314]
  b7:	48 98                	cdqe   
  b9:	c7 84 85 f8 fc ff ff 	mov    DWORD PTR [rbp+rax*4-0x308],0xe
  c0:	0e 00 00 00 
  c4:	83 85 ec fc ff ff 01 	add    DWORD PTR [rbp-0x314],0x1
  cb:	83 bd ec fc ff ff 6c 	cmp    DWORD PTR [rbp-0x314],0x6c
  d2:	7e ca                	jle    9e <main+0x2a>
  d4:	48 8d 85 10 fe ff ff 	lea    rax,[rbp-0x1f0]
  db:	48 89 85 f0 fc ff ff 	mov    QWORD PTR [rbp-0x310],rax
  e2:	48 8d 85 f0 fc ff ff 	lea    rax,[rbp-0x310]
  e9:	48 89 c7             	mov    rdi,rax
  ec:	e8 0f ff ff ff       	call   0 <epic_init_ring>
  f1:	c7 85 ec fc ff ff 4f 	mov    DWORD PTR [rbp-0x314],0x4f
  f8:	00 00 00 
  fb:	eb 53                	jmp    150 <main+0xdc>
  fd:	8b 85 ec fc ff ff    	mov    eax,DWORD PTR [rbp-0x314]
 103:	48 98                	cdqe   
 105:	8b 84 85 10 fe ff ff 	mov    eax,DWORD PTR [rbp+rax*4-0x1f0]
 10c:	8b 95 ec fc ff ff    	mov    edx,DWORD PTR [rbp-0x314]
 ...
 130:	8b 85 ec fc ff ff    	mov    eax,DWORD PTR [rbp-0x314]
 136:	48 98                	cdqe   
 138:	8b 84 85 f8 fc ff ff 	mov    eax,DWORD PTR [rbp+rax*4-0x308]
 13f:	83 f8 3a             	cmp    eax,0x3a
 142:	74 05                	je     149 <main+0xd5>
 144:	e8 00 00 00 00       	call   149 <main+0xd5>
 149:	83 85 ec fc ff ff 01 	add    DWORD PTR [rbp-0x314],0x1
 150:	83 bd ec fc ff ff 24 	cmp    DWORD PTR [rbp-0x314],0x24
 157:	7e a4                	jle    fd <main+0x89>
 159:	b8 7f 00 00 00       	mov    eax,0x7f
