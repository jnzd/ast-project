  ...
  65:	b8 2e 2e ff 59       	mov    eax,0x59ff2e2e
  ...
  88:	c7 45 e4 fc fa 8c 09 	mov    DWORD PTR [rbp-0x1c],0x98cfafc
  ...
  bf:	be e3 75 36 33       	mov    esi,0x333675e3
 ...
 129:	ba b4 a6 ab 0a       	mov    edx,0xaaba6b4
 12e:	be b1 60 ab 32       	mov    esi,0x32ab60b1
 133:	b8 00 00 00 00       	mov    eax,0x0
 138:	e8 00 00 00 00       	call   13d <main+0xbd>
 13d:	48 83 c4 40          	add    rsp,0x40
 141:	b8 1a f7 a0 07       	mov    eax,0x7a0f71a
 146:	c9                   	leave
 147:	c3                   	ret
