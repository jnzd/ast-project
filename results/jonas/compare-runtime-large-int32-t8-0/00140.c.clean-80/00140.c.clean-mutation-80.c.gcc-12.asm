  ...
  69:	b8 df 61 17 3c       	mov    eax,0x3c1761df
  ...
  9f:	c7 45 d4 96 8d 7a 02 	mov    DWORD PTR [rbp-0x2c],0x27a8d96
  ...
  d6:	be 85 74 96 72       	mov    esi,0x72967485
 ...
 140:	ba 48 37 20 0d       	mov    edx,0xd203748
 145:	be 6e 4a 4f 1e       	mov    esi,0x1e4f4a6e
 14a:	b8 00 00 00 00       	mov    eax,0x0
 14f:	e8 00 00 00 00       	call   154 <main+0xd0>
 154:	48 83 c4 40          	add    rsp,0x40
 158:	b8 46 48 86 50       	mov    eax,0x50864846
