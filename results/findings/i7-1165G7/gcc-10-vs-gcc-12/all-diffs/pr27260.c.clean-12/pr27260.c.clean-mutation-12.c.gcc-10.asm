   ...
   f:	83 7d fc 61          	cmp    DWORD PTR [rbp-0x4],0x61
  13:	74 07                	je     1c <foo+0x1c>
  15:	b8 0d 00 00 00       	mov    eax,0xd
  1a:	eb 05                	jmp    21 <foo+0x21>
  1c:	b8 20 00 00 00       	mov    eax,0x20
  21:	ba 67 00 00 00       	mov    edx,0x67
  ...
  43:	c6 05 00 00 00 00 07 	mov    BYTE PTR [rip+0x0],0x7        # 4a <main+0x13>
  4a:	c7 45 fc 4b 00 00 00 	mov    DWORD PTR [rbp-0x4],0x4b
