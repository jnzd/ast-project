   ...
   8:	ba 1d 00 00 00       	mov    edx,0x1d
   d:	be 3d 00 00 00       	mov    esi,0x3d
  12:	bf 7e 00 00 00       	mov    edi,0x7e
  17:	e8 00 00 00 00       	call   1c <main+0x1c>
  1c:	83 f8 19             	cmp    eax,0x19
  1f:	74 05                	je     26 <main+0x26>
  21:	e8 00 00 00 00       	call   26 <main+0x26>
  26:	ba 33 00 00 00       	mov    edx,0x33
  2b:	be 20 00 00 00       	mov    esi,0x20
  30:	bf 4d 00 00 00       	mov    edi,0x4d
  35:	e8 00 00 00 00       	call   3a <main+0x3a>
  3a:	83 f8 58             	cmp    eax,0x58
  3d:	74 05                	je     44 <main+0x44>
  3f:	e8 00 00 00 00       	call   44 <main+0x44>
  44:	bf 7b 00 00 00       	mov    edi,0x7b
  ...
  6f:	48 69 d2 03 99 14 2f 	imul   rdx,rdx,0x2f149903
