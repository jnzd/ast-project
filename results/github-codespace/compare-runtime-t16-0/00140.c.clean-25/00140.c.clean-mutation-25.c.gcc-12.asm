  ...
  65:	b8 41 34 70 32       	mov    eax,0x32703441
  ...
  88:	c7 45 e4 16 01 ad 3b 	mov    DWORD PTR [rbp-0x1c],0x3bad0116
  ...
  bf:	be d2 e6 04 0b       	mov    esi,0xb04e6d2
 ...
 129:	ba 4d c5 e9 5d       	mov    edx,0x5de9c54d
 12e:	be e7 05 3c 27       	mov    esi,0x273c05e7
 133:	b8 00 00 00 00       	mov    eax,0x0
 138:	e8 00 00 00 00       	call   13d <main+0xbd>
 13d:	48 83 c4 40          	add    rsp,0x40
 141:	b8 54 6e 49 4a       	mov    eax,0x4a496e54
 146:	c9                   	leave
 147:	c3                   	ret
