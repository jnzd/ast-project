  ...
  1b:	c7 45 f0 79 00 00 00 	mov    DWORD PTR [rbp-0x10],0x79
  22:	c7 45 f8 0b 00 00 00 	mov    DWORD PTR [rbp-0x8],0xb
  29:	e9 8a 00 00 00       	jmp    b8 <main+0xb8>
  2e:	c7 45 fc 36 00 00 00 	mov    DWORD PTR [rbp-0x4],0x36
  35:	c7 45 f4 79 00 00 00 	mov    DWORD PTR [rbp-0xc],0x79
  ...
  52:	c7 04 02 57 00 00 00 	mov    DWORD PTR [rdx+rax*1],0x57
  59:	83 45 f4 01          	add    DWORD PTR [rbp-0xc],0x1
  5d:	83 7d f4 7b          	cmp    DWORD PTR [rbp-0xc],0x7b
  ...
  91:	c7 45 f8 15 00 00 00 	mov    DWORD PTR [rbp-0x8],0x15
  ...
  ae:	83 7d fc 37          	cmp    DWORD PTR [rbp-0x4],0x37
  b2:	7e b1                	jle    65 <main+0x65>
  b4:	83 45 f0 1c          	add    DWORD PTR [rbp-0x10],0x1c
  b8:	83 7d f0 19          	cmp    DWORD PTR [rbp-0x10],0x19
  bc:	0f 8e 6c ff ff ff    	jle    2e <main+0x2e>
  c2:	bf 6c 00 00 00       	mov    edi,0x6c
