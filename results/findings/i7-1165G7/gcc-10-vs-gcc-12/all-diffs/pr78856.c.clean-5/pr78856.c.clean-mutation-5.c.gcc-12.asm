  ...
  22:	c7 45 f8 10 00 00 00 	mov    DWORD PTR [rbp-0x8],0x10
  ...
  5d:	83 7d f4 68          	cmp    DWORD PTR [rbp-0xc],0x68
  ...
  91:	c7 45 f8 05 00 00 00 	mov    DWORD PTR [rbp-0x8],0x5
  ...
  ae:	83 7d fc 25          	cmp    DWORD PTR [rbp-0x4],0x25
  b2:	7e b1                	jle    65 <main+0x65>
  b4:	83 45 f0 5b          	add    DWORD PTR [rbp-0x10],0x5b
  b8:	83 7d f0 76          	cmp    DWORD PTR [rbp-0x10],0x76
