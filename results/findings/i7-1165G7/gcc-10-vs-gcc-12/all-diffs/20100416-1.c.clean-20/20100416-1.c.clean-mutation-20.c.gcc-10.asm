  ...
  12:	c7 45 fc 4a 00 00 00 	mov    DWORD PTR [rbp-0x4],0x4a
  19:	c7 45 f8 4b 00 00 00 	mov    DWORD PTR [rbp-0x8],0x4b
  ...
  5d:	c7 45 fc 34 00 00 00 	mov    DWORD PTR [rbp-0x4],0x34
  ...
  80:	be 36 00 00 00       	mov    esi,0x36
  85:	bf bd ff ff ff       	mov    edi,0xffffffbd
