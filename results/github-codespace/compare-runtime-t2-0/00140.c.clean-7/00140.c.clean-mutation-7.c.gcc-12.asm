  ...
  65:	b8 58 2e db 49       	mov    eax,0x49db2e58
  ...
  88:	c7 45 e4 fe ec 43 05 	mov    DWORD PTR [rbp-0x1c],0x543ecfe
  ...
  bf:	be 81 75 97 6a       	mov    esi,0x6a977581
 ...
 129:	ba e3 43 71 5c       	mov    edx,0x5c7143e3
 12e:	be c3 29 b9 45       	mov    esi,0x45b929c3
 133:	b8 00 00 00 00       	mov    eax,0x0
 138:	e8 00 00 00 00       	call   13d <main+0xbd>
 13d:	48 83 c4 40          	add    rsp,0x40
 141:	b8 a3 29 f0 1f       	mov    eax,0x1ff029a3
 146:	c9                   	leave
 147:	c3                   	ret
