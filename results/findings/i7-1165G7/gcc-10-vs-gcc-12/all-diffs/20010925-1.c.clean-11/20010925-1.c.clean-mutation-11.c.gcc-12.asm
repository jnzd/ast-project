  ...
  51:	83 7d ec 39          	cmp    DWORD PTR [rbp-0x14],0x39
  55:	75 07                	jne    5e <foo+0x24>
  57:	b8 10 00 00 00       	mov    eax,0x10
  ...
  74:	b8 17 00 00 00       	mov    eax,0x17
  79:	c9                   	leave  
  7a:	c3                   	ret    
