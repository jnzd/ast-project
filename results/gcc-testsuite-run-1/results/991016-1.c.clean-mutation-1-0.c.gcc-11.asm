  ...
  fd:	c7 45 e4 57 00 00 00 	mov    DWORD PTR [rbp-0x1c],0x57
 104:	48 8d 45 e4          	lea    rax,[rbp-0x1c]
 108:	48 89 c2             	mov    rdx,rax
 10b:	be 26 00 00 00       	mov    esi,0x26
 110:	bf 17 00 00 00       	mov    edi,0x17
 115:	e8 00 00 00 00       	call   11a <main+0x38>
 11a:	48 c7 45 e8 4c 00 00 	mov    QWORD PTR [rbp-0x18],0x4c
 121:	00 
 122:	48 8d 45 e8          	lea    rax,[rbp-0x18]
 126:	48 89 c2             	mov    rdx,rax
 129:	be 6b 00 00 00       	mov    esi,0x6b
 12e:	bf 18 00 00 00       	mov    edi,0x18
 ...
 147:	be 6b 00 00 00       	mov    esi,0x6b
 14c:	bf 04 00 00 00       	mov    edi,0x4
