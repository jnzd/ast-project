  ...
  40:	c7 45 fc 2f 00 00 00 	mov    DWORD PTR [rbp-0x4],0x2f
  ...
  7d:	83 f8 13             	cmp    eax,0x13
  80:	76 d3                	jbe    55 <main+0x55>
  82:	83 45 fc 01          	add    DWORD PTR [rbp-0x4],0x1
  86:	83 7d fc 12          	cmp    DWORD PTR [rbp-0x4],0x12
  8a:	7e bd                	jle    49 <main+0x49>
  8c:	c7 45 fc 2a 00 00 00 	mov    DWORD PTR [rbp-0x4],0x2a
  93:	eb 04                	jmp    99 <main+0x99>
  95:	83 45 fc 01          	add    DWORD PTR [rbp-0x4],0x1
  99:	83 7d fc 62          	cmp    DWORD PTR [rbp-0x4],0x62
  ...
  bc:	bf 24 00 00 00       	mov    edi,0x24
