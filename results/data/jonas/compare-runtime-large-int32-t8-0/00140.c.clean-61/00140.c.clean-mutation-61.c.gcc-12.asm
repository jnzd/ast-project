  ...
  69:	b8 d1 d6 c2 69       	mov    eax,0x69c2d6d1
  ...
  9f:	c7 45 d4 dd be a6 16 	mov    DWORD PTR [rbp-0x2c],0x16a6bedd
  ...
  d6:	be 33 2c f1 4b       	mov    esi,0x4bf12c33
 ...
 140:	ba ed 93 30 1b       	mov    edx,0x1b3093ed
 145:	be a5 5e ee 3b       	mov    esi,0x3bee5ea5
 14a:	b8 00 00 00 00       	mov    eax,0x0
 14f:	e8 00 00 00 00       	call   154 <main+0xd0>
 154:	48 83 c4 40          	add    rsp,0x40
 158:	b8 d5 3f 8c 3a       	mov    eax,0x3a8c3fd5
