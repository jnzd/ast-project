  ...
  69:	b8 60 05 f0 19       	mov    eax,0x19f00560
  ...
  9f:	c7 45 d4 2c 6a 97 28 	mov    DWORD PTR [rbp-0x2c],0x28976a2c
  ...
  bc:	be 15 3c 9b 22       	mov    esi,0x229b3c15
