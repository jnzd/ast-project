  ...
  4d:	88 50 43             	mov    BYTE PTR [rax+0x43],dl
  50:	90                   	nop
  ...
  72:	c7 05 00 00 00 00 11 	mov    DWORD PTR [rip+0x0],0x11        # 7c <main+0x25>
  79:	00 00 00 
  7c:	8b 05 00 00 00 00    	mov    eax,DWORD PTR [rip+0x0]        # 82 <main+0x2b>
  82:	6b c0 39             	imul   eax,eax,0x39
  85:	48 98                	cdqe   
 ...
 15a:	bf 18 00 00 00       	mov    edi,0x18
