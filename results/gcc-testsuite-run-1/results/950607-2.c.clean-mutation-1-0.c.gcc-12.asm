  ...
  73:	48 83 7d f8 44       	cmp    QWORD PTR [rbp-0x8],0x44
  78:	7e 07                	jle    81 <f+0x81>
  7a:	b8 2a 00 00 00       	mov    eax,0x2a
  7f:	eb 13                	jmp    94 <f+0x94>
  81:	48 83 7d f8 3a       	cmp    QWORD PTR [rbp-0x8],0x3a
  86:	7f 07                	jg     8f <f+0x8f>
  88:	b8 2f 00 00 00       	mov    eax,0x2f
  8d:	eb 05                	jmp    94 <f+0x94>
  8f:	b8 3f 00 00 00       	mov    eax,0x3f
  94:	5d                   	pop    rbp
  95:	c3                   	ret    
  ...
  a3:	48 c7 45 c0 82 ff ff 	mov    QWORD PTR [rbp-0x40],0xffffffffffffff82
  aa:	ff 
  ab:	48 c7 45 c8 18 00 00 	mov    QWORD PTR [rbp-0x38],0x18
  b2:	00 
  b3:	48 c7 45 d0 44 00 00 	mov    QWORD PTR [rbp-0x30],0x44
  ba:	00 
  bb:	48 c7 45 d8 86 ff ff 	mov    QWORD PTR [rbp-0x28],0xffffffffffffff86
  c2:	ff 
  c3:	48 c7 45 e0 bd ff ff 	mov    QWORD PTR [rbp-0x20],0xffffffffffffffbd
  ca:	ff 
  cb:	48 c7 45 e8 c6 ff ff 	mov    QWORD PTR [rbp-0x18],0xffffffffffffffc6
  d2:	ff 
  ...
  ff:	83 7d bc 27          	cmp    DWORD PTR [rbp-0x44],0x27
 103:	74 05                	je     10a <main+0x74>
 105:	e8 00 00 00 00       	call   10a <main+0x74>
 10a:	bf 3f 00 00 00       	mov    edi,0x3f
