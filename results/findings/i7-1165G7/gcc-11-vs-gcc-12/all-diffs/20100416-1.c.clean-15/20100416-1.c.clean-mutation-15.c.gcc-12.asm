  ...
  12:	c7 45 fc 25 00 00 00 	mov    DWORD PTR [rbp-0x4],0x25
  19:	c7 45 f8 76 00 00 00 	mov    DWORD PTR [rbp-0x8],0x76
  ...
  5d:	c7 45 fc 73 00 00 00 	mov    DWORD PTR [rbp-0x4],0x73
  ...
  80:	be 28 00 00 00       	mov    esi,0x28
  85:	bf a8 ff ff ff       	mov    edi,0xffffffa8
  ...
  bc:	b8 48 00 00 00       	mov    eax,0x48
  c1:	c9                   	leave  
  c2:	c3                   	ret    
