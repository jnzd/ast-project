   ...
   f:	83 7d fc 5c          	cmp    DWORD PTR [rbp-0x4],0x5c
 ...
 1a7:	0f b6 41 6c          	movzx  eax,BYTE PTR [rcx+0x6c]
 1ab:	88 44 24 6c          	mov    BYTE PTR [rsp+0x6c],al
 1af:	49 8b 41 08          	mov    rax,QWORD PTR [r9+0x8]
 1b3:	49 8b 51 10          	mov    rdx,QWORD PTR [r9+0x10]
 1b7:	49 8b 49 18          	mov    rcx,QWORD PTR [r9+0x18]
 1bb:	49 8b 71 20          	mov    rsi,QWORD PTR [r9+0x20]
 1bf:	49 8b 79 28          	mov    rdi,QWORD PTR [r9+0x28]
 1c3:	f3 41 0f 6f 41 30    	movdqu xmm0,XMMWORD PTR [r9+0x30]
 1c9:	f3 41 0f 6f 49 40    	movdqu xmm1,XMMWORD PTR [r9+0x40]
 1cf:	f3 41 0f 6f 51 50    	movdqu xmm2,XMMWORD PTR [r9+0x50]
 1d5:	f3 41 0f 6f 59 60    	movdqu xmm3,XMMWORD PTR [r9+0x60]
 1db:	f3 41 0f 6f 61 70    	movdqu xmm4,XMMWORD PTR [r9+0x70]
 1e1:	f3 41 0f 6f a9 80 00 	movdqu xmm5,XMMWORD PTR [r9+0x80]
 1e8:	00 00 
 1ea:	f3 41 0f 6f b1 90 00 	movdqu xmm6,XMMWORD PTR [r9+0x90]
 1f1:	00 00 
 1f3:	f3 41 0f 6f b9 a0 00 	movdqu xmm7,XMMWORD PTR [r9+0xa0]
 1fa:	00 00 
 1fc:	4d 8b 81 b0 00 00 00 	mov    r8,QWORD PTR [r9+0xb0]
 203:	4d 8b 89 b8 00 00 00 	mov    r9,QWORD PTR [r9+0xb8]
 20a:	b8 07 00 00 00       	mov    eax,0x7
 20f:	e8 ec fd ff ff       	call   0 <foo>
 214:	48 89 85 a0 fe ff ff 	mov    QWORD PTR [rbp-0x160],rax
 21b:	48 89 95 a8 fe ff ff 	mov    QWORD PTR [rbp-0x158],rdx
 222:	48 89 b5 b0 fe ff ff 	mov    QWORD PTR [rbp-0x150],rsi
 229:	48 89 bd b8 fe ff ff 	mov    QWORD PTR [rbp-0x148],rdi
 230:	db bd c0 fe ff ff    	fstp   TBYTE PTR [rbp-0x140]
 236:	db bd d0 fe ff ff    	fstp   TBYTE PTR [rbp-0x130]
 23c:	0f 29 85 e0 fe ff ff 	movaps XMMWORD PTR [rbp-0x120],xmm0
 243:	0f 29 8d f0 fe ff ff 	movaps XMMWORD PTR [rbp-0x110],xmm1
 24a:	b8 00 00 00 00       	mov    eax,0x0
 24f:	f3 48 0f 1e c8       	rdsspq rax
 254:	48 2b 85 90 fe ff ff 	sub    rax,QWORD PTR [rbp-0x170]
 25b:	48 85 c0             	test   rax,rax
 25e:	74 2c                	je     28c <bar+0x26f>
 260:	48 f7 d8             	neg    rax
 263:	48 c1 e8 03          	shr    rax,0x3
 267:	48 3d ff 00 00 00    	cmp    rax,0xff
 26d:	76 18                	jbe    287 <bar+0x26a>
 26f:	ba ff 00 00 00       	mov    edx,0xff
 274:	f3 48 0f ae ea       	incsspq rdx
 279:	48 2d ff 00 00 00    	sub    rax,0xff
 27f:	48 3d ff 00 00 00    	cmp    rax,0xff
 285:	77 e8                	ja     26f <bar+0x252>
 287:	f3 48 0f ae e8       	incsspq rax
 28c:	48 8b a5 98 fe ff ff 	mov    rsp,QWORD PTR [rbp-0x168]
 293:	90                   	nop
 294:	48 8b 5d f8          	mov    rbx,QWORD PTR [rbp-0x8]
 298:	c9                   	leave  
 299:	c3                   	ret    
 29a:	f3 0f 1e fa          	endbr64 
 29e:	55                   	push   rbp
 29f:	48 89 e5             	mov    rbp,rsp
 2a2:	bf 3b 00 00 00       	mov    edi,0x3b
 2a7:	e8 71 fd ff ff       	call   1d <bar>
 2ac:	b8 12 00 00 00       	mov    eax,0x12
 2b1:	5d                   	pop    rbp
 2b2:	c3                   	ret    
