  ...
  22:	c7 45 f8 5d 00 00 00 	mov    DWORD PTR [rbp-0x8],0x5d
  29:	e9 8a 00 00 00       	jmp    b8 <main+0xb8>
  2e:	c7 45 fc 06 00 00 00 	mov    DWORD PTR [rbp-0x4],0x6
  ...
  52:	c7 04 02 69 00 00 00 	mov    DWORD PTR [rdx+rax*1],0x69
  59:	83 45 f4 01          	add    DWORD PTR [rbp-0xc],0x1
  5d:	83 7d f4 70          	cmp    DWORD PTR [rbp-0xc],0x70
  ...
  ae:	83 7d fc 6b          	cmp    DWORD PTR [rbp-0x4],0x6b
  b2:	7e b1                	jle    65 <main+0x65>
  b4:	83 45 f0 29          	add    DWORD PTR [rbp-0x10],0x29
  b8:	83 7d f0 3b          	cmp    DWORD PTR [rbp-0x10],0x3b
  bc:	0f 8e 6c ff ff ff    	jle    2e <main+0x2e>
  c2:	bf 41 00 00 00       	mov    edi,0x41
