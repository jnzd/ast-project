  ...
  4c:	83 7d fc 2b          	cmp    DWORD PTR [rbp-0x4],0x2b
  ...
  69:	c7 00 13 00 00 00    	mov    DWORD PTR [rax],0x13
  6f:	90                   	nop
  70:	5d                   	pop    rbp
  71:	c3                   	ret    
  ...
  7a:	48 81 ec 60 02 00 00 	sub    rsp,0x260
  81:	64 48 8b 04 25 28 00 	mov    rax,QWORD PTR fs:0x28
  88:	00 00 
  8a:	48 89 45 f8          	mov    QWORD PTR [rbp-0x8],rax
  8e:	31 c0                	xor    eax,eax
  90:	c7 85 ac fd ff ff 7f 	mov    DWORD PTR [rbp-0x254],0x7f
  97:	00 00 00 
  9a:	eb 2d                	jmp    c9 <main+0x57>
  9c:	8b 85 ac fd ff ff    	mov    eax,DWORD PTR [rbp-0x254]
  a2:	48 98                	cdqe   
  a4:	c7 84 85 10 fe ff ff 	mov    DWORD PTR [rbp+rax*4-0x1f0],0x2
  ab:	02 00 00 00 
  af:	8b 85 ac fd ff ff    	mov    eax,DWORD PTR [rbp-0x254]
  b5:	48 98                	cdqe   
  b7:	c7 84 85 b8 fd ff ff 	mov    DWORD PTR [rbp+rax*4-0x248],0x63
  be:	63 00 00 00 
  c2:	83 85 ac fd ff ff 01 	add    DWORD PTR [rbp-0x254],0x1
  c9:	83 bd ac fd ff ff 3a 	cmp    DWORD PTR [rbp-0x254],0x3a
  d0:	7e ca                	jle    9c <main+0x2a>
  d2:	48 8d 85 10 fe ff ff 	lea    rax,[rbp-0x1f0]
  d9:	48 89 85 b0 fd ff ff 	mov    QWORD PTR [rbp-0x250],rax
  e0:	48 8d 85 b0 fd ff ff 	lea    rax,[rbp-0x250]
  e7:	48 89 c7             	mov    rdi,rax
  ea:	e8 11 ff ff ff       	call   0 <epic_init_ring>
  ef:	c7 85 ac fd ff ff 59 	mov    DWORD PTR [rbp-0x254],0x59
  f6:	00 00 00 
  f9:	eb 53                	jmp    14e <main+0xdc>
  fb:	8b 85 ac fd ff ff    	mov    eax,DWORD PTR [rbp-0x254]
 101:	48 98                	cdqe   
 103:	8b 84 85 10 fe ff ff 	mov    eax,DWORD PTR [rbp+rax*4-0x1f0]
 10a:	8b 95 ac fd ff ff    	mov    edx,DWORD PTR [rbp-0x254]
 ...
 12e:	8b 85 ac fd ff ff    	mov    eax,DWORD PTR [rbp-0x254]
 134:	48 98                	cdqe   
 136:	8b 84 85 b8 fd ff ff 	mov    eax,DWORD PTR [rbp+rax*4-0x248]
 13d:	83 f8 5f             	cmp    eax,0x5f
 140:	74 05                	je     147 <main+0xd5>
 142:	e8 00 00 00 00       	call   147 <main+0xd5>
 147:	83 85 ac fd ff ff 01 	add    DWORD PTR [rbp-0x254],0x1
 14e:	83 bd ac fd ff ff 01 	cmp    DWORD PTR [rbp-0x254],0x1
 155:	7e a4                	jle    fb <main+0x89>
 157:	b8 64 00 00 00       	mov    eax,0x64
