 ...
 300:	83 f8 4e             	cmp    eax,0x4e
 303:	75 0b                	jne    310 <main+0x310>
 305:	8b 05 00 00 00 00    	mov    eax,DWORD PTR [rip+0x0]        # 30b <main+0x30b>
 30b:	83 f8 3e             	cmp    eax,0x3e
 30e:	74 05                	je     315 <main+0x315>
 310:	e8 00 00 00 00       	call   315 <main+0x315>
 315:	c6 45 11 20          	mov    BYTE PTR [rbp+0x11],0x20
 319:	c6 45 aa 00          	mov    BYTE PTR [rbp-0x56],0x0
 31d:	c7 05 00 00 00 00 12 	mov    DWORD PTR [rip+0x0],0x12        # 327 <main+0x327>
 324:	00 00 00 
 327:	c7 05 00 00 00 00 5a 	mov    DWORD PTR [rip+0x0],0x5a        # 331 <main+0x331>
 32e:	00 00 00 
 ...
 354:	48 83 c0 68          	add    rax,0x68
 358:	ba 41 00 00 00       	mov    edx,0x41
 ...
 476:	ba 36 00 00 00       	mov    edx,0x36
 ...
 49d:	ba 5a 00 00 00       	mov    edx,0x5a
 ...
 4c4:	00 00 00 
 4c7:	ba 5f 00 00 00       	mov    edx,0x5f
 ...
 5a0:	83 f8 5a             	cmp    eax,0x5a
 5a3:	75 22                	jne    5c7 <main+0x5c7>
 5a5:	ba 04 00 00 00       	mov    edx,0x4
 ...
 5cc:	c7 05 00 00 00 00 1f 	mov    DWORD PTR [rip+0x0],0x1f        # 5d6 <main+0x5d6>
 5d3:	00 00 00 
 ...
 683:	ba 7f 00 00 00       	mov    edx,0x7f
 688:	be 66 00 00 00       	mov    esi,0x66
 ...
 6b3:	ba 03 00 00 00       	mov    edx,0x3
