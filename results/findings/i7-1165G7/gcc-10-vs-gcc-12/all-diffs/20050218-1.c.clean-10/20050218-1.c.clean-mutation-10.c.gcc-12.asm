  ...
  18:	48 c7 45 f8 18 00 00 	mov    QWORD PTR [rbp-0x8],0x18
  1f:	00 
  20:	48 c7 45 f0 66 00 00 	mov    QWORD PTR [rbp-0x10],0x66
  27:	00 
  ...
  7c:	83 f8 0f             	cmp    eax,0xf
  7f:	74 07                	je     88 <foo+0x88>
  81:	b8 63 00 00 00       	mov    eax,0x63
