  ...
  2e:	83 7d dc 51          	cmp    DWORD PTR [rbp-0x24],0x51
  32:	74 47                	je     7b <doit+0x7b>
  34:	83 7d dc 51          	cmp    DWORD PTR [rbp-0x24],0x51
  38:	0f 8f a1 00 00 00    	jg     df <doit+0xdf>
  3e:	83 7d dc 0f          	cmp    DWORD PTR [rbp-0x24],0xf
  42:	74 69                	je     ad <doit+0xad>
  44:	83 7d dc 1e          	cmp    DWORD PTR [rbp-0x24],0x1e
 ...
 101:	c7 45 e4 57 00 00 00 	mov    DWORD PTR [rbp-0x1c],0x57
 108:	48 8d 45 e4          	lea    rax,[rbp-0x1c]
 10c:	48 89 c2             	mov    rdx,rax
 10f:	be 26 00 00 00       	mov    esi,0x26
 114:	bf 17 00 00 00       	mov    edi,0x17
 119:	e8 00 00 00 00       	call   11e <main+0x38>
 11e:	48 c7 45 e8 4c 00 00 	mov    QWORD PTR [rbp-0x18],0x4c
 125:	00 
 126:	48 8d 45 e8          	lea    rax,[rbp-0x18]
 12a:	48 89 c2             	mov    rdx,rax
 12d:	be 6b 00 00 00       	mov    esi,0x6b
 132:	bf 18 00 00 00       	mov    edi,0x18
