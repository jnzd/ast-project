  ...
  65:	b8 dc ca 22 63       	mov    eax,0x6322cadc
  ...
  88:	c7 45 e4 0b 3e 55 1e 	mov    DWORD PTR [rbp-0x1c],0x1e553e0b
  ...
  bf:	be dd a2 93 14       	mov    esi,0x1493a2dd
 ...
 129:	ba a5 79 90 73       	mov    edx,0x739079a5
 12e:	be d0 02 bd 22       	mov    esi,0x22bd02d0
 133:	b8 00 00 00 00       	mov    eax,0x0
 138:	e8 00 00 00 00       	call   13d <main+0xbd>
 13d:	48 83 c4 40          	add    rsp,0x40
 141:	b8 f7 bc 90 27       	mov    eax,0x2790bcf7
 146:	c9                   	leave
 147:	c3                   	ret
