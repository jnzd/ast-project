  ...
  65:	b8 60 05 f0 19       	mov    eax,0x19f00560
  ...
  88:	c7 45 e4 2c 6a 97 28 	mov    DWORD PTR [rbp-0x1c],0x28976a2c
  ...
  bf:	be 15 3c 9b 22       	mov    esi,0x229b3c15
 ...
 129:	ba a4 d7 26 3a       	mov    edx,0x3a26d7a4
 12e:	be 4e d2 35 17       	mov    esi,0x1735d24e
 133:	b8 00 00 00 00       	mov    eax,0x0
 138:	e8 00 00 00 00       	call   13d <main+0xbd>
 13d:	48 83 c4 40          	add    rsp,0x40
 141:	b8 b1 17 52 28       	mov    eax,0x285217b1
 146:	c9                   	leave
 147:	c3                   	ret
