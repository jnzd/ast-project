  ...
  13:	c7 45 f4 2d 00 00 00 	mov    DWORD PTR [rbp-0xc],0x2d
  1a:	c7 45 f0 11 00 00 00 	mov    DWORD PTR [rbp-0x10],0x11
  ...
  3c:	83 7d fc 28          	cmp    DWORD PTR [rbp-0x4],0x28
  ...
  5b:	c7 45 f4 27 00 00 00 	mov    DWORD PTR [rbp-0xc],0x27
