  ...
  29:	c7 45 fc 5e 00 00 00 	mov    DWORD PTR [rbp-0x4],0x5e
  30:	8b 45 fc             	mov    eax,DWORD PTR [rbp-0x4]
  33:	83 c0 0b             	add    eax,0xb
  ...
  71:	48 c7 45 f8 15 00 00 	mov    QWORD PTR [rbp-0x8],0x15
  78:	00 
  79:	bf 14 00 00 80       	mov    edi,0x80000014
