  ...
  61:	83 f8 70             	cmp    eax,0x70
  64:	74 05                	je     6b <main+0x6b>
  66:	e8 00 00 00 00       	call   6b <main+0x6b>
  6b:	c7 05 00 00 00 00 6e 	mov    DWORD PTR [rip+0x0],0x6e        # 75 <main+0x75>
  72:	00 00 00 
  75:	8b 15 00 00 00 00    	mov    edx,DWORD PTR [rip+0x0]        # 7b <main+0x7b>
  7b:	48 8d 45 c0          	lea    rax,[rbp-0x40]
  ...
  bb:	83 f8 7d             	cmp    eax,0x7d
  be:	74 05                	je     c5 <main+0xc5>
  c0:	e8 00 00 00 00       	call   c5 <main+0xc5>
  c5:	c7 05 00 00 00 00 73 	mov    DWORD PTR [rip+0x0],0x73        # cf <main+0xcf>
  cc:	00 00 00 
  cf:	8b 15 00 00 00 00    	mov    edx,DWORD PTR [rip+0x0]        # d5 <main+0xd5>
  d5:	48 8d 45 c0          	lea    rax,[rbp-0x40]
  ...
  fc:	48 8d 45 c0          	lea    rax,[rbp-0x40]
