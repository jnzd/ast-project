  ...
  12:	c7 45 fc 60 00 00 00 	mov    DWORD PTR [rbp-0x4],0x60
  ...
  5d:	c7 45 fc 41 00 00 00 	mov    DWORD PTR [rbp-0x4],0x41
  ...
  80:	be 03 00 00 00       	mov    esi,0x3
  85:	bf 84 ff ff ff       	mov    edi,0xffffff84
  ...
  bc:	b8 41 00 00 00       	mov    eax,0x41
  c1:	c9                   	leave  
  c2:	c3                   	ret    
