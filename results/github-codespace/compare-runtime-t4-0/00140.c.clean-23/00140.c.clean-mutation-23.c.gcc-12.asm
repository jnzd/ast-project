  ...
  65:	b8 72 4e ae 23       	mov    eax,0x23ae4e72
  ...
  88:	c7 45 e4 68 54 d8 15 	mov    DWORD PTR [rbp-0x1c],0x15d85468
  ...
  bf:	be 5e a8 30 0a       	mov    esi,0xa30a85e
 ...
 129:	ba ea 22 aa 56       	mov    edx,0x56aa22ea
 12e:	be 19 40 d1 02       	mov    esi,0x2d14019
 133:	b8 00 00 00 00       	mov    eax,0x0
 138:	e8 00 00 00 00       	call   13d <main+0xbd>
 13d:	48 83 c4 40          	add    rsp,0x40
 141:	b8 ec 35 08 37       	mov    eax,0x370835ec
 146:	c9                   	leave
 147:	c3                   	ret
