  ...
  69:	b8 55 8f 48 10       	mov    eax,0x10488f55
  ...
  9f:	c7 45 d4 0a 01 b1 18 	mov    DWORD PTR [rbp-0x2c],0x18b1010a
  ...
  bc:	be 49 86 d1 1f       	mov    esi,0x1fd18649
