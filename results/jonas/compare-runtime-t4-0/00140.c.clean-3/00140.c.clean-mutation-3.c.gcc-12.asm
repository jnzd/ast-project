  ...
  69:	b8 91 68 27 4c       	mov    eax,0x4c276891
  ...
  9f:	c7 45 d4 ec c5 c1 37 	mov    DWORD PTR [rbp-0x2c],0x37c1c5ec
  ...
  d6:	be aa 09 44 2d       	mov    esi,0x2d4409aa
 ...
 140:	ba d5 cd 1b 5a       	mov    edx,0x5a1bcdd5
 145:	be 8d 0a 61 0b       	mov    esi,0xb610a8d
 14a:	b8 00 00 00 00       	mov    eax,0x0
 14f:	e8 00 00 00 00       	call   154 <main+0xd0>
 154:	48 83 c4 40          	add    rsp,0x40
 158:	b8 42 46 5e 59       	mov    eax,0x595e4642
