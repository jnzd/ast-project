  ...
  65:	b8 bc b1 45 10       	mov    eax,0x1045b1bc
  ...
  88:	c7 45 e4 22 9e 10 31 	mov    DWORD PTR [rbp-0x1c],0x31109e22
  ...
  bf:	be 7e d5 85 2a       	mov    esi,0x2a85d57e
 ...
 129:	ba 99 8b 4d 6e       	mov    edx,0x6e4d8b99
 12e:	be 5b 10 c9 25       	mov    esi,0x25c9105b
 133:	b8 00 00 00 00       	mov    eax,0x0
 138:	e8 00 00 00 00       	call   13d <main+0xbd>
 13d:	48 83 c4 40          	add    rsp,0x40
 141:	b8 29 89 60 2e       	mov    eax,0x2e608929
 146:	c9                   	leave
 147:	c3                   	ret
