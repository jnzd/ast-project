 ...
 300:	83 f8 3c             	cmp    eax,0x3c
 303:	75 0b                	jne    310 <main+0x310>
 305:	8b 05 00 00 00 00    	mov    eax,DWORD PTR [rip+0x0]        # 30b <main+0x30b>
 30b:	83 f8 2b             	cmp    eax,0x2b
 30e:	74 05                	je     315 <main+0x315>
 310:	e8 00 00 00 00       	call   315 <main+0x315>
 315:	c6 45 f7 20          	mov    BYTE PTR [rbp-0x9],0x20
 319:	c6 45 a7 00          	mov    BYTE PTR [rbp-0x59],0x0
 31d:	c7 05 00 00 00 00 44 	mov    DWORD PTR [rip+0x0],0x44        # 327 <main+0x327>
 324:	00 00 00 
 327:	c7 05 00 00 00 00 17 	mov    DWORD PTR [rip+0x0],0x17        # 331 <main+0x331>
 32e:	00 00 00 
 ...
 354:	48 83 c0 0c          	add    rax,0xc
 358:	ba 30 00 00 00       	mov    edx,0x30
 ...
 3aa:	ba 49 00 00 00       	mov    edx,0x49
 ...
 460:	ba 49 00 00 00       	mov    edx,0x49
 ...
 476:	ba 2b 00 00 00       	mov    edx,0x2b
 ...
 49d:	ba 67 00 00 00       	mov    edx,0x67
 ...
 4c4:	00 00 00 
 4c7:	ba 2d 00 00 00       	mov    edx,0x2d
 ...
 57e:	ba 7b 00 00 00       	mov    edx,0x7b
 ...
 5a2:	83 f8 5e             	cmp    eax,0x5e
 5a5:	75 22                	jne    5c9 <main+0x5c9>
 5a7:	ba 21 00 00 00       	mov    edx,0x21
 ...
 5ce:	c7 05 00 00 00 00 36 	mov    DWORD PTR [rip+0x0],0x36        # 5d8 <main+0x5d8>
 5d5:	00 00 00 
 ...
 60e:	be 4d 00 00 00       	mov    esi,0x4d
 ...
 685:	ba 0c 00 00 00       	mov    edx,0xc
 68a:	be 4c 00 00 00       	mov    esi,0x4c
 ...
 6d5:	b8 15 00 00 00       	mov    eax,0x15
