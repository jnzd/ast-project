  ...
  69:	b8 95 f8 0a 45       	mov    eax,0x450af895
  ...
  9f:	c7 45 d4 bd e6 39 19 	mov    DWORD PTR [rbp-0x2c],0x1939e6bd
  ...
  d6:	be bb 8f 79 1a       	mov    esi,0x1a798fbb
 ...
 140:	ba 48 16 ab 7b       	mov    edx,0x7bab1648
 145:	be 29 06 f3 31       	mov    esi,0x31f30629
 14a:	b8 00 00 00 00       	mov    eax,0x0
 14f:	e8 00 00 00 00       	call   154 <main+0xd0>
 154:	48 83 c4 40          	add    rsp,0x40
 158:	b8 77 b0 23 4e       	mov    eax,0x4e23b077
