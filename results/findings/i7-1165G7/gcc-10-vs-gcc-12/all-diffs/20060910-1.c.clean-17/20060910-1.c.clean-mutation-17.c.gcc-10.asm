  ...
  23:	c7 45 fc 5a 00 00 00 	mov    DWORD PTR [rbp-0x4],0x5a
  ...
  db:	b8 15 00 00 00       	mov    eax,0x15
  e0:	5d                   	pop    rbp
  e1:	c3                   	ret    
