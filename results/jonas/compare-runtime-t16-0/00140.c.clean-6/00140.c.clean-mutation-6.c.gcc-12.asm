  ...
  69:	b8 18 c9 a5 26       	mov    eax,0x26a5c918
  ...
  9f:	c7 45 d4 25 a3 7a 0a 	mov    DWORD PTR [rbp-0x2c],0xa7aa325
  ...
  d6:	be a2 d2 6d 15       	mov    esi,0x156dd2a2
 ...
 140:	ba e1 29 e5 37       	mov    edx,0x37e529e1
 145:	be 49 a3 c6 4c       	mov    esi,0x4cc6a349
 14a:	b8 00 00 00 00       	mov    eax,0x0
 14f:	e8 00 00 00 00       	call   154 <main+0xd0>
 154:	48 83 c4 40          	add    rsp,0x40
 158:	b8 df db bb 4a       	mov    eax,0x4abbdbdf
