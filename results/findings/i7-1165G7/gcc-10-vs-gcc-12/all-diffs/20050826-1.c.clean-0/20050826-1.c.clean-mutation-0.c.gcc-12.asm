  ...
  34:	48 c7 45 f8 1d 00 00 	mov    QWORD PTR [rbp-0x8],0x1d
  3b:	00 
  ...
  49:	48 05 a5 00 00 00    	add    rax,0xa5
  ...
  76:	ba 9e 08 00 00       	mov    edx,0x89e
  7b:	be 0e 00 00 00       	mov    esi,0xe
  80:	48 8d 05 00 00 00 00 	lea    rax,[rip+0x0]        # 87 <foo+0x19>
  87:	48 89 c7             	mov    rdi,rax
  8a:	e8 00 00 00 00       	call   8f <foo+0x21>
  8f:	c6 05 00 00 00 00 08 	mov    BYTE PTR [rip+0x0],0x8        # 96 <foo+0x28>
