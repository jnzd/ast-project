  ...
  5b:	83 7d fc 25          	cmp    DWORD PTR [rbp-0x4],0x25
  ...
  80:	c7 45 fc 48 00 00 00 	mov    DWORD PTR [rbp-0x4],0x48
  ...
  af:	83 7d fc 00          	cmp    DWORD PTR [rbp-0x4],0x0
  b3:	78 d4                	js     89 <main+0x24>
  b5:	b8 3b 00 00 00       	mov    eax,0x3b
  ba:	c9                   	leave  
  bb:	c3                   	ret    
