  ...
  3e:	c7 45 dc 3d 00 00 00 	mov    DWORD PTR [rbp-0x24],0x3d
  45:	c7 45 e0 00 00 00 00 	mov    DWORD PTR [rbp-0x20],0x0
  4c:	8b 0d 00 00 00 00    	mov    ecx,DWORD PTR [rip+0x0]        # 52 <main+0x20>
  52:	b8 4b 00 00 00       	mov    eax,0x4b
  57:	99                   	cdq    
  58:	f7 f9                	idiv   ecx
  ...
  6f:	83 c0 4c             	add    eax,0x4c
  72:	89 45 ec             	mov    DWORD PTR [rbp-0x14],eax
  75:	b8 0c 00 00 00       	mov    eax,0xc
  7a:	99                   	cdq    
  ...
  cd:	6b c0 a2             	imul   eax,eax,0xffffffa2
  ...
  ff:	66 83 7d da 8b       	cmp    WORD PTR [rbp-0x26],0xff8b
 104:	74 05                	je     10b <main+0xd9>
 106:	e8 00 00 00 00       	call   10b <main+0xd9>
 10b:	b8 55 00 00 00       	mov    eax,0x55
 110:	c9                   	leave  
 111:	c3                   	ret    
