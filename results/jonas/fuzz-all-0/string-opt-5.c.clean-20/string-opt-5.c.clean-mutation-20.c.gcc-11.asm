 ...
 2ff:	83 f8 12             	cmp    eax,0x12
 302:	75 0b                	jne    30f <main+0x30f>
 304:	8b 05 00 00 00 00    	mov    eax,DWORD PTR [rip+0x0]        # 30a <main+0x30a>
 30a:	83 f8 26             	cmp    eax,0x26
 30d:	74 05                	je     314 <main+0x314>
 30f:	e8 00 00 00 00       	call   314 <main+0x314>
 314:	c6 45 c2 20          	mov    BYTE PTR [rbp-0x3e],0x20
 318:	c6 45 c0 00          	mov    BYTE PTR [rbp-0x40],0x0
 31c:	c7 05 00 00 00 00 56 	mov    DWORD PTR [rip+0x0],0x56        # 326 <main+0x326>
 323:	00 00 00 
 326:	c7 05 00 00 00 00 70 	mov    DWORD PTR [rip+0x0],0x70        # 330 <main+0x330>
 32d:	00 00 00 
 ...
 353:	48 83 c0 09          	add    rax,0x9
 357:	ba 51 00 00 00       	mov    edx,0x51
 ...
 475:	ba 15 00 00 00       	mov    edx,0x15
 ...
 499:	ba 04 00 00 00       	mov    edx,0x4
 ...
 4c0:	00 00 00 
 4c3:	ba 71 00 00 00       	mov    edx,0x71
 ...
 531:	83 f8 65             	cmp    eax,0x65
 534:	75 22                	jne    558 <main+0x558>
 536:	ba 1d 00 00 00       	mov    edx,0x1d
 ...
 578:	ba 30 00 00 00       	mov    edx,0x30
 ...
 5a1:	ba 1d 00 00 00       	mov    edx,0x1d
 ...
 5c8:	c7 05 00 00 00 00 76 	mov    DWORD PTR [rip+0x0],0x76        # 5d2 <main+0x5d2>
 5cf:	00 00 00 
 ...
 608:	be 4b 00 00 00       	mov    esi,0x4b
 ...
 67f:	ba 51 00 00 00       	mov    edx,0x51
 684:	be 24 00 00 00       	mov    esi,0x24
 ...
 6cf:	b8 6e 00 00 00       	mov    eax,0x6e
