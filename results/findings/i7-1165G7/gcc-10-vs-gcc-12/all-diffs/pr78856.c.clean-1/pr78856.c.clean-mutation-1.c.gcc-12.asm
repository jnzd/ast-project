  ...
  1b:	c7 45 f0 16 00 00 00 	mov    DWORD PTR [rbp-0x10],0x16
  22:	c7 45 f8 21 00 00 00 	mov    DWORD PTR [rbp-0x8],0x21
  29:	e9 8a 00 00 00       	jmp    b8 <main+0xb8>
  2e:	c7 45 fc 32 00 00 00 	mov    DWORD PTR [rbp-0x4],0x32
  35:	c7 45 f4 07 00 00 00 	mov    DWORD PTR [rbp-0xc],0x7
  ...
  52:	c7 04 02 33 00 00 00 	mov    DWORD PTR [rdx+rax*1],0x33
  59:	83 45 f4 01          	add    DWORD PTR [rbp-0xc],0x1
  5d:	83 7d f4 4e          	cmp    DWORD PTR [rbp-0xc],0x4e
  ...
  91:	c7 45 f8 4b 00 00 00 	mov    DWORD PTR [rbp-0x8],0x4b
  ...
  ae:	83 7d fc 6a          	cmp    DWORD PTR [rbp-0x4],0x6a
  b2:	7e b1                	jle    65 <main+0x65>
  b4:	83 45 f0 10          	add    DWORD PTR [rbp-0x10],0x10
  b8:	83 7d f0 1c          	cmp    DWORD PTR [rbp-0x10],0x1c
  bc:	0f 8e 6c ff ff ff    	jle    2e <main+0x2e>
  c2:	bf 31 00 00 00       	mov    edi,0x31
