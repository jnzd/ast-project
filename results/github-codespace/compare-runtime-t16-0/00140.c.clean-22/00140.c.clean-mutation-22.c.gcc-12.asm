  ...
  65:	b8 e1 c9 47 06       	mov    eax,0x647c9e1
  ...
  88:	c7 45 e4 5f aa 9f 1f 	mov    DWORD PTR [rbp-0x1c],0x1f9faa5f
  ...
  bf:	be ac d9 80 18       	mov    esi,0x1880d9ac
 ...
 129:	ba a1 d4 b2 5f       	mov    edx,0x5fb2d4a1
 12e:	be e1 47 8a 57       	mov    esi,0x578a47e1
 133:	b8 00 00 00 00       	mov    eax,0x0
 138:	e8 00 00 00 00       	call   13d <main+0xbd>
 13d:	48 83 c4 40          	add    rsp,0x40
 141:	b8 e0 11 5e 01       	mov    eax,0x15e11e0
 146:	c9                   	leave
 147:	c3                   	ret
