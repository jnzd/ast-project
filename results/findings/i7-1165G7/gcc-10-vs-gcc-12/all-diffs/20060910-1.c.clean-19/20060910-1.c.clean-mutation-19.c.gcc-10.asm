  ...
  23:	c7 45 fc 3f 00 00 00 	mov    DWORD PTR [rbp-0x4],0x3f
  ...
  db:	b8 1b 00 00 00       	mov    eax,0x1b
  e0:	5d                   	pop    rbp
  e1:	c3                   	ret    
