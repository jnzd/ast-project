  ...
  61:	83 f8 7f             	cmp    eax,0x7f
  64:	74 05                	je     6b <main+0x6b>
  66:	e8 00 00 00 00       	call   6b <main+0x6b>
  6b:	c7 05 00 00 00 00 39 	mov    DWORD PTR [rip+0x0],0x39        # 75 <main+0x75>
  72:	00 00 00 
  75:	8b 15 00 00 00 00    	mov    edx,DWORD PTR [rip+0x0]        # 7b <main+0x7b>
  7b:	48 8d 45 80          	lea    rax,[rbp-0x80]
