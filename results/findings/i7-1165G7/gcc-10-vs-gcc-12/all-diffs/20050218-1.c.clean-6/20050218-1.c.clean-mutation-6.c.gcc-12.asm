  ...
  18:	48 c7 45 f8 2e 00 00 	mov    QWORD PTR [rbp-0x8],0x2e
  1f:	00 
  20:	48 c7 45 f0 55 00 00 	mov    QWORD PTR [rbp-0x10],0x55
  27:	00 
  ...
  7c:	83 f8 3d             	cmp    eax,0x3d
  7f:	74 07                	je     88 <foo+0x88>
  81:	b8 1b 00 00 00       	mov    eax,0x1b
  ...
  d5:	b8 3c 00 00 00       	mov    eax,0x3c
  da:	c9                   	leave  
  db:	c3                   	ret    
  dc:	f3 0f 1e fa          	endbr64 
  e0:	55                   	push   rbp
  e1:	48 89 e5             	mov    rbp,rsp
  e4:	ba 54 00 00 00       	mov    edx,0x54
  e9:	be 27 00 00 00       	mov    esi,0x27
  ee:	48 8d 05 00 00 00 00 	lea    rax,[rip+0x0]        # f5 <main+0x19>
  f5:	48 89 c7             	mov    rdi,rax
  f8:	e8 00 00 00 00       	call   fd <main+0x21>
  fd:	83 f8 31             	cmp    eax,0x31
 100:	74 05                	je     107 <main+0x2b>
 102:	e8 00 00 00 00       	call   107 <main+0x2b>
 107:	b8 43 00 00 00       	mov    eax,0x43
 10c:	5d                   	pop    rbp
 10d:	c3                   	ret    
