  ...
  34:	48 c7 45 f8 24 00 00 	mov    QWORD PTR [rbp-0x8],0x24
  3b:	00 
  ...
  49:	48 05 d2 00 00 00    	add    rax,0xd2
  ...
  76:	ba cb 08 00 00       	mov    edx,0x8cb
  7b:	be 07 00 00 00       	mov    esi,0x7
  80:	48 8d 05 00 00 00 00 	lea    rax,[rip+0x0]        # 87 <foo+0x19>
  87:	48 89 c7             	mov    rdi,rax
  8a:	e8 00 00 00 00       	call   8f <foo+0x21>
  8f:	c6 05 00 00 00 00 01 	mov    BYTE PTR [rip+0x0],0x1        # 96 <foo+0x28>
  ...
  de:	b8 53 00 00 00       	mov    eax,0x53
  e3:	5d                   	pop    rbp
  e4:	c3                   	ret    
