 ...
 300:	83 f8 78             	cmp    eax,0x78
 303:	75 0b                	jne    310 <main+0x310>
 305:	8b 05 00 00 00 00    	mov    eax,DWORD PTR [rip+0x0]        # 30b <main+0x30b>
 30b:	83 f8 77             	cmp    eax,0x77
 30e:	74 05                	je     315 <main+0x315>
 310:	e8 00 00 00 00       	call   315 <main+0x315>
 315:	c6 45 f4 20          	mov    BYTE PTR [rbp-0xc],0x20
 319:	c6 45 2c 00          	mov    BYTE PTR [rbp+0x2c],0x0
 31d:	c7 05 00 00 00 00 13 	mov    DWORD PTR [rip+0x0],0x13        # 327 <main+0x327>
 324:	00 00 00 
 327:	c7 05 00 00 00 00 24 	mov    DWORD PTR [rip+0x0],0x24        # 331 <main+0x331>
 32e:	00 00 00 
 ...
 354:	48 83 c0 5d          	add    rax,0x5d
 358:	ba 3a 00 00 00       	mov    edx,0x3a
 ...
 3aa:	ba 1e 00 00 00       	mov    edx,0x1e
 ...
 460:	ba 1e 00 00 00       	mov    edx,0x1e
 ...
 476:	ba 0f 00 00 00       	mov    edx,0xf
 ...
 49d:	ba 34 00 00 00       	mov    edx,0x34
 ...
 4c4:	00 00 00 
 4c7:	c6 05 00 00 00 00 20 	mov    BYTE PTR [rip+0x0],0x20        # 4ce <main+0x4ce>
 4ce:	8b 05 00 00 00 00    	mov    eax,DWORD PTR [rip+0x0]        # 4d4 <main+0x4d4>
 4d4:	83 c0 01             	add    eax,0x1
 4d7:	89 05 00 00 00 00    	mov    DWORD PTR [rip+0x0],eax        # 4dd <main+0x4dd>
 4dd:	8b 05 00 00 00 00    	mov    eax,DWORD PTR [rip+0x0]        # 4e3 <main+0x4e3>
 4e3:	48 63 d0             	movsxd rdx,eax
 4e6:	8b 05 00 00 00 00    	mov    eax,DWORD PTR [rip+0x0]        # 4ec <main+0x4ec>
 4ec:	8d 48 01             	lea    ecx,[rax+0x1]
 4ef:	89 0d 00 00 00 00    	mov    DWORD PTR [rip+0x0],ecx        # 4f5 <main+0x4f5>
 4f5:	89 c6                	mov    esi,eax
 4f7:	48 8d 05 00 00 00 00 	lea    rax,[rip+0x0]        # 4fe <main+0x4fe>
 4fe:	48 89 c7             	mov    rdi,rax
 501:	e8 00 00 00 00       	call   506 <main+0x506>
 506:	48 8d 15 00 00 00 00 	lea    rdx,[rip+0x0]        # 50d <main+0x50d>
 50d:	48 39 d0             	cmp    rax,rdx
 510:	75 3a                	jne    54c <main+0x54c>
 512:	8b 05 00 00 00 00    	mov    eax,DWORD PTR [rip+0x0]        # 518 <main+0x518>
 518:	3d 9f 00 00 00       	cmp    eax,0x9f
 51d:	75 2d                	jne    54c <main+0x54c>
 51f:	8b 05 00 00 00 00    	mov    eax,DWORD PTR [rip+0x0]        # 525 <main+0x525>
 525:	83 f8 75             	cmp    eax,0x75
 528:	75 22                	jne    54c <main+0x54c>
 52a:	ba 14 00 00 00       	mov    edx,0x14
 52f:	48 8d 05 00 00 00 00 	lea    rax,[rip+0x0]        # 536 <main+0x536>
 536:	48 89 c6             	mov    rsi,rax
 539:	48 8d 05 00 00 00 00 	lea    rax,[rip+0x0]        # 540 <main+0x540>
 540:	48 89 c7             	mov    rdi,rax
 543:	e8 00 00 00 00       	call   548 <main+0x548>
 548:	85 c0                	test   eax,eax
 54a:	74 05                	je     551 <main+0x551>
 54c:	e8 00 00 00 00       	call   551 <main+0x551>
 551:	8b 05 00 00 00 00    	mov    eax,DWORD PTR [rip+0x0]        # 557 <main+0x557>
 557:	8d 50 01             	lea    edx,[rax+0x1]
 55a:	89 15 00 00 00 00    	mov    DWORD PTR [rip+0x0],edx        # 560 <main+0x560>
 560:	48 98                	cdqe   
 562:	48 8d 15 00 00 00 00 	lea    rdx,[rip+0x0]        # 569 <main+0x569>
 569:	48 01 d0             	add    rax,rdx
 56c:	ba 76 00 00 00       	mov    edx,0x76
 571:	be 2d 00 00 00       	mov    esi,0x2d
 576:	48 89 c7             	mov    rdi,rax
 579:	e8 00 00 00 00       	call   57e <main+0x57e>
 57e:	48 8d 15 00 00 00 00 	lea    rdx,[rip+0x0]        # 585 <main+0x585>
 585:	48 39 d0             	cmp    rax,rdx
 588:	75 2d                	jne    5b7 <main+0x5b7>
 58a:	8b 05 00 00 00 00    	mov    eax,DWORD PTR [rip+0x0]        # 590 <main+0x590>
 590:	83 f8 55             	cmp    eax,0x55
 593:	75 22                	jne    5b7 <main+0x5b7>
 595:	ba 30 00 00 00       	mov    edx,0x30
 59a:	48 8d 05 00 00 00 00 	lea    rax,[rip+0x0]        # 5a1 <main+0x5a1>
 5a1:	48 89 c6             	mov    rsi,rax
 5a4:	48 8d 05 00 00 00 00 	lea    rax,[rip+0x0]        # 5ab <main+0x5ab>
 5ab:	48 89 c7             	mov    rdi,rax
 5ae:	e8 00 00 00 00       	call   5b3 <main+0x5b3>
 5b3:	85 c0                	test   eax,eax
 5b5:	74 05                	je     5bc <main+0x5bc>
 5b7:	e8 00 00 00 00       	call   5bc <main+0x5bc>
 5bc:	c7 05 00 00 00 00 27 	mov    DWORD PTR [rip+0x0],0x27        # 5c6 <main+0x5c6>
 5c3:	00 00 00 
 5c6:	8b 05 00 00 00 00    	mov    eax,DWORD PTR [rip+0x0]        # 5cc <main+0x5cc>
 5cc:	8d 50 01             	lea    edx,[rax+0x1]
 5cf:	89 15 00 00 00 00    	mov    DWORD PTR [rip+0x0],edx        # 5d5 <main+0x5d5>
 5d5:	48 98                	cdqe   
 5d7:	8b 15 00 00 00 00    	mov    edx,DWORD PTR [rip+0x0]        # 5dd <main+0x5dd>
 5dd:	83 c2 01             	add    edx,0x1
 ...
 5ec:	48 63 d2             	movsxd rdx,edx
 5ef:	48 8d 0d 00 00 00 00 	lea    rcx,[rip+0x0]        # 5f6 <main+0x5f6>
 5f6:	48 01 d1             	add    rcx,rdx
 5f9:	48 89 c2             	mov    rdx,rax
 5fc:	be 55 00 00 00       	mov    esi,0x55
 601:	48 89 cf             	mov    rdi,rcx
 604:	e8 00 00 00 00       	call   609 <main+0x609>
 609:	48 8d 15 00 00 00 00 	lea    rdx,[rip+0x0]        # 610 <main+0x610>
 610:	48 39 d0             	cmp    rax,rdx
 613:	75 38                	jne    64d <main+0x64d>
 615:	8b 05 00 00 00 00    	mov    eax,DWORD PTR [rip+0x0]        # 61b <main+0x61b>
 61b:	83 f8 03             	cmp    eax,0x3
 61e:	75 2d                	jne    64d <main+0x64d>
 620:	8b 05 00 00 00 00    	mov    eax,DWORD PTR [rip+0x0]        # 626 <main+0x626>
 626:	83 f8 08             	cmp    eax,0x8
 629:	75 22                	jne    64d <main+0x64d>
 62b:	48 8d 05 00 00 00 00 	lea    rax,[rip+0x0]        # 632 <main+0x632>
 632:	ba 31 00 00 00       	mov    edx,0x31
 637:	48 8d 0d 00 00 00 00 	lea    rcx,[rip+0x0]        # 63e <main+0x63e>
 63e:	48 89 ce             	mov    rsi,rcx
 641:	48 89 c7             	mov    rdi,rax
 644:	e8 00 00 00 00       	call   649 <main+0x649>
 649:	85 c0                	test   eax,eax
 64b:	74 05                	je     652 <main+0x652>
 64d:	e8 00 00 00 00       	call   652 <main+0x652>
 652:	8b 05 00 00 00 00    	mov    eax,DWORD PTR [rip+0x0]        # 658 <main+0x658>
 658:	83 c0 3c             	add    eax,0x3c
 65b:	89 05 00 00 00 00    	mov    DWORD PTR [rip+0x0],eax        # 661 <main+0x661>
 661:	8b 05 00 00 00 00    	mov    eax,DWORD PTR [rip+0x0]        # 667 <main+0x667>
 667:	48 98                	cdqe   
 669:	48 8d 15 00 00 00 00 	lea    rdx,[rip+0x0]        # 670 <main+0x670>
 670:	48 01 d0             	add    rax,rdx
 673:	ba 77 00 00 00       	mov    edx,0x77
 678:	be 7f 00 00 00       	mov    esi,0x7f
 67d:	48 89 c7             	mov    rdi,rax
 680:	e8 00 00 00 00       	call   685 <main+0x685>
 685:	48 8d 15 00 00 00 00 	lea    rdx,[rip+0x0]        # 68c <main+0x68c>
 68c:	48 39 d0             	cmp    rax,rdx
 68f:	75 2d                	jne    6be <main+0x6be>
 691:	8b 05 00 00 00 00    	mov    eax,DWORD PTR [rip+0x0]        # 697 <main+0x697>
 697:	83 f8 7e             	cmp    eax,0x7e
 69a:	75 22                	jne    6be <main+0x6be>
 69c:	48 8d 05 00 00 00 00 	lea    rax,[rip+0x0]        # 6a3 <main+0x6a3>
 6a3:	ba 43 00 00 00       	mov    edx,0x43
 6a8:	48 8d 0d 00 00 00 00 	lea    rcx,[rip+0x0]        # 6af <main+0x6af>
 6af:	48 89 ce             	mov    rsi,rcx
 6b2:	48 89 c7             	mov    rdi,rax
 6b5:	e8 00 00 00 00       	call   6ba <main+0x6ba>
 6ba:	85 c0                	test   eax,eax
 6bc:	74 05                	je     6c3 <main+0x6c3>
 6be:	e8 00 00 00 00       	call   6c3 <main+0x6c3>
 6c3:	b8 42 00 00 00       	mov    eax,0x42
 6c8:	48 8b 55 e8          	mov    rdx,QWORD PTR [rbp-0x18]
 6cc:	64 48 2b 14 25 28 00 	sub    rdx,QWORD PTR fs:0x28
 6d3:	00 00 
 6d5:	74 05                	je     6dc <main+0x6dc>
 6d7:	e8 00 00 00 00       	call   6dc <main+0x6dc>
 6dc:	48 8b 5d f8          	mov    rbx,QWORD PTR [rbp-0x8]
 6e0:	c9                   	leave  
 6e1:	c3                   	ret    
