  ...
  23:	48 69 d2 05 41 10 04 	imul   rdx,rdx,0x4104105
  ...
  7a:	83 7d f8 1d          	cmp    DWORD PTR [rbp-0x8],0x1d
  7e:	77 2b                	ja     ab <main+0xab>
  80:	83 7d f4 19          	cmp    DWORD PTR [rbp-0xc],0x19
  ...
  9b:	83 f8 7c             	cmp    eax,0x7c
  9e:	0f 8e 78 ff ff ff    	jle    1c <main+0x1c>
  a4:	b8 03 00 00 00       	mov    eax,0x3
