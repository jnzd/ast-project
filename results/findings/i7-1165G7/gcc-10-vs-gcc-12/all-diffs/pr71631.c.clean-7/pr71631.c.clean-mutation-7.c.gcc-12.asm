  ...
  3e:	c7 45 dc 00 00 00 00 	mov    DWORD PTR [rbp-0x24],0x0
  45:	c7 45 e0 23 00 00 00 	mov    DWORD PTR [rbp-0x20],0x23
  4c:	8b 0d 00 00 00 00    	mov    ecx,DWORD PTR [rip+0x0]        # 52 <main+0x20>
  52:	b8 74 00 00 00       	mov    eax,0x74
  57:	99                   	cdq    
  58:	f7 f9                	idiv   ecx
  ...
  6f:	83 c0 59             	add    eax,0x59
  72:	89 45 ec             	mov    DWORD PTR [rbp-0x14],eax
  75:	b8 41 00 00 00       	mov    eax,0x41
  7a:	99                   	cdq    
  ...
  cd:	6b c0 de             	imul   eax,eax,0xffffffde
  ...
  ea:	83 7d f0 0c          	cmp    DWORD PTR [rbp-0x10],0xc
  ...
  ff:	66 83 7d da 8d       	cmp    WORD PTR [rbp-0x26],0xff8d
 104:	74 05                	je     10b <main+0xd9>
 106:	e8 00 00 00 00       	call   10b <main+0xd9>
 10b:	b8 60 00 00 00       	mov    eax,0x60
 110:	c9                   	leave  
 111:	c3                   	ret    
