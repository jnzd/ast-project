  ...
  69:	b8 24 7a 8f 41       	mov    eax,0x418f7a24
  ...
  9f:	c7 45 d4 04 21 cc 10 	mov    DWORD PTR [rbp-0x2c],0x10cc2104
  ...
  d6:	be cf 72 9f 41       	mov    esi,0x419f72cf
 ...
 140:	ba 46 91 7b 4c       	mov    edx,0x4c7b9146
 145:	be 71 14 57 1e       	mov    esi,0x1e571471
 14a:	b8 00 00 00 00       	mov    eax,0x0
 14f:	e8 00 00 00 00       	call   154 <main+0xd0>
 154:	48 83 c4 40          	add    rsp,0x40
 158:	b8 25 51 4b 02       	mov    eax,0x24b5125
