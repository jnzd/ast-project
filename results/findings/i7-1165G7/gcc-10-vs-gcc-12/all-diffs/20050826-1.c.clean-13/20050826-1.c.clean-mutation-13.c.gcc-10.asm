  ...
  31:	48 c7 45 f8 2c 00 00 	mov    QWORD PTR [rbp-0x8],0x2c
  38:	00 
  ...
  46:	48 05 96 00 00 00    	add    rax,0x96
  ...
  73:	ba 8f 08 00 00       	mov    edx,0x88f
  78:	be 30 00 00 00       	mov    esi,0x30
  7d:	48 8d 3d 00 00 00 00 	lea    rdi,[rip+0x0]        # 84 <foo+0x19>
  84:	e8 00 00 00 00       	call   89 <foo+0x1e>
  89:	c6 05 00 00 00 00 36 	mov    BYTE PTR [rip+0x0],0x36        # 90 <foo+0x25>
  ...
  a8:	c6 05 00 00 00 00 7f 	mov    BYTE PTR [rip+0x0],0x7f        # af <foo+0x44>
  af:	48 8d 3d 00 00 00 00 	lea    rdi,[rip+0x0]        # b6 <foo+0x4b>
  b6:	e8 00 00 00 00       	call   bb <foo+0x50>
  bb:	b8 5b 00 00 00       	mov    eax,0x5b
  c0:	5d                   	pop    rbp
  c1:	c3                   	ret    
  ...
  cf:	b8 3f 00 00 00       	mov    eax,0x3f
  d4:	5d                   	pop    rbp
  d5:	c3                   	ret    
