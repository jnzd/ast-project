  ...
  9b:	00 
  9c:	48 c7 45 e8 00 00 00 	mov    QWORD PTR [rbp-0x18],0x0
  a3:	00 
  a4:	c6 45 f0 00          	mov    BYTE PTR [rbp-0x10],0x0
  a8:	90                   	nop
  a9:	48 8b 45 f8          	mov    rax,QWORD PTR [rbp-0x8]
  ad:	64 48 2b 04 25 28 00 	sub    rax,QWORD PTR fs:0x28
  b4:	00 00 
  b6:	74 05                	je     bd <foo+0xbd>
  b8:	e8 00 00 00 00       	call   bd <foo+0xbd>
  bd:	c9                   	leave  
  be:	c3                   	ret    
  ...
  cb:	e8 30 ff ff ff       	call   0 <foo>
  d0:	c7 45 fc 64 00 00 00 	mov    DWORD PTR [rbp-0x4],0x64
  d7:	bf 17 00 00 00       	mov    edi,0x17
  dc:	e8 00 00 00 00       	call   e1 <main+0x22>
