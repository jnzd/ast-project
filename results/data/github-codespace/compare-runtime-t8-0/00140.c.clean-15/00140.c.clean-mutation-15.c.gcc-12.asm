  ...
  65:	b8 27 7c 7a 13       	mov    eax,0x137a7c27
  ...
  88:	c7 45 e4 82 06 54 2b 	mov    DWORD PTR [rbp-0x1c],0x2b540682
  ...
  bf:	be b7 2a b2 13       	mov    esi,0x13b22ab7
 ...
 129:	ba 25 96 d3 08       	mov    edx,0x8d39625
 12e:	be 3a f9 8c 48       	mov    esi,0x488cf93a
 133:	b8 00 00 00 00       	mov    eax,0x0
 138:	e8 00 00 00 00       	call   13d <main+0xbd>
 13d:	48 83 c4 40          	add    rsp,0x40
 141:	b8 38 a6 6b 44       	mov    eax,0x446ba638
 146:	c9                   	leave
 147:	c3                   	ret
