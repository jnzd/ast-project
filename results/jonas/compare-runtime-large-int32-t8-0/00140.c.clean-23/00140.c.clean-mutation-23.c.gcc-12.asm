  ...
  69:	b8 7c 26 dc 05       	mov    eax,0x5dc267c
  ...
  9f:	c7 45 d4 cc 47 9a 12 	mov    DWORD PTR [rbp-0x2c],0x129a47cc
  ...
  d6:	be 9a 96 ae 68       	mov    esi,0x68ae969a
 ...
 140:	ba 43 68 2b 74       	mov    edx,0x742b6843
 145:	be 0d d2 00 11       	mov    esi,0x1100d20d
 14a:	b8 00 00 00 00       	mov    eax,0x0
 14f:	e8 00 00 00 00       	call   154 <main+0xd0>
 154:	48 83 c4 40          	add    rsp,0x40
 158:	b8 f8 66 0b 29       	mov    eax,0x290b66f8
