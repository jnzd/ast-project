  ...
  69:	b8 ce a4 fe 79       	mov    eax,0x79fea4ce
  ...
  9f:	c7 45 d4 57 84 d4 31 	mov    DWORD PTR [rbp-0x2c],0x31d48457
  ...
  d6:	be 90 da 48 34       	mov    esi,0x3448da90
 ...
 140:	ba c2 fe 7a 12       	mov    edx,0x127afec2
 145:	be 38 16 d1 33       	mov    esi,0x33d11638
 14a:	b8 00 00 00 00       	mov    eax,0x0
 14f:	e8 00 00 00 00       	call   154 <main+0xd0>
 154:	48 83 c4 40          	add    rsp,0x40
 158:	b8 d9 29 55 78       	mov    eax,0x785529d9
