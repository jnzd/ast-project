  ...
  65:	b8 af b7 6e 16       	mov    eax,0x166eb7af
  ...
  88:	c7 45 e4 af 94 08 28 	mov    DWORD PTR [rbp-0x1c],0x280894af
  ...
  bf:	be 4e 52 a9 38       	mov    esi,0x38a9524e
 ...
 129:	ba 9a de cb 59       	mov    edx,0x59cbde9a
 12e:	be 53 d7 29 31       	mov    esi,0x3129d753
 133:	b8 00 00 00 00       	mov    eax,0x0
 138:	e8 00 00 00 00       	call   13d <main+0xbd>
 13d:	48 83 c4 40          	add    rsp,0x40
 141:	b8 71 9f 57 37       	mov    eax,0x37579f71
 146:	c9                   	leave
 147:	c3                   	ret
