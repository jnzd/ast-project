  ...
  1b:	c7 45 f0 7a 00 00 00 	mov    DWORD PTR [rbp-0x10],0x7a
  22:	c7 45 f8 03 00 00 00 	mov    DWORD PTR [rbp-0x8],0x3
  29:	e9 8a 00 00 00       	jmp    b8 <main+0xb8>
  2e:	c7 45 fc 41 00 00 00 	mov    DWORD PTR [rbp-0x4],0x41
  35:	c7 45 f4 12 00 00 00 	mov    DWORD PTR [rbp-0xc],0x12
  ...
  52:	c7 04 02 7c 00 00 00 	mov    DWORD PTR [rdx+rax*1],0x7c
  59:	83 45 f4 01          	add    DWORD PTR [rbp-0xc],0x1
  5d:	83 7d f4 59          	cmp    DWORD PTR [rbp-0xc],0x59
  ...
  91:	c7 45 f8 03 00 00 00 	mov    DWORD PTR [rbp-0x8],0x3
  ...
  ae:	83 7d fc 62          	cmp    DWORD PTR [rbp-0x4],0x62
  b2:	7e b1                	jle    65 <main+0x65>
  b4:	83 45 f0 24          	add    DWORD PTR [rbp-0x10],0x24
  b8:	83 7d f0 5e          	cmp    DWORD PTR [rbp-0x10],0x5e
  bc:	0f 8e 6c ff ff ff    	jle    2e <main+0x2e>
  c2:	bf 21 00 00 00       	mov    edi,0x21
