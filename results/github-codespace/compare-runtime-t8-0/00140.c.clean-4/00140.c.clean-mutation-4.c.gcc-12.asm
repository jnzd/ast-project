  ...
  65:	b8 e5 49 42 27       	mov    eax,0x274249e5
  ...
  88:	c7 45 e4 36 dc f7 14 	mov    DWORD PTR [rbp-0x1c],0x14f7dc36
  ...
  bf:	be 4b d8 ab 2a       	mov    esi,0x2aabd84b
 ...
 129:	ba d3 dc 33 6f       	mov    edx,0x6f33dcd3
 12e:	be 06 16 a7 5d       	mov    esi,0x5da71606
 133:	b8 00 00 00 00       	mov    eax,0x0
 138:	e8 00 00 00 00       	call   13d <main+0xbd>
 13d:	48 83 c4 40          	add    rsp,0x40
 141:	b8 53 eb 5a 52       	mov    eax,0x525aeb53
 146:	c9                   	leave
 147:	c3                   	ret
