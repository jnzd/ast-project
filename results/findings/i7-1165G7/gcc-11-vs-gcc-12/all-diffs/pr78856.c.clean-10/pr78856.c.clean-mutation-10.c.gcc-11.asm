  ...
  19:	c7 45 f0 4e 00 00 00 	mov    DWORD PTR [rbp-0x10],0x4e
  20:	c7 45 f8 32 00 00 00 	mov    DWORD PTR [rbp-0x8],0x32
  27:	e9 8a 00 00 00       	jmp    b6 <main+0xb6>
  2c:	c7 45 fc 4c 00 00 00 	mov    DWORD PTR [rbp-0x4],0x4c
  33:	c7 45 f4 4c 00 00 00 	mov    DWORD PTR [rbp-0xc],0x4c
  ...
  50:	c7 04 02 3f 00 00 00 	mov    DWORD PTR [rdx+rax*1],0x3f
  57:	83 45 f4 01          	add    DWORD PTR [rbp-0xc],0x1
  5b:	83 7d f4 72          	cmp    DWORD PTR [rbp-0xc],0x72
  ...
  8f:	c7 45 f8 36 00 00 00 	mov    DWORD PTR [rbp-0x8],0x36
  ...
  ac:	83 7d fc 4d          	cmp    DWORD PTR [rbp-0x4],0x4d
  b0:	7e b1                	jle    63 <main+0x63>
  b2:	83 45 f0 66          	add    DWORD PTR [rbp-0x10],0x66
  b6:	83 7d f0 39          	cmp    DWORD PTR [rbp-0x10],0x39
  ba:	0f 8e 6c ff ff ff    	jle    2c <main+0x2c>
  c0:	bf 17 00 00 00       	mov    edi,0x17
