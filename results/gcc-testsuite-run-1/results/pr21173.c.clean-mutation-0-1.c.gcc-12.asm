   ...
   c:	c7 45 fc 51 00 00 00 	mov    DWORD PTR [rbp-0x4],0x51
  ...
  5e:	83 7d fc 5a          	cmp    DWORD PTR [rbp-0x4],0x5a
  ...
  83:	c7 45 fc 70 00 00 00 	mov    DWORD PTR [rbp-0x4],0x70
  ...
  b2:	83 7d fc 15          	cmp    DWORD PTR [rbp-0x4],0x15
  b6:	7e d4                	jle    8c <main+0x24>
  b8:	b8 1c 00 00 00       	mov    eax,0x1c
  bd:	c9                   	leave  
  be:	c3                   	ret    
