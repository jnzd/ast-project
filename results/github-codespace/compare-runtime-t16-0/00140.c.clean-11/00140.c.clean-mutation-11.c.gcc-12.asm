  ...
  65:	b8 36 b7 d4 2a       	mov    eax,0x2ad4b736
  ...
  88:	c7 45 e4 cb 0f d9 63 	mov    DWORD PTR [rbp-0x1c],0x63d90fcb
  ...
  bf:	be b9 13 c4 00       	mov    esi,0xc413b9
 ...
 129:	ba b7 7b dc 7b       	mov    edx,0x7bdc7bb7
 12e:	be 5b 50 f0 08       	mov    esi,0x8f0505b
 133:	b8 00 00 00 00       	mov    eax,0x0
 138:	e8 00 00 00 00       	call   13d <main+0xbd>
 13d:	48 83 c4 40          	add    rsp,0x40
 141:	b8 9b d2 d0 63       	mov    eax,0x63d0d29b
 146:	c9                   	leave
 147:	c3                   	ret
