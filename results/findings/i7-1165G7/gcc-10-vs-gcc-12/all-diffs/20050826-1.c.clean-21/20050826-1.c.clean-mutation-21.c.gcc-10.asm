  ...
  31:	48 c7 45 f8 1f 00 00 	mov    QWORD PTR [rbp-0x8],0x1f
  38:	00 
  ...
  71:	ba 29 08 00 00       	mov    edx,0x829
  76:	be 25 00 00 00       	mov    esi,0x25
  7b:	48 8d 3d 00 00 00 00 	lea    rdi,[rip+0x0]        # 82 <foo+0x19>
  82:	e8 00 00 00 00       	call   87 <foo+0x1e>
  87:	c6 05 00 00 00 00 12 	mov    BYTE PTR [rip+0x0],0x12        # 8e <foo+0x25>
  ...
  a6:	c6 05 00 00 00 00 69 	mov    BYTE PTR [rip+0x0],0x69        # ad <foo+0x44>
  ad:	48 8d 3d 00 00 00 00 	lea    rdi,[rip+0x0]        # b4 <foo+0x4b>
  b4:	e8 00 00 00 00       	call   b9 <foo+0x50>
  b9:	b8 02 00 00 00       	mov    eax,0x2
  be:	5d                   	pop    rbp
  bf:	c3                   	ret    
  ...
  cd:	b8 29 00 00 00       	mov    eax,0x29
  d2:	5d                   	pop    rbp
  d3:	c3                   	ret    
