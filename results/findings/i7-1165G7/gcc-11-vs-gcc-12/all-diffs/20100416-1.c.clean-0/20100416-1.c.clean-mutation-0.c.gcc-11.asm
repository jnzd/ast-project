  ...
  12:	c7 45 fc 64 00 00 00 	mov    DWORD PTR [rbp-0x4],0x64
  19:	c7 45 f8 2e 00 00 00 	mov    DWORD PTR [rbp-0x8],0x2e
  ...
  5d:	c7 45 fc 5e 00 00 00 	mov    DWORD PTR [rbp-0x4],0x5e
  ...
  80:	be 61 00 00 00       	mov    esi,0x61
  85:	bf dd ff ff ff       	mov    edi,0xffffffdd
  ...
  bb:	b8 62 00 00 00       	mov    eax,0x62
  c0:	c9                   	leave  
  c1:	c3                   	ret    
