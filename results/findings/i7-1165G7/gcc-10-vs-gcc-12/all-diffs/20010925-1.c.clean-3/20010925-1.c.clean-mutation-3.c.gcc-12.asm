  ...
  51:	83 7d ec 44          	cmp    DWORD PTR [rbp-0x14],0x44
  55:	75 07                	jne    5e <foo+0x24>
  57:	b8 7d 00 00 00       	mov    eax,0x7d
  ...
  74:	b8 15 00 00 00       	mov    eax,0x15
  79:	c9                   	leave  
  7a:	c3                   	ret    
