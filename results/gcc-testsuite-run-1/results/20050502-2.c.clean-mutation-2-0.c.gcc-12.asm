   ...
   c:	c7 45 fc 45 00 00 00 	mov    DWORD PTR [rbp-0x4],0x45
  13:	eb 04                	jmp    19 <foo+0x19>
  15:	83 45 fc 01          	add    DWORD PTR [rbp-0x4],0x1
  19:	83 7d fc 0c          	cmp    DWORD PTR [rbp-0x4],0xc
  ...
  40:	c7 45 fc 6d 00 00 00 	mov    DWORD PTR [rbp-0x4],0x6d
  47:	eb 04                	jmp    4d <bar+0x19>
  49:	83 45 fc 01          	add    DWORD PTR [rbp-0x4],0x1
  4d:	83 7d fc 4c          	cmp    DWORD PTR [rbp-0x4],0x4c
  ...
  c0:	83 f8 32             	cmp    eax,0x32
  c3:	74 05                	je     ca <main+0x61>
  c5:	e8 00 00 00 00       	call   ca <main+0x61>
  ca:	c6 45 5e 4d          	mov    BYTE PTR [rbp+0x5e],0x4d
