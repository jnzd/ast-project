  ...
  1b:	c7 45 f0 52 00 00 00 	mov    DWORD PTR [rbp-0x10],0x52
  22:	c7 45 f8 52 00 00 00 	mov    DWORD PTR [rbp-0x8],0x52
  29:	e9 8a 00 00 00       	jmp    b8 <main+0xb8>
  2e:	c7 45 fc 40 00 00 00 	mov    DWORD PTR [rbp-0x4],0x40
  35:	c7 45 f4 2b 00 00 00 	mov    DWORD PTR [rbp-0xc],0x2b
  ...
  52:	c7 04 02 03 00 00 00 	mov    DWORD PTR [rdx+rax*1],0x3
  59:	83 45 f4 01          	add    DWORD PTR [rbp-0xc],0x1
  5d:	83 7d f4 49          	cmp    DWORD PTR [rbp-0xc],0x49
  ...
  91:	c7 45 f8 62 00 00 00 	mov    DWORD PTR [rbp-0x8],0x62
  ...
  ae:	83 7d fc 52          	cmp    DWORD PTR [rbp-0x4],0x52
  b2:	7e b1                	jle    65 <main+0x65>
  b4:	83 45 f0 5a          	add    DWORD PTR [rbp-0x10],0x5a
  b8:	83 7d f0 41          	cmp    DWORD PTR [rbp-0x10],0x41
  bc:	0f 8e 6c ff ff ff    	jle    2e <main+0x2e>
  c2:	bf 38 00 00 00       	mov    edi,0x38
