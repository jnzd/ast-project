  ...
  69:	b8 fa 77 1e 65       	mov    eax,0x651e77fa
  ...
  9f:	c7 45 d4 2b 4f aa 26 	mov    DWORD PTR [rbp-0x2c],0x26aa4f2b
  ...
  d6:	be 32 19 58 18       	mov    esi,0x18581932
 ...
 140:	ba 8a 42 31 51       	mov    edx,0x5131428a
 145:	be 55 83 e6 2e       	mov    esi,0x2ee68355
 14a:	b8 00 00 00 00       	mov    eax,0x0
 14f:	e8 00 00 00 00       	call   154 <main+0xd0>
 154:	48 83 c4 40          	add    rsp,0x40
 158:	b8 a8 a1 87 25       	mov    eax,0x2587a1a8
