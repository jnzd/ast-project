 ...
 2ff:	83 f8 5d             	cmp    eax,0x5d
 302:	75 0b                	jne    30f <main+0x30f>
 304:	8b 05 00 00 00 00    	mov    eax,DWORD PTR [rip+0x0]        # 30a <main+0x30a>
 30a:	83 f8 6e             	cmp    eax,0x6e
 30d:	74 05                	je     314 <main+0x314>
 30f:	e8 00 00 00 00       	call   314 <main+0x314>
 314:	c6 45 d6 20          	mov    BYTE PTR [rbp-0x2a],0x20
 318:	c6 45 c7 00          	mov    BYTE PTR [rbp-0x39],0x0
 31c:	c7 05 00 00 00 00 7a 	mov    DWORD PTR [rip+0x0],0x7a        # 326 <main+0x326>
 323:	00 00 00 
 326:	c7 05 00 00 00 00 1c 	mov    DWORD PTR [rip+0x0],0x1c        # 330 <main+0x330>
 32d:	00 00 00 
 ...
 353:	48 83 c0 62          	add    rax,0x62
 357:	ba 61 00 00 00       	mov    edx,0x61
 ...
 3a9:	ba 29 00 00 00       	mov    edx,0x29
 ...
 45f:	ba 29 00 00 00       	mov    edx,0x29
 ...
 475:	ba 2f 00 00 00       	mov    edx,0x2f
 ...
 4c0:	00 00 00 
 4c3:	ba 4b 00 00 00       	mov    edx,0x4b
 ...
 578:	ba 60 00 00 00       	mov    edx,0x60
 ...
 59c:	83 f8 75             	cmp    eax,0x75
 59f:	75 22                	jne    5c3 <main+0x5c3>
 5a1:	ba 1c 00 00 00       	mov    edx,0x1c
 ...
 5c8:	c7 05 00 00 00 00 40 	mov    DWORD PTR [rip+0x0],0x40        # 5d2 <main+0x5d2>
 5cf:	00 00 00 
 ...
 608:	be 40 00 00 00       	mov    esi,0x40
 ...
 67f:	ba 43 00 00 00       	mov    edx,0x43
 684:	be 42 00 00 00       	mov    esi,0x42
 ...
 6af:	ba 29 00 00 00       	mov    edx,0x29
 ...
 6cf:	b8 42 00 00 00       	mov    eax,0x42
