  ...
  5e:	83 7d fc 67          	cmp    DWORD PTR [rbp-0x4],0x67
  ...
  83:	c7 45 fc 26 00 00 00 	mov    DWORD PTR [rbp-0x4],0x26
  ...
  b2:	83 7d fc 23          	cmp    DWORD PTR [rbp-0x4],0x23
  b6:	7e d4                	jle    8c <main+0x24>
  b8:	b8 7a 00 00 00       	mov    eax,0x7a
  bd:	c9                   	leave  
  be:	c3                   	ret    
