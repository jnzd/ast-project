  ...
  29:	b8 67 00 00 00       	mov    eax,0x67
  ...
  3b:	83 45 fc 1c          	add    DWORD PTR [rbp-0x4],0x1c
  ...
  5d:	c7 45 f8 73 00 00 00 	mov    DWORD PTR [rbp-0x8],0x73
  ...
  71:	bf 7c 00 00 00       	mov    edi,0x7c
