  ...
  19:	c7 45 f0 53 00 00 00 	mov    DWORD PTR [rbp-0x10],0x53
  20:	c7 45 f8 40 00 00 00 	mov    DWORD PTR [rbp-0x8],0x40
  27:	e9 8a 00 00 00       	jmp    b6 <main+0xb6>
  2c:	c7 45 fc 64 00 00 00 	mov    DWORD PTR [rbp-0x4],0x64
  33:	c7 45 f4 1f 00 00 00 	mov    DWORD PTR [rbp-0xc],0x1f
  ...
  5b:	83 7d f4 27          	cmp    DWORD PTR [rbp-0xc],0x27
  ...
  8f:	c7 45 f8 12 00 00 00 	mov    DWORD PTR [rbp-0x8],0x12
  ...
  ac:	83 7d fc 0a          	cmp    DWORD PTR [rbp-0x4],0xa
  ...
  c0:	bf 78 00 00 00       	mov    edi,0x78
