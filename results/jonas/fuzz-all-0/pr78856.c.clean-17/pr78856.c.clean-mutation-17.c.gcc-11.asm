  ...
  19:	c7 45 f0 41 00 00 00 	mov    DWORD PTR [rbp-0x10],0x41
  20:	c7 45 f8 11 00 00 00 	mov    DWORD PTR [rbp-0x8],0x11
  27:	e9 8a 00 00 00       	jmp    b6 <main+0xb6>
  2c:	c7 45 fc 61 00 00 00 	mov    DWORD PTR [rbp-0x4],0x61
  33:	c7 45 f4 5c 00 00 00 	mov    DWORD PTR [rbp-0xc],0x5c
  ...
  5b:	83 7d f4 4a          	cmp    DWORD PTR [rbp-0xc],0x4a
  ...
  ac:	83 7d fc 68          	cmp    DWORD PTR [rbp-0x4],0x68
  b0:	7e b1                	jle    63 <main+0x63>
  b2:	83 45 f0 55          	add    DWORD PTR [rbp-0x10],0x55
  b6:	83 7d f0 17          	cmp    DWORD PTR [rbp-0x10],0x17
  ba:	0f 8e 6c ff ff ff    	jle    2c <main+0x2c>
  c0:	bf 3e 00 00 00       	mov    edi,0x3e
