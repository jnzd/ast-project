  ...
  1b:	c7 45 f0 45 00 00 00 	mov    DWORD PTR [rbp-0x10],0x45
  22:	c7 45 f8 43 00 00 00 	mov    DWORD PTR [rbp-0x8],0x43
  29:	e9 8a 00 00 00       	jmp    b8 <main+0xb8>
  2e:	c7 45 fc 1c 00 00 00 	mov    DWORD PTR [rbp-0x4],0x1c
  35:	c7 45 f4 60 00 00 00 	mov    DWORD PTR [rbp-0xc],0x60
  ...
  52:	c7 04 02 52 00 00 00 	mov    DWORD PTR [rdx+rax*1],0x52
  59:	83 45 f4 01          	add    DWORD PTR [rbp-0xc],0x1
  5d:	83 7d f4 31          	cmp    DWORD PTR [rbp-0xc],0x31
  ...
  91:	c7 45 f8 38 00 00 00 	mov    DWORD PTR [rbp-0x8],0x38
  ...
  ae:	83 7d fc 0e          	cmp    DWORD PTR [rbp-0x4],0xe
  b2:	7e b1                	jle    65 <main+0x65>
  b4:	83 45 f0 45          	add    DWORD PTR [rbp-0x10],0x45
  b8:	83 7d f0 23          	cmp    DWORD PTR [rbp-0x10],0x23
  bc:	0f 8e 6c ff ff ff    	jle    2e <main+0x2e>
  c2:	bf 2c 00 00 00       	mov    edi,0x2c
