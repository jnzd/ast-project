  ...
  31:	48 c7 45 f8 10 00 00 	mov    QWORD PTR [rbp-0x8],0x10
  38:	00 
  ...
  46:	48 05 89 00 00 00    	add    rax,0x89
  ...
  73:	ba 82 08 00 00       	mov    edx,0x882
  78:	be 05 00 00 00       	mov    esi,0x5
  7d:	48 8d 3d 00 00 00 00 	lea    rdi,[rip+0x0]        # 84 <foo+0x19>
  84:	e8 00 00 00 00       	call   89 <foo+0x1e>
  89:	c6 05 00 00 00 00 14 	mov    BYTE PTR [rip+0x0],0x14        # 90 <foo+0x25>
  ...
  bb:	b8 3c 00 00 00       	mov    eax,0x3c
  c0:	5d                   	pop    rbp
  c1:	c3                   	ret    
  ...
  cf:	b8 14 00 00 00       	mov    eax,0x14
  d4:	5d                   	pop    rbp
  d5:	c3                   	ret    
