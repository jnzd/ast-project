  ...
  51:	83 7d ec 23          	cmp    DWORD PTR [rbp-0x14],0x23
  55:	75 07                	jne    5e <foo+0x24>
  57:	b8 3d 00 00 00       	mov    eax,0x3d
  ...
  74:	b8 14 00 00 00       	mov    eax,0x14
  79:	c9                   	leave  
  7a:	c3                   	ret    
