  ...
  1b:	c7 45 f0 6a 00 00 00 	mov    DWORD PTR [rbp-0x10],0x6a
  ...
  35:	c7 45 f4 6e 00 00 00 	mov    DWORD PTR [rbp-0xc],0x6e
  ...
  5d:	83 7d f4 33          	cmp    DWORD PTR [rbp-0xc],0x33
  ...
  91:	c7 45 f8 24 00 00 00 	mov    DWORD PTR [rbp-0x8],0x24
  ...
  ae:	83 7d fc 35          	cmp    DWORD PTR [rbp-0x4],0x35
  b2:	7e b1                	jle    65 <main+0x65>
  b4:	83 45 f0 40          	add    DWORD PTR [rbp-0x10],0x40
  b8:	83 7d f0 70          	cmp    DWORD PTR [rbp-0x10],0x70
  bc:	0f 8e 6c ff ff ff    	jle    2e <main+0x2e>
  c2:	bf 65 00 00 00       	mov    edi,0x65
