  ...
  23:	c7 45 fc 18 00 00 00 	mov    DWORD PTR [rbp-0x4],0x18
  ...
  de:	b8 1c 00 00 00       	mov    eax,0x1c
  e3:	5d                   	pop    rbp
  e4:	c3                   	ret    
