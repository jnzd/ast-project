  ...
  12:	c7 45 fc 51 00 00 00 	mov    DWORD PTR [rbp-0x4],0x51
  19:	c7 45 f8 54 00 00 00 	mov    DWORD PTR [rbp-0x8],0x54
  ...
  5d:	c7 45 fc 48 00 00 00 	mov    DWORD PTR [rbp-0x4],0x48
  ...
  80:	be 62 00 00 00       	mov    esi,0x62
  85:	bf d2 ff ff ff       	mov    edi,0xffffffd2
