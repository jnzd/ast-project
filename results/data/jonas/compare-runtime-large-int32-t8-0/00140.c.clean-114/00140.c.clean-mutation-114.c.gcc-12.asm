  ...
  69:	b8 a0 6a d1 2d       	mov    eax,0x2dd16aa0
  ...
  9f:	c7 45 d4 a5 b0 5f 10 	mov    DWORD PTR [rbp-0x2c],0x105fb0a5
  ...
  d6:	be 5b 9e f4 0e       	mov    esi,0xef49e5b
 ...
 140:	ba 5d b6 2a 66       	mov    edx,0x662ab65d
 145:	be d3 2c 60 23       	mov    esi,0x23602cd3
 14a:	b8 00 00 00 00       	mov    eax,0x0
 14f:	e8 00 00 00 00       	call   154 <main+0xd0>
 154:	48 83 c4 40          	add    rsp,0x40
 158:	b8 53 b4 1f 2b       	mov    eax,0x2b1fb453
