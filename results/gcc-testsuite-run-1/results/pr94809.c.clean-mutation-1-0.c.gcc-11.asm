   ...
   c:	c7 45 f4 3d 00 00 00 	mov    DWORD PTR [rbp-0xc],0x3d
  13:	48 c7 45 f8 22 00 00 	mov    QWORD PTR [rbp-0x8],0x22
  1a:	00 
  ...
  2a:	83 7d f4 10          	cmp    DWORD PTR [rbp-0xc],0x10
  2e:	74 05                	je     35 <main+0x35>
  30:	e8 00 00 00 00       	call   35 <main+0x35>
  35:	b8 3f 00 00 00       	mov    eax,0x3f
  3a:	c9                   	leave  
  3b:	c3                   	ret    
