  ...
  6b:	c7 05 00 00 00 00 49 	mov    DWORD PTR [rip+0x0],0x49        # 75 <main+0x75>
  72:	00 00 00 
  ...
  bb:	83 f8 65             	cmp    eax,0x65
  be:	74 05                	je     c5 <main+0xc5>
  c0:	e8 00 00 00 00       	call   c5 <main+0xc5>
  c5:	c7 05 00 00 00 00 32 	mov    DWORD PTR [rip+0x0],0x32        # cf <main+0xcf>
  cc:	00 00 00 
