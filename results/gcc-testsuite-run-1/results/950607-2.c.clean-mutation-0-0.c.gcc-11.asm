  ...
  70:	48 83 7d f8 25       	cmp    QWORD PTR [rbp-0x8],0x25
  75:	7e 07                	jle    7e <f+0x7e>
  77:	b8 7a 00 00 00       	mov    eax,0x7a
  7c:	eb 13                	jmp    91 <f+0x91>
  7e:	48 83 7d f8 0a       	cmp    QWORD PTR [rbp-0x8],0xa
  83:	7f 07                	jg     8c <f+0x8c>
  85:	b8 3a 00 00 00       	mov    eax,0x3a
  8a:	eb 05                	jmp    91 <f+0x91>
  8c:	b8 57 00 00 00       	mov    eax,0x57
  91:	5d                   	pop    rbp
  92:	c3                   	ret    
  ...
  a0:	48 c7 45 c0 89 ff ff 	mov    QWORD PTR [rbp-0x40],0xffffffffffffff89
  a7:	ff 
  a8:	48 c7 45 c8 39 00 00 	mov    QWORD PTR [rbp-0x38],0x39
  af:	00 
  b0:	48 c7 45 d0 28 00 00 	mov    QWORD PTR [rbp-0x30],0x28
  b7:	00 
  b8:	48 c7 45 d8 d9 ff ff 	mov    QWORD PTR [rbp-0x28],0xffffffffffffffd9
  bf:	ff 
  c0:	48 c7 45 e0 a7 ff ff 	mov    QWORD PTR [rbp-0x20],0xffffffffffffffa7
  c7:	ff 
  c8:	48 c7 45 e8 ec ff ff 	mov    QWORD PTR [rbp-0x18],0xffffffffffffffec
  cf:	ff 
  ...
  fc:	83 7d bc 17          	cmp    DWORD PTR [rbp-0x44],0x17
 100:	74 05                	je     107 <main+0x74>
 102:	e8 00 00 00 00       	call   107 <main+0x74>
 107:	bf 75 00 00 00       	mov    edi,0x75
