  ...
  13:	c7 45 f4 22 00 00 00 	mov    DWORD PTR [rbp-0xc],0x22
  1a:	c7 45 f0 67 00 00 00 	mov    DWORD PTR [rbp-0x10],0x67
  ...
  3c:	83 7d fc 09          	cmp    DWORD PTR [rbp-0x4],0x9
  ...
  5b:	c7 45 f4 07 00 00 00 	mov    DWORD PTR [rbp-0xc],0x7
