  ...
  69:	b8 26 d4 a9 61       	mov    eax,0x61a9d426
  ...
  9f:	c7 45 d4 5d f7 d2 0e 	mov    DWORD PTR [rbp-0x2c],0xed2f75d
  ...
  d6:	be 94 b5 b3 66       	mov    esi,0x66b3b594
 ...
 140:	ba 8a b4 37 61       	mov    edx,0x6137b48a
 145:	be 68 16 60 02       	mov    esi,0x2601668
 14a:	b8 00 00 00 00       	mov    eax,0x0
 14f:	e8 00 00 00 00       	call   154 <main+0xd0>
 154:	48 83 c4 40          	add    rsp,0x40
 158:	b8 2c 54 fe 76       	mov    eax,0x76fe542c
