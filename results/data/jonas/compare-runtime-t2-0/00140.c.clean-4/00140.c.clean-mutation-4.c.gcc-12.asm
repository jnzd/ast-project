  ...
  69:	b8 df fa 51 4c       	mov    eax,0x4c51fadf
  ...
  9f:	c7 45 d4 d8 fd 1c 39 	mov    DWORD PTR [rbp-0x2c],0x391cfdd8
  ...
  d6:	be 90 ef f4 23       	mov    esi,0x23f4ef90
 ...
 140:	ba 31 3d ed 1a       	mov    edx,0x1aed3d31
 145:	be ca 3f 24 42       	mov    esi,0x42243fca
 14a:	b8 00 00 00 00       	mov    eax,0x0
 14f:	e8 00 00 00 00       	call   154 <main+0xd0>
 154:	48 83 c4 40          	add    rsp,0x40
 158:	b8 46 6c e4 64       	mov    eax,0x64e46c46
