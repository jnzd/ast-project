  ...
  69:	b8 1a f7 86 60       	mov    eax,0x6086f71a
  ...
  9f:	c7 45 d4 44 f0 5d 00 	mov    DWORD PTR [rbp-0x2c],0x5df044
  ...
  bc:	be 43 d1 71 30       	mov    esi,0x3071d143
