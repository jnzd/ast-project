  ...
  69:	b8 37 e4 b6 0e       	mov    eax,0xeb6e437
  ...
  9f:	c7 45 d4 45 e1 09 0f 	mov    DWORD PTR [rbp-0x2c],0xf09e145
  ...
  bc:	be 43 a6 0a 42       	mov    esi,0x420aa643
