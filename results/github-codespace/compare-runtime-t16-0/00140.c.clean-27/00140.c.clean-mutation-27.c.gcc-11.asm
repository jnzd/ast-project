  ...
  69:	b8 c7 9a 58 6f       	mov    eax,0x6f589ac7
  ...
  9f:	c7 45 d4 9f 1b 6a 14 	mov    DWORD PTR [rbp-0x2c],0x146a1b9f
  ...
  bc:	be 83 05 c6 46       	mov    esi,0x46c60583
