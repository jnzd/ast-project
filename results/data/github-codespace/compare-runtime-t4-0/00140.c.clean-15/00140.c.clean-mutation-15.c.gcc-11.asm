  ...
  69:	b8 c6 33 2d 6d       	mov    eax,0x6d2d33c6
  ...
  9f:	c7 45 d4 4e c2 bd 48 	mov    DWORD PTR [rbp-0x2c],0x48bdc24e
  ...
  bc:	be 6c d9 1f 2b       	mov    esi,0x2b1fd96c
