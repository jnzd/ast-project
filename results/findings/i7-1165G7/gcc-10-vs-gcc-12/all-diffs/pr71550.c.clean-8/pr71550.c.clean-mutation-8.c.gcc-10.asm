  ...
  40:	c7 45 fc 5e 00 00 00 	mov    DWORD PTR [rbp-0x4],0x5e
  ...
  86:	83 7d fc 34          	cmp    DWORD PTR [rbp-0x4],0x34
  8a:	7e bd                	jle    49 <main+0x49>
  8c:	c7 45 fc 7e 00 00 00 	mov    DWORD PTR [rbp-0x4],0x7e
  93:	eb 04                	jmp    99 <main+0x99>
  95:	83 45 fc 01          	add    DWORD PTR [rbp-0x4],0x1
  99:	83 7d fc 26          	cmp    DWORD PTR [rbp-0x4],0x26
