  ...
  12:	c7 45 fc 56 00 00 00 	mov    DWORD PTR [rbp-0x4],0x56
  19:	c7 45 f8 4a 00 00 00 	mov    DWORD PTR [rbp-0x8],0x4a
  ...
  5d:	c7 45 fc 64 00 00 00 	mov    DWORD PTR [rbp-0x4],0x64
  ...
  80:	be 77 00 00 00       	mov    esi,0x77
  85:	bf c5 ff ff ff       	mov    edi,0xffffffc5
  ...
  bc:	b8 1a 00 00 00       	mov    eax,0x1a
  c1:	c9                   	leave  
  c2:	c3                   	ret    
