  ...
  73:	48 83 7d f8 25       	cmp    QWORD PTR [rbp-0x8],0x25
  78:	7e 07                	jle    81 <f+0x81>
  7a:	b8 7a 00 00 00       	mov    eax,0x7a
  7f:	eb 13                	jmp    94 <f+0x94>
  81:	48 83 7d f8 0a       	cmp    QWORD PTR [rbp-0x8],0xa
  86:	7f 07                	jg     8f <f+0x8f>
  88:	b8 3a 00 00 00       	mov    eax,0x3a
  8d:	eb 05                	jmp    94 <f+0x94>
  8f:	b8 57 00 00 00       	mov    eax,0x57
  94:	5d                   	pop    rbp
  95:	c3                   	ret    
  ...
  a3:	48 c7 45 c0 89 ff ff 	mov    QWORD PTR [rbp-0x40],0xffffffffffffff89
  aa:	ff 
  ab:	48 c7 45 c8 39 00 00 	mov    QWORD PTR [rbp-0x38],0x39
  b2:	00 
  b3:	48 c7 45 d0 28 00 00 	mov    QWORD PTR [rbp-0x30],0x28
  ba:	00 
  bb:	48 c7 45 d8 d9 ff ff 	mov    QWORD PTR [rbp-0x28],0xffffffffffffffd9
  c2:	ff 
  c3:	48 c7 45 e0 a7 ff ff 	mov    QWORD PTR [rbp-0x20],0xffffffffffffffa7
  ca:	ff 
  cb:	48 c7 45 e8 ec ff ff 	mov    QWORD PTR [rbp-0x18],0xffffffffffffffec
  d2:	ff 
  ...
  ff:	83 7d bc 17          	cmp    DWORD PTR [rbp-0x44],0x17
 103:	74 05                	je     10a <main+0x74>
 105:	e8 00 00 00 00       	call   10a <main+0x74>
 10a:	bf 75 00 00 00       	mov    edi,0x75
