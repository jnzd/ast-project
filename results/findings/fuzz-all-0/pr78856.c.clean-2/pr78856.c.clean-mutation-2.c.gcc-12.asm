  ...
  22:	c7 45 f8 0c 00 00 00 	mov    DWORD PTR [rbp-0x8],0xc
  29:	e9 8a 00 00 00       	jmp    b8 <main+0xb8>
  2e:	c7 45 fc 1c 00 00 00 	mov    DWORD PTR [rbp-0x4],0x1c
  35:	c7 45 f4 1c 00 00 00 	mov    DWORD PTR [rbp-0xc],0x1c
  ...
  52:	c7 04 02 16 00 00 00 	mov    DWORD PTR [rdx+rax*1],0x16
  59:	83 45 f4 01          	add    DWORD PTR [rbp-0xc],0x1
  5d:	83 7d f4 13          	cmp    DWORD PTR [rbp-0xc],0x13
  ...
  91:	c7 45 f8 0b 00 00 00 	mov    DWORD PTR [rbp-0x8],0xb
  ...
  ae:	83 7d fc 4a          	cmp    DWORD PTR [rbp-0x4],0x4a
  b2:	7e b1                	jle    65 <main+0x65>
  b4:	83 45 f0 23          	add    DWORD PTR [rbp-0x10],0x23
  b8:	83 7d f0 14          	cmp    DWORD PTR [rbp-0x10],0x14
  bc:	0f 8e 6c ff ff ff    	jle    2e <main+0x2e>
  c2:	bf 24 00 00 00       	mov    edi,0x24
