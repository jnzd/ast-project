   ...
   c:	c7 45 fc 2a 00 00 00 	mov    DWORD PTR [rbp-0x4],0x2a
  ...
  5e:	83 7d fc 12          	cmp    DWORD PTR [rbp-0x4],0x12
  ...
  83:	c7 45 fc 6e 00 00 00 	mov    DWORD PTR [rbp-0x4],0x6e
  ...
  b2:	83 7d fc 14          	cmp    DWORD PTR [rbp-0x4],0x14
  b6:	7e d4                	jle    8c <main+0x24>
  b8:	b8 19 00 00 00       	mov    eax,0x19
  bd:	c9                   	leave  
  be:	c3                   	ret    
