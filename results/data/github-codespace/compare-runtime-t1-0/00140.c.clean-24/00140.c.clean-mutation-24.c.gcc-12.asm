  ...
  65:	b8 4b ff ca 3b       	mov    eax,0x3bcaff4b
  ...
  88:	c7 45 e4 b0 3b 0c 07 	mov    DWORD PTR [rbp-0x1c],0x70c3bb0
  ...
  bf:	be d7 6f 18 29       	mov    esi,0x29186fd7
 ...
 129:	ba b2 b1 90 48       	mov    edx,0x4890b1b2
 12e:	be af 94 f3 14       	mov    esi,0x14f394af
 133:	b8 00 00 00 00       	mov    eax,0x0
 138:	e8 00 00 00 00       	call   13d <main+0xbd>
 13d:	48 83 c4 40          	add    rsp,0x40
 141:	b8 cf 8d 2a 3f       	mov    eax,0x3f2a8dcf
 146:	c9                   	leave
 147:	c3                   	ret
