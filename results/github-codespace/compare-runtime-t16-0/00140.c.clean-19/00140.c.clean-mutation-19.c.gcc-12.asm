  ...
  65:	b8 4c a2 0c 42       	mov    eax,0x420ca24c
  ...
  88:	c7 45 e4 f6 74 cd 39 	mov    DWORD PTR [rbp-0x1c],0x39cd74f6
  ...
  bf:	be 32 4c a0 13       	mov    esi,0x13a04c32
 ...
 129:	ba 4c 61 04 6d       	mov    edx,0x6d04614c
 12e:	be 5f 23 22 19       	mov    esi,0x1922235f
 133:	b8 00 00 00 00       	mov    eax,0x0
 138:	e8 00 00 00 00       	call   13d <main+0xbd>
 13d:	48 83 c4 40          	add    rsp,0x40
 141:	b8 e7 a1 c2 11       	mov    eax,0x11c2a1e7
 146:	c9                   	leave
 147:	c3                   	ret
