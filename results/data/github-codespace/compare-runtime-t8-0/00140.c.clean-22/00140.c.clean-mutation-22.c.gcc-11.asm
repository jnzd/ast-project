  ...
  69:	b8 dc ca 22 63       	mov    eax,0x6322cadc
  ...
  9f:	c7 45 d4 0b 3e 55 1e 	mov    DWORD PTR [rbp-0x2c],0x1e553e0b
  ...
  bc:	be dd a2 93 14       	mov    esi,0x1493a2dd
