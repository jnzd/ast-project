  ...
  34:	48 c7 45 f8 5f 00 00 	mov    QWORD PTR [rbp-0x8],0x5f
  3b:	00 
  ...
  49:	48 05 e7 00 00 00    	add    rax,0xe7
  ...
  76:	ba e0 08 00 00       	mov    edx,0x8e0
  7b:	be 3d 00 00 00       	mov    esi,0x3d
  80:	48 8d 05 00 00 00 00 	lea    rax,[rip+0x0]        # 87 <foo+0x19>
  87:	48 89 c7             	mov    rdi,rax
  8a:	e8 00 00 00 00       	call   8f <foo+0x21>
  8f:	c6 05 00 00 00 00 2f 	mov    BYTE PTR [rip+0x0],0x2f        # 96 <foo+0x28>
