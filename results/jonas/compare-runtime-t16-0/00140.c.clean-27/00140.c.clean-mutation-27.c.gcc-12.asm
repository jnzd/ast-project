  ...
  69:	b8 14 01 90 7f       	mov    eax,0x7f900114
  ...
  9f:	c7 45 d4 a5 a8 f1 06 	mov    DWORD PTR [rbp-0x2c],0x6f1a8a5
  ...
  d6:	be 89 de 3e 3c       	mov    esi,0x3c3ede89
 ...
 140:	ba cb ec 5e 66       	mov    edx,0x665eeccb
 145:	be 1d 95 9b 0c       	mov    esi,0xc9b951d
 14a:	b8 00 00 00 00       	mov    eax,0x0
 14f:	e8 00 00 00 00       	call   154 <main+0xd0>
 154:	48 83 c4 40          	add    rsp,0x40
 158:	b8 75 fc 42 55       	mov    eax,0x5542fc75
