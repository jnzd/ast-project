  ...
  65:	b8 f6 44 c8 72       	mov    eax,0x72c844f6
  ...
  88:	c7 45 e4 cc e8 68 00 	mov    DWORD PTR [rbp-0x1c],0x68e8cc
  ...
  bf:	be 37 22 f8 40       	mov    esi,0x40f82237
 ...
 129:	ba ca e8 67 05       	mov    edx,0x567e8ca
 12e:	be 04 ee a6 19       	mov    esi,0x19a6ee04
 133:	b8 00 00 00 00       	mov    eax,0x0
 138:	e8 00 00 00 00       	call   13d <main+0xbd>
 13d:	48 83 c4 40          	add    rsp,0x40
 141:	b8 4f 81 60 4b       	mov    eax,0x4b60814f
 146:	c9                   	leave
 147:	c3                   	ret
