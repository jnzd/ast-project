   ...
   b:	c7 45 f8 86 ff ff ff 	mov    DWORD PTR [rbp-0x8],0xffffff86
  ...
  29:	b8 5e 00 00 00       	mov    eax,0x5e
  ...
  3b:	83 45 fc 7d          	add    DWORD PTR [rbp-0x4],0x7d
  ...
  5d:	c7 45 f8 32 00 00 00 	mov    DWORD PTR [rbp-0x8],0x32
  ...
  71:	bf 6b 00 00 00       	mov    edi,0x6b
