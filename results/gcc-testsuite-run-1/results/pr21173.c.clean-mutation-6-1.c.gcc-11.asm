  ...
  5b:	83 7d fc 15          	cmp    DWORD PTR [rbp-0x4],0x15
  ...
  80:	c7 45 fc 47 00 00 00 	mov    DWORD PTR [rbp-0x4],0x47
  ...
  af:	83 7d fc 08          	cmp    DWORD PTR [rbp-0x4],0x8
  b3:	7e d4                	jle    89 <main+0x24>
  b5:	b8 44 00 00 00       	mov    eax,0x44
  ba:	c9                   	leave  
  bb:	c3                   	ret    
