 ...
 2fc:	83 f8 5b             	cmp    eax,0x5b
 2ff:	75 0b                	jne    30c <main+0x30c>
 301:	8b 05 00 00 00 00    	mov    eax,DWORD PTR [rip+0x0]        # 307 <main+0x307>
 307:	83 f8 57             	cmp    eax,0x57
 30a:	74 05                	je     311 <main+0x311>
 30c:	e8 00 00 00 00       	call   311 <main+0x311>
 311:	c6 45 de 20          	mov    BYTE PTR [rbp-0x22],0x20
 315:	c6 45 df 00          	mov    BYTE PTR [rbp-0x21],0x0
 319:	c7 05 00 00 00 00 22 	mov    DWORD PTR [rip+0x0],0x22        # 323 <main+0x323>
 320:	00 00 00 
 323:	c7 05 00 00 00 00 36 	mov    DWORD PTR [rip+0x0],0x36        # 32d <main+0x32d>
 32a:	00 00 00 
 ...
 350:	48 83 c0 51          	add    rax,0x51
 354:	ba 66 00 00 00       	mov    edx,0x66
 ...
 3a3:	ba 12 00 00 00       	mov    edx,0x12
 ...
 456:	ba 12 00 00 00       	mov    edx,0x12
 ...
 46c:	ba 33 00 00 00       	mov    edx,0x33
 ...
 489:	48 8d 45 d0          	lea    rax,[rbp-0x30]
 48d:	ba 1b 00 00 00       	mov    edx,0x1b
 ...
 4b1:	00 00 00 
 4b4:	ba 3a 00 00 00       	mov    edx,0x3a
 ...
 509:	75 31                	jne    53c <main+0x53c>
 50b:	8b 05 00 00 00 00    	mov    eax,DWORD PTR [rip+0x0]        # 511 <main+0x511>
 511:	83 f8 2f             	cmp    eax,0x2f
 514:	75 26                	jne    53c <main+0x53c>
 516:	8b 05 00 00 00 00    	mov    eax,DWORD PTR [rip+0x0]        # 51c <main+0x51c>
 51c:	85 c0                	test   eax,eax
 51e:	75 1c                	jne    53c <main+0x53c>
 520:	ba 7b 00 00 00       	mov    edx,0x7b
 525:	48 8d 35 00 00 00 00 	lea    rsi,[rip+0x0]        # 52c <main+0x52c>
 52c:	48 8d 3d 00 00 00 00 	lea    rdi,[rip+0x0]        # 533 <main+0x533>
 533:	e8 00 00 00 00       	call   538 <main+0x538>
 538:	85 c0                	test   eax,eax
 53a:	74 05                	je     541 <main+0x541>
 53c:	e8 00 00 00 00       	call   541 <main+0x541>
 541:	8b 05 00 00 00 00    	mov    eax,DWORD PTR [rip+0x0]        # 547 <main+0x547>
 547:	8d 50 01             	lea    edx,[rax+0x1]
 54a:	89 15 00 00 00 00    	mov    DWORD PTR [rip+0x0],edx        # 550 <main+0x550>
 550:	48 98                	cdqe   
 552:	48 8d 15 00 00 00 00 	lea    rdx,[rip+0x0]        # 559 <main+0x559>
 559:	48 01 d0             	add    rax,rdx
 55c:	ba 7c 00 00 00       	mov    edx,0x7c
 561:	be 2d 00 00 00       	mov    esi,0x2d
 566:	48 89 c7             	mov    rdi,rax
 569:	e8 00 00 00 00       	call   56e <main+0x56e>
 56e:	48 8d 15 00 00 00 00 	lea    rdx,[rip+0x0]        # 575 <main+0x575>
 575:	48 39 d0             	cmp    rax,rdx
 578:	75 27                	jne    5a1 <main+0x5a1>
 57a:	8b 05 00 00 00 00    	mov    eax,DWORD PTR [rip+0x0]        # 580 <main+0x580>
 580:	83 f8 47             	cmp    eax,0x47
 583:	75 1c                	jne    5a1 <main+0x5a1>
 585:	ba 13 00 00 00       	mov    edx,0x13
 58a:	48 8d 35 00 00 00 00 	lea    rsi,[rip+0x0]        # 591 <main+0x591>
 591:	48 8d 3d 00 00 00 00 	lea    rdi,[rip+0x0]        # 598 <main+0x598>
 ...
 5a6:	c7 05 00 00 00 00 25 	mov    DWORD PTR [rip+0x0],0x25        # 5b0 <main+0x5b0>
 5ad:	00 00 00 
 ...
 5e6:	be 42 00 00 00       	mov    esi,0x42
 ...
 5fd:	75 35                	jne    634 <main+0x634>
 5ff:	8b 05 00 00 00 00    	mov    eax,DWORD PTR [rip+0x0]        # 605 <main+0x605>
 605:	83 f8 4b             	cmp    eax,0x4b
 608:	75 2a                	jne    634 <main+0x634>
 60a:	8b 05 00 00 00 00    	mov    eax,DWORD PTR [rip+0x0]        # 610 <main+0x610>
 610:	83 f8 2c             	cmp    eax,0x2c
 613:	75 1f                	jne    634 <main+0x634>
 615:	48 8d 05 00 00 00 00 	lea    rax,[rip+0x0]        # 61c <main+0x61c>
 61c:	ba 76 00 00 00       	mov    edx,0x76
 621:	48 8d 35 00 00 00 00 	lea    rsi,[rip+0x0]        # 628 <main+0x628>
 628:	48 89 c7             	mov    rdi,rax
 62b:	e8 00 00 00 00       	call   630 <main+0x630>
 630:	85 c0                	test   eax,eax
 632:	74 05                	je     639 <main+0x639>
 634:	e8 00 00 00 00       	call   639 <main+0x639>
 639:	8b 05 00 00 00 00    	mov    eax,DWORD PTR [rip+0x0]        # 63f <main+0x63f>
 63f:	83 c0 53             	add    eax,0x53
 ...
 65a:	ba 56 00 00 00       	mov    edx,0x56
 65f:	be 0b 00 00 00       	mov    esi,0xb
 ...
 6a7:	b8 4a 00 00 00       	mov    eax,0x4a
