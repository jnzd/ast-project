  ...
  34:	48 c7 45 f8 10 00 00 	mov    QWORD PTR [rbp-0x8],0x10
  3b:	00 
  ...
  49:	48 05 89 00 00 00    	add    rax,0x89
  ...
  76:	ba 82 08 00 00       	mov    edx,0x882
  7b:	be 05 00 00 00       	mov    esi,0x5
  80:	48 8d 05 00 00 00 00 	lea    rax,[rip+0x0]        # 87 <foo+0x19>
  87:	48 89 c7             	mov    rdi,rax
  8a:	e8 00 00 00 00       	call   8f <foo+0x21>
  8f:	c6 05 00 00 00 00 14 	mov    BYTE PTR [rip+0x0],0x14        # 96 <foo+0x28>
  ...
  ca:	b8 3c 00 00 00       	mov    eax,0x3c
  cf:	5d                   	pop    rbp
  d0:	c3                   	ret    
  ...
  de:	b8 14 00 00 00       	mov    eax,0x14
  e3:	5d                   	pop    rbp
  e4:	c3                   	ret    
