   ...
   c:	c7 45 f8 28 00 00 00 	mov    DWORD PTR [rbp-0x8],0x28
  ...
  54:	83 7d fc a7          	cmp    DWORD PTR [rbp-0x4],0xffffffa7
  58:	75 06                	jne    60 <main+0x60>
  5a:	83 7d f8 43          	cmp    DWORD PTR [rbp-0x8],0x43
  5e:	74 05                	je     65 <main+0x65>
  60:	e8 00 00 00 00       	call   65 <main+0x65>
  65:	b8 5e 00 00 00       	mov    eax,0x5e
  6a:	c9                   	leave  
  6b:	c3                   	ret    
