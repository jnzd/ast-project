  ...
  5b:	83 7d fc 12          	cmp    DWORD PTR [rbp-0x4],0x12
  ...
  80:	c7 45 fc 6e 00 00 00 	mov    DWORD PTR [rbp-0x4],0x6e
  ...
  af:	83 7d fc 14          	cmp    DWORD PTR [rbp-0x4],0x14
  b3:	7e d4                	jle    89 <main+0x24>
  b5:	b8 19 00 00 00       	mov    eax,0x19
  ba:	c9                   	leave  
  bb:	c3                   	ret    
