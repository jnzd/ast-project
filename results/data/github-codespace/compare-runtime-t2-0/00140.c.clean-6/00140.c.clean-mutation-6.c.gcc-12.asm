  ...
  65:	b8 f8 77 03 7a       	mov    eax,0x7a0377f8
  ...
  88:	c7 45 e4 f2 a2 69 24 	mov    DWORD PTR [rbp-0x1c],0x2469a2f2
  ...
  bf:	be fd 2b dd 40       	mov    esi,0x40dd2bfd
 ...
 129:	ba 3a 13 9b 46       	mov    edx,0x469b133a
 12e:	be 0c 1f 90 3f       	mov    esi,0x3f901f0c
 133:	b8 00 00 00 00       	mov    eax,0x0
 138:	e8 00 00 00 00       	call   13d <main+0xbd>
 13d:	48 83 c4 40          	add    rsp,0x40
 141:	b8 03 a0 11 2d       	mov    eax,0x2d11a003
 146:	c9                   	leave
 147:	c3                   	ret
