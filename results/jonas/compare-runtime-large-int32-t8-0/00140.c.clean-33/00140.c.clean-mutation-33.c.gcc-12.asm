  ...
  69:	b8 db 7e 37 2e       	mov    eax,0x2e377edb
  ...
  9f:	c7 45 d4 da f3 44 32 	mov    DWORD PTR [rbp-0x2c],0x3244f3da
  ...
  d6:	be 54 ad c6 43       	mov    esi,0x43c6ad54
 ...
 140:	ba f2 e7 e6 71       	mov    edx,0x71e6e7f2
 145:	be 44 3a 58 06       	mov    esi,0x6583a44
 14a:	b8 00 00 00 00       	mov    eax,0x0
 14f:	e8 00 00 00 00       	call   154 <main+0xd0>
 154:	48 83 c4 40          	add    rsp,0x40
 158:	b8 a0 ce 84 44       	mov    eax,0x4484cea0
