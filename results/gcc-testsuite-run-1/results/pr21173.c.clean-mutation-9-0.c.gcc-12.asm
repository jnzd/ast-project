   ...
   c:	c7 45 fc 7e 00 00 00 	mov    DWORD PTR [rbp-0x4],0x7e
  ...
  5e:	83 7d fc 6b          	cmp    DWORD PTR [rbp-0x4],0x6b
  ...
  83:	c7 45 fc 78 00 00 00 	mov    DWORD PTR [rbp-0x4],0x78
  ...
  b2:	83 7d fc 2f          	cmp    DWORD PTR [rbp-0x4],0x2f
