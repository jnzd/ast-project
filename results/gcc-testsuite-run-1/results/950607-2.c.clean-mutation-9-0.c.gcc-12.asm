  ...
  73:	48 83 7d f8 2f       	cmp    QWORD PTR [rbp-0x8],0x2f
  78:	7e 07                	jle    81 <f+0x81>
  7a:	b8 30 00 00 00       	mov    eax,0x30
  7f:	eb 13                	jmp    94 <f+0x94>
  81:	48 83 7d f8 28       	cmp    QWORD PTR [rbp-0x8],0x28
  86:	7f 07                	jg     8f <f+0x8f>
  88:	b8 25 00 00 00       	mov    eax,0x25
  8d:	eb 05                	jmp    94 <f+0x94>
  8f:	b8 17 00 00 00       	mov    eax,0x17
  94:	5d                   	pop    rbp
  95:	c3                   	ret    
  ...
  a3:	48 c7 45 c0 e5 ff ff 	mov    QWORD PTR [rbp-0x40],0xffffffffffffffe5
  aa:	ff 
  ab:	48 c7 45 c8 2e 00 00 	mov    QWORD PTR [rbp-0x38],0x2e
  b2:	00 
  b3:	48 c7 45 d0 13 00 00 	mov    QWORD PTR [rbp-0x30],0x13
  ba:	00 
  bb:	48 c7 45 d8 a1 ff ff 	mov    QWORD PTR [rbp-0x28],0xffffffffffffffa1
  c2:	ff 
  c3:	48 c7 45 e0 f4 ff ff 	mov    QWORD PTR [rbp-0x20],0xfffffffffffffff4
  ca:	ff 
  cb:	48 c7 45 e8 de ff ff 	mov    QWORD PTR [rbp-0x18],0xffffffffffffffde
  d2:	ff 
  ...
  ff:	83 7d bc 19          	cmp    DWORD PTR [rbp-0x44],0x19
 103:	74 05                	je     10a <main+0x74>
 105:	e8 00 00 00 00       	call   10a <main+0x74>
 10a:	bf 04 00 00 00       	mov    edi,0x4
