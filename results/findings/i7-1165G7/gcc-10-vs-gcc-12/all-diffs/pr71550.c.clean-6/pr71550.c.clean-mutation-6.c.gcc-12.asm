  ...
  43:	c7 45 fc 26 00 00 00 	mov    DWORD PTR [rbp-0x4],0x26
  ...
  80:	83 f8 4c             	cmp    eax,0x4c
  83:	76 d3                	jbe    58 <main+0x58>
  85:	83 45 fc 01          	add    DWORD PTR [rbp-0x4],0x1
  89:	83 7d fc 4d          	cmp    DWORD PTR [rbp-0x4],0x4d
  8d:	7e bd                	jle    4c <main+0x4c>
  8f:	c7 45 fc 05 00 00 00 	mov    DWORD PTR [rbp-0x4],0x5
  96:	eb 04                	jmp    9c <main+0x9c>
  98:	83 45 fc 01          	add    DWORD PTR [rbp-0x4],0x1
  9c:	83 7d fc 10          	cmp    DWORD PTR [rbp-0x4],0x10
  ...
  bf:	bf 66 00 00 00       	mov    edi,0x66
