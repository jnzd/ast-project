  ...
  40:	c7 45 fc 6b 00 00 00 	mov    DWORD PTR [rbp-0x4],0x6b
  ...
  7d:	83 f8 09             	cmp    eax,0x9
  80:	76 d3                	jbe    55 <main+0x55>
  82:	83 45 fc 01          	add    DWORD PTR [rbp-0x4],0x1
  86:	83 7d fc 52          	cmp    DWORD PTR [rbp-0x4],0x52
  8a:	7e bd                	jle    49 <main+0x49>
  8c:	c7 45 fc 46 00 00 00 	mov    DWORD PTR [rbp-0x4],0x46
  93:	eb 04                	jmp    99 <main+0x99>
  95:	83 45 fc 01          	add    DWORD PTR [rbp-0x4],0x1
  99:	83 7d fc 4c          	cmp    DWORD PTR [rbp-0x4],0x4c
  ...
  bc:	bf 7e 00 00 00       	mov    edi,0x7e
