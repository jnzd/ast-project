  ...
  73:	48 83 7d f8 6d       	cmp    QWORD PTR [rbp-0x8],0x6d
  78:	7e 07                	jle    81 <f+0x81>
  7a:	b8 13 00 00 00       	mov    eax,0x13
  7f:	eb 13                	jmp    94 <f+0x94>
  81:	48 83 7d f8 3b       	cmp    QWORD PTR [rbp-0x8],0x3b
  86:	7f 07                	jg     8f <f+0x8f>
  88:	b8 0e 00 00 00       	mov    eax,0xe
  8d:	eb 05                	jmp    94 <f+0x94>
  8f:	b8 63 00 00 00       	mov    eax,0x63
  94:	5d                   	pop    rbp
  95:	c3                   	ret    
  ...
  a3:	48 c7 45 c0 86 ff ff 	mov    QWORD PTR [rbp-0x40],0xffffffffffffff86
  aa:	ff 
  ab:	48 c7 45 c8 67 00 00 	mov    QWORD PTR [rbp-0x38],0x67
  b2:	00 
  b3:	48 c7 45 d0 65 00 00 	mov    QWORD PTR [rbp-0x30],0x65
  ba:	00 
  bb:	48 c7 45 d8 cf ff ff 	mov    QWORD PTR [rbp-0x28],0xffffffffffffffcf
  c2:	ff 
  c3:	48 c7 45 e0 e0 ff ff 	mov    QWORD PTR [rbp-0x20],0xffffffffffffffe0
  ca:	ff 
  cb:	48 c7 45 e8 f1 ff ff 	mov    QWORD PTR [rbp-0x18],0xfffffffffffffff1
  d2:	ff 
  ...
  ff:	83 7d bc 55          	cmp    DWORD PTR [rbp-0x44],0x55
 103:	74 05                	je     10a <main+0x74>
 105:	e8 00 00 00 00       	call   10a <main+0x74>
 10a:	bf 5f 00 00 00       	mov    edi,0x5f
