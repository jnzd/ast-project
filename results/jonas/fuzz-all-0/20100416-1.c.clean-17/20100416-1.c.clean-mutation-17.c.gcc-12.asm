  ...
  12:	c7 45 fc 5b 00 00 00 	mov    DWORD PTR [rbp-0x4],0x5b
  19:	c7 45 f8 06 00 00 00 	mov    DWORD PTR [rbp-0x8],0x6
  ...
  5d:	c7 45 fc 29 00 00 00 	mov    DWORD PTR [rbp-0x4],0x29
  ...
  80:	be 45 00 00 00       	mov    esi,0x45
  85:	bf bc ff ff ff       	mov    edi,0xffffffbc
  ...
  bc:	b8 2c 00 00 00       	mov    eax,0x2c
  c1:	c9                   	leave  
  c2:	c3                   	ret    
