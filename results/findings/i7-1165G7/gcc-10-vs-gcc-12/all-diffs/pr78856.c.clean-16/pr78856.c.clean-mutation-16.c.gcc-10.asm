  ...
  19:	c7 45 f0 04 00 00 00 	mov    DWORD PTR [rbp-0x10],0x4
  20:	c7 45 f8 55 00 00 00 	mov    DWORD PTR [rbp-0x8],0x55
  27:	e9 8a 00 00 00       	jmp    b6 <main+0xb6>
  2c:	c7 45 fc 01 00 00 00 	mov    DWORD PTR [rbp-0x4],0x1
  33:	c7 45 f4 19 00 00 00 	mov    DWORD PTR [rbp-0xc],0x19
  ...
  5b:	83 7d f4 22          	cmp    DWORD PTR [rbp-0xc],0x22
  ...
  8f:	c7 45 f8 1e 00 00 00 	mov    DWORD PTR [rbp-0x8],0x1e
  ...
  b2:	83 45 f0 6f          	add    DWORD PTR [rbp-0x10],0x6f
  b6:	83 7d f0 79          	cmp    DWORD PTR [rbp-0x10],0x79
  ba:	0f 8e 6c ff ff ff    	jle    2c <main+0x2c>
  c0:	bf 0a 00 00 00       	mov    edi,0xa
