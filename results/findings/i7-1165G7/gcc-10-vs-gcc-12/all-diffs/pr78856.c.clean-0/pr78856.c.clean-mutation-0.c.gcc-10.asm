  ...
  19:	c7 45 f0 07 00 00 00 	mov    DWORD PTR [rbp-0x10],0x7
  20:	c7 45 f8 1c 00 00 00 	mov    DWORD PTR [rbp-0x8],0x1c
  27:	e9 8a 00 00 00       	jmp    b6 <main+0xb6>
  2c:	c7 45 fc 71 00 00 00 	mov    DWORD PTR [rbp-0x4],0x71
  33:	c7 45 f4 4f 00 00 00 	mov    DWORD PTR [rbp-0xc],0x4f
  ...
  50:	c7 04 02 02 00 00 00 	mov    DWORD PTR [rdx+rax*1],0x2
  ...
  8f:	c7 45 f8 3d 00 00 00 	mov    DWORD PTR [rbp-0x8],0x3d
  ...
  ac:	83 7d fc 2b          	cmp    DWORD PTR [rbp-0x4],0x2b
  b0:	7e b1                	jle    63 <main+0x63>
  b2:	83 45 f0 0a          	add    DWORD PTR [rbp-0x10],0xa
  b6:	83 7d f0 22          	cmp    DWORD PTR [rbp-0x10],0x22
  ba:	0f 8e 6c ff ff ff    	jle    2c <main+0x2c>
  c0:	bf 32 00 00 00       	mov    edi,0x32
