  ...
  65:	b8 1a f7 86 60       	mov    eax,0x6086f71a
  ...
  88:	c7 45 e4 44 f0 5d 00 	mov    DWORD PTR [rbp-0x1c],0x5df044
  ...
  bf:	be 43 d1 71 30       	mov    esi,0x3071d143
 ...
 129:	ba af ea 21 38       	mov    edx,0x3821eaaf
 12e:	be 0c 82 fa 58       	mov    esi,0x58fa820c
 133:	b8 00 00 00 00       	mov    eax,0x0
 138:	e8 00 00 00 00       	call   13d <main+0xbd>
 13d:	48 83 c4 40          	add    rsp,0x40
 141:	b8 ca 2c d4 4a       	mov    eax,0x4ad42cca
 146:	c9                   	leave
 147:	c3                   	ret
