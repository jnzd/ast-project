  ...
  69:	b8 9b 29 e4 67       	mov    eax,0x67e4299b
  ...
  9f:	c7 45 d4 4b 16 f5 0f 	mov    DWORD PTR [rbp-0x2c],0xff5164b
  ...
  bc:	be 4f 8d db 2e       	mov    esi,0x2edb8d4f
