  ...
  23:	48 89 45 d0          	mov    QWORD PTR [rbp-0x30],rax
 ...
 2d3:	48 98                	cdqe   
 2d5:	83 e0 68             	and    eax,0x68
 2d8:	48 89 c1             	mov    rcx,rax
 2db:	48 8b 45 d0          	mov    rax,QWORD PTR [rbp-0x30]
 ...
 39f:	48 8d 45 df          	lea    rax,[rbp-0x21]
 3a3:	ba 09 00 00 00       	mov    edx,0x9
 ...
 4b1:	00 00 00 
 4b4:	ba 1e 00 00 00       	mov    edx,0x1e
 ...
 509:	75 34                	jne    53f <main+0x53f>
 50b:	8b 05 00 00 00 00    	mov    eax,DWORD PTR [rip+0x0]        # 511 <main+0x511>
 511:	3d 8a 00 00 00       	cmp    eax,0x8a
 516:	75 27                	jne    53f <main+0x53f>
 518:	8b 05 00 00 00 00    	mov    eax,DWORD PTR [rip+0x0]        # 51e <main+0x51e>
 51e:	83 f8 6c             	cmp    eax,0x6c
 521:	75 1c                	jne    53f <main+0x53f>
 523:	ba 32 00 00 00       	mov    edx,0x32
 528:	48 8d 35 00 00 00 00 	lea    rsi,[rip+0x0]        # 52f <main+0x52f>
 52f:	48 8d 3d 00 00 00 00 	lea    rdi,[rip+0x0]        # 536 <main+0x536>
 536:	e8 00 00 00 00       	call   53b <main+0x53b>
 53b:	85 c0                	test   eax,eax
 53d:	74 05                	je     544 <main+0x544>
 53f:	e8 00 00 00 00       	call   544 <main+0x544>
 544:	8b 05 00 00 00 00    	mov    eax,DWORD PTR [rip+0x0]        # 54a <main+0x54a>
 54a:	8d 50 01             	lea    edx,[rax+0x1]
 54d:	89 15 00 00 00 00    	mov    DWORD PTR [rip+0x0],edx        # 553 <main+0x553>
 553:	48 98                	cdqe   
 555:	48 8d 15 00 00 00 00 	lea    rdx,[rip+0x0]        # 55c <main+0x55c>
 55c:	48 01 d0             	add    rax,rdx
 55f:	ba 1a 00 00 00       	mov    edx,0x1a
 564:	be 2d 00 00 00       	mov    esi,0x2d
 569:	48 89 c7             	mov    rdi,rax
 56c:	e8 00 00 00 00       	call   571 <main+0x571>
 571:	48 8d 15 00 00 00 00 	lea    rdx,[rip+0x0]        # 578 <main+0x578>
 578:	48 39 d0             	cmp    rax,rdx
 57b:	75 27                	jne    5a4 <main+0x5a4>
 57d:	8b 05 00 00 00 00    	mov    eax,DWORD PTR [rip+0x0]        # 583 <main+0x583>
 583:	83 f8 29             	cmp    eax,0x29
 586:	75 1c                	jne    5a4 <main+0x5a4>
 588:	ba 69 00 00 00       	mov    edx,0x69
 58d:	48 8d 35 00 00 00 00 	lea    rsi,[rip+0x0]        # 594 <main+0x594>
 594:	48 8d 3d 00 00 00 00 	lea    rdi,[rip+0x0]        # 59b <main+0x59b>
 59b:	e8 00 00 00 00       	call   5a0 <main+0x5a0>
 5a0:	85 c0                	test   eax,eax
 5a2:	74 05                	je     5a9 <main+0x5a9>
 5a4:	e8 00 00 00 00       	call   5a9 <main+0x5a9>
 5a9:	c7 05 00 00 00 00 07 	mov    DWORD PTR [rip+0x0],0x7        # 5b3 <main+0x5b3>
 5b0:	00 00 00 
 5b3:	8b 05 00 00 00 00    	mov    eax,DWORD PTR [rip+0x0]        # 5b9 <main+0x5b9>
 5b9:	8d 50 01             	lea    edx,[rax+0x1]
 5bc:	89 15 00 00 00 00    	mov    DWORD PTR [rip+0x0],edx        # 5c2 <main+0x5c2>
 5c2:	48 98                	cdqe   
 5c4:	8b 15 00 00 00 00    	mov    edx,DWORD PTR [rip+0x0]        # 5ca <main+0x5ca>
 5ca:	83 c2 01             	add    edx,0x1
 5cd:	89 15 00 00 00 00    	mov    DWORD PTR [rip+0x0],edx        # 5d3 <main+0x5d3>
 5d3:	8b 15 00 00 00 00    	mov    edx,DWORD PTR [rip+0x0]        # 5d9 <main+0x5d9>
 5d9:	48 63 d2             	movsxd rdx,edx
 5dc:	48 8d 0d 00 00 00 00 	lea    rcx,[rip+0x0]        # 5e3 <main+0x5e3>
 5e3:	48 01 d1             	add    rcx,rdx
 5e6:	48 89 c2             	mov    rdx,rax
 5e9:	be 7b 00 00 00       	mov    esi,0x7b
 5ee:	48 89 cf             	mov    rdi,rcx
 5f1:	e8 00 00 00 00       	call   5f6 <main+0x5f6>
 5f6:	48 8d 15 00 00 00 00 	lea    rdx,[rip+0x0]        # 5fd <main+0x5fd>
 5fd:	48 39 d0             	cmp    rax,rdx
 600:	75 35                	jne    637 <main+0x637>
 602:	8b 05 00 00 00 00    	mov    eax,DWORD PTR [rip+0x0]        # 608 <main+0x608>
 608:	83 f8 1d             	cmp    eax,0x1d
 60b:	75 2a                	jne    637 <main+0x637>
 60d:	8b 05 00 00 00 00    	mov    eax,DWORD PTR [rip+0x0]        # 613 <main+0x613>
 613:	83 f8 03             	cmp    eax,0x3
 616:	75 1f                	jne    637 <main+0x637>
 618:	48 8d 05 00 00 00 00 	lea    rax,[rip+0x0]        # 61f <main+0x61f>
 61f:	ba 55 00 00 00       	mov    edx,0x55
 624:	48 8d 35 00 00 00 00 	lea    rsi,[rip+0x0]        # 62b <main+0x62b>
 ...
 642:	89 05 00 00 00 00    	mov    DWORD PTR [rip+0x0],eax        # 648 <main+0x648>
 648:	8b 05 00 00 00 00    	mov    eax,DWORD PTR [rip+0x0]        # 64e <main+0x64e>
 64e:	48 98                	cdqe   
 650:	48 8d 15 00 00 00 00 	lea    rdx,[rip+0x0]        # 657 <main+0x657>
 657:	48 01 d0             	add    rax,rdx
 65a:	ba 5b 00 00 00       	mov    edx,0x5b
 65f:	be 55 00 00 00       	mov    esi,0x55
 664:	48 89 c7             	mov    rdi,rax
 667:	e8 00 00 00 00       	call   66c <main+0x66c>
 66c:	48 8d 15 00 00 00 00 	lea    rdx,[rip+0x0]        # 673 <main+0x673>
 673:	48 39 d0             	cmp    rax,rdx
 676:	75 2a                	jne    6a2 <main+0x6a2>
 678:	8b 05 00 00 00 00    	mov    eax,DWORD PTR [rip+0x0]        # 67e <main+0x67e>
 67e:	83 f8 33             	cmp    eax,0x33
 681:	75 1f                	jne    6a2 <main+0x6a2>
 683:	48 8d 05 00 00 00 00 	lea    rax,[rip+0x0]        # 68a <main+0x68a>
 68a:	ba 29 00 00 00       	mov    edx,0x29
 68f:	48 8d 35 00 00 00 00 	lea    rsi,[rip+0x0]        # 696 <main+0x696>
 ...
 6a7:	b8 07 00 00 00       	mov    eax,0x7
 6ac:	48 8b 5d e8          	mov    rbx,QWORD PTR [rbp-0x18]
 6b0:	64 48 2b 1c 25 28 00 	sub    rbx,QWORD PTR fs:0x28
 6b7:	00 00 
