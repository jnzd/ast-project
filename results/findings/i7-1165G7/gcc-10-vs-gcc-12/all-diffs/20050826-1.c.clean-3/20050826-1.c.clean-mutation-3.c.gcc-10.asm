  ...
  31:	48 c7 45 f8 67 00 00 	mov    QWORD PTR [rbp-0x8],0x67
  38:	00 
  ...
  46:	48 05 21 01 00 00    	add    rax,0x121
  ...
  73:	ba 1a 09 00 00       	mov    edx,0x91a
  78:	be 57 00 00 00       	mov    esi,0x57
  7d:	48 8d 3d 00 00 00 00 	lea    rdi,[rip+0x0]        # 84 <foo+0x19>
  84:	e8 00 00 00 00       	call   89 <foo+0x1e>
  89:	c6 05 00 00 00 00 0b 	mov    BYTE PTR [rip+0x0],0xb        # 90 <foo+0x25>
  ...
  a8:	c6 05 00 00 00 00 6e 	mov    BYTE PTR [rip+0x0],0x6e        # af <foo+0x44>
  af:	48 8d 3d 00 00 00 00 	lea    rdi,[rip+0x0]        # b6 <foo+0x4b>
  b6:	e8 00 00 00 00       	call   bb <foo+0x50>
  bb:	b8 19 00 00 00       	mov    eax,0x19
  c0:	5d                   	pop    rbp
  c1:	c3                   	ret    
  ...
  cf:	b8 7d 00 00 00       	mov    eax,0x7d
  d4:	5d                   	pop    rbp
  d5:	c3                   	ret    
