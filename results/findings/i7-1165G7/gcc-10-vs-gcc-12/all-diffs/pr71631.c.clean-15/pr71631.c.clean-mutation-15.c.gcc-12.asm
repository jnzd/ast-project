  ...
  f9:	75 0f                	jne    10a <main+0xd8>
  fb:	48 8d 05 00 00 00 00 	lea    rax,[rip+0x0]        # 102 <main+0xd0>
 102:	48 89 c7             	mov    rdi,rax
 105:	e8 00 00 00 00       	call   10a <main+0xd8>
 10a:	66 83 7d da cd       	cmp    WORD PTR [rbp-0x26],0xffcd
 10f:	74 05                	je     116 <main+0xe4>
 111:	e8 00 00 00 00       	call   116 <main+0xe4>
 116:	b8 5b 00 00 00       	mov    eax,0x5b
 11b:	c9                   	leave  
 11c:	c3                   	ret    
