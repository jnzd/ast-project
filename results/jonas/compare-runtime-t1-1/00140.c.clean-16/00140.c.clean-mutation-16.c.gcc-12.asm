  ...
  69:	b8 89 c8 fb 06       	mov    eax,0x6fbc889
  ...
  9f:	c7 45 d4 89 59 e7 32 	mov    DWORD PTR [rbp-0x2c],0x32e75989
  ...
  d6:	be 54 a1 8d 2d       	mov    esi,0x2d8da154
 ...
 140:	ba cf af 54 20       	mov    edx,0x2054afcf
 145:	be 61 f6 44 09       	mov    esi,0x944f661
 14a:	b8 00 00 00 00       	mov    eax,0x0
 14f:	e8 00 00 00 00       	call   154 <main+0xd0>
 154:	48 83 c4 40          	add    rsp,0x40
 158:	b8 42 e2 41 4b       	mov    eax,0x4b41e242
