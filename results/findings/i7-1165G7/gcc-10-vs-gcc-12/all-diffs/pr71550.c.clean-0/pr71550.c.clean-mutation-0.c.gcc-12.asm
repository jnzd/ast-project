  ...
  43:	c7 45 fc 50 00 00 00 	mov    DWORD PTR [rbp-0x4],0x50
  ...
  80:	83 f8 67             	cmp    eax,0x67
  83:	76 d3                	jbe    58 <main+0x58>
  85:	83 45 fc 01          	add    DWORD PTR [rbp-0x4],0x1
  89:	83 7d fc 68          	cmp    DWORD PTR [rbp-0x4],0x68
  8d:	7e bd                	jle    4c <main+0x4c>
  8f:	c7 45 fc 2b 00 00 00 	mov    DWORD PTR [rbp-0x4],0x2b
  96:	eb 04                	jmp    9c <main+0x9c>
  98:	83 45 fc 01          	add    DWORD PTR [rbp-0x4],0x1
  9c:	83 7d fc 66          	cmp    DWORD PTR [rbp-0x4],0x66
  ...
  bf:	bf 18 00 00 00       	mov    edi,0x18
