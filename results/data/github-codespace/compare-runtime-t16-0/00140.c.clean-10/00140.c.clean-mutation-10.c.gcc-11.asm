  ...
  69:	b8 9d f1 9c 79       	mov    eax,0x799cf19d
  ...
  9f:	c7 45 d4 a3 b0 12 04 	mov    DWORD PTR [rbp-0x2c],0x412b0a3
  ...
  bc:	be ff 14 bc 3a       	mov    esi,0x3abc14ff
