  ...
  65:	b8 c2 ff 99 5e       	mov    eax,0x5e99ffc2
  ...
  88:	c7 45 e4 b1 45 2d 4e 	mov    DWORD PTR [rbp-0x1c],0x4e2d45b1
  ...
  bf:	be 53 2f b6 00       	mov    esi,0xb62f53
 ...
 129:	ba e5 5d e2 00       	mov    edx,0xe25de5
 12e:	be be 9a 31 30       	mov    esi,0x30319abe
 133:	b8 00 00 00 00       	mov    eax,0x0
 138:	e8 00 00 00 00       	call   13d <main+0xbd>
 13d:	48 83 c4 40          	add    rsp,0x40
 141:	b8 61 74 78 4b       	mov    eax,0x4b787461
 146:	c9                   	leave
 147:	c3                   	ret
