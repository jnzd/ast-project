  ...
  69:	b8 a9 b2 79 65       	mov    eax,0x6579b2a9
  ...
  9f:	c7 45 d4 ae 04 a8 13 	mov    DWORD PTR [rbp-0x2c],0x13a804ae
  ...
  d6:	be f1 e8 e7 25       	mov    esi,0x25e7e8f1
 ...
 140:	ba 47 5a 38 5a       	mov    edx,0x5a385a47
 145:	be a7 1f fd 2f       	mov    esi,0x2ffd1fa7
 14a:	b8 00 00 00 00       	mov    eax,0x0
 14f:	e8 00 00 00 00       	call   154 <main+0xd0>
 154:	48 83 c4 40          	add    rsp,0x40
 158:	b8 33 99 eb 24       	mov    eax,0x24eb9933
