  ...
  65:	b8 ec be a5 3f       	mov    eax,0x3fa5beec
  ...
  88:	c7 45 e4 7f 26 f9 3f 	mov    DWORD PTR [rbp-0x1c],0x3ff9267f
  ...
  bf:	be e2 8e 9b 0d       	mov    esi,0xd9b8ee2
 ...
 129:	ba a0 69 42 26       	mov    edx,0x264269a0
 12e:	be e9 79 35 04       	mov    esi,0x43579e9
 133:	b8 00 00 00 00       	mov    eax,0x0
 138:	e8 00 00 00 00       	call   13d <main+0xbd>
 13d:	48 83 c4 40          	add    rsp,0x40
 141:	b8 a4 a6 02 65       	mov    eax,0x6502a6a4
 146:	c9                   	leave
 147:	c3                   	ret
