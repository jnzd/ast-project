   ...
   f:	83 7d fc 70          	cmp    DWORD PTR [rbp-0x4],0x70
  ...
  29:	c7 45 fc 0e 00 00 00 	mov    DWORD PTR [rbp-0x4],0xe
  30:	8b 45 fc             	mov    eax,DWORD PTR [rbp-0x4]
  33:	83 c0 2a             	add    eax,0x2a
  ...
  71:	48 c7 45 f8 46 00 00 	mov    QWORD PTR [rbp-0x8],0x46
  78:	00 
  79:	bf 45 00 00 80       	mov    edi,0x80000045
  ...
  b0:	bf 6f 00 00 00       	mov    edi,0x6f
