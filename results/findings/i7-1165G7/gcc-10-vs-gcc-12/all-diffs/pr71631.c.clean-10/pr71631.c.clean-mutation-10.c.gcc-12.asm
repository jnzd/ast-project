  ...
  3e:	c7 45 dc 6b 00 00 00 	mov    DWORD PTR [rbp-0x24],0x6b
  45:	c7 45 e0 7e 00 00 00 	mov    DWORD PTR [rbp-0x20],0x7e
  4c:	8b 0d 00 00 00 00    	mov    ecx,DWORD PTR [rip+0x0]        # 52 <main+0x20>
  52:	b8 06 00 00 00       	mov    eax,0x6
  57:	99                   	cdq    
  58:	f7 f9                	idiv   ecx
  ...
  6f:	83 c0 5d             	add    eax,0x5d
  72:	89 45 ec             	mov    DWORD PTR [rbp-0x14],eax
  75:	b8 17 00 00 00       	mov    eax,0x17
  7a:	99                   	cdq    
  ...
  cd:	6b c0 ce             	imul   eax,eax,0xffffffce
  ...
  ea:	83 7d f0 57          	cmp    DWORD PTR [rbp-0x10],0x57
  ...
  ff:	66 83 7d da 87       	cmp    WORD PTR [rbp-0x26],0xff87
 104:	74 05                	je     10b <main+0xd9>
 106:	e8 00 00 00 00       	call   10b <main+0xd9>
 10b:	b8 0a 00 00 00       	mov    eax,0xa
 110:	c9                   	leave  
 111:	c3                   	ret    
