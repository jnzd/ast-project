  ...
  51:	83 7d ec 65          	cmp    DWORD PTR [rbp-0x14],0x65
  55:	75 07                	jne    5e <foo+0x24>
  57:	b8 0b 00 00 00       	mov    eax,0xb
  ...
  74:	b8 13 00 00 00       	mov    eax,0x13
  79:	c9                   	leave  
  7a:	c3                   	ret    
