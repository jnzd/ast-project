  ...
  70:	48 83 7d f8 44       	cmp    QWORD PTR [rbp-0x8],0x44
  75:	7e 07                	jle    7e <f+0x7e>
  77:	b8 2a 00 00 00       	mov    eax,0x2a
  7c:	eb 13                	jmp    91 <f+0x91>
  7e:	48 83 7d f8 3a       	cmp    QWORD PTR [rbp-0x8],0x3a
  83:	7f 07                	jg     8c <f+0x8c>
  85:	b8 2f 00 00 00       	mov    eax,0x2f
  8a:	eb 05                	jmp    91 <f+0x91>
  8c:	b8 3f 00 00 00       	mov    eax,0x3f
  91:	5d                   	pop    rbp
  92:	c3                   	ret    
  ...
  a0:	48 c7 45 c0 82 ff ff 	mov    QWORD PTR [rbp-0x40],0xffffffffffffff82
  a7:	ff 
  a8:	48 c7 45 c8 18 00 00 	mov    QWORD PTR [rbp-0x38],0x18
  af:	00 
  b0:	48 c7 45 d0 44 00 00 	mov    QWORD PTR [rbp-0x30],0x44
  b7:	00 
  b8:	48 c7 45 d8 86 ff ff 	mov    QWORD PTR [rbp-0x28],0xffffffffffffff86
  bf:	ff 
  c0:	48 c7 45 e0 bd ff ff 	mov    QWORD PTR [rbp-0x20],0xffffffffffffffbd
  c7:	ff 
  c8:	48 c7 45 e8 c6 ff ff 	mov    QWORD PTR [rbp-0x18],0xffffffffffffffc6
  cf:	ff 
  ...
  fc:	83 7d bc 27          	cmp    DWORD PTR [rbp-0x44],0x27
 100:	74 05                	je     107 <main+0x74>
 102:	e8 00 00 00 00       	call   107 <main+0x74>
 107:	bf 3f 00 00 00       	mov    edi,0x3f
