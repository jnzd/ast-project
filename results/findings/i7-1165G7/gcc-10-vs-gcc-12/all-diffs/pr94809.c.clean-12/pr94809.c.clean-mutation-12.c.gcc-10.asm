   ...
   c:	c7 45 f4 5e 00 00 00 	mov    DWORD PTR [rbp-0xc],0x5e
  13:	48 c7 45 f8 17 00 00 	mov    QWORD PTR [rbp-0x8],0x17
  1a:	00 
  ...
  2a:	83 7d f4 12          	cmp    DWORD PTR [rbp-0xc],0x12
  2e:	74 05                	je     35 <main+0x35>
  30:	e8 00 00 00 00       	call   35 <main+0x35>
  35:	b8 3c 00 00 00       	mov    eax,0x3c
  3a:	c9                   	leave  
  3b:	c3                   	ret    
