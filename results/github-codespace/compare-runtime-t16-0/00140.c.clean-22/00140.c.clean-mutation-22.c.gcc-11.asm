  ...
  69:	b8 e1 c9 47 06       	mov    eax,0x647c9e1
  ...
  9f:	c7 45 d4 5f aa 9f 1f 	mov    DWORD PTR [rbp-0x2c],0x1f9faa5f
  ...
  bc:	be ac d9 80 18       	mov    esi,0x1880d9ac
