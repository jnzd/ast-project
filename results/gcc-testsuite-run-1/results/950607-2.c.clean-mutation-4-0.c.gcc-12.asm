  ...
  73:	48 83 7d f8 12       	cmp    QWORD PTR [rbp-0x8],0x12
  78:	7e 07                	jle    81 <f+0x81>
  7a:	b8 1b 00 00 00       	mov    eax,0x1b
  7f:	eb 13                	jmp    94 <f+0x94>
  81:	48 83 7d f8 39       	cmp    QWORD PTR [rbp-0x8],0x39
  86:	7f 07                	jg     8f <f+0x8f>
  88:	b8 40 00 00 00       	mov    eax,0x40
  8d:	eb 05                	jmp    94 <f+0x94>
  8f:	b8 53 00 00 00       	mov    eax,0x53
  94:	5d                   	pop    rbp
  95:	c3                   	ret    
  ...
  a3:	48 c7 45 c0 fa ff ff 	mov    QWORD PTR [rbp-0x40],0xfffffffffffffffa
  aa:	ff 
  ab:	48 c7 45 c8 31 00 00 	mov    QWORD PTR [rbp-0x38],0x31
  b2:	00 
  b3:	48 c7 45 d0 68 00 00 	mov    QWORD PTR [rbp-0x30],0x68
  ba:	00 
  bb:	48 c7 45 d8 a1 ff ff 	mov    QWORD PTR [rbp-0x28],0xffffffffffffffa1
  c2:	ff 
  c3:	48 c7 45 e0 c7 ff ff 	mov    QWORD PTR [rbp-0x20],0xffffffffffffffc7
  ca:	ff 
  cb:	48 c7 45 e8 fe ff ff 	mov    QWORD PTR [rbp-0x18],0xfffffffffffffffe
  d2:	ff 
  ...
  ff:	83 7d bc 47          	cmp    DWORD PTR [rbp-0x44],0x47
 103:	74 05                	je     10a <main+0x74>
 105:	e8 00 00 00 00       	call   10a <main+0x74>
 10a:	bf 62 00 00 00       	mov    edi,0x62
