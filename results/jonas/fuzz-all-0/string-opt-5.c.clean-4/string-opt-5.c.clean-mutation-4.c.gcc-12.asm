 ...
 300:	83 f8 75             	cmp    eax,0x75
 303:	75 0b                	jne    310 <main+0x310>
 305:	8b 05 00 00 00 00    	mov    eax,DWORD PTR [rip+0x0]        # 30b <main+0x30b>
 30b:	83 f8 6c             	cmp    eax,0x6c
 30e:	74 05                	je     315 <main+0x315>
 310:	e8 00 00 00 00       	call   315 <main+0x315>
 315:	c6 45 da 20          	mov    BYTE PTR [rbp-0x26],0x20
 319:	c6 45 ce 00          	mov    BYTE PTR [rbp-0x32],0x0
 31d:	c7 05 00 00 00 00 7c 	mov    DWORD PTR [rip+0x0],0x7c        # 327 <main+0x327>
 324:	00 00 00 
 ...
 476:	ba 50 00 00 00       	mov    edx,0x50
 ...
 4c4:	00 00 00 
 4c7:	ba 0c 00 00 00       	mov    edx,0xc
 ...
 535:	83 f8 52             	cmp    eax,0x52
 538:	75 22                	jne    55c <main+0x55c>
 53a:	ba 51 00 00 00       	mov    edx,0x51
 ...
 57c:	ba 20 00 00 00       	mov    edx,0x20
 ...
 5a0:	83 f8 64             	cmp    eax,0x64
 5a3:	75 22                	jne    5c7 <main+0x5c7>
 5a5:	ba 61 00 00 00       	mov    edx,0x61
 ...
 5cc:	c7 05 00 00 00 00 30 	mov    DWORD PTR [rip+0x0],0x30        # 5d6 <main+0x5d6>
 5d3:	00 00 00 
 ...
 60c:	be 70 00 00 00       	mov    esi,0x70
 ...
 683:	ba 59 00 00 00       	mov    edx,0x59
 688:	be 18 00 00 00       	mov    esi,0x18
 ...
 6d3:	b8 6b 00 00 00       	mov    eax,0x6b
