  ...
  69:	b8 0a 9d 38 26       	mov    eax,0x26389d0a
  ...
  9f:	c7 45 d4 d6 26 94 13 	mov    DWORD PTR [rbp-0x2c],0x139426d6
  ...
  d6:	be 03 5e db 53       	mov    esi,0x53db5e03
 ...
 140:	ba 2b 5c fe 4b       	mov    edx,0x4bfe5c2b
 145:	be c9 f9 45 06       	mov    esi,0x645f9c9
 14a:	b8 00 00 00 00       	mov    eax,0x0
 14f:	e8 00 00 00 00       	call   154 <main+0xd0>
 154:	48 83 c4 40          	add    rsp,0x40
 158:	b8 02 c3 89 5d       	mov    eax,0x5d89c302
