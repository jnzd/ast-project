   ...
   b:	83 7d fc 47          	cmp    DWORD PTR [rbp-0x4],0x47
  ...
  48:	48 83 7d f8 11       	cmp    QWORD PTR [rbp-0x8],0x11
  ...
  8e:	c7 45 fc 25 00 00 00 	mov    DWORD PTR [rbp-0x4],0x25
 ...
 172:	83 7d fc 23          	cmp    DWORD PTR [rbp-0x4],0x23
 176:	0f 8e 1e ff ff ff    	jle    9a <main+0x18>
 17c:	bf 47 00 00 00       	mov    edi,0x47
