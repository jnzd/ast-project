   ...
   b:	c7 45 f8 8b ff ff ff 	mov    DWORD PTR [rbp-0x8],0xffffff8b
  ...
  27:	ba 5c 00 00 00       	mov    edx,0x5c
  ...
  39:	83 45 fc 7b          	add    DWORD PTR [rbp-0x4],0x7b
  ...
  5b:	c7 45 f8 67 00 00 00 	mov    DWORD PTR [rbp-0x8],0x67
  ...
  6f:	bf 4f 00 00 00       	mov    edi,0x4f
