  ...
  3e:	c7 45 dc 63 00 00 00 	mov    DWORD PTR [rbp-0x24],0x63
  45:	c7 45 e0 2a 00 00 00 	mov    DWORD PTR [rbp-0x20],0x2a
  4c:	8b 0d 00 00 00 00    	mov    ecx,DWORD PTR [rip+0x0]        # 52 <main+0x20>
  52:	b8 78 00 00 00       	mov    eax,0x78
  57:	99                   	cdq    
  58:	f7 f9                	idiv   ecx
