  ...
  70:	48 83 7d f8 12       	cmp    QWORD PTR [rbp-0x8],0x12
  75:	7e 07                	jle    7e <f+0x7e>
  77:	b8 1b 00 00 00       	mov    eax,0x1b
  7c:	eb 13                	jmp    91 <f+0x91>
  7e:	48 83 7d f8 39       	cmp    QWORD PTR [rbp-0x8],0x39
  83:	7f 07                	jg     8c <f+0x8c>
  85:	b8 40 00 00 00       	mov    eax,0x40
  8a:	eb 05                	jmp    91 <f+0x91>
  8c:	b8 53 00 00 00       	mov    eax,0x53
  91:	5d                   	pop    rbp
  92:	c3                   	ret    
  ...
  a0:	48 c7 45 c0 fa ff ff 	mov    QWORD PTR [rbp-0x40],0xfffffffffffffffa
  a7:	ff 
  a8:	48 c7 45 c8 31 00 00 	mov    QWORD PTR [rbp-0x38],0x31
  af:	00 
  b0:	48 c7 45 d0 68 00 00 	mov    QWORD PTR [rbp-0x30],0x68
  b7:	00 
  b8:	48 c7 45 d8 a1 ff ff 	mov    QWORD PTR [rbp-0x28],0xffffffffffffffa1
  bf:	ff 
  c0:	48 c7 45 e0 c7 ff ff 	mov    QWORD PTR [rbp-0x20],0xffffffffffffffc7
  c7:	ff 
  c8:	48 c7 45 e8 fe ff ff 	mov    QWORD PTR [rbp-0x18],0xfffffffffffffffe
  cf:	ff 
  ...
  fc:	83 7d bc 47          	cmp    DWORD PTR [rbp-0x44],0x47
 100:	74 05                	je     107 <main+0x74>
 102:	e8 00 00 00 00       	call   107 <main+0x74>
 107:	bf 62 00 00 00       	mov    edi,0x62
