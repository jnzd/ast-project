  ...
  73:	48 83 7d f8 1f       	cmp    QWORD PTR [rbp-0x8],0x1f
  78:	7e 07                	jle    81 <f+0x81>
  7a:	b8 16 00 00 00       	mov    eax,0x16
  7f:	eb 13                	jmp    94 <f+0x94>
  81:	48 83 7d f8 5b       	cmp    QWORD PTR [rbp-0x8],0x5b
  86:	7f 07                	jg     8f <f+0x8f>
  88:	b8 33 00 00 00       	mov    eax,0x33
  8d:	eb 05                	jmp    94 <f+0x94>
  8f:	b8 2f 00 00 00       	mov    eax,0x2f
  94:	5d                   	pop    rbp
  95:	c3                   	ret    
  ...
  a3:	48 c7 45 c0 ec ff ff 	mov    QWORD PTR [rbp-0x40],0xffffffffffffffec
  aa:	ff 
  ab:	48 c7 45 c8 37 00 00 	mov    QWORD PTR [rbp-0x38],0x37
  b2:	00 
  b3:	48 c7 45 d0 7c 00 00 	mov    QWORD PTR [rbp-0x30],0x7c
  ba:	00 
  bb:	48 c7 45 d8 a4 ff ff 	mov    QWORD PTR [rbp-0x28],0xffffffffffffffa4
  c2:	ff 
  c3:	48 c7 45 e0 a2 ff ff 	mov    QWORD PTR [rbp-0x20],0xffffffffffffffa2
  ca:	ff 
  cb:	48 c7 45 e8 cd ff ff 	mov    QWORD PTR [rbp-0x18],0xffffffffffffffcd
  d2:	ff 
  ...
  ff:	83 7d bc 6e          	cmp    DWORD PTR [rbp-0x44],0x6e
 103:	74 05                	je     10a <main+0x74>
 105:	e8 00 00 00 00       	call   10a <main+0x74>
 10a:	bf 4f 00 00 00       	mov    edi,0x4f
