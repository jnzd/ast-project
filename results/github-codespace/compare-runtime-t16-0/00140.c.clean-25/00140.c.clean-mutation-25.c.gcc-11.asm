  ...
  69:	b8 41 34 70 32       	mov    eax,0x32703441
  ...
  9f:	c7 45 d4 16 01 ad 3b 	mov    DWORD PTR [rbp-0x2c],0x3bad0116
  ...
  bc:	be d2 e6 04 0b       	mov    esi,0xb04e6d2
