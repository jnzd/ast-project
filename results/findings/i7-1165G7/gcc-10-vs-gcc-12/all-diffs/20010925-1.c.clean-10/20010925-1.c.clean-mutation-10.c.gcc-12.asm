  ...
  51:	83 7d ec 43          	cmp    DWORD PTR [rbp-0x14],0x43
  55:	75 07                	jne    5e <foo+0x24>
  57:	b8 7a 00 00 00       	mov    eax,0x7a
