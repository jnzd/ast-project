  ...
  69:	b8 72 f8 86 41       	mov    eax,0x4186f872
  ...
  9f:	c7 45 d4 ab 4a 7a 03 	mov    DWORD PTR [rbp-0x2c],0x37a4aab
  ...
  d6:	be f9 50 21 1d       	mov    esi,0x1d2150f9
 ...
 140:	ba c2 f8 55 05       	mov    edx,0x555f8c2
 145:	be 47 b7 71 31       	mov    esi,0x3171b747
 14a:	b8 00 00 00 00       	mov    eax,0x0
 14f:	e8 00 00 00 00       	call   154 <main+0xd0>
 154:	48 83 c4 40          	add    rsp,0x40
 158:	b8 9b a6 0b 48       	mov    eax,0x480ba69b
