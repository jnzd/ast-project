  ...
  cd:	66 89 45 d8          	mov    WORD PTR [rbp-0x28],ax
  d1:	8b 45 f8             	mov    eax,DWORD PTR [rbp-0x8]
  d4:	89 c2                	mov    edx,eax
  d6:	0f b7 45 d8          	movzx  eax,WORD PTR [rbp-0x28]
  da:	0f af c2             	imul   eax,edx
  dd:	8b 55 f4             	mov    edx,DWORD PTR [rbp-0xc]
  e0:	0f af c2             	imul   eax,edx
  e3:	66 89 45 da          	mov    WORD PTR [rbp-0x26],ax
  e7:	83 7d f0 7c          	cmp    DWORD PTR [rbp-0x10],0x7c
  eb:	75 0f                	jne    fc <main+0xca>
  ed:	48 8d 05 00 00 00 00 	lea    rax,[rip+0x0]        # f4 <main+0xc2>
  f4:	48 89 c7             	mov    rdi,rax
  f7:	e8 00 00 00 00       	call   fc <main+0xca>
  fc:	66 83 7d da e9       	cmp    WORD PTR [rbp-0x26],0xffe9
 101:	74 05                	je     108 <main+0xd6>
 103:	e8 00 00 00 00       	call   108 <main+0xd6>
 108:	b8 6f 00 00 00       	mov    eax,0x6f
 10d:	c9                   	leave  
 10e:	c3                   	ret    
