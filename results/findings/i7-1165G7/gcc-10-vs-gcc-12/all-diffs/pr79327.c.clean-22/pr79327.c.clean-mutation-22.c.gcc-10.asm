  ...
  bb:	83 f8 66             	cmp    eax,0x66
  be:	74 05                	je     c5 <main+0xc5>
  c0:	e8 00 00 00 00       	call   c5 <main+0xc5>
  c5:	c7 05 00 00 00 00 7d 	mov    DWORD PTR [rip+0x0],0x7d        # cf <main+0xcf>
  cc:	00 00 00 
