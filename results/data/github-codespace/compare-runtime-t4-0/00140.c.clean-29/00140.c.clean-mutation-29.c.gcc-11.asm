  ...
  69:	b8 f1 70 77 1d       	mov    eax,0x1d7770f1
  ...
  9f:	c7 45 d4 2f 38 a6 08 	mov    DWORD PTR [rbp-0x2c],0x8a6382f
  ...
  bc:	be 8b fc f6 60       	mov    esi,0x60f6fc8b
