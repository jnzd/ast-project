   ...
   b:	c7 45 f8 b9 ff ff ff 	mov    DWORD PTR [rbp-0x8],0xffffffb9
  ...
  27:	ba 67 00 00 00       	mov    edx,0x67
  ...
  39:	83 45 fc 1c          	add    DWORD PTR [rbp-0x4],0x1c
  ...
  5b:	c7 45 f8 73 00 00 00 	mov    DWORD PTR [rbp-0x8],0x73
  ...
  6f:	bf 7c 00 00 00       	mov    edi,0x7c
