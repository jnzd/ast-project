  ...
  13:	c7 45 f4 1a 00 00 00 	mov    DWORD PTR [rbp-0xc],0x1a
  1a:	c7 45 f0 5d 00 00 00 	mov    DWORD PTR [rbp-0x10],0x5d
  ...
  3c:	83 7d fc 2a          	cmp    DWORD PTR [rbp-0x4],0x2a
  ...
  5b:	c7 45 f4 12 00 00 00 	mov    DWORD PTR [rbp-0xc],0x12
