 ...
 2ff:	83 f8 75             	cmp    eax,0x75
 302:	75 0b                	jne    30f <main+0x30f>
 304:	8b 05 00 00 00 00    	mov    eax,DWORD PTR [rip+0x0]        # 30a <main+0x30a>
 30a:	83 f8 6c             	cmp    eax,0x6c
 30d:	74 05                	je     314 <main+0x314>
 30f:	e8 00 00 00 00       	call   314 <main+0x314>
 314:	c6 45 da 20          	mov    BYTE PTR [rbp-0x26],0x20
 318:	c6 45 ce 00          	mov    BYTE PTR [rbp-0x32],0x0
 31c:	c7 05 00 00 00 00 7c 	mov    DWORD PTR [rip+0x0],0x7c        # 326 <main+0x326>
 323:	00 00 00 
 326:	c7 05 00 00 00 00 10 	mov    DWORD PTR [rip+0x0],0x10        # 330 <main+0x330>
 32d:	00 00 00 
 ...
 353:	48 83 c0 0e          	add    rax,0xe
 357:	ba 58 00 00 00       	mov    edx,0x58
 ...
 43b:	ba 59 00 00 00       	mov    edx,0x59
 ...
 475:	ba 50 00 00 00       	mov    edx,0x50
 ...
 499:	ba 0b 00 00 00       	mov    edx,0xb
 ...
 4c0:	00 00 00 
 4c3:	ba 0c 00 00 00       	mov    edx,0xc
 ...
 578:	ba 20 00 00 00       	mov    edx,0x20
 ...
 59c:	83 f8 64             	cmp    eax,0x64
 59f:	75 22                	jne    5c3 <main+0x5c3>
 5a1:	ba 61 00 00 00       	mov    edx,0x61
 ...
 5c8:	c7 05 00 00 00 00 30 	mov    DWORD PTR [rip+0x0],0x30        # 5d2 <main+0x5d2>
 5cf:	00 00 00 
 ...
 608:	be 70 00 00 00       	mov    esi,0x70
 ...
 67f:	ba 59 00 00 00       	mov    edx,0x59
 684:	be 18 00 00 00       	mov    esi,0x18
 ...
 6cf:	b8 6b 00 00 00       	mov    eax,0x6b
