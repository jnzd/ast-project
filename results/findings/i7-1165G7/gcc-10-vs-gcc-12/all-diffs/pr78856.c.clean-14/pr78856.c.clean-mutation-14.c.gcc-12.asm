  ...
  1b:	c7 45 f0 39 00 00 00 	mov    DWORD PTR [rbp-0x10],0x39
  22:	c7 45 f8 57 00 00 00 	mov    DWORD PTR [rbp-0x8],0x57
  29:	e9 8a 00 00 00       	jmp    b8 <main+0xb8>
  2e:	c7 45 fc 47 00 00 00 	mov    DWORD PTR [rbp-0x4],0x47
  35:	c7 45 f4 2a 00 00 00 	mov    DWORD PTR [rbp-0xc],0x2a
  ...
  52:	c7 04 02 2a 00 00 00 	mov    DWORD PTR [rdx+rax*1],0x2a
  59:	83 45 f4 01          	add    DWORD PTR [rbp-0xc],0x1
  5d:	83 7d f4 09          	cmp    DWORD PTR [rbp-0xc],0x9
  ...
  91:	c7 45 f8 11 00 00 00 	mov    DWORD PTR [rbp-0x8],0x11
  ...
  ae:	83 7d fc 16          	cmp    DWORD PTR [rbp-0x4],0x16
  b2:	7e b1                	jle    65 <main+0x65>
  b4:	83 45 f0 38          	add    DWORD PTR [rbp-0x10],0x38
  b8:	83 7d f0 2c          	cmp    DWORD PTR [rbp-0x10],0x2c
  bc:	0f 8e 6c ff ff ff    	jle    2e <main+0x2e>
  c2:	bf 72 00 00 00       	mov    edi,0x72
