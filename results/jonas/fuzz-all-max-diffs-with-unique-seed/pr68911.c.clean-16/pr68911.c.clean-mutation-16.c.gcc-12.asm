   ...
   c:	c7 45 f4 7a 00 00 00 	mov    DWORD PTR [rbp-0xc],0x7a
  13:	c7 45 f8 16 00 00 00 	mov    DWORD PTR [rbp-0x8],0x16
  1a:	eb 7b                	jmp    97 <main+0x97>
  1c:	8b 45 f4             	mov    eax,DWORD PTR [rbp-0xc]
  1f:	f7 d0                	not    eax
  21:	89 c2                	mov    edx,eax
  23:	89 d0                	mov    eax,edx
  25:	48 69 c0 13 78 fb 21 	imul   rax,rax,0x21fb7813
  ...
  7c:	83 7d f8 4c          	cmp    DWORD PTR [rbp-0x8],0x4c
  ...
  9d:	83 f8 0a             	cmp    eax,0xa
  a0:	0f 8e 76 ff ff ff    	jle    1c <main+0x1c>
  a6:	b8 2d 00 00 00       	mov    eax,0x2d
