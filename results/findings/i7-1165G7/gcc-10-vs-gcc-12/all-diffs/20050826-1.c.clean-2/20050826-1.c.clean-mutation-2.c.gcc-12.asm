  ...
  74:	ba 6c 08 00 00       	mov    edx,0x86c
  79:	be 05 00 00 00       	mov    esi,0x5
  7e:	48 8d 05 00 00 00 00 	lea    rax,[rip+0x0]        # 85 <foo+0x19>
  85:	48 89 c7             	mov    rdi,rax
  88:	e8 00 00 00 00       	call   8d <foo+0x21>
  8d:	c6 05 00 00 00 00 21 	mov    BYTE PTR [rip+0x0],0x21        # 94 <foo+0x28>
  ...
  dc:	b8 2b 00 00 00       	mov    eax,0x2b
  e1:	5d                   	pop    rbp
  e2:	c3                   	ret    
