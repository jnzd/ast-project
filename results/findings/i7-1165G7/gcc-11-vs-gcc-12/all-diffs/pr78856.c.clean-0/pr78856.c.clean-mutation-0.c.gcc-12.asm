  ...
  1b:	c7 45 f0 59 00 00 00 	mov    DWORD PTR [rbp-0x10],0x59
  22:	c7 45 f8 4a 00 00 00 	mov    DWORD PTR [rbp-0x8],0x4a
  29:	e9 8a 00 00 00       	jmp    b8 <main+0xb8>
  2e:	c7 45 fc 61 00 00 00 	mov    DWORD PTR [rbp-0x4],0x61
  35:	c7 45 f4 66 00 00 00 	mov    DWORD PTR [rbp-0xc],0x66
  ...
  52:	c7 04 02 3b 00 00 00 	mov    DWORD PTR [rdx+rax*1],0x3b
  59:	83 45 f4 01          	add    DWORD PTR [rbp-0xc],0x1
  5d:	83 7d f4 32          	cmp    DWORD PTR [rbp-0xc],0x32
  ...
  91:	c7 45 f8 79 00 00 00 	mov    DWORD PTR [rbp-0x8],0x79
  ...
  ae:	83 7d fc 76          	cmp    DWORD PTR [rbp-0x4],0x76
  b2:	7e b1                	jle    65 <main+0x65>
  b4:	83 45 f0 37          	add    DWORD PTR [rbp-0x10],0x37
  b8:	83 7d f0 36          	cmp    DWORD PTR [rbp-0x10],0x36
  bc:	0f 8e 6c ff ff ff    	jle    2e <main+0x2e>
  c2:	bf 79 00 00 00       	mov    edi,0x79
