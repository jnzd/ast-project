  ...
  3a:	48 8b 05 00 00 00 00 	mov    rax,QWORD PTR [rip+0x0]        # 41 <main+0x41>
  41:	8b 15 00 00 00 00    	mov    edx,DWORD PTR [rip+0x0]        # 47 <main+0x47>
  47:	83 c2 01             	add    edx,0x1
  4a:	89 15 00 00 00 00    	mov    DWORD PTR [rip+0x0],edx        # 50 <main+0x50>
  50:	8b 15 00 00 00 00    	mov    edx,DWORD PTR [rip+0x0]        # 56 <main+0x56>
  56:	48 63 d2             	movsxd rdx,edx
  59:	83 e2 0d             	and    edx,0xd
  5c:	48 01 d0             	add    rax,rdx
  5f:	48 89 c7             	mov    rdi,rax
  62:	e8 00 00 00 00       	call   67 <main+0x67>
  67:	48 83 f8 08          	cmp    rax,0x8
  6b:	74 05                	je     72 <main+0x72>
  6d:	e8 00 00 00 00       	call   72 <main+0x72>
  72:	8b 05 00 00 00 00    	mov    eax,DWORD PTR [rip+0x0]        # 78 <main+0x78>
  78:	83 f8 68             	cmp    eax,0x68
 ...
 11b:	48 8b 45 98          	mov    rax,QWORD PTR [rbp-0x68]
 ...
 2d0:	48 98                	cdqe   
 2d2:	83 e0 56             	and    eax,0x56
 2d5:	48 89 c1             	mov    rcx,rax
 2d8:	48 8b 45 98          	mov    rax,QWORD PTR [rbp-0x68]
 ...
 2f9:	83 f8 25             	cmp    eax,0x25
 2fc:	75 0b                	jne    309 <main+0x309>
 2fe:	8b 05 00 00 00 00    	mov    eax,DWORD PTR [rip+0x0]        # 304 <main+0x304>
 304:	83 f8 77             	cmp    eax,0x77
 307:	74 05                	je     30e <main+0x30e>
 309:	e8 00 00 00 00       	call   30e <main+0x30e>
 30e:	c6 45 d2 20          	mov    BYTE PTR [rbp-0x2e],0x20
 312:	c6 45 b8 00          	mov    BYTE PTR [rbp-0x48],0x0
 316:	c7 05 00 00 00 00 16 	mov    DWORD PTR [rip+0x0],0x16        # 320 <main+0x320>
 31d:	00 00 00 
 320:	c7 05 00 00 00 00 16 	mov    DWORD PTR [rip+0x0],0x16        # 32a <main+0x32a>
 327:	00 00 00 
 ...
 455:	48 8d 45 a0          	lea    rax,[rbp-0x60]
 459:	ba 3c 00 00 00       	mov    edx,0x3c
 45e:	be 20 00 00 00       	mov    esi,0x20
 463:	48 89 c7             	mov    rdi,rax
 466:	e8 00 00 00 00       	call   46b <main+0x46b>
 46b:	48 8d 45 a0          	lea    rax,[rbp-0x60]
 46f:	ba 5e 00 00 00       	mov    edx,0x5e
 ...
 492:	48 8d 45 a0          	lea    rax,[rbp-0x60]
 496:	ba 4b 00 00 00       	mov    edx,0x4b
 ...
 4bd:	00 00 00 
 4c0:	ba 52 00 00 00       	mov    edx,0x52
 ...
 577:	ba 66 00 00 00       	mov    edx,0x66
 ...
 59b:	83 f8 5f             	cmp    eax,0x5f
 59e:	75 22                	jne    5c2 <main+0x5c2>
 5a0:	ba 2c 00 00 00       	mov    edx,0x2c
 ...
 5c7:	c7 05 00 00 00 00 54 	mov    DWORD PTR [rip+0x0],0x54        # 5d1 <main+0x5d1>
 5ce:	00 00 00 
 ...
 607:	be 58 00 00 00       	mov    esi,0x58
 ...
 67e:	ba 52 00 00 00       	mov    edx,0x52
 683:	be 64 00 00 00       	mov    esi,0x64
 ...
 6ce:	b8 1a 00 00 00       	mov    eax,0x1a
