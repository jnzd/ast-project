  ...
  22:	c7 45 f8 00 00 00 00 	mov    DWORD PTR [rbp-0x8],0x0
  29:	e9 8a 00 00 00       	jmp    b8 <main+0xb8>
  2e:	c7 45 fc 06 00 00 00 	mov    DWORD PTR [rbp-0x4],0x6
  35:	c7 45 f4 72 00 00 00 	mov    DWORD PTR [rbp-0xc],0x72
  ...
  52:	c7 04 02 77 00 00 00 	mov    DWORD PTR [rdx+rax*1],0x77
  ...
  91:	c7 45 f8 5e 00 00 00 	mov    DWORD PTR [rbp-0x8],0x5e
  ...
  ae:	83 7d fc 79          	cmp    DWORD PTR [rbp-0x4],0x79
  b2:	7e b1                	jle    65 <main+0x65>
  b4:	83 45 f0 31          	add    DWORD PTR [rbp-0x10],0x31
