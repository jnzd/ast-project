  ...
  20:	83 f8 47             	cmp    eax,0x47
  23:	74 05                	je     2a <main+0x2a>
  25:	e8 00 00 00 00       	call   2a <main+0x2a>
  2a:	bf 4a 00 00 00       	mov    edi,0x4a
  ...
  4b:	83 7d ec 43          	cmp    DWORD PTR [rbp-0x14],0x43
  4f:	75 07                	jne    58 <foo+0x24>
  51:	b8 7a 00 00 00       	mov    eax,0x7a
