  ...
  4b:	88 50 48             	mov    BYTE PTR [rax+0x48],dl
  4e:	90                   	nop
  ...
  70:	c7 05 00 00 00 00 7b 	mov    DWORD PTR [rip+0x0],0x7b        # 7a <main+0x25>
  77:	00 00 00 
  7a:	8b 05 00 00 00 00    	mov    eax,DWORD PTR [rip+0x0]        # 80 <main+0x2b>
  80:	6b c0 2e             	imul   eax,eax,0x2e
  83:	48 98                	cdqe   
 ...
 158:	bf 31 00 00 00       	mov    edi,0x31
