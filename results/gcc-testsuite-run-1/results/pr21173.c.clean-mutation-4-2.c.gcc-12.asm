  ...
  5e:	83 7d fc 14          	cmp    DWORD PTR [rbp-0x4],0x14
  ...
  83:	c7 45 fc 1b 00 00 00 	mov    DWORD PTR [rbp-0x4],0x1b
  ...
  b2:	83 7d fc 28          	cmp    DWORD PTR [rbp-0x4],0x28
  b6:	7e d4                	jle    8c <main+0x24>
  b8:	b8 08 00 00 00       	mov    eax,0x8
  bd:	c9                   	leave  
  be:	c3                   	ret    
