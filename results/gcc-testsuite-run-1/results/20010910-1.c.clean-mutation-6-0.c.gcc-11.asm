  ...
  62:	48 2d dc 00 00 00    	sub    rax,0xdc
  68:	48 01 d0             	add    rax,rdx
  6b:	c7 00 54 00 00 00    	mov    DWORD PTR [rax],0x54
  71:	90                   	nop
  72:	5d                   	pop    rbp
  73:	c3                   	ret    
  ...
  7c:	48 81 ec a0 02 00 00 	sub    rsp,0x2a0
  83:	64 48 8b 04 25 28 00 	mov    rax,QWORD PTR fs:0x28
  8a:	00 00 
  8c:	48 89 45 f8          	mov    QWORD PTR [rbp-0x8],rax
  90:	31 c0                	xor    eax,eax
  92:	c7 85 6c fd ff ff 67 	mov    DWORD PTR [rbp-0x294],0x67
  99:	00 00 00 
  9c:	eb 2d                	jmp    cb <main+0x57>
  9e:	8b 85 6c fd ff ff    	mov    eax,DWORD PTR [rbp-0x294]
  a4:	48 98                	cdqe   
  a6:	c7 84 85 40 fe ff ff 	mov    DWORD PTR [rbp+rax*4-0x1c0],0x32
  ad:	32 00 00 00 
  b1:	8b 85 6c fd ff ff    	mov    eax,DWORD PTR [rbp-0x294]
  b7:	48 98                	cdqe   
  b9:	c7 84 85 78 fd ff ff 	mov    DWORD PTR [rbp+rax*4-0x288],0x79
  c0:	79 00 00 00 
  c4:	83 85 6c fd ff ff 01 	add    DWORD PTR [rbp-0x294],0x1
  cb:	83 bd 6c fd ff ff 1c 	cmp    DWORD PTR [rbp-0x294],0x1c
  d2:	7e ca                	jle    9e <main+0x2a>
  d4:	48 8d 85 40 fe ff ff 	lea    rax,[rbp-0x1c0]
  db:	48 89 85 70 fd ff ff 	mov    QWORD PTR [rbp-0x290],rax
  e2:	48 8d 85 70 fd ff ff 	lea    rax,[rbp-0x290]
  e9:	48 89 c7             	mov    rdi,rax
  ec:	e8 0f ff ff ff       	call   0 <epic_init_ring>
  f1:	c7 85 6c fd ff ff 56 	mov    DWORD PTR [rbp-0x294],0x56
  f8:	00 00 00 
  fb:	eb 53                	jmp    150 <main+0xdc>
  fd:	8b 85 6c fd ff ff    	mov    eax,DWORD PTR [rbp-0x294]
 103:	48 98                	cdqe   
 105:	8b 84 85 40 fe ff ff 	mov    eax,DWORD PTR [rbp+rax*4-0x1c0]
 10c:	8b 95 6c fd ff ff    	mov    edx,DWORD PTR [rbp-0x294]
 ...
 130:	8b 85 6c fd ff ff    	mov    eax,DWORD PTR [rbp-0x294]
 136:	48 98                	cdqe   
 138:	8b 84 85 78 fd ff ff 	mov    eax,DWORD PTR [rbp+rax*4-0x288]
 13f:	83 f8 46             	cmp    eax,0x46
 142:	74 05                	je     149 <main+0xd5>
 144:	e8 00 00 00 00       	call   149 <main+0xd5>
 149:	83 85 6c fd ff ff 01 	add    DWORD PTR [rbp-0x294],0x1
 150:	83 bd 6c fd ff ff 07 	cmp    DWORD PTR [rbp-0x294],0x7
 157:	7e a4                	jle    fd <main+0x89>
 159:	b8 40 00 00 00       	mov    eax,0x40
