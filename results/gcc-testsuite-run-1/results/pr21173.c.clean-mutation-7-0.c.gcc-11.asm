   ...
   c:	c7 45 fc 1d 00 00 00 	mov    DWORD PTR [rbp-0x4],0x1d
  ...
  5b:	83 7d fc 5e          	cmp    DWORD PTR [rbp-0x4],0x5e
  ...
  80:	c7 45 fc 1e 00 00 00 	mov    DWORD PTR [rbp-0x4],0x1e
  ...
  af:	83 7d fc 1b          	cmp    DWORD PTR [rbp-0x4],0x1b
  b3:	7e d4                	jle    89 <main+0x24>
  b5:	b8 31 00 00 00       	mov    eax,0x31
  ba:	c9                   	leave  
  bb:	c3                   	ret    
