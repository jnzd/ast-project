  ...
  69:	b8 09 6d 22 50       	mov    eax,0x50226d09
  ...
  9f:	c7 45 d4 3b 58 bc 25 	mov    DWORD PTR [rbp-0x2c],0x25bc583b
  ...
  d6:	be 66 6b 3b 1d       	mov    esi,0x1d3b6b66
 ...
 140:	ba 77 79 24 1c       	mov    edx,0x1c247977
 145:	be 1d 2f 19 4a       	mov    esi,0x4a192f1d
 14a:	b8 00 00 00 00       	mov    eax,0x0
 14f:	e8 00 00 00 00       	call   154 <main+0xd0>
 154:	48 83 c4 40          	add    rsp,0x40
 158:	b8 57 d7 b3 62       	mov    eax,0x62b3d757
