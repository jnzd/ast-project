   ...
   c:	c7 45 f4 22 00 00 00 	mov    DWORD PTR [rbp-0xc],0x22
  13:	48 c7 45 f8 0c 00 00 	mov    QWORD PTR [rbp-0x8],0xc
  1a:	00 
  ...
  2a:	83 7d f4 6d          	cmp    DWORD PTR [rbp-0xc],0x6d
  2e:	74 05                	je     35 <main+0x35>
  30:	e8 00 00 00 00       	call   35 <main+0x35>
  35:	b8 53 00 00 00       	mov    eax,0x53
  3a:	c9                   	leave  
  3b:	c3                   	ret    
