  ...
  65:	b8 3d 52 ca 11       	mov    eax,0x11ca523d
  ...
  88:	c7 45 e4 29 f9 05 0a 	mov    DWORD PTR [rbp-0x1c],0xa05f929
  ...
  bf:	be 1c e2 48 59       	mov    esi,0x5948e21c
 ...
 129:	ba 33 53 3c 4e       	mov    edx,0x4e3c5333
 12e:	be c6 c5 a5 63       	mov    esi,0x63a5c5c6
 133:	b8 00 00 00 00       	mov    eax,0x0
 138:	e8 00 00 00 00       	call   13d <main+0xbd>
 13d:	48 83 c4 40          	add    rsp,0x40
 141:	b8 38 e3 ca 7b       	mov    eax,0x7bcae338
 146:	c9                   	leave
 147:	c3                   	ret
