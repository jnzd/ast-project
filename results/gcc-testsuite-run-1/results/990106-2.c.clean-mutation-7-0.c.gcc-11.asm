  ...
  29:	b8 7c 00 00 00       	mov    eax,0x7c
  ...
  3b:	83 45 fc 20          	add    DWORD PTR [rbp-0x4],0x20
  ...
  5d:	c7 45 f8 25 00 00 00 	mov    DWORD PTR [rbp-0x8],0x25
  ...
  71:	83 7d fc 7e          	cmp    DWORD PTR [rbp-0x4],0x7e
  75:	74 05                	je     7c <main+0x32>
  77:	e8 00 00 00 00       	call   7c <main+0x32>
  7c:	bf 5f 00 00 00       	mov    edi,0x5f
  81:	e8 00 00 00 00       	call   86 <main+0x3c>
