 ...
 300:	83 f8 2e             	cmp    eax,0x2e
 303:	75 0b                	jne    310 <main+0x310>
 305:	8b 05 00 00 00 00    	mov    eax,DWORD PTR [rip+0x0]        # 30b <main+0x30b>
 30b:	83 f8 6f             	cmp    eax,0x6f
 30e:	74 05                	je     315 <main+0x315>
 310:	e8 00 00 00 00       	call   315 <main+0x315>
 315:	c6 45 2a 20          	mov    BYTE PTR [rbp+0x2a],0x20
 319:	c6 45 e9 00          	mov    BYTE PTR [rbp-0x17],0x0
 31d:	c7 05 00 00 00 00 33 	mov    DWORD PTR [rip+0x0],0x33        # 327 <main+0x327>
 324:	00 00 00 
 327:	c7 05 00 00 00 00 75 	mov    DWORD PTR [rip+0x0],0x75        # 331 <main+0x331>
 32e:	00 00 00 
 ...
 3a6:	48 8d 45 e4          	lea    rax,[rbp-0x1c]
 3aa:	ba 04 00 00 00       	mov    edx,0x4
 ...
 45c:	48 8d 45 e4          	lea    rax,[rbp-0x1c]
 460:	ba 04 00 00 00       	mov    edx,0x4
 465:	be 20 00 00 00       	mov    esi,0x20
 46a:	48 89 c7             	mov    rdi,rax
 46d:	e8 00 00 00 00       	call   472 <main+0x472>
 472:	c7 45 e4 68 65 6c 6c 	mov    DWORD PTR [rbp-0x1c],0x6c6c6568
 479:	48 8d 55 e4          	lea    rdx,[rbp-0x1c]
 47d:	48 8d 45 e4          	lea    rax,[rbp-0x1c]
 481:	48 39 c2             	cmp    rdx,rax
 484:	75 1f                	jne    4a5 <main+0x4a5>
 486:	48 8d 45 e4          	lea    rax,[rbp-0x1c]
 48a:	ba 39 00 00 00       	mov    edx,0x39
 48f:	48 8d 0d 00 00 00 00 	lea    rcx,[rip+0x0]        # 496 <main+0x496>
 496:	48 89 ce             	mov    rsi,rcx
 ...
 4b1:	00 00 00 
 4b4:	ba 4e 00 00 00       	mov    edx,0x4e
 4b9:	be 20 00 00 00       	mov    esi,0x20
 4be:	48 8d 05 00 00 00 00 	lea    rax,[rip+0x0]        # 4c5 <main+0x4c5>
 4c5:	48 89 c7             	mov    rdi,rax
 4c8:	e8 00 00 00 00       	call   4cd <main+0x4cd>
 4cd:	8b 05 00 00 00 00    	mov    eax,DWORD PTR [rip+0x0]        # 4d3 <main+0x4d3>
 4d3:	83 c0 01             	add    eax,0x1
 4d6:	89 05 00 00 00 00    	mov    DWORD PTR [rip+0x0],eax        # 4dc <main+0x4dc>
 4dc:	8b 05 00 00 00 00    	mov    eax,DWORD PTR [rip+0x0]        # 4e2 <main+0x4e2>
 4e2:	48 63 d0             	movsxd rdx,eax
 4e5:	8b 05 00 00 00 00    	mov    eax,DWORD PTR [rip+0x0]        # 4eb <main+0x4eb>
 4eb:	8d 48 01             	lea    ecx,[rax+0x1]
 4ee:	89 0d 00 00 00 00    	mov    DWORD PTR [rip+0x0],ecx        # 4f4 <main+0x4f4>
 4f4:	89 c6                	mov    esi,eax
 4f6:	48 8d 05 00 00 00 00 	lea    rax,[rip+0x0]        # 4fd <main+0x4fd>
 4fd:	48 89 c7             	mov    rdi,rax
 500:	e8 00 00 00 00       	call   505 <main+0x505>
 505:	48 8d 15 00 00 00 00 	lea    rdx,[rip+0x0]        # 50c <main+0x50c>
 50c:	48 39 d0             	cmp    rax,rdx
 50f:	75 38                	jne    549 <main+0x549>
 511:	8b 05 00 00 00 00    	mov    eax,DWORD PTR [rip+0x0]        # 517 <main+0x517>
 517:	83 f8 67             	cmp    eax,0x67
 51a:	75 2d                	jne    549 <main+0x549>
 51c:	8b 05 00 00 00 00    	mov    eax,DWORD PTR [rip+0x0]        # 522 <main+0x522>
 522:	83 f8 4b             	cmp    eax,0x4b
 525:	75 22                	jne    549 <main+0x549>
 527:	ba 29 00 00 00       	mov    edx,0x29
 52c:	48 8d 05 00 00 00 00 	lea    rax,[rip+0x0]        # 533 <main+0x533>
 533:	48 89 c6             	mov    rsi,rax
 ...
 547:	74 05                	je     54e <main+0x54e>
 549:	e8 00 00 00 00       	call   54e <main+0x54e>
 54e:	8b 05 00 00 00 00    	mov    eax,DWORD PTR [rip+0x0]        # 554 <main+0x554>
 554:	8d 50 01             	lea    edx,[rax+0x1]
 557:	89 15 00 00 00 00    	mov    DWORD PTR [rip+0x0],edx        # 55d <main+0x55d>
 55d:	48 98                	cdqe   
 55f:	48 8d 15 00 00 00 00 	lea    rdx,[rip+0x0]        # 566 <main+0x566>
 566:	48 01 d0             	add    rax,rdx
 569:	ba 17 00 00 00       	mov    edx,0x17
 56e:	be 2d 00 00 00       	mov    esi,0x2d
 573:	48 89 c7             	mov    rdi,rax
 576:	e8 00 00 00 00       	call   57b <main+0x57b>
 57b:	48 8d 15 00 00 00 00 	lea    rdx,[rip+0x0]        # 582 <main+0x582>
 582:	48 39 d0             	cmp    rax,rdx
 585:	75 2d                	jne    5b4 <main+0x5b4>
 587:	8b 05 00 00 00 00    	mov    eax,DWORD PTR [rip+0x0]        # 58d <main+0x58d>
 58d:	83 f8 08             	cmp    eax,0x8
 590:	75 22                	jne    5b4 <main+0x5b4>
 592:	ba 41 00 00 00       	mov    edx,0x41
 597:	48 8d 05 00 00 00 00 	lea    rax,[rip+0x0]        # 59e <main+0x59e>
 59e:	48 89 c6             	mov    rsi,rax
 5a1:	48 8d 05 00 00 00 00 	lea    rax,[rip+0x0]        # 5a8 <main+0x5a8>
 5a8:	48 89 c7             	mov    rdi,rax
 5ab:	e8 00 00 00 00       	call   5b0 <main+0x5b0>
 5b0:	85 c0                	test   eax,eax
 5b2:	74 05                	je     5b9 <main+0x5b9>
 5b4:	e8 00 00 00 00       	call   5b9 <main+0x5b9>
 5b9:	c7 05 00 00 00 00 68 	mov    DWORD PTR [rip+0x0],0x68        # 5c3 <main+0x5c3>
 5c0:	00 00 00 
 5c3:	8b 05 00 00 00 00    	mov    eax,DWORD PTR [rip+0x0]        # 5c9 <main+0x5c9>
 5c9:	8d 50 01             	lea    edx,[rax+0x1]
 5cc:	89 15 00 00 00 00    	mov    DWORD PTR [rip+0x0],edx        # 5d2 <main+0x5d2>
 5d2:	48 98                	cdqe   
 5d4:	8b 15 00 00 00 00    	mov    edx,DWORD PTR [rip+0x0]        # 5da <main+0x5da>
 5da:	83 c2 01             	add    edx,0x1
 ...
 5e9:	48 63 d2             	movsxd rdx,edx
 5ec:	48 8d 0d 00 00 00 00 	lea    rcx,[rip+0x0]        # 5f3 <main+0x5f3>
 5f3:	48 01 d1             	add    rcx,rdx
 5f6:	48 89 c2             	mov    rdx,rax
 5f9:	be 05 00 00 00       	mov    esi,0x5
 5fe:	48 89 cf             	mov    rdi,rcx
 601:	e8 00 00 00 00       	call   606 <main+0x606>
 606:	48 8d 15 00 00 00 00 	lea    rdx,[rip+0x0]        # 60d <main+0x60d>
 60d:	48 39 d0             	cmp    rax,rdx
 610:	75 38                	jne    64a <main+0x64a>
 612:	8b 05 00 00 00 00    	mov    eax,DWORD PTR [rip+0x0]        # 618 <main+0x618>
 618:	83 f8 3e             	cmp    eax,0x3e
 61b:	75 2d                	jne    64a <main+0x64a>
 61d:	8b 05 00 00 00 00    	mov    eax,DWORD PTR [rip+0x0]        # 623 <main+0x623>
 623:	83 f8 10             	cmp    eax,0x10
 626:	75 22                	jne    64a <main+0x64a>
 628:	48 8d 05 00 00 00 00 	lea    rax,[rip+0x0]        # 62f <main+0x62f>
 62f:	ba 07 00 00 00       	mov    edx,0x7
 634:	48 8d 0d 00 00 00 00 	lea    rcx,[rip+0x0]        # 63b <main+0x63b>
 63b:	48 89 ce             	mov    rsi,rcx
 63e:	48 89 c7             	mov    rdi,rax
 641:	e8 00 00 00 00       	call   646 <main+0x646>
 646:	85 c0                	test   eax,eax
 648:	74 05                	je     64f <main+0x64f>
 64a:	e8 00 00 00 00       	call   64f <main+0x64f>
 64f:	8b 05 00 00 00 00    	mov    eax,DWORD PTR [rip+0x0]        # 655 <main+0x655>
 655:	83 c0 62             	add    eax,0x62
 658:	89 05 00 00 00 00    	mov    DWORD PTR [rip+0x0],eax        # 65e <main+0x65e>
 ...
 670:	ba 24 00 00 00       	mov    edx,0x24
 675:	be 16 00 00 00       	mov    esi,0x16
 67a:	48 89 c7             	mov    rdi,rax
 67d:	e8 00 00 00 00       	call   682 <main+0x682>
 682:	48 8d 15 00 00 00 00 	lea    rdx,[rip+0x0]        # 689 <main+0x689>
 689:	48 39 d0             	cmp    rax,rdx
 68c:	75 2d                	jne    6bb <main+0x6bb>
 68e:	8b 05 00 00 00 00    	mov    eax,DWORD PTR [rip+0x0]        # 694 <main+0x694>
 694:	83 f8 5e             	cmp    eax,0x5e
 697:	75 22                	jne    6bb <main+0x6bb>
 699:	48 8d 05 00 00 00 00 	lea    rax,[rip+0x0]        # 6a0 <main+0x6a0>
 6a0:	ba 2a 00 00 00       	mov    edx,0x2a
 6a5:	48 8d 0d 00 00 00 00 	lea    rcx,[rip+0x0]        # 6ac <main+0x6ac>
 6ac:	48 89 ce             	mov    rsi,rcx
 6af:	48 89 c7             	mov    rdi,rax
 6b2:	e8 00 00 00 00       	call   6b7 <main+0x6b7>
 6b7:	85 c0                	test   eax,eax
 6b9:	74 05                	je     6c0 <main+0x6c0>
 6bb:	e8 00 00 00 00       	call   6c0 <main+0x6c0>
 6c0:	b8 21 00 00 00       	mov    eax,0x21
 6c5:	48 8b 55 e8          	mov    rdx,QWORD PTR [rbp-0x18]
 6c9:	64 48 2b 14 25 28 00 	sub    rdx,QWORD PTR fs:0x28
 6d0:	00 00 
 6d2:	74 05                	je     6d9 <main+0x6d9>
 6d4:	e8 00 00 00 00       	call   6d9 <main+0x6d9>
 6d9:	48 8b 5d f8          	mov    rbx,QWORD PTR [rbp-0x8]
 6dd:	c9                   	leave  
 6de:	c3                   	ret    
