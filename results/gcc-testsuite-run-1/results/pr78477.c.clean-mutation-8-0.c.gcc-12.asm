  ...
  3e:	ba 22 00 00 00       	mov    edx,0x22
  ...
  5b:	ba 4e 00 00 00       	mov    edx,0x4e
  ...
  ac:	b8 6b 00 00 00       	mov    eax,0x6b
  b1:	5d                   	pop    rbp
  b2:	c3                   	ret    
