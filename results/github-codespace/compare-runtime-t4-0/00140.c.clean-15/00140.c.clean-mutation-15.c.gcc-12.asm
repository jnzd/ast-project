  ...
  65:	b8 c6 33 2d 6d       	mov    eax,0x6d2d33c6
  ...
  88:	c7 45 e4 4e c2 bd 48 	mov    DWORD PTR [rbp-0x1c],0x48bdc24e
  ...
  bf:	be 6c d9 1f 2b       	mov    esi,0x2b1fd96c
 ...
 129:	ba e1 61 19 70       	mov    edx,0x701961e1
 12e:	be f0 a8 15 02       	mov    esi,0x215a8f0
 133:	b8 00 00 00 00       	mov    eax,0x0
 138:	e8 00 00 00 00       	call   13d <main+0xbd>
 13d:	48 83 c4 40          	add    rsp,0x40
 141:	b8 2b 00 c4 2c       	mov    eax,0x2cc4002b
 146:	c9                   	leave
 147:	c3                   	ret
