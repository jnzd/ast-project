  ...
  69:	b8 8e cd d3 51       	mov    eax,0x51d3cd8e
  ...
  9f:	c7 45 d4 aa bc 79 2a 	mov    DWORD PTR [rbp-0x2c],0x2a79bcaa
  ...
  bc:	be 0e 4b 51 2c       	mov    esi,0x2c514b0e
