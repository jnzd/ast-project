  ...
  69:	b8 4e d4 a4 71       	mov    eax,0x71a4d44e
  ...
  9f:	c7 45 d4 65 7a fd 27 	mov    DWORD PTR [rbp-0x2c],0x27fd7a65
  ...
  d6:	be c0 50 4c 44       	mov    esi,0x444c50c0
 ...
 140:	ba 1a f9 17 4b       	mov    edx,0x4b17f91a
 145:	be bd bf 61 05       	mov    esi,0x561bfbd
 14a:	b8 00 00 00 00       	mov    eax,0x0
 14f:	e8 00 00 00 00       	call   154 <main+0xd0>
 154:	48 83 c4 40          	add    rsp,0x40
 158:	b8 b5 54 ce 37       	mov    eax,0x37ce54b5
