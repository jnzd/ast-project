  ...
  19:	c7 45 f8 27 00 00 00 	mov    DWORD PTR [rbp-0x8],0x27
  ...
  5d:	c7 45 fc 24 00 00 00 	mov    DWORD PTR [rbp-0x4],0x24
  ...
  80:	be 74 00 00 00       	mov    esi,0x74
  85:	bf 8b ff ff ff       	mov    edi,0xffffff8b
  ...
  bb:	b8 44 00 00 00       	mov    eax,0x44
  c0:	c9                   	leave  
  c1:	c3                   	ret    
