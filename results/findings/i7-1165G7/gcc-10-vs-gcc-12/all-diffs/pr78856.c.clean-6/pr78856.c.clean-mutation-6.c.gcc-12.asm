  ...
  1b:	c7 45 f0 6b 00 00 00 	mov    DWORD PTR [rbp-0x10],0x6b
  22:	c7 45 f8 0f 00 00 00 	mov    DWORD PTR [rbp-0x8],0xf
  29:	e9 8a 00 00 00       	jmp    b8 <main+0xb8>
  2e:	c7 45 fc 63 00 00 00 	mov    DWORD PTR [rbp-0x4],0x63
  35:	c7 45 f4 78 00 00 00 	mov    DWORD PTR [rbp-0xc],0x78
  ...
  52:	c7 04 02 61 00 00 00 	mov    DWORD PTR [rdx+rax*1],0x61
  ...
  91:	c7 45 f8 60 00 00 00 	mov    DWORD PTR [rbp-0x8],0x60
  ...
  ae:	83 7d fc 6d          	cmp    DWORD PTR [rbp-0x4],0x6d
  b2:	7e b1                	jle    65 <main+0x65>
  b4:	83 45 f0 37          	add    DWORD PTR [rbp-0x10],0x37
  b8:	83 7d f0 01          	cmp    DWORD PTR [rbp-0x10],0x1
  bc:	0f 8e 6c ff ff ff    	jle    2e <main+0x2e>
  c2:	bf 52 00 00 00       	mov    edi,0x52
