  ...
  69:	b8 ad 8b 72 40       	mov    eax,0x40728bad
  ...
  9f:	c7 45 d4 47 cc d2 3f 	mov    DWORD PTR [rbp-0x2c],0x3fd2cc47
  ...
  d6:	be d4 15 1c 08       	mov    esi,0x81c15d4
 ...
 140:	ba c4 2a d1 16       	mov    edx,0x16d12ac4
 145:	be 35 28 f8 05       	mov    esi,0x5f82835
 14a:	b8 00 00 00 00       	mov    eax,0x0
 14f:	e8 00 00 00 00       	call   154 <main+0xd0>
 154:	48 83 c4 40          	add    rsp,0x40
 158:	b8 ca 7a 24 04       	mov    eax,0x4247aca
