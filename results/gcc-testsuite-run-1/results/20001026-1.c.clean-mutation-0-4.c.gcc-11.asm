 ...
 1be:	48 be 31 31 31 31 31 	movabs rsi,0x3131313131313131
 1c5:	31 31 31 
 1c8:	48 bf 31 31 31 31 31 	movabs rdi,0x3131313131313131
 1cf:	31 31 31 
 1d2:	48 89 30             	mov    QWORD PTR [rax],rsi
 1d5:	48 89 78 08          	mov    QWORD PTR [rax+0x8],rdi
 1d9:	48 89 70 10          	mov    QWORD PTR [rax+0x10],rsi
 1dd:	48 89 78 18          	mov    QWORD PTR [rax+0x18],rdi
 1e1:	48 89 70 20          	mov    QWORD PTR [rax+0x20],rsi
 1e5:	48 89 78 28          	mov    QWORD PTR [rax+0x28],rdi
 1e9:	48 89 70 30          	mov    QWORD PTR [rax+0x30],rsi
 1ed:	48 89 78 38          	mov    QWORD PTR [rax+0x38],rdi
 1f1:	48 89 70 40          	mov    QWORD PTR [rax+0x40],rsi
 1f5:	48 89 78 48          	mov    QWORD PTR [rax+0x48],rdi
 1f9:	48 89 70 50          	mov    QWORD PTR [rax+0x50],rsi
 1fd:	48 89 78 58          	mov    QWORD PTR [rax+0x58],rdi
 201:	48 b9 31 31 31 31 31 	movabs rcx,0x3131313131313131
 208:	31 31 31 
 20b:	48 89 48 60          	mov    QWORD PTR [rax+0x60],rcx
 20f:	48 8d 45 90          	lea    rax,[rbp-0x70]
 213:	48 89 c7             	mov    rdi,rax
 216:	b8 00 00 00 00       	mov    eax,0x0
 21b:	e8 b6 fe ff ff       	call   d6 <build_real_from_int_cst_1>
 220:	48 8b 45 c8          	mov    rax,QWORD PTR [rbp-0x38]
 224:	48 83 f8 18          	cmp    rax,0x18
 228:	75 05                	jne    22f <main+0x90>
 22a:	e8 00 00 00 00       	call   22f <main+0x90>
 22f:	b8 68 00 00 00       	mov    eax,0x68
 234:	48 8b 55 f8          	mov    rdx,QWORD PTR [rbp-0x8]
 238:	64 48 2b 14 25 28 00 	sub    rdx,QWORD PTR fs:0x28
 23f:	00 00 
 241:	74 05                	je     248 <main+0xa9>
 243:	e8 00 00 00 00       	call   248 <main+0xa9>
 248:	c9                   	leave  
 249:	c3                   	ret    
