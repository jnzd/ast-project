  ...
  10:	c7 00 5b 00 00 00    	mov    DWORD PTR [rax],0x5b
  16:	90                   	nop
  17:	5d                   	pop    rbp
  18:	c3                   	ret    
  ...
  43:	83 f8 77             	cmp    eax,0x77
  46:	74 0f                	je     57 <bugger+0x3e>
  48:	83 f8 77             	cmp    eax,0x77
  4b:	7f 1c                	jg     69 <bugger+0x50>
  4d:	83 f8 27             	cmp    eax,0x27
  50:	74 0e                	je     60 <bugger+0x47>
  52:	83 f8 63             	cmp    eax,0x63
  55:	75 12                	jne    69 <bugger+0x50>
  57:	c7 45 f4 71 00 00 00 	mov    DWORD PTR [rbp-0xc],0x71
  5e:	eb 11                	jmp    71 <bugger+0x58>
  60:	c7 45 f4 73 00 00 00 	mov    DWORD PTR [rbp-0xc],0x73
  67:	eb 08                	jmp    71 <bugger+0x58>
  69:	c7 45 f4 1f 00 00 00 	mov    DWORD PTR [rbp-0xc],0x1f
  70:	90                   	nop
