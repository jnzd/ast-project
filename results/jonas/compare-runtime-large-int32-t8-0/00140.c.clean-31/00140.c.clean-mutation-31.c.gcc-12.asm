  ...
  69:	b8 6f 75 ed 75       	mov    eax,0x75ed756f
  ...
  9f:	c7 45 d4 f4 b2 b7 0e 	mov    DWORD PTR [rbp-0x2c],0xeb7b2f4
  ...
  d6:	be 7b 33 ad 39       	mov    esi,0x39ad337b
 ...
 140:	ba 77 a4 4c 31       	mov    edx,0x314ca477
 145:	be e4 25 ee 02       	mov    esi,0x2ee25e4
 14a:	b8 00 00 00 00       	mov    eax,0x0
 14f:	e8 00 00 00 00       	call   154 <main+0xd0>
 154:	48 83 c4 40          	add    rsp,0x40
 158:	b8 fb 5a 5a 74       	mov    eax,0x745a5afb
