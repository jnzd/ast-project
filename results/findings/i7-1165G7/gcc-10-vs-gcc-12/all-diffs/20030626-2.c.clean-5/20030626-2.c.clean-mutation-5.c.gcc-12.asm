   ...
   c:	c7 45 f8 2b 00 00 00 	mov    DWORD PTR [rbp-0x8],0x2b
  ...
  54:	83 7d fc 9c          	cmp    DWORD PTR [rbp-0x4],0xffffff9c
  58:	75 06                	jne    60 <main+0x60>
  5a:	83 7d f8 13          	cmp    DWORD PTR [rbp-0x8],0x13
  5e:	74 05                	je     65 <main+0x65>
  60:	e8 00 00 00 00       	call   65 <main+0x65>
  65:	b8 1f 00 00 00       	mov    eax,0x1f
  6a:	c9                   	leave  
  6b:	c3                   	ret    
