  ...
  65:	b8 02 64 23 03       	mov    eax,0x3236402
  ...
  88:	c7 45 e4 4b 7b 3e 31 	mov    DWORD PTR [rbp-0x1c],0x313e7b4b
  ...
  bf:	be dd be 85 0e       	mov    esi,0xe85bedd
 ...
 129:	ba 50 a3 9f 7f       	mov    edx,0x7f9fa350
 12e:	be cf 51 a6 43       	mov    esi,0x43a651cf
 133:	b8 00 00 00 00       	mov    eax,0x0
 138:	e8 00 00 00 00       	call   13d <main+0xbd>
 13d:	48 83 c4 40          	add    rsp,0x40
 141:	b8 80 37 08 16       	mov    eax,0x16083780
 146:	c9                   	leave
 147:	c3                   	ret
