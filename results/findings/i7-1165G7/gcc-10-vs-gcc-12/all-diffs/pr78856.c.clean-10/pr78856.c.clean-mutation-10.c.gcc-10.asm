  ...
  19:	c7 45 f0 5e 00 00 00 	mov    DWORD PTR [rbp-0x10],0x5e
  20:	c7 45 f8 08 00 00 00 	mov    DWORD PTR [rbp-0x8],0x8
  27:	e9 8a 00 00 00       	jmp    b6 <main+0xb6>
  2c:	c7 45 fc 7b 00 00 00 	mov    DWORD PTR [rbp-0x4],0x7b
  33:	c7 45 f4 4e 00 00 00 	mov    DWORD PTR [rbp-0xc],0x4e
  ...
  5b:	83 7d f4 06          	cmp    DWORD PTR [rbp-0xc],0x6
  ...
  ac:	83 7d fc 0c          	cmp    DWORD PTR [rbp-0x4],0xc
  b0:	7e b1                	jle    63 <main+0x63>
  b2:	83 45 f0 02          	add    DWORD PTR [rbp-0x10],0x2
  b6:	83 7d f0 6e          	cmp    DWORD PTR [rbp-0x10],0x6e
  ba:	0f 8e 6c ff ff ff    	jle    2c <main+0x2c>
  c0:	bf 43 00 00 00       	mov    edi,0x43
