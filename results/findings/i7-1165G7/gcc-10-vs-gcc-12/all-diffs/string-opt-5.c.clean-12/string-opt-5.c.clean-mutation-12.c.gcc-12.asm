 ...
 300:	83 f8 7e             	cmp    eax,0x7e
 303:	75 0b                	jne    310 <main+0x310>
 305:	8b 05 00 00 00 00    	mov    eax,DWORD PTR [rip+0x0]        # 30b <main+0x30b>
 30b:	83 f8 64             	cmp    eax,0x64
 30e:	74 05                	je     315 <main+0x315>
 310:	e8 00 00 00 00       	call   315 <main+0x315>
 315:	c6 45 37 20          	mov    BYTE PTR [rbp+0x37],0x20
 319:	c6 45 f7 00          	mov    BYTE PTR [rbp-0x9],0x0
 31d:	c7 05 00 00 00 00 3a 	mov    DWORD PTR [rip+0x0],0x3a        # 327 <main+0x327>
 324:	00 00 00 
 327:	c7 05 00 00 00 00 77 	mov    DWORD PTR [rip+0x0],0x77        # 331 <main+0x331>
 32e:	00 00 00 
 ...
 383:	48 8d 45 e5          	lea    rax,[rbp-0x1b]
 387:	48 83 c0 49          	add    rax,0x49
 ...
 3a6:	48 8d 45 e5          	lea    rax,[rbp-0x1b]
 3aa:	ba 03 00 00 00       	mov    edx,0x3
 ...
 45c:	48 8d 45 e5          	lea    rax,[rbp-0x1b]
 460:	ba 03 00 00 00       	mov    edx,0x3
 465:	be 20 00 00 00       	mov    esi,0x20
 46a:	48 89 c7             	mov    rdi,rax
 46d:	e8 00 00 00 00       	call   472 <main+0x472>
 472:	48 8d 45 e5          	lea    rax,[rbp-0x1b]
 476:	ba 7a 00 00 00       	mov    edx,0x7a
 ...
 490:	48 8d 45 e5          	lea    rax,[rbp-0x1b]
 494:	48 39 c2             	cmp    rdx,rax
 497:	75 1f                	jne    4b8 <main+0x4b8>
 499:	48 8d 45 e5          	lea    rax,[rbp-0x1b]
 49d:	ba 47 00 00 00       	mov    edx,0x47
 ...
 4c4:	00 00 00 
 4c7:	ba 7f 00 00 00       	mov    edx,0x7f
 ...
 57c:	ba 58 00 00 00       	mov    edx,0x58
 ...
 5a0:	83 f8 6f             	cmp    eax,0x6f
 5a3:	75 22                	jne    5c7 <main+0x5c7>
 5a5:	ba 08 00 00 00       	mov    edx,0x8
 ...
 5cc:	c7 05 00 00 00 00 78 	mov    DWORD PTR [rip+0x0],0x78        # 5d6 <main+0x5d6>
 5d3:	00 00 00 
 ...
 60c:	be 04 00 00 00       	mov    esi,0x4
 ...
 683:	ba 35 00 00 00       	mov    edx,0x35
 688:	be 15 00 00 00       	mov    esi,0x15
 ...
 6d3:	b8 37 00 00 00       	mov    eax,0x37
