  ...
  12:	c7 45 fc 42 00 00 00 	mov    DWORD PTR [rbp-0x4],0x42
  19:	c7 45 f8 70 00 00 00 	mov    DWORD PTR [rbp-0x8],0x70
  ...
  5d:	c7 45 fc 02 00 00 00 	mov    DWORD PTR [rbp-0x4],0x2
  ...
  80:	be 46 00 00 00       	mov    esi,0x46
  ...
  bc:	b8 20 00 00 00       	mov    eax,0x20
  c1:	c9                   	leave  
  c2:	c3                   	ret    
