  ...
  69:	b8 fa 93 d2 40       	mov    eax,0x40d293fa
  ...
  9f:	c7 45 d4 35 8e 4c 03 	mov    DWORD PTR [rbp-0x2c],0x34c8e35
  ...
  d6:	be 1e 6b 3f 01       	mov    esi,0x13f6b1e
 ...
 140:	ba f9 6b 02 0b       	mov    edx,0xb026bf9
 145:	be c7 bc a5 48       	mov    esi,0x48a5bcc7
 14a:	b8 00 00 00 00       	mov    eax,0x0
 14f:	e8 00 00 00 00       	call   154 <main+0xd0>
 154:	48 83 c4 40          	add    rsp,0x40
 158:	b8 51 52 85 7d       	mov    eax,0x7d855251
