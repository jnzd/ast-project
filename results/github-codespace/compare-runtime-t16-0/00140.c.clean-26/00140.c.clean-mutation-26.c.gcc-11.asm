  ...
  69:	b8 de fb 90 1b       	mov    eax,0x1b90fbde
  ...
  9f:	c7 45 d4 05 98 b1 51 	mov    DWORD PTR [rbp-0x2c],0x51b19805
  ...
  bc:	be 7c da 97 29       	mov    esi,0x2997da7c
