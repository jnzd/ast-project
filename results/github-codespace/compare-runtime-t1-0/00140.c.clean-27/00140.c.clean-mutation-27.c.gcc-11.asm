  ...
  69:	b8 fe 84 fe 27       	mov    eax,0x27fe84fe
  ...
  9f:	c7 45 d4 ee 72 b7 08 	mov    DWORD PTR [rbp-0x2c],0x8b772ee
  ...
  bc:	be 0a 3d a1 27       	mov    esi,0x27a13d0a
