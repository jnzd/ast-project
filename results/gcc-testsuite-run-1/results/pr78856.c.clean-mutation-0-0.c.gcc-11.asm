  ...
  19:	c7 45 f0 13 00 00 00 	mov    DWORD PTR [rbp-0x10],0x13
  20:	c7 45 f8 3e 00 00 00 	mov    DWORD PTR [rbp-0x8],0x3e
  27:	e9 8a 00 00 00       	jmp    b6 <main+0xb6>
  2c:	c7 45 fc 20 00 00 00 	mov    DWORD PTR [rbp-0x4],0x20
  33:	c7 45 f4 6f 00 00 00 	mov    DWORD PTR [rbp-0xc],0x6f
  ...
  50:	c7 04 02 36 00 00 00 	mov    DWORD PTR [rdx+rax*1],0x36
  57:	83 45 f4 01          	add    DWORD PTR [rbp-0xc],0x1
  5b:	83 7d f4 5b          	cmp    DWORD PTR [rbp-0xc],0x5b
  ...
  8f:	c7 45 f8 34 00 00 00 	mov    DWORD PTR [rbp-0x8],0x34
  ...
  ac:	83 7d fc 57          	cmp    DWORD PTR [rbp-0x4],0x57
  b0:	7e b1                	jle    63 <main+0x63>
  b2:	83 45 f0 16          	add    DWORD PTR [rbp-0x10],0x16
  b6:	83 7d f0 02          	cmp    DWORD PTR [rbp-0x10],0x2
  ba:	0f 8e 6c ff ff ff    	jle    2c <main+0x2c>
  c0:	bf 66 00 00 00       	mov    edi,0x66
