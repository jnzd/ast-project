   ...
   f:	83 7d fc 77          	cmp    DWORD PTR [rbp-0x4],0x77
  ...
  29:	c7 45 fc 61 00 00 00 	mov    DWORD PTR [rbp-0x4],0x61
  30:	8b 45 fc             	mov    eax,DWORD PTR [rbp-0x4]
  33:	83 c0 2c             	add    eax,0x2c
  ...
  71:	48 c7 45 f8 0c 00 00 	mov    QWORD PTR [rbp-0x8],0xc
  78:	00 
  79:	b8 0b 00 00 80       	mov    eax,0x8000000b
