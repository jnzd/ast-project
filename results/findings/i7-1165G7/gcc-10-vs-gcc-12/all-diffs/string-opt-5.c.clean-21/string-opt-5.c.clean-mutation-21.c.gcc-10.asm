 ...
 2fc:	83 f8 67             	cmp    eax,0x67
 2ff:	75 0b                	jne    30c <main+0x30c>
 301:	8b 05 00 00 00 00    	mov    eax,DWORD PTR [rip+0x0]        # 307 <main+0x307>
 307:	83 f8 33             	cmp    eax,0x33
 30a:	74 05                	je     311 <main+0x311>
 30c:	e8 00 00 00 00       	call   311 <main+0x311>
 311:	c6 45 0d 20          	mov    BYTE PTR [rbp+0xd],0x20
 315:	c6 45 57 00          	mov    BYTE PTR [rbp+0x57],0x0
 319:	c7 05 00 00 00 00 7d 	mov    DWORD PTR [rip+0x0],0x7d        # 323 <main+0x323>
 320:	00 00 00 
 323:	c7 05 00 00 00 00 48 	mov    DWORD PTR [rip+0x0],0x48        # 32d <main+0x32d>
 32a:	00 00 00 
 ...
 39f:	48 8d 45 db          	lea    rax,[rbp-0x25]
 3a3:	ba 0d 00 00 00       	mov    edx,0xd
 ...
 452:	48 8d 45 db          	lea    rax,[rbp-0x25]
 456:	ba 0d 00 00 00       	mov    edx,0xd
 45b:	be 20 00 00 00       	mov    esi,0x20
 460:	48 89 c7             	mov    rdi,rax
 463:	e8 00 00 00 00       	call   468 <main+0x468>
 468:	48 8d 45 db          	lea    rax,[rbp-0x25]
 ...
 480:	48 8d 55 db          	lea    rdx,[rbp-0x25]
 484:	48 39 d0             	cmp    rax,rdx
 487:	75 1c                	jne    4a5 <main+0x4a5>
 489:	48 8d 45 db          	lea    rax,[rbp-0x25]
 48d:	ba 45 00 00 00       	mov    edx,0x45
 ...
 4b1:	00 00 00 
 4b4:	ba 64 00 00 00       	mov    edx,0x64
 ...
 55d:	ba 70 00 00 00       	mov    edx,0x70
 ...
 581:	83 f8 51             	cmp    eax,0x51
 584:	75 1c                	jne    5a2 <main+0x5a2>
 586:	ba 68 00 00 00       	mov    edx,0x68
 ...
 5a7:	c7 05 00 00 00 00 5b 	mov    DWORD PTR [rip+0x0],0x5b        # 5b1 <main+0x5b1>
 5ae:	00 00 00 
 ...
 5e7:	be 14 00 00 00       	mov    esi,0x14
 ...
 65b:	ba 1e 00 00 00       	mov    edx,0x1e
 660:	be 56 00 00 00       	mov    esi,0x56
 ...
 6a8:	b8 2d 00 00 00       	mov    eax,0x2d
