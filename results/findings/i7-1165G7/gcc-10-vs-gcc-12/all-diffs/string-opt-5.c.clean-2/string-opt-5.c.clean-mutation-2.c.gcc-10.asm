 ...
 2fc:	83 f8 46             	cmp    eax,0x46
 2ff:	75 0b                	jne    30c <main+0x30c>
 301:	8b 05 00 00 00 00    	mov    eax,DWORD PTR [rip+0x0]        # 307 <main+0x307>
 307:	83 f8 1a             	cmp    eax,0x1a
 30a:	74 05                	je     311 <main+0x311>
 30c:	e8 00 00 00 00       	call   311 <main+0x311>
 311:	c6 45 46 20          	mov    BYTE PTR [rbp+0x46],0x20
 315:	c6 45 1b 00          	mov    BYTE PTR [rbp+0x1b],0x0
 319:	c7 05 00 00 00 00 30 	mov    DWORD PTR [rip+0x0],0x30        # 323 <main+0x323>
 320:	00 00 00 
 ...
 354:	ba 2b 00 00 00       	mov    edx,0x2b
 ...
 3fb:	ba 30 00 00 00       	mov    edx,0x30
 ...
 48d:	ba 27 00 00 00       	mov    edx,0x27
 ...
 4b1:	00 00 00 
 4b4:	ba 46 00 00 00       	mov    edx,0x46
 ...
 581:	83 f8 06             	cmp    eax,0x6
 584:	75 1c                	jne    5a2 <main+0x5a2>
 586:	ba 28 00 00 00       	mov    edx,0x28
 ...
 5a7:	c7 05 00 00 00 00 2b 	mov    DWORD PTR [rip+0x0],0x2b        # 5b1 <main+0x5b1>
 5ae:	00 00 00 
 ...
 5e7:	be 7b 00 00 00       	mov    esi,0x7b
 ...
 65b:	ba 72 00 00 00       	mov    edx,0x72
 660:	be 5f 00 00 00       	mov    esi,0x5f
 ...
 6a8:	b8 48 00 00 00       	mov    eax,0x48
