 ...
 2fc:	83 f8 16             	cmp    eax,0x16
 2ff:	75 0b                	jne    30c <main+0x30c>
 301:	8b 05 00 00 00 00    	mov    eax,DWORD PTR [rip+0x0]        # 307 <main+0x307>
 307:	83 f8 16             	cmp    eax,0x16
 30a:	74 05                	je     311 <main+0x311>
 30c:	e8 00 00 00 00       	call   311 <main+0x311>
 311:	c6 45 5b 20          	mov    BYTE PTR [rbp+0x5b],0x20
 315:	c6 45 53 00          	mov    BYTE PTR [rbp+0x53],0x0
 319:	c7 05 00 00 00 00 24 	mov    DWORD PTR [rip+0x0],0x24        # 323 <main+0x323>
 320:	00 00 00 
 323:	c7 05 00 00 00 00 3b 	mov    DWORD PTR [rip+0x0],0x3b        # 32d <main+0x32d>
 32a:	00 00 00 
 ...
 39f:	48 8d 45 e2          	lea    rax,[rbp-0x1e]
 3a3:	ba 06 00 00 00       	mov    edx,0x6
 ...
 4b1:	00 00 00 
 4b4:	ba 36 00 00 00       	mov    edx,0x36
 ...
 55d:	ba 13 00 00 00       	mov    edx,0x13
 ...
 581:	83 f8 70             	cmp    eax,0x70
 584:	75 1c                	jne    5a2 <main+0x5a2>
 586:	ba 55 00 00 00       	mov    edx,0x55
 ...
 5a7:	c7 05 00 00 00 00 27 	mov    DWORD PTR [rip+0x0],0x27        # 5b1 <main+0x5b1>
 5ae:	00 00 00 
 ...
 5e7:	be 75 00 00 00       	mov    esi,0x75
 ...
 65b:	ba 2a 00 00 00       	mov    edx,0x2a
 660:	be 0c 00 00 00       	mov    esi,0xc
 ...
 6a8:	b8 34 00 00 00       	mov    eax,0x34
