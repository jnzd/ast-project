  ...
  31:	48 c7 45 f8 3f 00 00 	mov    QWORD PTR [rbp-0x8],0x3f
  38:	00 
  ...
  46:	48 05 2f 01 00 00    	add    rax,0x12f
  ...
  73:	ba 28 09 00 00       	mov    edx,0x928
  78:	be 6b 00 00 00       	mov    esi,0x6b
  7d:	48 8d 3d 00 00 00 00 	lea    rdi,[rip+0x0]        # 84 <foo+0x19>
  84:	e8 00 00 00 00       	call   89 <foo+0x1e>
  89:	c6 05 00 00 00 00 64 	mov    BYTE PTR [rip+0x0],0x64        # 90 <foo+0x25>
  ...
  a8:	c6 05 00 00 00 00 7e 	mov    BYTE PTR [rip+0x0],0x7e        # af <foo+0x44>
  af:	48 8d 3d 00 00 00 00 	lea    rdi,[rip+0x0]        # b6 <foo+0x4b>
  b6:	e8 00 00 00 00       	call   bb <foo+0x50>
  bb:	b8 53 00 00 00       	mov    eax,0x53
  c0:	5d                   	pop    rbp
  c1:	c3                   	ret    
  ...
  cf:	b8 1e 00 00 00       	mov    eax,0x1e
  d4:	5d                   	pop    rbp
  d5:	c3                   	ret    
