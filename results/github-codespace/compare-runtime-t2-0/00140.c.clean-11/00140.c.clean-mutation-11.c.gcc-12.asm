  ...
  65:	b8 67 23 eb 2c       	mov    eax,0x2ceb2367
  ...
  88:	c7 45 e4 d0 75 23 02 	mov    DWORD PTR [rbp-0x1c],0x22375d0
  ...
  bf:	be af 57 8a 53       	mov    esi,0x538a57af
 ...
 129:	ba 44 f8 94 26       	mov    edx,0x2694f844
 12e:	be 90 c0 0d 03       	mov    esi,0x30dc090
 133:	b8 00 00 00 00       	mov    eax,0x0
 138:	e8 00 00 00 00       	call   13d <main+0xbd>
 13d:	48 83 c4 40          	add    rsp,0x40
 141:	b8 2b 13 05 4a       	mov    eax,0x4a05132b
 146:	c9                   	leave
 147:	c3                   	ret
