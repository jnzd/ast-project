 ...
 31e:	83 f8 47             	cmp    eax,0x47
 321:	75 0b                	jne    32e <main+0x32e>
 323:	8b 05 00 00 00 00    	mov    eax,DWORD PTR [rip+0x0]        # 329 <main+0x329>
 329:	83 f8 23             	cmp    eax,0x23
 32c:	74 05                	je     333 <main+0x333>
 32e:	e8 00 00 00 00       	call   333 <main+0x333>
 333:	c6 45 b1 20          	mov    BYTE PTR [rbp-0x4f],0x20
 337:	c6 45 c8 00          	mov    BYTE PTR [rbp-0x38],0x0
 33b:	c7 05 00 00 00 00 07 	mov    DWORD PTR [rip+0x0],0x7        # 345 <main+0x345>
 342:	00 00 00 
 345:	c7 05 00 00 00 00 4e 	mov    DWORD PTR [rip+0x0],0x4e        # 34f <main+0x34f>
 34c:	00 00 00 
 ...
 378:	48 83 c0 40          	add    rax,0x40
 37c:	ba 61 00 00 00       	mov    edx,0x61
 ...
 499:	ba 6b 00 00 00       	mov    edx,0x6b
 ...
 4b2:	ba 6d 00 00 00       	mov    edx,0x6d
 ...
 4df:	ba 70 00 00 00       	mov    edx,0x70
 ...
 506:	00 00 00 
 509:	ba 3e 00 00 00       	mov    edx,0x3e
 ...
 577:	83 f8 0b             	cmp    eax,0xb
 57a:	75 22                	jne    59e <main+0x59e>
 57c:	ba 62 00 00 00       	mov    edx,0x62
 ...
 5be:	ba 3e 00 00 00       	mov    edx,0x3e
 ...
 5e2:	83 f8 1b             	cmp    eax,0x1b
 5e5:	75 22                	jne    609 <main+0x609>
 5e7:	ba 36 00 00 00       	mov    edx,0x36
 ...
 60e:	c7 05 00 00 00 00 2c 	mov    DWORD PTR [rip+0x0],0x2c        # 618 <main+0x618>
 615:	00 00 00 
 ...
 64e:	be 1b 00 00 00       	mov    esi,0x1b
 ...
 6c5:	ba 22 00 00 00       	mov    edx,0x22
 6ca:	be 6e 00 00 00       	mov    esi,0x6e
 ...
 715:	b8 25 00 00 00       	mov    eax,0x25
