  ...
  13:	c7 45 f4 51 00 00 00 	mov    DWORD PTR [rbp-0xc],0x51
  1a:	c7 45 f0 6b 00 00 00 	mov    DWORD PTR [rbp-0x10],0x6b
  ...
  3c:	83 7d fc 6f          	cmp    DWORD PTR [rbp-0x4],0x6f
  ...
  5b:	c7 45 f4 56 00 00 00 	mov    DWORD PTR [rbp-0xc],0x56
