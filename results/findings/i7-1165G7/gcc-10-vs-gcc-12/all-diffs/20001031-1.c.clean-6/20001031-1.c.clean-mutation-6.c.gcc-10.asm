   ...
   f:	83 7d fc 2b          	cmp    DWORD PTR [rbp-0x4],0x2b
  ...
  29:	c7 45 fc 09 00 00 00 	mov    DWORD PTR [rbp-0x4],0x9
  30:	8b 45 fc             	mov    eax,DWORD PTR [rbp-0x4]
  33:	83 c0 27             	add    eax,0x27
  ...
  71:	48 c7 45 f8 69 00 00 	mov    QWORD PTR [rbp-0x8],0x69
  78:	00 
  79:	bf 68 00 00 80       	mov    edi,0x80000068
