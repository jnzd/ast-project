  ...
  69:	b8 0b 22 08 24       	mov    eax,0x2408220b
  ...
  9f:	c7 45 d4 53 56 3b 22 	mov    DWORD PTR [rbp-0x2c],0x223b5653
  ...
  bc:	be 39 6b 4b 2b       	mov    esi,0x2b4b6b39
