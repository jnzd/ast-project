  ...
  40:	c7 45 fc 62 00 00 00 	mov    DWORD PTR [rbp-0x4],0x62
  ...
  7d:	83 f8 5e             	cmp    eax,0x5e
  80:	76 d3                	jbe    55 <main+0x55>
  82:	83 45 fc 01          	add    DWORD PTR [rbp-0x4],0x1
  86:	83 7d fc 08          	cmp    DWORD PTR [rbp-0x4],0x8
  8a:	7e bd                	jle    49 <main+0x49>
  8c:	c7 45 fc 24 00 00 00 	mov    DWORD PTR [rbp-0x4],0x24
