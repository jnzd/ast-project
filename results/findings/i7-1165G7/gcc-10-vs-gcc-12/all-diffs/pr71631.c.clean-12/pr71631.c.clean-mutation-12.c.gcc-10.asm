  ...
  6f:	83 c0 32             	add    eax,0x32
  72:	89 45 ec             	mov    DWORD PTR [rbp-0x14],eax
  75:	b8 61 00 00 00       	mov    eax,0x61
  7a:	99                   	cdq    
