  ...
  69:	b8 02 bc a7 14       	mov    eax,0x14a7bc02
  ...
  9f:	c7 45 d4 b1 4b 5b 09 	mov    DWORD PTR [rbp-0x2c],0x95b4bb1
  ...
  d6:	be 15 8b 46 25       	mov    esi,0x25468b15
 ...
 140:	ba e0 6e dc 63       	mov    edx,0x63dc6ee0
 145:	be dd cb 1b 2d       	mov    esi,0x2d1bcbdd
 14a:	b8 00 00 00 00       	mov    eax,0x0
 14f:	e8 00 00 00 00       	call   154 <main+0xd0>
 154:	48 83 c4 40          	add    rsp,0x40
 158:	b8 53 d3 b8 3e       	mov    eax,0x3eb8d353
