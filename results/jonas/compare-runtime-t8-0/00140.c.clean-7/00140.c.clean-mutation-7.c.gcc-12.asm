  ...
  69:	b8 5f d4 b6 22       	mov    eax,0x22b6d45f
  ...
  9f:	c7 45 d4 f8 ec 5d 2a 	mov    DWORD PTR [rbp-0x2c],0x2a5decf8
  ...
  d6:	be f8 12 4d 3a       	mov    esi,0x3a4d12f8
 ...
 140:	ba 8d 7b 3e 2a       	mov    edx,0x2a3e7b8d
 145:	be 0b 0b 21 30       	mov    esi,0x30210b0b
 14a:	b8 00 00 00 00       	mov    eax,0x0
 14f:	e8 00 00 00 00       	call   154 <main+0xd0>
 154:	48 83 c4 40          	add    rsp,0x40
 158:	b8 fb 84 56 1b       	mov    eax,0x1b5684fb
