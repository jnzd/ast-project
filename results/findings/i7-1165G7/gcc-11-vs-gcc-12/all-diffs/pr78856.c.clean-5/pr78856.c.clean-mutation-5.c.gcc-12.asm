  ...
  1b:	c7 45 f0 43 00 00 00 	mov    DWORD PTR [rbp-0x10],0x43
  22:	c7 45 f8 03 00 00 00 	mov    DWORD PTR [rbp-0x8],0x3
  29:	e9 8a 00 00 00       	jmp    b8 <main+0xb8>
  2e:	c7 45 fc 5c 00 00 00 	mov    DWORD PTR [rbp-0x4],0x5c
  35:	c7 45 f4 3c 00 00 00 	mov    DWORD PTR [rbp-0xc],0x3c
  ...
  5d:	83 7d f4 42          	cmp    DWORD PTR [rbp-0xc],0x42
  ...
  91:	c7 45 f8 33 00 00 00 	mov    DWORD PTR [rbp-0x8],0x33
  ...
  ae:	83 7d fc 02          	cmp    DWORD PTR [rbp-0x4],0x2
  b2:	7e b1                	jle    65 <main+0x65>
  b4:	83 45 f0 11          	add    DWORD PTR [rbp-0x10],0x11
  b8:	83 7d f0 40          	cmp    DWORD PTR [rbp-0x10],0x40
  bc:	0f 8e 6c ff ff ff    	jle    2e <main+0x2e>
  c2:	bf 5d 00 00 00       	mov    edi,0x5d
