  ...
  23:	c7 45 fc 50 00 00 00 	mov    DWORD PTR [rbp-0x4],0x50
  ...
  68:	83 f8 56             	cmp    eax,0x56
  6b:	0f 9e c0             	setle  al
  6e:	84 c0                	test   al,al
  70:	74 07                	je     79 <check_header+0x66>
  72:	b8 04 00 00 00       	mov    eax,0x4
  ...
  83:	b8 65 00 00 00       	mov    eax,0x65
  88:	c9                   	leave  
  89:	c3                   	ret    
