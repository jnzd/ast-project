  ...
  19:	c7 45 f0 6b 00 00 00 	mov    DWORD PTR [rbp-0x10],0x6b
  20:	c7 45 f8 0f 00 00 00 	mov    DWORD PTR [rbp-0x8],0xf
  27:	e9 8a 00 00 00       	jmp    b6 <main+0xb6>
  2c:	c7 45 fc 63 00 00 00 	mov    DWORD PTR [rbp-0x4],0x63
  33:	c7 45 f4 78 00 00 00 	mov    DWORD PTR [rbp-0xc],0x78
  ...
  50:	c7 04 02 61 00 00 00 	mov    DWORD PTR [rdx+rax*1],0x61
  ...
  8f:	c7 45 f8 60 00 00 00 	mov    DWORD PTR [rbp-0x8],0x60
  ...
  ac:	83 7d fc 6d          	cmp    DWORD PTR [rbp-0x4],0x6d
  b0:	7e b1                	jle    63 <main+0x63>
  b2:	83 45 f0 37          	add    DWORD PTR [rbp-0x10],0x37
  b6:	83 7d f0 01          	cmp    DWORD PTR [rbp-0x10],0x1
  ba:	0f 8e 6c ff ff ff    	jle    2c <main+0x2c>
  c0:	bf 52 00 00 00       	mov    edi,0x52
