   ...
   c:	c7 45 fc 53 00 00 00 	mov    DWORD PTR [rbp-0x4],0x53
  ...
  5e:	83 7d fc 2e          	cmp    DWORD PTR [rbp-0x4],0x2e
  ...
  83:	c7 45 fc 6c 00 00 00 	mov    DWORD PTR [rbp-0x4],0x6c
  ...
  b2:	83 7d fc 49          	cmp    DWORD PTR [rbp-0x4],0x49
  b6:	7e d4                	jle    8c <main+0x24>
  b8:	b8 53 00 00 00       	mov    eax,0x53
  bd:	c9                   	leave  
  be:	c3                   	ret    
