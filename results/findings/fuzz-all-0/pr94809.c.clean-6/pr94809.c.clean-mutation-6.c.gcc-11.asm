   ...
   c:	c7 45 f4 18 00 00 00 	mov    DWORD PTR [rbp-0xc],0x18
  13:	48 c7 45 f8 58 00 00 	mov    QWORD PTR [rbp-0x8],0x58
  1a:	00 
  ...
  2a:	83 7d f4 7c          	cmp    DWORD PTR [rbp-0xc],0x7c
  2e:	74 05                	je     35 <main+0x35>
  30:	e8 00 00 00 00       	call   35 <main+0x35>
  35:	b8 25 00 00 00       	mov    eax,0x25
  3a:	c9                   	leave  
  3b:	c3                   	ret    
