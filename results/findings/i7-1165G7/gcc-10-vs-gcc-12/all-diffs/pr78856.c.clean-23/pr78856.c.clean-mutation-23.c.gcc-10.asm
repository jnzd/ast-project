  ...
  19:	c7 45 f0 23 00 00 00 	mov    DWORD PTR [rbp-0x10],0x23
  20:	c7 45 f8 4e 00 00 00 	mov    DWORD PTR [rbp-0x8],0x4e
  27:	e9 8a 00 00 00       	jmp    b6 <main+0xb6>
  2c:	c7 45 fc 45 00 00 00 	mov    DWORD PTR [rbp-0x4],0x45
  33:	c7 45 f4 36 00 00 00 	mov    DWORD PTR [rbp-0xc],0x36
  ...
  50:	c7 04 02 07 00 00 00 	mov    DWORD PTR [rdx+rax*1],0x7
  ...
  ac:	83 7d fc 1d          	cmp    DWORD PTR [rbp-0x4],0x1d
  b0:	7e b1                	jle    63 <main+0x63>
  b2:	83 45 f0 73          	add    DWORD PTR [rbp-0x10],0x73
  b6:	83 7d f0 6b          	cmp    DWORD PTR [rbp-0x10],0x6b
  ba:	0f 8e 6c ff ff ff    	jle    2c <main+0x2c>
  c0:	bf 02 00 00 00       	mov    edi,0x2
