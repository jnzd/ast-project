  ...
  19:	c7 45 f0 43 00 00 00 	mov    DWORD PTR [rbp-0x10],0x43
  20:	c7 45 f8 03 00 00 00 	mov    DWORD PTR [rbp-0x8],0x3
  27:	e9 8a 00 00 00       	jmp    b6 <main+0xb6>
  2c:	c7 45 fc 5c 00 00 00 	mov    DWORD PTR [rbp-0x4],0x5c
  33:	c7 45 f4 3c 00 00 00 	mov    DWORD PTR [rbp-0xc],0x3c
  ...
  5b:	83 7d f4 42          	cmp    DWORD PTR [rbp-0xc],0x42
  ...
  8f:	c7 45 f8 33 00 00 00 	mov    DWORD PTR [rbp-0x8],0x33
  ...
  ac:	83 7d fc 02          	cmp    DWORD PTR [rbp-0x4],0x2
  b0:	7e b1                	jle    63 <main+0x63>
  b2:	83 45 f0 11          	add    DWORD PTR [rbp-0x10],0x11
  b6:	83 7d f0 40          	cmp    DWORD PTR [rbp-0x10],0x40
  ba:	0f 8e 6c ff ff ff    	jle    2c <main+0x2c>
  c0:	bf 5d 00 00 00       	mov    edi,0x5d
