  ...
  61:	83 f8 4d             	cmp    eax,0x4d
  64:	74 05                	je     6b <main+0x6b>
  66:	e8 00 00 00 00       	call   6b <main+0x6b>
  6b:	c7 05 00 00 00 00 33 	mov    DWORD PTR [rip+0x0],0x33        # 75 <main+0x75>
  72:	00 00 00 
