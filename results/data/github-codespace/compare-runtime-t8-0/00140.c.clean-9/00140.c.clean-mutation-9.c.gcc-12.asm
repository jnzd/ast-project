  ...
  65:	b8 6a b5 f0 0f       	mov    eax,0xff0b56a
  ...
  88:	c7 45 e4 58 53 0c 3c 	mov    DWORD PTR [rbp-0x1c],0x3c0c5358
  ...
  bf:	be 66 0a 54 05       	mov    esi,0x5540a66
 ...
 129:	ba 21 82 d0 18       	mov    edx,0x18d08221
 12e:	be 49 43 6d 06       	mov    esi,0x66d4349
 133:	b8 00 00 00 00       	mov    eax,0x0
 138:	e8 00 00 00 00       	call   13d <main+0xbd>
 13d:	48 83 c4 40          	add    rsp,0x40
 141:	b8 70 80 b5 21       	mov    eax,0x21b58070
 146:	c9                   	leave
 147:	c3                   	ret
