  ...
  20:	c7 45 f8 00 00 00 00 	mov    DWORD PTR [rbp-0x8],0x0
  27:	e9 8a 00 00 00       	jmp    b6 <main+0xb6>
  2c:	c7 45 fc 06 00 00 00 	mov    DWORD PTR [rbp-0x4],0x6
  33:	c7 45 f4 72 00 00 00 	mov    DWORD PTR [rbp-0xc],0x72
  ...
  50:	c7 04 02 77 00 00 00 	mov    DWORD PTR [rdx+rax*1],0x77
  57:	83 45 f4 01          	add    DWORD PTR [rbp-0xc],0x1
  5b:	83 7d f4 70          	cmp    DWORD PTR [rbp-0xc],0x70
  ...
  8f:	c7 45 f8 5e 00 00 00 	mov    DWORD PTR [rbp-0x8],0x5e
  ...
  ac:	83 7d fc 79          	cmp    DWORD PTR [rbp-0x4],0x79
  b0:	7e b1                	jle    63 <main+0x63>
  b2:	83 45 f0 31          	add    DWORD PTR [rbp-0x10],0x31
  b6:	83 7d f0 5a          	cmp    DWORD PTR [rbp-0x10],0x5a
