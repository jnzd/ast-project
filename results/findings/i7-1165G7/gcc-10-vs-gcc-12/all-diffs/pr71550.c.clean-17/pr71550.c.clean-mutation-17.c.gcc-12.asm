  ...
  43:	c7 45 fc 6b 00 00 00 	mov    DWORD PTR [rbp-0x4],0x6b
  ...
  80:	83 f8 09             	cmp    eax,0x9
  83:	76 d3                	jbe    58 <main+0x58>
  85:	83 45 fc 01          	add    DWORD PTR [rbp-0x4],0x1
  89:	83 7d fc 52          	cmp    DWORD PTR [rbp-0x4],0x52
  8d:	7e bd                	jle    4c <main+0x4c>
  8f:	c7 45 fc 46 00 00 00 	mov    DWORD PTR [rbp-0x4],0x46
  96:	eb 04                	jmp    9c <main+0x9c>
  98:	83 45 fc 01          	add    DWORD PTR [rbp-0x4],0x1
  9c:	83 7d fc 4c          	cmp    DWORD PTR [rbp-0x4],0x4c
  ...
  bf:	bf 7e 00 00 00       	mov    edi,0x7e
