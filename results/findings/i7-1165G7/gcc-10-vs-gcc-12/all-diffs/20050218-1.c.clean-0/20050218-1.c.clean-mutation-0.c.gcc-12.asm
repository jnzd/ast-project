  ...
  18:	48 c7 45 f8 63 00 00 	mov    QWORD PTR [rbp-0x8],0x63
  1f:	00 
  20:	48 c7 45 f0 7d 00 00 	mov    QWORD PTR [rbp-0x10],0x7d
  27:	00 
  ...
  7c:	83 f8 52             	cmp    eax,0x52
  7f:	74 07                	je     88 <foo+0x88>
  81:	b8 4d 00 00 00       	mov    eax,0x4d
