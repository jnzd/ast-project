  ...
  69:	b8 d7 b1 e0 05       	mov    eax,0x5e0b1d7
  ...
  9f:	c7 45 d4 ff 5c b3 0b 	mov    DWORD PTR [rbp-0x2c],0xbb35cff
  ...
  d6:	be 89 39 42 59       	mov    esi,0x59423989
 ...
 140:	ba fb 1c 59 00       	mov    edx,0x591cfb
 145:	be 34 41 b5 1d       	mov    esi,0x1db54134
 14a:	b8 00 00 00 00       	mov    eax,0x0
 14f:	e8 00 00 00 00       	call   154 <main+0xd0>
 154:	48 83 c4 40          	add    rsp,0x40
 158:	b8 c4 6e 0d 4c       	mov    eax,0x4c0d6ec4
