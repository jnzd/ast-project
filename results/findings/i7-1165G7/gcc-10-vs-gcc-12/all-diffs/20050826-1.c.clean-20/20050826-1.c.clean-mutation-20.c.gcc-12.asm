  ...
  34:	48 c7 45 f8 23 00 00 	mov    QWORD PTR [rbp-0x8],0x23
  3b:	00 
  ...
  49:	48 05 82 00 00 00    	add    rax,0x82
  ...
  76:	ba 7b 08 00 00       	mov    edx,0x87b
  7b:	be 76 00 00 00       	mov    esi,0x76
  80:	48 8d 05 00 00 00 00 	lea    rax,[rip+0x0]        # 87 <foo+0x19>
  87:	48 89 c7             	mov    rdi,rax
  8a:	e8 00 00 00 00       	call   8f <foo+0x21>
  8f:	c6 05 00 00 00 00 2d 	mov    BYTE PTR [rip+0x0],0x2d        # 96 <foo+0x28>
  ...
  de:	b8 4e 00 00 00       	mov    eax,0x4e
  e3:	5d                   	pop    rbp
  e4:	c3                   	ret    
