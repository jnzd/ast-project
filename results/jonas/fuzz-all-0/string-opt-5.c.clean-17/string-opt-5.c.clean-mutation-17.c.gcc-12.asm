 ...
 31e:	83 f8 02             	cmp    eax,0x2
 321:	75 0b                	jne    32e <main+0x32e>
 323:	8b 05 00 00 00 00    	mov    eax,DWORD PTR [rip+0x0]        # 329 <main+0x329>
 329:	83 f8 44             	cmp    eax,0x44
 32c:	74 05                	je     333 <main+0x333>
 32e:	e8 00 00 00 00       	call   333 <main+0x333>
 333:	c6 45 93 20          	mov    BYTE PTR [rbp-0x6d],0x20
 337:	c6 45 8d 00          	mov    BYTE PTR [rbp-0x73],0x0
 33b:	c7 05 00 00 00 00 53 	mov    DWORD PTR [rip+0x0],0x53        # 345 <main+0x345>
 342:	00 00 00 
 345:	c7 05 00 00 00 00 69 	mov    DWORD PTR [rip+0x0],0x69        # 34f <main+0x34f>
 34c:	00 00 00 
 ...
 378:	48 83 c0 22          	add    rax,0x22
 37c:	ba 79 00 00 00       	mov    edx,0x79
 ...
 3d7:	ba 6f 00 00 00       	mov    edx,0x6f
 ...
 499:	ba 6f 00 00 00       	mov    edx,0x6f
 ...
 4b2:	ba 2c 00 00 00       	mov    edx,0x2c
 ...
 4df:	ba 2a 00 00 00       	mov    edx,0x2a
 ...
 506:	00 00 00 
 509:	ba 2c 00 00 00       	mov    edx,0x2c
 ...
 564:	75 3a                	jne    5a0 <main+0x5a0>
 566:	8b 05 00 00 00 00    	mov    eax,DWORD PTR [rip+0x0]        # 56c <main+0x56c>
 56c:	3d 92 00 00 00       	cmp    eax,0x92
 571:	75 2d                	jne    5a0 <main+0x5a0>
 573:	8b 05 00 00 00 00    	mov    eax,DWORD PTR [rip+0x0]        # 579 <main+0x579>
 579:	83 f8 41             	cmp    eax,0x41
 57c:	75 22                	jne    5a0 <main+0x5a0>
 57e:	ba 55 00 00 00       	mov    edx,0x55
 583:	48 8d 05 00 00 00 00 	lea    rax,[rip+0x0]        # 58a <main+0x58a>
 58a:	48 89 c6             	mov    rsi,rax
 58d:	48 8d 05 00 00 00 00 	lea    rax,[rip+0x0]        # 594 <main+0x594>
 594:	48 89 c7             	mov    rdi,rax
 597:	e8 00 00 00 00       	call   59c <main+0x59c>
 59c:	85 c0                	test   eax,eax
 59e:	74 05                	je     5a5 <main+0x5a5>
 5a0:	e8 00 00 00 00       	call   5a5 <main+0x5a5>
 5a5:	8b 05 00 00 00 00    	mov    eax,DWORD PTR [rip+0x0]        # 5ab <main+0x5ab>
 5ab:	8d 50 01             	lea    edx,[rax+0x1]
 5ae:	89 15 00 00 00 00    	mov    DWORD PTR [rip+0x0],edx        # 5b4 <main+0x5b4>
 5b4:	48 98                	cdqe   
 5b6:	48 8d 15 00 00 00 00 	lea    rdx,[rip+0x0]        # 5bd <main+0x5bd>
 5bd:	48 01 d0             	add    rax,rdx
 5c0:	ba 26 00 00 00       	mov    edx,0x26
 5c5:	be 2d 00 00 00       	mov    esi,0x2d
 5ca:	48 89 c7             	mov    rdi,rax
 5cd:	e8 00 00 00 00       	call   5d2 <main+0x5d2>
 5d2:	48 8d 15 00 00 00 00 	lea    rdx,[rip+0x0]        # 5d9 <main+0x5d9>
 5d9:	48 39 d0             	cmp    rax,rdx
 5dc:	75 2d                	jne    60b <main+0x60b>
 5de:	8b 05 00 00 00 00    	mov    eax,DWORD PTR [rip+0x0]        # 5e4 <main+0x5e4>
 5e4:	83 f8 1c             	cmp    eax,0x1c
 5e7:	75 22                	jne    60b <main+0x60b>
 5e9:	ba 69 00 00 00       	mov    edx,0x69
 5ee:	48 8d 05 00 00 00 00 	lea    rax,[rip+0x0]        # 5f5 <main+0x5f5>
 5f5:	48 89 c6             	mov    rsi,rax
 5f8:	48 8d 05 00 00 00 00 	lea    rax,[rip+0x0]        # 5ff <main+0x5ff>
 5ff:	48 89 c7             	mov    rdi,rax
 602:	e8 00 00 00 00       	call   607 <main+0x607>
 607:	85 c0                	test   eax,eax
 609:	74 05                	je     610 <main+0x610>
 60b:	e8 00 00 00 00       	call   610 <main+0x610>
 610:	c7 05 00 00 00 00 54 	mov    DWORD PTR [rip+0x0],0x54        # 61a <main+0x61a>
 617:	00 00 00 
 61a:	8b 05 00 00 00 00    	mov    eax,DWORD PTR [rip+0x0]        # 620 <main+0x620>
 620:	8d 50 01             	lea    edx,[rax+0x1]
 623:	89 15 00 00 00 00    	mov    DWORD PTR [rip+0x0],edx        # 629 <main+0x629>
 629:	48 98                	cdqe   
 62b:	8b 15 00 00 00 00    	mov    edx,DWORD PTR [rip+0x0]        # 631 <main+0x631>
 631:	83 c2 01             	add    edx,0x1
 634:	89 15 00 00 00 00    	mov    DWORD PTR [rip+0x0],edx        # 63a <main+0x63a>
 63a:	8b 15 00 00 00 00    	mov    edx,DWORD PTR [rip+0x0]        # 640 <main+0x640>
 640:	48 63 d2             	movsxd rdx,edx
 643:	48 8d 0d 00 00 00 00 	lea    rcx,[rip+0x0]        # 64a <main+0x64a>
 64a:	48 01 d1             	add    rcx,rdx
 64d:	48 89 c2             	mov    rdx,rax
 650:	be 7c 00 00 00       	mov    esi,0x7c
 655:	48 89 cf             	mov    rdi,rcx
 658:	e8 00 00 00 00       	call   65d <main+0x65d>
 65d:	48 8d 15 00 00 00 00 	lea    rdx,[rip+0x0]        # 664 <main+0x664>
 664:	48 39 d0             	cmp    rax,rdx
 667:	75 37                	jne    6a0 <main+0x6a0>
 669:	8b 05 00 00 00 00    	mov    eax,DWORD PTR [rip+0x0]        # 66f <main+0x66f>
 66f:	85 c0                	test   eax,eax
 671:	75 2d                	jne    6a0 <main+0x6a0>
 673:	8b 05 00 00 00 00    	mov    eax,DWORD PTR [rip+0x0]        # 679 <main+0x679>
 679:	83 f8 73             	cmp    eax,0x73
 67c:	75 22                	jne    6a0 <main+0x6a0>
 67e:	48 8d 05 00 00 00 00 	lea    rax,[rip+0x0]        # 685 <main+0x685>
 685:	ba 07 00 00 00       	mov    edx,0x7
 68a:	48 8d 0d 00 00 00 00 	lea    rcx,[rip+0x0]        # 691 <main+0x691>
 691:	48 89 ce             	mov    rsi,rcx
 ...
 6a5:	8b 05 00 00 00 00    	mov    eax,DWORD PTR [rip+0x0]        # 6ab <main+0x6ab>
 6ab:	83 c0 3e             	add    eax,0x3e
 6ae:	89 05 00 00 00 00    	mov    DWORD PTR [rip+0x0],eax        # 6b4 <main+0x6b4>
 6b4:	8b 05 00 00 00 00    	mov    eax,DWORD PTR [rip+0x0]        # 6ba <main+0x6ba>
 6ba:	48 98                	cdqe   
 6bc:	48 8d 15 00 00 00 00 	lea    rdx,[rip+0x0]        # 6c3 <main+0x6c3>
 6c3:	48 01 d0             	add    rax,rdx
 6c6:	ba 18 00 00 00       	mov    edx,0x18
 6cb:	be 42 00 00 00       	mov    esi,0x42
 6d0:	48 89 c7             	mov    rdi,rax
 6d3:	e8 00 00 00 00       	call   6d8 <main+0x6d8>
 6d8:	48 8d 15 00 00 00 00 	lea    rdx,[rip+0x0]        # 6df <main+0x6df>
 6df:	48 39 d0             	cmp    rax,rdx
 6e2:	75 2d                	jne    711 <main+0x711>
 6e4:	8b 05 00 00 00 00    	mov    eax,DWORD PTR [rip+0x0]        # 6ea <main+0x6ea>
 6ea:	83 f8 0f             	cmp    eax,0xf
 6ed:	75 22                	jne    711 <main+0x711>
 6ef:	48 8d 05 00 00 00 00 	lea    rax,[rip+0x0]        # 6f6 <main+0x6f6>
 6f6:	ba 14 00 00 00       	mov    edx,0x14
 6fb:	48 8d 0d 00 00 00 00 	lea    rcx,[rip+0x0]        # 702 <main+0x702>
 702:	48 89 ce             	mov    rsi,rcx
 705:	48 89 c7             	mov    rdi,rax
 708:	e8 00 00 00 00       	call   70d <main+0x70d>
 70d:	85 c0                	test   eax,eax
 70f:	74 05                	je     716 <main+0x716>
 711:	e8 00 00 00 00       	call   716 <main+0x716>
 716:	b8 22 00 00 00       	mov    eax,0x22
 71b:	48 8b 55 e8          	mov    rdx,QWORD PTR [rbp-0x18]
 71f:	64 48 2b 14 25 28 00 	sub    rdx,QWORD PTR fs:0x28
 726:	00 00 
 728:	74 05                	je     72f <main+0x72f>
 72a:	e8 00 00 00 00       	call   72f <main+0x72f>
 72f:	48 8b 5d f8          	mov    rbx,QWORD PTR [rbp-0x8]
 733:	c9                   	leave  
 734:	c3                   	ret    
