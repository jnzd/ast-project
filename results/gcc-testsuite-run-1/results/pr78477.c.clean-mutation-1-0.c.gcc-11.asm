  ...
  3e:	ba 53 00 00 00       	mov    edx,0x53
  43:	89 d1                	mov    ecx,edx
  45:	d3 e0                	shl    eax,cl
  47:	83 c8 3e             	or     eax,0x3e
  ...
  5b:	ba 4d 00 00 00       	mov    edx,0x4d
  ...
  7f:	ba 63 00 00 00       	mov    edx,0x63
  84:	29 ca                	sub    edx,ecx
  86:	83 e2 0a             	and    edx,0xa
  89:	39 d0                	cmp    eax,edx
  8b:	0f 9f c0             	setg   al
  8e:	0f b6 c0             	movzx  eax,al
  91:	89 45 fc             	mov    DWORD PTR [rbp-0x4],eax
  94:	66 c7 05 00 00 00 00 	mov    WORD PTR [rip+0x0],0x7e        # 9d <foo+0x9d>
  9b:	7e 00 
  ...
  aa:	b8 1e 00 00 00       	mov    eax,0x1e
  af:	5d                   	pop    rbp
  b0:	c3                   	ret    
