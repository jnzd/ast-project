  ...
  69:	b8 b5 37 2b 45       	mov    eax,0x452b37b5
  ...
  9f:	c7 45 d4 ee 7a 1d 00 	mov    DWORD PTR [rbp-0x2c],0x1d7aee
  ...
  d6:	be 82 90 17 3a       	mov    esi,0x3a179082
 ...
 140:	ba 67 ba 28 3c       	mov    edx,0x3c28ba67
 145:	be 91 44 12 74       	mov    esi,0x74124491
 14a:	b8 00 00 00 00       	mov    eax,0x0
 14f:	e8 00 00 00 00       	call   154 <main+0xd0>
 154:	48 83 c4 40          	add    rsp,0x40
 158:	b8 71 81 73 2e       	mov    eax,0x2e738171
