  ...
  13:	c7 45 f4 15 00 00 00 	mov    DWORD PTR [rbp-0xc],0x15
  1a:	c7 45 f0 42 00 00 00 	mov    DWORD PTR [rbp-0x10],0x42
  ...
  3c:	83 7d fc 1d          	cmp    DWORD PTR [rbp-0x4],0x1d
  ...
  5b:	c7 45 f4 7a 00 00 00 	mov    DWORD PTR [rbp-0xc],0x7a
  ...
  90:	b8 7d 00 00 00       	mov    eax,0x7d
  95:	5d                   	pop    rbp
  96:	c3                   	ret    
