  ...
  12:	c7 45 fc 37 00 00 00 	mov    DWORD PTR [rbp-0x4],0x37
  19:	c7 45 f8 48 00 00 00 	mov    DWORD PTR [rbp-0x8],0x48
  ...
  5d:	c7 45 fc 38 00 00 00 	mov    DWORD PTR [rbp-0x4],0x38
  ...
  80:	be 7f 00 00 00       	mov    esi,0x7f
  85:	bf b0 ff ff ff       	mov    edi,0xffffffb0
  ...
  bb:	b8 6e 00 00 00       	mov    eax,0x6e
  c0:	c9                   	leave  
  c1:	c3                   	ret    
