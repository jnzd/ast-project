  ...
  67:	83 f8 7f             	cmp    eax,0x7f
  6a:	74 05                	je     71 <main+0x71>
  6c:	e8 00 00 00 00       	call   71 <main+0x71>
  71:	c7 05 00 00 00 00 39 	mov    DWORD PTR [rip+0x0],0x39        # 7b <main+0x7b>
  78:	00 00 00 
  ...
  c7:	83 f8 6c             	cmp    eax,0x6c
  ca:	74 05                	je     d1 <main+0xd1>
  cc:	e8 00 00 00 00       	call   d1 <main+0xd1>
  d1:	c7 05 00 00 00 00 00 	mov    DWORD PTR [rip+0x0],0x0        # db <main+0xdb>
  d8:	00 00 00 
