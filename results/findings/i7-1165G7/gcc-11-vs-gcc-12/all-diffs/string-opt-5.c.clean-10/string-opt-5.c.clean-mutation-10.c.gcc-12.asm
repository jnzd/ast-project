 ...
 300:	83 f8 79             	cmp    eax,0x79
 303:	75 0b                	jne    310 <main+0x310>
 305:	8b 05 00 00 00 00    	mov    eax,DWORD PTR [rip+0x0]        # 30b <main+0x30b>
 30b:	83 f8 60             	cmp    eax,0x60
 30e:	74 05                	je     315 <main+0x315>
 310:	e8 00 00 00 00       	call   315 <main+0x315>
 315:	c6 45 df 20          	mov    BYTE PTR [rbp-0x21],0x20
 319:	c6 45 dc 00          	mov    BYTE PTR [rbp-0x24],0x0
 31d:	c7 05 00 00 00 00 38 	mov    DWORD PTR [rip+0x0],0x38        # 327 <main+0x327>
 324:	00 00 00 
 327:	c7 05 00 00 00 00 78 	mov    DWORD PTR [rip+0x0],0x78        # 331 <main+0x331>
 32e:	00 00 00 
 ...
 354:	48 83 c0 1a          	add    rax,0x1a
 358:	ba 39 00 00 00       	mov    edx,0x39
 ...
 3aa:	ba 44 00 00 00       	mov    edx,0x44
 ...
 402:	ba 31 00 00 00       	mov    edx,0x31
 ...
 460:	ba 44 00 00 00       	mov    edx,0x44
 ...
 476:	ba 7d 00 00 00       	mov    edx,0x7d
 ...
 49d:	ba 3f 00 00 00       	mov    edx,0x3f
 ...
 4c4:	00 00 00 
 4c7:	ba 16 00 00 00       	mov    edx,0x16
 ...
 57e:	ba 09 00 00 00       	mov    edx,0x9
 ...
 5a2:	83 f8 2b             	cmp    eax,0x2b
 5a5:	75 22                	jne    5c9 <main+0x5c9>
 5a7:	ba 32 00 00 00       	mov    edx,0x32
 ...
 5ce:	c7 05 00 00 00 00 1d 	mov    DWORD PTR [rip+0x0],0x1d        # 5d8 <main+0x5d8>
 5d5:	00 00 00 
 ...
 60e:	be 45 00 00 00       	mov    esi,0x45
 ...
 685:	ba 34 00 00 00       	mov    edx,0x34
 68a:	be 41 00 00 00       	mov    esi,0x41
 ...
 6d5:	b8 0b 00 00 00       	mov    eax,0xb
