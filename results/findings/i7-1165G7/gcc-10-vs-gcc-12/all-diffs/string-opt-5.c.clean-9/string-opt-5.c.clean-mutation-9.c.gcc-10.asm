 ...
 31a:	83 f8 27             	cmp    eax,0x27
 31d:	75 0b                	jne    32a <main+0x32a>
 31f:	8b 05 00 00 00 00    	mov    eax,DWORD PTR [rip+0x0]        # 325 <main+0x325>
 325:	83 f8 49             	cmp    eax,0x49
 328:	74 05                	je     32f <main+0x32f>
 32a:	e8 00 00 00 00       	call   32f <main+0x32f>
 32f:	c6 45 94 20          	mov    BYTE PTR [rbp-0x6c],0x20
 333:	c6 45 d8 00          	mov    BYTE PTR [rbp-0x28],0x0
 337:	c7 05 00 00 00 00 6d 	mov    DWORD PTR [rip+0x0],0x6d        # 341 <main+0x341>
 33e:	00 00 00 
 341:	c7 05 00 00 00 00 6d 	mov    DWORD PTR [rip+0x0],0x6d        # 34b <main+0x34b>
 348:	00 00 00 
 ...
 374:	48 83 c0 48          	add    rax,0x48
 378:	ba 6c 00 00 00       	mov    edx,0x6c
 ...
 3d0:	ba 6d 00 00 00       	mov    edx,0x6d
 ...
 48f:	ba 6d 00 00 00       	mov    edx,0x6d
 ...
 4cf:	ba 3e 00 00 00       	mov    edx,0x3e
 ...
 4f3:	00 00 00 
 4f6:	ba 24 00 00 00       	mov    edx,0x24
 ...
 59f:	ba 57 00 00 00       	mov    edx,0x57
 ...
 5c3:	83 f8 23             	cmp    eax,0x23
 5c6:	75 1c                	jne    5e4 <main+0x5e4>
 5c8:	ba 20 00 00 00       	mov    edx,0x20
 ...
 5e9:	c7 05 00 00 00 00 45 	mov    DWORD PTR [rip+0x0],0x45        # 5f3 <main+0x5f3>
 5f0:	00 00 00 
 ...
 629:	be 5a 00 00 00       	mov    esi,0x5a
 ...
 69d:	ba 47 00 00 00       	mov    edx,0x47
 6a2:	be 4c 00 00 00       	mov    esi,0x4c
 ...
 6ea:	b8 4c 00 00 00       	mov    eax,0x4c
