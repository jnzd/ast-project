   ...
   c:	48 89 7d a8          	mov    QWORD PTR [rbp-0x58],rdi
  10:	64 48 8b 04 25 28 00 	mov    rax,QWORD PTR fs:0x28
  17:	00 00 
  19:	48 89 45 f8          	mov    QWORD PTR [rbp-0x8],rax
  1d:	31 c0                	xor    eax,eax
  1f:	48 8b 55 a8          	mov    rdx,QWORD PTR [rbp-0x58]
  23:	48 8d 45 c0          	lea    rax,[rbp-0x40]
  ...
  3b:	48 98                	cdqe   
  3d:	48 89 45 b8          	mov    QWORD PTR [rbp-0x48],rax
  41:	48 83 7d b8 43       	cmp    QWORD PTR [rbp-0x48],0x43
  ...
  6c:	bf 39 00 00 00       	mov    edi,0x39
  71:	e8 00 00 00 00       	call   76 <main+0x12>
  76:	b8 35 00 00 00       	mov    eax,0x35
  7b:	5d                   	pop    rbp
  7c:	c3                   	ret    
