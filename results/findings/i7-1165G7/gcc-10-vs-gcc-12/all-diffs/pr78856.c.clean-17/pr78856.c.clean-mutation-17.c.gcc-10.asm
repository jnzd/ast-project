  ...
  19:	c7 45 f0 18 00 00 00 	mov    DWORD PTR [rbp-0x10],0x18
  20:	c7 45 f8 7c 00 00 00 	mov    DWORD PTR [rbp-0x8],0x7c
  27:	e9 8a 00 00 00       	jmp    b6 <main+0xb6>
  2c:	c7 45 fc 0b 00 00 00 	mov    DWORD PTR [rbp-0x4],0xb
  33:	c7 45 f4 0a 00 00 00 	mov    DWORD PTR [rbp-0xc],0xa
  ...
  5b:	83 7d f4 15          	cmp    DWORD PTR [rbp-0xc],0x15
  ...
  8f:	c7 45 f8 7b 00 00 00 	mov    DWORD PTR [rbp-0x8],0x7b
