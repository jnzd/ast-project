  ...
  69:	b8 f9 f6 08 15       	mov    eax,0x1508f6f9
  ...
  9f:	c7 45 d4 ab 69 67 20 	mov    DWORD PTR [rbp-0x2c],0x206769ab
  ...
  bc:	be 5d a2 73 5c       	mov    esi,0x5c73a25d
