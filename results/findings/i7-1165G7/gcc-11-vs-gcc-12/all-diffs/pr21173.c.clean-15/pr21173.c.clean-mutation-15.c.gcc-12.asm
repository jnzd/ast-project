   ...
   c:	c7 45 fc 42 00 00 00 	mov    DWORD PTR [rbp-0x4],0x42
  ...
  5e:	83 7d fc 3b          	cmp    DWORD PTR [rbp-0x4],0x3b
  ...
  83:	c7 45 fc 50 00 00 00 	mov    DWORD PTR [rbp-0x4],0x50
  ...
  b2:	83 7d fc 2b          	cmp    DWORD PTR [rbp-0x4],0x2b
  b6:	7e d4                	jle    8c <main+0x24>
  b8:	b8 5b 00 00 00       	mov    eax,0x5b
  bd:	c9                   	leave  
  be:	c3                   	ret    
