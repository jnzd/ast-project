  ...
  69:	b8 fb cb d7 5a       	mov    eax,0x5ad7cbfb
  ...
  9f:	c7 45 d4 f4 ac 78 10 	mov    DWORD PTR [rbp-0x2c],0x1078acf4
  ...
  d6:	be 49 ed e6 39       	mov    esi,0x39e6ed49
 ...
 140:	ba a6 67 44 3c       	mov    edx,0x3c4467a6
 145:	be 71 f7 30 09       	mov    esi,0x930f771
 14a:	b8 00 00 00 00       	mov    eax,0x0
 14f:	e8 00 00 00 00       	call   154 <main+0xd0>
 154:	48 83 c4 40          	add    rsp,0x40
 158:	b8 44 6b f3 18       	mov    eax,0x18f36b44
