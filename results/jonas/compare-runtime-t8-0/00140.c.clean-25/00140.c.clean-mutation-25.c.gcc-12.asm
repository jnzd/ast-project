  ...
  69:	b8 ef 30 18 56       	mov    eax,0x561830ef
  ...
  9f:	c7 45 d4 49 ec f2 16 	mov    DWORD PTR [rbp-0x2c],0x16f2ec49
  ...
  d6:	be 7c dc 54 59       	mov    esi,0x5954dc7c
 ...
 140:	ba 44 ac f2 30       	mov    edx,0x30f2ac44
 145:	be 10 a9 a7 47       	mov    esi,0x47a7a910
 14a:	b8 00 00 00 00       	mov    eax,0x0
 14f:	e8 00 00 00 00       	call   154 <main+0xd0>
 154:	48 83 c4 40          	add    rsp,0x40
 158:	b8 28 e2 33 3f       	mov    eax,0x3f33e228
