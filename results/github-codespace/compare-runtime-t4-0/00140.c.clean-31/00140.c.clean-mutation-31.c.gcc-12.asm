  ...
  65:	b8 a8 ca 07 23       	mov    eax,0x2307caa8
  ...
  88:	c7 45 e4 83 6e f1 09 	mov    DWORD PTR [rbp-0x1c],0x9f16e83
  ...
  bf:	be 46 a6 0d 76       	mov    esi,0x760da646
 ...
 129:	ba e8 60 ed 34       	mov    edx,0x34ed60e8
 12e:	be c9 dc 98 25       	mov    esi,0x2598dcc9
 133:	b8 00 00 00 00       	mov    eax,0x0
 138:	e8 00 00 00 00       	call   13d <main+0xbd>
 13d:	48 83 c4 40          	add    rsp,0x40
 141:	b8 ca 13 3e 12       	mov    eax,0x123e13ca
 146:	c9                   	leave
 147:	c3                   	ret
