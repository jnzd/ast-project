  ...
  1b:	c7 45 f0 72 00 00 00 	mov    DWORD PTR [rbp-0x10],0x72
  22:	c7 45 f8 4f 00 00 00 	mov    DWORD PTR [rbp-0x8],0x4f
  29:	e9 8a 00 00 00       	jmp    b8 <main+0xb8>
  2e:	c7 45 fc 22 00 00 00 	mov    DWORD PTR [rbp-0x4],0x22
  35:	c7 45 f4 53 00 00 00 	mov    DWORD PTR [rbp-0xc],0x53
  ...
  5d:	83 7d f4 08          	cmp    DWORD PTR [rbp-0xc],0x8
  ...
  ae:	83 7d fc 4b          	cmp    DWORD PTR [rbp-0x4],0x4b
  b2:	7e b1                	jle    65 <main+0x65>
  b4:	83 45 f0 44          	add    DWORD PTR [rbp-0x10],0x44
  b8:	83 7d f0 0f          	cmp    DWORD PTR [rbp-0x10],0xf
  bc:	0f 8e 6c ff ff ff    	jle    2e <main+0x2e>
  c2:	bf 4d 00 00 00       	mov    edi,0x4d
