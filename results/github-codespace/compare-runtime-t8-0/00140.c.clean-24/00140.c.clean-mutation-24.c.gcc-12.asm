  ...
  65:	b8 03 e5 1c 75       	mov    eax,0x751ce503
  ...
  88:	c7 45 e4 4e 02 b8 0d 	mov    DWORD PTR [rbp-0x1c],0xdb8024e
  ...
  bf:	be c5 86 bd 1b       	mov    esi,0x1bbd86c5
 ...
 129:	ba a6 68 9f 58       	mov    edx,0x589f68a6
 12e:	be ef 4d 05 43       	mov    esi,0x43054def
 133:	b8 00 00 00 00       	mov    eax,0x0
 138:	e8 00 00 00 00       	call   13d <main+0xbd>
 13d:	48 83 c4 40          	add    rsp,0x40
 141:	b8 7e df 7e 07       	mov    eax,0x77edf7e
 146:	c9                   	leave
 147:	c3                   	ret
