  ...
  19:	c7 45 f0 39 00 00 00 	mov    DWORD PTR [rbp-0x10],0x39
  20:	c7 45 f8 57 00 00 00 	mov    DWORD PTR [rbp-0x8],0x57
  27:	e9 8a 00 00 00       	jmp    b6 <main+0xb6>
  2c:	c7 45 fc 47 00 00 00 	mov    DWORD PTR [rbp-0x4],0x47
  33:	c7 45 f4 2a 00 00 00 	mov    DWORD PTR [rbp-0xc],0x2a
  ...
  50:	c7 04 02 2a 00 00 00 	mov    DWORD PTR [rdx+rax*1],0x2a
  57:	83 45 f4 01          	add    DWORD PTR [rbp-0xc],0x1
  5b:	83 7d f4 09          	cmp    DWORD PTR [rbp-0xc],0x9
  ...
  8f:	c7 45 f8 11 00 00 00 	mov    DWORD PTR [rbp-0x8],0x11
  ...
  ac:	83 7d fc 16          	cmp    DWORD PTR [rbp-0x4],0x16
  b0:	7e b1                	jle    63 <main+0x63>
  b2:	83 45 f0 38          	add    DWORD PTR [rbp-0x10],0x38
  b6:	83 7d f0 2c          	cmp    DWORD PTR [rbp-0x10],0x2c
  ba:	0f 8e 6c ff ff ff    	jle    2c <main+0x2c>
  c0:	bf 72 00 00 00       	mov    edi,0x72
