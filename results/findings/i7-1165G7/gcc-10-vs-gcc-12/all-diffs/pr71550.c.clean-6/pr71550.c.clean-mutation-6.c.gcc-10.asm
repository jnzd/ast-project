  ...
  40:	c7 45 fc 26 00 00 00 	mov    DWORD PTR [rbp-0x4],0x26
  ...
  7d:	83 f8 4c             	cmp    eax,0x4c
  80:	76 d3                	jbe    55 <main+0x55>
  82:	83 45 fc 01          	add    DWORD PTR [rbp-0x4],0x1
  86:	83 7d fc 4d          	cmp    DWORD PTR [rbp-0x4],0x4d
  8a:	7e bd                	jle    49 <main+0x49>
  8c:	c7 45 fc 05 00 00 00 	mov    DWORD PTR [rbp-0x4],0x5
  93:	eb 04                	jmp    99 <main+0x99>
  95:	83 45 fc 01          	add    DWORD PTR [rbp-0x4],0x1
  99:	83 7d fc 10          	cmp    DWORD PTR [rbp-0x4],0x10
  ...
  bc:	bf 66 00 00 00       	mov    edi,0x66
