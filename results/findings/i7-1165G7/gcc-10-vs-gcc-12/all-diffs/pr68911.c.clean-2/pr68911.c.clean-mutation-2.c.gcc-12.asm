   ...
   c:	c7 45 f4 48 00 00 00 	mov    DWORD PTR [rbp-0xc],0x48
  13:	c7 45 f8 11 00 00 00 	mov    DWORD PTR [rbp-0x8],0x11
  1a:	eb 7b                	jmp    97 <main+0x97>
  1c:	8b 45 f4             	mov    eax,DWORD PTR [rbp-0xc]
  1f:	f7 d0                	not    eax
  21:	89 c2                	mov    edx,eax
  23:	89 d0                	mov    eax,edx
  25:	48 69 c0 25 49 92 24 	imul   rax,rax,0x24924925
  2c:	48 c1 e8 20          	shr    rax,0x20
  30:	29 c2                	sub    edx,eax
  32:	d1 ea                	shr    edx,1
  34:	01 d0                	add    eax,edx
  36:	c1 e8 02             	shr    eax,0x2
  ...
  7c:	83 7d f8 39          	cmp    DWORD PTR [rbp-0x8],0x39
  80:	77 2b                	ja     ad <main+0xad>
  82:	83 7d f4 64          	cmp    DWORD PTR [rbp-0xc],0x64
  ...
  9d:	83 f8 15             	cmp    eax,0x15
  a0:	0f 8e 76 ff ff ff    	jle    1c <main+0x1c>
  a6:	b8 15 00 00 00       	mov    eax,0x15
