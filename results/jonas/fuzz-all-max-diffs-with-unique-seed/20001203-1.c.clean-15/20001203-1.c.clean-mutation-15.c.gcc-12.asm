  ...
  1b:	48 c7 45 90 4f 00 00 	mov    QWORD PTR [rbp-0x70],0x4f
  22:	00 
  23:	48 c7 45 98 0e 00 00 	mov    QWORD PTR [rbp-0x68],0xe
  2a:	00 
  ...
  72:	00 
  73:	48 c7 45 e1 00 00 00 	mov    QWORD PTR [rbp-0x1f],0x0
  7a:	00 
  7b:	48 c7 45 e9 00 00 00 	mov    QWORD PTR [rbp-0x17],0x0
  82:	00 
  83:	90                   	nop
  84:	48 8b 45 f8          	mov    rax,QWORD PTR [rbp-0x8]
  88:	64 48 2b 04 25 28 00 	sub    rax,QWORD PTR fs:0x28
  8f:	00 00 
  91:	74 05                	je     98 <foo+0x98>
  93:	e8 00 00 00 00       	call   98 <foo+0x98>
  98:	c9                   	leave  
  99:	c3                   	ret    
  ...
  a6:	e8 55 ff ff ff       	call   0 <foo>
  ab:	c7 45 fc 7c 00 00 00 	mov    DWORD PTR [rbp-0x4],0x7c
  b2:	bf 73 00 00 00       	mov    edi,0x73
  b7:	e8 00 00 00 00       	call   bc <main+0x22>
