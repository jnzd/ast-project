 ...
 30b:	83 f8 36             	cmp    eax,0x36
 30e:	74 05                	je     315 <main+0x315>
 310:	e8 00 00 00 00       	call   315 <main+0x315>
 315:	c6 45 b7 20          	mov    BYTE PTR [rbp-0x49],0x20
 319:	c6 45 d4 00          	mov    BYTE PTR [rbp-0x2c],0x0
 31d:	c7 05 00 00 00 00 73 	mov    DWORD PTR [rip+0x0],0x73        # 327 <main+0x327>
 324:	00 00 00 
 327:	c7 05 00 00 00 00 21 	mov    DWORD PTR [rip+0x0],0x21        # 331 <main+0x331>
 32e:	00 00 00 
 ...
 354:	48 83 c0 4a          	add    rax,0x4a
 358:	ba 2f 00 00 00       	mov    edx,0x2f
 ...
 476:	ba 32 00 00 00       	mov    edx,0x32
 ...
 4c4:	00 00 00 
 4c7:	ba 05 00 00 00       	mov    edx,0x5
 ...
 57c:	ba 01 00 00 00       	mov    edx,0x1
 ...
 5a0:	83 f8 1a             	cmp    eax,0x1a
 5a3:	75 22                	jne    5c7 <main+0x5c7>
 5a5:	ba 5b 00 00 00       	mov    edx,0x5b
 ...
 5cc:	c7 05 00 00 00 00 65 	mov    DWORD PTR [rip+0x0],0x65        # 5d6 <main+0x5d6>
 5d3:	00 00 00 
 ...
 60c:	be 2a 00 00 00       	mov    esi,0x2a
 ...
 683:	ba 0b 00 00 00       	mov    edx,0xb
 688:	be 40 00 00 00       	mov    esi,0x40
 ...
 6d3:	b8 24 00 00 00       	mov    eax,0x24
