  ...
  43:	c7 45 fc 57 00 00 00 	mov    DWORD PTR [rbp-0x4],0x57
  ...
  80:	83 f8 1f             	cmp    eax,0x1f
  83:	76 d3                	jbe    58 <main+0x58>
  85:	83 45 fc 01          	add    DWORD PTR [rbp-0x4],0x1
  89:	83 7d fc 6d          	cmp    DWORD PTR [rbp-0x4],0x6d
  8d:	7e bd                	jle    4c <main+0x4c>
  8f:	c7 45 fc 20 00 00 00 	mov    DWORD PTR [rbp-0x4],0x20
  96:	eb 04                	jmp    9c <main+0x9c>
  98:	83 45 fc 01          	add    DWORD PTR [rbp-0x4],0x1
  9c:	83 7d fc 0d          	cmp    DWORD PTR [rbp-0x4],0xd
