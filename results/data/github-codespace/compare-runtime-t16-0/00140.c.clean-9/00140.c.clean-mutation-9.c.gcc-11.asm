  ...
  69:	b8 bc 0a fd 54       	mov    eax,0x54fd0abc
  ...
  9f:	c7 45 d4 16 ed af 0e 	mov    DWORD PTR [rbp-0x2c],0xeafed16
  ...
  bc:	be 77 99 18 44       	mov    esi,0x44189977
