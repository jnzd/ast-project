  ...
  1b:	c7 45 f0 36 00 00 00 	mov    DWORD PTR [rbp-0x10],0x36
  22:	c7 45 f8 2b 00 00 00 	mov    DWORD PTR [rbp-0x8],0x2b
  29:	e9 8a 00 00 00       	jmp    b8 <main+0xb8>
  2e:	c7 45 fc 25 00 00 00 	mov    DWORD PTR [rbp-0x4],0x25
  35:	c7 45 f4 52 00 00 00 	mov    DWORD PTR [rbp-0xc],0x52
  ...
  52:	c7 04 02 5b 00 00 00 	mov    DWORD PTR [rdx+rax*1],0x5b
  59:	83 45 f4 01          	add    DWORD PTR [rbp-0xc],0x1
  5d:	83 7d f4 65          	cmp    DWORD PTR [rbp-0xc],0x65
  ...
  91:	c7 45 f8 68 00 00 00 	mov    DWORD PTR [rbp-0x8],0x68
  ...
  ae:	83 7d fc 3e          	cmp    DWORD PTR [rbp-0x4],0x3e
  b2:	7e b1                	jle    65 <main+0x65>
  b4:	83 45 f0 2b          	add    DWORD PTR [rbp-0x10],0x2b
  b8:	83 7d f0 70          	cmp    DWORD PTR [rbp-0x10],0x70
  bc:	0f 8e 6c ff ff ff    	jle    2e <main+0x2e>
  c2:	bf 62 00 00 00       	mov    edi,0x62
