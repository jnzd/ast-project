  ...
  20:	c7 45 f8 73 00 00 00 	mov    DWORD PTR [rbp-0x8],0x73
  27:	e9 8a 00 00 00       	jmp    b6 <main+0xb6>
  2c:	c7 45 fc 56 00 00 00 	mov    DWORD PTR [rbp-0x4],0x56
  33:	c7 45 f4 21 00 00 00 	mov    DWORD PTR [rbp-0xc],0x21
  ...
  50:	c7 04 02 50 00 00 00 	mov    DWORD PTR [rdx+rax*1],0x50
  ...
  b2:	83 45 f0 0f          	add    DWORD PTR [rbp-0x10],0xf
  b6:	83 7d f0 25          	cmp    DWORD PTR [rbp-0x10],0x25
