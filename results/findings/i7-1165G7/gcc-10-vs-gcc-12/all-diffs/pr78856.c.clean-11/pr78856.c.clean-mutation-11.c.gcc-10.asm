  ...
  19:	c7 45 f0 00 00 00 00 	mov    DWORD PTR [rbp-0x10],0x0
  20:	c7 45 f8 1f 00 00 00 	mov    DWORD PTR [rbp-0x8],0x1f
  27:	e9 8a 00 00 00       	jmp    b6 <main+0xb6>
  2c:	c7 45 fc 37 00 00 00 	mov    DWORD PTR [rbp-0x4],0x37
  33:	c7 45 f4 18 00 00 00 	mov    DWORD PTR [rbp-0xc],0x18
  ...
  50:	c7 04 02 6b 00 00 00 	mov    DWORD PTR [rdx+rax*1],0x6b
  57:	83 45 f4 01          	add    DWORD PTR [rbp-0xc],0x1
  5b:	83 7d f4 1b          	cmp    DWORD PTR [rbp-0xc],0x1b
  ...
  8f:	c7 45 f8 3e 00 00 00 	mov    DWORD PTR [rbp-0x8],0x3e
  ...
  ac:	83 7d fc 1c          	cmp    DWORD PTR [rbp-0x4],0x1c
  b0:	7e b1                	jle    63 <main+0x63>
  b2:	83 45 f0 58          	add    DWORD PTR [rbp-0x10],0x58
  b6:	83 7d f0 11          	cmp    DWORD PTR [rbp-0x10],0x11
  ba:	0f 8e 6c ff ff ff    	jle    2c <main+0x2c>
  c0:	bf 4a 00 00 00       	mov    edi,0x4a
