  ...
  5b:	83 7d fc 5a          	cmp    DWORD PTR [rbp-0x4],0x5a
  ...
  80:	c7 45 fc 70 00 00 00 	mov    DWORD PTR [rbp-0x4],0x70
  ...
  af:	83 7d fc 15          	cmp    DWORD PTR [rbp-0x4],0x15
  b3:	7e d4                	jle    89 <main+0x24>
  b5:	b8 1c 00 00 00       	mov    eax,0x1c
  ba:	c9                   	leave  
  bb:	c3                   	ret    
