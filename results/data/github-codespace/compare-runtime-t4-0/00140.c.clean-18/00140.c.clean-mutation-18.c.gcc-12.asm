  ...
  65:	b8 8a 55 8a 31       	mov    eax,0x318a558a
  ...
  88:	c7 45 e4 af 37 81 54 	mov    DWORD PTR [rbp-0x1c],0x548137af
  ...
  bf:	be a0 d3 f6 27       	mov    esi,0x27f6d3a0
 ...
 129:	ba 04 ab 07 63       	mov    edx,0x6307ab04
 12e:	be e6 2d f3 27       	mov    esi,0x27f32de6
 133:	b8 00 00 00 00       	mov    eax,0x0
 138:	e8 00 00 00 00       	call   13d <main+0xbd>
 13d:	48 83 c4 40          	add    rsp,0x40
 141:	b8 9e ee b5 55       	mov    eax,0x55b5ee9e
 146:	c9                   	leave
 147:	c3                   	ret
