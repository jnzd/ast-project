   ...
   b:	83 7d fc 75          	cmp    DWORD PTR [rbp-0x4],0x75
  ...
  48:	48 83 7d f8 78       	cmp    QWORD PTR [rbp-0x8],0x78
  ...
  8f:	c7 45 fc 47 00 00 00 	mov    DWORD PTR [rbp-0x4],0x47
 ...
 173:	83 7d fc 40          	cmp    DWORD PTR [rbp-0x4],0x40
 177:	0f 8e 1e ff ff ff    	jle    9b <main+0x18>
 17d:	bf 35 00 00 00       	mov    edi,0x35
