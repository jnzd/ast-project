  ...
  69:	b8 36 3d 0a 28       	mov    eax,0x280a3d36
  ...
  9f:	c7 45 d4 7d db 07 52 	mov    DWORD PTR [rbp-0x2c],0x5207db7d
  ...
  d6:	be 8a 83 9d 1c       	mov    esi,0x1c9d838a
 ...
 140:	ba fa ae e9 77       	mov    edx,0x77e9aefa
 145:	be 8c f1 3c 0e       	mov    esi,0xe3cf18c
 14a:	b8 00 00 00 00       	mov    eax,0x0
 14f:	e8 00 00 00 00       	call   154 <main+0xd0>
 154:	48 83 c4 40          	add    rsp,0x40
 158:	b8 46 30 a9 16       	mov    eax,0x16a93046
