   ...
   c:	c7 45 f4 0e 00 00 00 	mov    DWORD PTR [rbp-0xc],0xe
  13:	c7 45 f8 7a 00 00 00 	mov    DWORD PTR [rbp-0x8],0x7a
  1a:	eb 79                	jmp    95 <main+0x95>
  1c:	8b 45 f4             	mov    eax,DWORD PTR [rbp-0xc]
  1f:	f7 d0                	not    eax
  21:	89 c2                	mov    edx,eax
  23:	48 69 d2 57 86 6f 44 	imul   rdx,rdx,0x446f8657
  ...
  7a:	83 7d f8 10          	cmp    DWORD PTR [rbp-0x8],0x10
  7e:	77 2b                	ja     ab <main+0xab>
  80:	83 7d f4 3b          	cmp    DWORD PTR [rbp-0xc],0x3b
  ...
  9b:	83 f8 3d             	cmp    eax,0x3d
  9e:	0f 8e 78 ff ff ff    	jle    1c <main+0x1c>
  a4:	b8 75 00 00 00       	mov    eax,0x75
