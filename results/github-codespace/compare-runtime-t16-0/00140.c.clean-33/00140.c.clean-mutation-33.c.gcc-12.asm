  ...
  65:	b8 97 1f 58 1a       	mov    eax,0x1a581f97
  ...
  88:	c7 45 e4 5f 92 b1 00 	mov    DWORD PTR [rbp-0x1c],0xb1925f
  ...
  bf:	be f6 98 35 2a       	mov    esi,0x2a3598f6
 ...
 129:	ba 7a 8d c8 57       	mov    edx,0x57c88d7a
 12e:	be 1b f8 66 1f       	mov    esi,0x1f66f81b
 133:	b8 00 00 00 00       	mov    eax,0x0
 138:	e8 00 00 00 00       	call   13d <main+0xbd>
 13d:	48 83 c4 40          	add    rsp,0x40
 141:	b8 3f a1 80 7a       	mov    eax,0x7a80a13f
 146:	c9                   	leave
 147:	c3                   	ret
