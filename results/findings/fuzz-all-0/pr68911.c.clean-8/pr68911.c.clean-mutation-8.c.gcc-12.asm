  ...
  25:	48 69 c0 85 10 42 08 	imul   rax,rax,0x8421085
  ...
  7c:	83 7d f8 23          	cmp    DWORD PTR [rbp-0x8],0x23
  80:	77 2b                	ja     ad <main+0xad>
  82:	83 7d f4 4e          	cmp    DWORD PTR [rbp-0xc],0x4e
  ...
  9d:	83 f8 4b             	cmp    eax,0x4b
  a0:	0f 8e 76 ff ff ff    	jle    1c <main+0x1c>
  a6:	b8 7e 00 00 00       	mov    eax,0x7e
