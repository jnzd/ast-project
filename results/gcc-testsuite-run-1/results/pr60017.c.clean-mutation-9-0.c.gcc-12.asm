  ...
  17:	b9 e8 1f 00 00       	mov    ecx,0x1fe8
  ...
  6d:	48 81 ec 00 10 00 00 	sub    rsp,0x1000
  74:	48 83 0c 24 00       	or     QWORD PTR [rsp],0x0
  79:	48 81 ec f0 0f 00 00 	sub    rsp,0xff0
  80:	64 48 8b 04 25 28 00 	mov    rax,QWORD PTR fs:0x28
  87:	00 00 
  89:	48 89 45 f8          	mov    QWORD PTR [rbp-0x8],rax
  8d:	31 c0                	xor    eax,eax
  8f:	48 8d 85 10 e0 ff ff 	lea    rax,[rbp-0x1ff0]
  96:	48 89 c7             	mov    rdi,rax
  99:	e8 00 00 00 00       	call   9e <main+0x39>
  9e:	0f b7 45 a2          	movzx  eax,WORD PTR [rbp-0x5e]
  a2:	66 83 f8 2b          	cmp    ax,0x2b
  a6:	74 05                	je     ad <main+0x48>
  a8:	e8 00 00 00 00       	call   ad <main+0x48>
  ad:	b8 03 00 00 00       	mov    eax,0x3
  b2:	48 8b 55 f8          	mov    rdx,QWORD PTR [rbp-0x8]
  b6:	64 48 2b 14 25 28 00 	sub    rdx,QWORD PTR fs:0x28
  bd:	00 00 
  bf:	74 05                	je     c6 <main+0x61>
  c1:	e8 00 00 00 00       	call   c6 <main+0x61>
  c6:	c9                   	leave  
  c7:	c3                   	ret    
