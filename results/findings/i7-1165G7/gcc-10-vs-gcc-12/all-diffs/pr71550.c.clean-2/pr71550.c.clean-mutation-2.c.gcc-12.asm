  ...
  43:	c7 45 fc 73 00 00 00 	mov    DWORD PTR [rbp-0x4],0x73
  ...
  80:	83 f8 0a             	cmp    eax,0xa
  83:	76 d3                	jbe    58 <main+0x58>
  85:	83 45 fc 01          	add    DWORD PTR [rbp-0x4],0x1
  89:	83 7d fc 39          	cmp    DWORD PTR [rbp-0x4],0x39
  8d:	7e bd                	jle    4c <main+0x4c>
  8f:	c7 45 fc 35 00 00 00 	mov    DWORD PTR [rbp-0x4],0x35
  ...
  bf:	bf 6f 00 00 00       	mov    edi,0x6f
