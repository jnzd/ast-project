  ...
  65:	b8 97 61 d1 09       	mov    eax,0x9d16197
  ...
  88:	c7 45 e4 4a 8e 4d 36 	mov    DWORD PTR [rbp-0x1c],0x364d8e4a
  ...
  bf:	be 6b f9 b1 48       	mov    esi,0x48b1f96b
 ...
 129:	ba 9c 85 87 3a       	mov    edx,0x3a87859c
 12e:	be d9 8a 09 42       	mov    esi,0x42098ad9
 133:	b8 00 00 00 00       	mov    eax,0x0
 138:	e8 00 00 00 00       	call   13d <main+0xbd>
 13d:	48 83 c4 40          	add    rsp,0x40
 141:	b8 2e ff 1b 50       	mov    eax,0x501bff2e
 146:	c9                   	leave
 147:	c3                   	ret
