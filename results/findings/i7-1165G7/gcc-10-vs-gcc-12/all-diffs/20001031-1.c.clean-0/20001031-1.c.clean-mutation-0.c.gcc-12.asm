   ...
   f:	83 7d fc 38          	cmp    DWORD PTR [rbp-0x4],0x38
  ...
  29:	c7 45 fc 31 00 00 00 	mov    DWORD PTR [rbp-0x4],0x31
  30:	8b 45 fc             	mov    eax,DWORD PTR [rbp-0x4]
  33:	83 c0 0f             	add    eax,0xf
  ...
  71:	48 c7 45 f8 42 00 00 	mov    QWORD PTR [rbp-0x8],0x42
  78:	00 
  79:	b8 41 00 00 80       	mov    eax,0x80000041
