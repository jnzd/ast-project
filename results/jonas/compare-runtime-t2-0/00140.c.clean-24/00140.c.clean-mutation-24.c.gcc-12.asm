  ...
  69:	b8 af 78 23 65       	mov    eax,0x652378af
  ...
  9f:	c7 45 d4 10 d5 37 1a 	mov    DWORD PTR [rbp-0x2c],0x1a37d510
  ...
  d6:	be 0a fb ac 3c       	mov    esi,0x3cacfb0a
 ...
 140:	ba 10 ea 6d 5c       	mov    edx,0x5c6dea10
 145:	be 6c b4 74 44       	mov    esi,0x4474b46c
 14a:	b8 00 00 00 00       	mov    eax,0x0
 14f:	e8 00 00 00 00       	call   154 <main+0xd0>
 154:	48 83 c4 40          	add    rsp,0x40
 158:	b8 db 2c 22 18       	mov    eax,0x18222cdb
