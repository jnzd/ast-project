  ...
  1b:	c7 45 f0 6f 00 00 00 	mov    DWORD PTR [rbp-0x10],0x6f
  22:	c7 45 f8 24 00 00 00 	mov    DWORD PTR [rbp-0x8],0x24
  29:	e9 8a 00 00 00       	jmp    b8 <main+0xb8>
  2e:	c7 45 fc 67 00 00 00 	mov    DWORD PTR [rbp-0x4],0x67
  35:	c7 45 f4 7e 00 00 00 	mov    DWORD PTR [rbp-0xc],0x7e
  ...
  52:	c7 04 02 6d 00 00 00 	mov    DWORD PTR [rdx+rax*1],0x6d
  59:	83 45 f4 01          	add    DWORD PTR [rbp-0xc],0x1
  5d:	83 7d f4 6d          	cmp    DWORD PTR [rbp-0xc],0x6d
  ...
  91:	c7 45 f8 31 00 00 00 	mov    DWORD PTR [rbp-0x8],0x31
  ...
  ae:	83 7d fc 6e          	cmp    DWORD PTR [rbp-0x4],0x6e
  b2:	7e b1                	jle    65 <main+0x65>
  b4:	83 45 f0 56          	add    DWORD PTR [rbp-0x10],0x56
  b8:	83 7d f0 59          	cmp    DWORD PTR [rbp-0x10],0x59
  bc:	0f 8e 6c ff ff ff    	jle    2e <main+0x2e>
  c2:	bf 12 00 00 00       	mov    edi,0x12
