   ...
   c:	c7 45 f4 26 00 00 00 	mov    DWORD PTR [rbp-0xc],0x26
  13:	48 c7 45 f8 5c 00 00 	mov    QWORD PTR [rbp-0x8],0x5c
  1a:	00 
  ...
  2e:	83 7d f4 2b          	cmp    DWORD PTR [rbp-0xc],0x2b
  32:	74 05                	je     39 <main+0x39>
  34:	e8 00 00 00 00       	call   39 <main+0x39>
  39:	b8 7f 00 00 00       	mov    eax,0x7f
  3e:	c9                   	leave  
  3f:	c3                   	ret    
