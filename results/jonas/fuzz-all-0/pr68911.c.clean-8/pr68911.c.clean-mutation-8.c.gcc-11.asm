   ...
   c:	c7 45 f4 49 00 00 00 	mov    DWORD PTR [rbp-0xc],0x49
  13:	c7 45 f8 73 00 00 00 	mov    DWORD PTR [rbp-0x8],0x73
  1a:	eb 79                	jmp    95 <main+0x95>
  1c:	8b 45 f4             	mov    eax,DWORD PTR [rbp-0xc]
  1f:	f7 d0                	not    eax
  21:	89 c2                	mov    edx,eax
  23:	48 69 d2 85 10 42 08 	imul   rdx,rdx,0x8421085
  2a:	48 c1 ea 20          	shr    rdx,0x20
  2e:	29 d0                	sub    eax,edx
  30:	d1 e8                	shr    eax,1
  32:	01 d0                	add    eax,edx
  34:	c1 e8 04             	shr    eax,0x4
  ...
  7a:	83 7d f8 23          	cmp    DWORD PTR [rbp-0x8],0x23
  7e:	77 2b                	ja     ab <main+0xab>
  80:	83 7d f4 4e          	cmp    DWORD PTR [rbp-0xc],0x4e
  ...
  9b:	83 f8 4b             	cmp    eax,0x4b
  9e:	0f 8e 78 ff ff ff    	jle    1c <main+0x1c>
  a4:	b8 7e 00 00 00       	mov    eax,0x7e
