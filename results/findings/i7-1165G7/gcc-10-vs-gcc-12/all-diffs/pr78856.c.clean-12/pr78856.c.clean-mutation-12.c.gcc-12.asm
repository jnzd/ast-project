  ...
  22:	c7 45 f8 69 00 00 00 	mov    DWORD PTR [rbp-0x8],0x69
  29:	e9 8a 00 00 00       	jmp    b8 <main+0xb8>
  2e:	c7 45 fc 40 00 00 00 	mov    DWORD PTR [rbp-0x4],0x40
  35:	c7 45 f4 15 00 00 00 	mov    DWORD PTR [rbp-0xc],0x15
  ...
  52:	c7 04 02 60 00 00 00 	mov    DWORD PTR [rdx+rax*1],0x60
  59:	83 45 f4 01          	add    DWORD PTR [rbp-0xc],0x1
  5d:	83 7d f4 52          	cmp    DWORD PTR [rbp-0xc],0x52
  ...
  91:	c7 45 f8 58 00 00 00 	mov    DWORD PTR [rbp-0x8],0x58
  ...
  ae:	83 7d fc 7d          	cmp    DWORD PTR [rbp-0x4],0x7d
  b2:	7e b1                	jle    65 <main+0x65>
  b4:	83 45 f0 7a          	add    DWORD PTR [rbp-0x10],0x7a
  b8:	83 7d f0 6c          	cmp    DWORD PTR [rbp-0x10],0x6c
  bc:	0f 8e 6c ff ff ff    	jle    2e <main+0x2e>
  c2:	bf 50 00 00 00       	mov    edi,0x50
