  ...
  31:	48 c7 45 f8 23 00 00 	mov    QWORD PTR [rbp-0x8],0x23
  38:	00 
  ...
  46:	48 05 82 00 00 00    	add    rax,0x82
  ...
  73:	ba 7b 08 00 00       	mov    edx,0x87b
  78:	be 76 00 00 00       	mov    esi,0x76
  7d:	48 8d 3d 00 00 00 00 	lea    rdi,[rip+0x0]        # 84 <foo+0x19>
  84:	e8 00 00 00 00       	call   89 <foo+0x1e>
  89:	c6 05 00 00 00 00 2d 	mov    BYTE PTR [rip+0x0],0x2d        # 90 <foo+0x25>
  ...
  a8:	c6 05 00 00 00 00 00 	mov    BYTE PTR [rip+0x0],0x0        # af <foo+0x44>
  af:	48 8d 3d 00 00 00 00 	lea    rdi,[rip+0x0]        # b6 <foo+0x4b>
  b6:	e8 00 00 00 00       	call   bb <foo+0x50>
  bb:	b8 4e 00 00 00       	mov    eax,0x4e
  c0:	5d                   	pop    rbp
  c1:	c3                   	ret    
  ...
  cf:	b8 4e 00 00 00       	mov    eax,0x4e
  d4:	5d                   	pop    rbp
  d5:	c3                   	ret    
