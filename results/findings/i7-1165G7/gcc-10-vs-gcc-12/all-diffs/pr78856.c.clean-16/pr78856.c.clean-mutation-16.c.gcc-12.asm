  ...
  1b:	c7 45 f0 04 00 00 00 	mov    DWORD PTR [rbp-0x10],0x4
  22:	c7 45 f8 55 00 00 00 	mov    DWORD PTR [rbp-0x8],0x55
  29:	e9 8a 00 00 00       	jmp    b8 <main+0xb8>
  2e:	c7 45 fc 01 00 00 00 	mov    DWORD PTR [rbp-0x4],0x1
  35:	c7 45 f4 19 00 00 00 	mov    DWORD PTR [rbp-0xc],0x19
  ...
  5d:	83 7d f4 22          	cmp    DWORD PTR [rbp-0xc],0x22
  ...
  91:	c7 45 f8 1e 00 00 00 	mov    DWORD PTR [rbp-0x8],0x1e
  ...
  b4:	83 45 f0 6f          	add    DWORD PTR [rbp-0x10],0x6f
  b8:	83 7d f0 79          	cmp    DWORD PTR [rbp-0x10],0x79
  bc:	0f 8e 6c ff ff ff    	jle    2e <main+0x2e>
  c2:	bf 0a 00 00 00       	mov    edi,0xa
