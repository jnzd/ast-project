  ...
  69:	b8 f8 77 03 7a       	mov    eax,0x7a0377f8
  ...
  9f:	c7 45 d4 f2 a2 69 24 	mov    DWORD PTR [rbp-0x2c],0x2469a2f2
  ...
  bc:	be fd 2b dd 40       	mov    esi,0x40dd2bfd
