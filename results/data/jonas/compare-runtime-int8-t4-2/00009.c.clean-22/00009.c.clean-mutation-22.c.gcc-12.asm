   ...
   8:	c7 45 fc 5f 00 00 00 	mov    DWORD PTR [rbp-0x4],0x5f
   f:	8b 45 fc             	mov    eax,DWORD PTR [rbp-0x4]
  12:	6b c0 59             	imul   eax,eax,0x59
  15:	89 45 fc             	mov    DWORD PTR [rbp-0x4],eax
  18:	8b 45 fc             	mov    eax,DWORD PTR [rbp-0x4]
  1b:	48 63 d0             	movsxd rdx,eax
  1e:	48 69 d2 09 04 02 81 	imul   rdx,rdx,0xffffffff81020409
