 ...
 150:	66 0f 6f 05 00 00 00 	movdqa xmm0,XMMWORD PTR [rip+0x0]        # 158 <main+0x27>
 157:	00 
 158:	0f 29 00             	movaps XMMWORD PTR [rax],xmm0
 15b:	0f 29 40 10          	movaps XMMWORD PTR [rax+0x10],xmm0
 15f:	0f 29 40 20          	movaps XMMWORD PTR [rax+0x20],xmm0
 163:	0f 29 40 30          	movaps XMMWORD PTR [rax+0x30],xmm0
 167:	48 8d 45 b0          	lea    rax,[rbp-0x50]
 16b:	48 89 c7             	mov    rdi,rax
 16e:	b8 00 00 00 00       	mov    eax,0x0
 173:	e8 24 ff ff ff       	call   9c <build_real_from_int_cst_1>
 178:	48 8b 45 c0          	mov    rax,QWORD PTR [rbp-0x40]
 17c:	48 83 f8 59          	cmp    rax,0x59
 180:	75 05                	jne    187 <main+0x56>
 182:	e8 00 00 00 00       	call   187 <main+0x56>
 187:	b8 17 00 00 00       	mov    eax,0x17
 18c:	48 8b 55 f8          	mov    rdx,QWORD PTR [rbp-0x8]
 190:	64 48 2b 14 25 28 00 	sub    rdx,QWORD PTR fs:0x28
 197:	00 00 
 199:	74 05                	je     1a0 <main+0x6f>
 19b:	e8 00 00 00 00       	call   1a0 <main+0x6f>
 1a0:	c9                   	leave  
 1a1:	c3                   	ret    
