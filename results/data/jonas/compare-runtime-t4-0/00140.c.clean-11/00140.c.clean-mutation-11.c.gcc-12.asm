  ...
  69:	b8 8a 7a 57 16       	mov    eax,0x16577a8a
  ...
  9f:	c7 45 d4 aa d6 fa 01 	mov    DWORD PTR [rbp-0x2c],0x1fad6aa
  ...
  d6:	be 13 0f 24 2b       	mov    esi,0x2b240f13
 ...
 140:	ba 39 57 4e 7f       	mov    edx,0x7f4e5739
 145:	be b0 6b 6f 6a       	mov    esi,0x6a6f6bb0
 14a:	b8 00 00 00 00       	mov    eax,0x0
 14f:	e8 00 00 00 00       	call   154 <main+0xd0>
 154:	48 83 c4 40          	add    rsp,0x40
 158:	b8 5f d0 85 40       	mov    eax,0x4085d05f
