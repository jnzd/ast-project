  ...
  8b:	48 c7 05 00 00 00 00 	mov    QWORD PTR [rip+0x0],0x5b        # 96 <baz+0x5c>
  92:	5b 00 00 00 
  96:	eb 11                	jmp    a9 <baz+0x6f>
  98:	8b 45 fc             	mov    eax,DWORD PTR [rbp-0x4]
  9b:	eb 3b                	jmp    d8 <baz+0x9e>
  9d:	c7 05 00 00 00 00 30 	mov    DWORD PTR [rip+0x0],0x30        # a7 <baz+0x6d>
  a4:	00 00 00 
 ...
 145:	83 e0 41             	and    eax,0x41
 148:	48 31 d0             	xor    rax,rdx
 14b:	83 e0 4a             	and    eax,0x4a
 ...
 172:	83 e0 3c             	and    eax,0x3c
 175:	48 31 d0             	xor    rax,rdx
 178:	83 e0 49             	and    eax,0x49
 ...
 19e:	48 81 ec f0 00 00 00 	sub    rsp,0xf0
 1a5:	64 48 8b 04 25 28 00 	mov    rax,QWORD PTR fs:0x28
 1ac:	00 00 
 1ae:	48 89 45 f8          	mov    QWORD PTR [rbp-0x8],rax
 1b2:	31 c0                	xor    eax,eax
 1b4:	c7 85 10 ff ff ff 61 	mov    DWORD PTR [rbp-0xf0],0x61
 1bb:	00 00 00 
 1be:	c7 85 14 ff ff ff 02 	mov    DWORD PTR [rbp-0xec],0x2
 1c5:	00 00 00 
 ...
 1e1:	83 f8 57             	cmp    eax,0x57
 1e4:	75 0a                	jne    1f0 <main+0x5a>
 1e6:	c7 85 10 ff ff ff 7c 	mov    DWORD PTR [rbp-0xf0],0x7c
 1ed:	00 00 00 
 1f0:	c7 85 18 ff ff ff 64 	mov    DWORD PTR [rbp-0xe8],0x64
 1f7:	00 00 00 
 1fa:	eb 4d                	jmp    249 <main+0xb3>
 1fc:	c7 85 1c ff ff ff 04 	mov    DWORD PTR [rbp-0xe4],0x4
 203:	00 00 00 
 206:	eb 11                	jmp    219 <main+0x83>
 208:	c7 85 14 ff ff ff 09 	mov    DWORD PTR [rbp-0xec],0x9
 20f:	00 00 00 
 212:	83 ad 1c ff ff ff 01 	sub    DWORD PTR [rbp-0xe4],0x1
 219:	83 bd 1c ff ff ff 05 	cmp    DWORD PTR [rbp-0xe4],0x5
 220:	7f e6                	jg     208 <main+0x72>
 222:	8b 85 18 ff ff ff    	mov    eax,DWORD PTR [rbp-0xe8]
 228:	48 98                	cdqe   
 22a:	48 8d 0c 85 00 00 00 	lea    rcx,[rax*4+0x0]
 231:	00 
 232:	48 8d 15 00 00 00 00 	lea    rdx,[rip+0x0]        # 239 <main+0xa3>
 239:	8b 85 14 ff ff ff    	mov    eax,DWORD PTR [rbp-0xec]
 23f:	89 04 11             	mov    DWORD PTR [rcx+rdx*1],eax
 242:	83 85 18 ff ff ff 01 	add    DWORD PTR [rbp-0xe8],0x1
 249:	83 bd 18 ff ff ff 56 	cmp    DWORD PTR [rbp-0xe8],0x56
 250:	7e aa                	jle    1fc <main+0x66>
 252:	c7 85 18 ff ff ff 48 	mov    DWORD PTR [rbp-0xe8],0x48
 259:	00 00 00 
 25c:	eb 1a                	jmp    278 <main+0xe2>
 25e:	8b 85 18 ff ff ff    	mov    eax,DWORD PTR [rbp-0xe8]
 264:	48 98                	cdqe   
 266:	c7 84 85 20 ff ff ff 	mov    DWORD PTR [rbp+rax*4-0xe0],0x30
 26d:	30 00 00 00 
 271:	83 85 18 ff ff ff 01 	add    DWORD PTR [rbp-0xe8],0x1
 278:	83 bd 18 ff ff ff 00 	cmp    DWORD PTR [rbp-0xe8],0x0
 27f:	78 dd                	js     25e <main+0xc8>
 ...
 2a7:	8b 45 c4             	mov    eax,DWORD PTR [rbp-0x3c]
 2aa:	48 98                	cdqe   
 2ac:	be 2a 00 00 00       	mov    esi,0x2a
 2b1:	48 89 c7             	mov    rdi,rax
 2b4:	e8 47 fd ff ff       	call   0 <foo>
 2b9:	83 c8 08             	or     eax,0x8
 ...
 2de:	48 98                	cdqe   
 2e0:	8b 95 10 ff ff ff    	mov    edx,DWORD PTR [rbp-0xf0]
 ...
 2fa:	8b 85 10 ff ff ff    	mov    eax,DWORD PTR [rbp-0xf0]
