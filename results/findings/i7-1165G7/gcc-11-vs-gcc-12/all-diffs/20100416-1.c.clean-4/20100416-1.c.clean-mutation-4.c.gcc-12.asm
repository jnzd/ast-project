  ...
  12:	c7 45 fc 3c 00 00 00 	mov    DWORD PTR [rbp-0x4],0x3c
  ...
  5d:	c7 45 fc 6e 00 00 00 	mov    DWORD PTR [rbp-0x4],0x6e
  ...
  80:	be 30 00 00 00       	mov    esi,0x30
  85:	bf e4 ff ff ff       	mov    edi,0xffffffe4
