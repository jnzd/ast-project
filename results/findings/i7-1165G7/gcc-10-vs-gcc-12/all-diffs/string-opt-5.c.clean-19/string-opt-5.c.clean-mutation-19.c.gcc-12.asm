 ...
 31e:	83 f8 25             	cmp    eax,0x25
 321:	75 0b                	jne    32e <main+0x32e>
 323:	8b 05 00 00 00 00    	mov    eax,DWORD PTR [rip+0x0]        # 329 <main+0x329>
 329:	83 f8 28             	cmp    eax,0x28
 32c:	74 05                	je     333 <main+0x333>
 32e:	e8 00 00 00 00       	call   333 <main+0x333>
 333:	c6 45 fc 20          	mov    BYTE PTR [rbp-0x4],0x20
 337:	c6 45 b6 00          	mov    BYTE PTR [rbp-0x4a],0x0
 33b:	c7 05 00 00 00 00 09 	mov    DWORD PTR [rip+0x0],0x9        # 345 <main+0x345>
 342:	00 00 00 
 345:	c7 05 00 00 00 00 7e 	mov    DWORD PTR [rip+0x0],0x7e        # 34f <main+0x34f>
 34c:	00 00 00 
 ...
 375:	48 83 c0 78          	add    rax,0x78
 379:	ba 32 00 00 00       	mov    edx,0x32
 ...
 3cb:	ba 66 00 00 00       	mov    edx,0x66
 ...
 481:	ba 66 00 00 00       	mov    edx,0x66
 ...
 497:	ba 4a 00 00 00       	mov    edx,0x4a
 ...
 4be:	ba 41 00 00 00       	mov    edx,0x41
 ...
 4e5:	00 00 00 
 4e8:	ba 2c 00 00 00       	mov    edx,0x2c
 ...
 59d:	ba 5a 00 00 00       	mov    edx,0x5a
 ...
 5c1:	83 f8 70             	cmp    eax,0x70
 5c4:	75 22                	jne    5e8 <main+0x5e8>
 5c6:	ba 76 00 00 00       	mov    edx,0x76
 ...
 5ed:	c7 05 00 00 00 00 4d 	mov    DWORD PTR [rip+0x0],0x4d        # 5f7 <main+0x5f7>
 5f4:	00 00 00 
 ...
 62d:	be 50 00 00 00       	mov    esi,0x50
 ...
 6a4:	ba 74 00 00 00       	mov    edx,0x74
 6a9:	be 13 00 00 00       	mov    esi,0x13
 ...
 6f4:	b8 4c 00 00 00       	mov    eax,0x4c
