  ...
  5b:	83 7d fc 02          	cmp    DWORD PTR [rbp-0x4],0x2
  ...
  7d:	c7 45 fc 5a 00 00 00 	mov    DWORD PTR [rbp-0x4],0x5a
  ...
  ac:	83 7d fc 58          	cmp    DWORD PTR [rbp-0x4],0x58
  b0:	7e d4                	jle    86 <main+0x21>
  b2:	b8 55 00 00 00       	mov    eax,0x55
  b7:	c9                   	leave  
  b8:	c3                   	ret    
