  ...
  23:	c7 45 fc 67 00 00 00 	mov    DWORD PTR [rbp-0x4],0x67
  ...
  de:	b8 71 00 00 00       	mov    eax,0x71
  e3:	5d                   	pop    rbp
  e4:	c3                   	ret    
