  ...
  23:	48 69 d2 25 49 92 24 	imul   rdx,rdx,0x24924925
  2a:	48 c1 ea 20          	shr    rdx,0x20
  2e:	29 d0                	sub    eax,edx
  30:	d1 e8                	shr    eax,1
  32:	01 d0                	add    eax,edx
  34:	c1 e8 02             	shr    eax,0x2
  ...
  7a:	83 7d f8 39          	cmp    DWORD PTR [rbp-0x8],0x39
  7e:	77 2b                	ja     ab <main+0xab>
  80:	83 7d f4 64          	cmp    DWORD PTR [rbp-0xc],0x64
  ...
  9b:	83 f8 15             	cmp    eax,0x15
  9e:	0f 8e 78 ff ff ff    	jle    1c <main+0x1c>
  a4:	b8 15 00 00 00       	mov    eax,0x15
