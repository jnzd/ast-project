  ...
  69:	b8 4a 29 14 26       	mov    eax,0x2614294a
  ...
  9f:	c7 45 d4 de e8 bd 1c 	mov    DWORD PTR [rbp-0x2c],0x1cbde8de
  ...
  d6:	be a4 a5 18 39       	mov    esi,0x3918a5a4
 ...
 140:	ba 1d b0 12 69       	mov    edx,0x6912b01d
 145:	be 5e 3f bb 38       	mov    esi,0x38bb3f5e
 14a:	b8 00 00 00 00       	mov    eax,0x0
 14f:	e8 00 00 00 00       	call   154 <main+0xd0>
 154:	48 83 c4 40          	add    rsp,0x40
 158:	b8 ea bc 40 10       	mov    eax,0x1040bcea
