   ...
   c:	c7 45 fc 64 00 00 00 	mov    DWORD PTR [rbp-0x4],0x64
  ...
  40:	c7 45 fc 53 00 00 00 	mov    DWORD PTR [rbp-0x4],0x53
  47:	eb 04                	jmp    4d <bar+0x19>
  49:	83 45 fc 01          	add    DWORD PTR [rbp-0x4],0x1
  4d:	83 7d fc 47          	cmp    DWORD PTR [rbp-0x4],0x47
  ...
  c3:	83 f8 6f             	cmp    eax,0x6f
  c6:	74 05                	je     cd <main+0x64>
  c8:	e8 00 00 00 00       	call   cd <main+0x64>
  cd:	c6 45 4e 4d          	mov    BYTE PTR [rbp+0x4e],0x4d
