  ...
  1b:	c7 45 f0 4e 00 00 00 	mov    DWORD PTR [rbp-0x10],0x4e
  22:	c7 45 f8 32 00 00 00 	mov    DWORD PTR [rbp-0x8],0x32
  29:	e9 8a 00 00 00       	jmp    b8 <main+0xb8>
  2e:	c7 45 fc 4c 00 00 00 	mov    DWORD PTR [rbp-0x4],0x4c
  35:	c7 45 f4 4c 00 00 00 	mov    DWORD PTR [rbp-0xc],0x4c
  ...
  52:	c7 04 02 3f 00 00 00 	mov    DWORD PTR [rdx+rax*1],0x3f
  59:	83 45 f4 01          	add    DWORD PTR [rbp-0xc],0x1
  5d:	83 7d f4 72          	cmp    DWORD PTR [rbp-0xc],0x72
  ...
  91:	c7 45 f8 36 00 00 00 	mov    DWORD PTR [rbp-0x8],0x36
  ...
  ae:	83 7d fc 4d          	cmp    DWORD PTR [rbp-0x4],0x4d
  b2:	7e b1                	jle    65 <main+0x65>
  b4:	83 45 f0 66          	add    DWORD PTR [rbp-0x10],0x66
  b8:	83 7d f0 39          	cmp    DWORD PTR [rbp-0x10],0x39
  bc:	0f 8e 6c ff ff ff    	jle    2e <main+0x2e>
  c2:	bf 17 00 00 00       	mov    edi,0x17
