  ...
  31:	48 c7 45 f8 4d 00 00 	mov    QWORD PTR [rbp-0x8],0x4d
  38:	00 
  ...
  46:	48 05 ca 00 00 00    	add    rax,0xca
  ...
  73:	ba c3 08 00 00       	mov    edx,0x8c3
  78:	be 28 00 00 00       	mov    esi,0x28
  ...
  a8:	c6 05 00 00 00 00 55 	mov    BYTE PTR [rip+0x0],0x55        # af <foo+0x44>
  af:	48 8d 3d 00 00 00 00 	lea    rdi,[rip+0x0]        # b6 <foo+0x4b>
  b6:	e8 00 00 00 00       	call   bb <foo+0x50>
  bb:	b8 1e 00 00 00       	mov    eax,0x1e
  c0:	5d                   	pop    rbp
  c1:	c3                   	ret    
  ...
  cf:	b8 1d 00 00 00       	mov    eax,0x1d
  d4:	5d                   	pop    rbp
  d5:	c3                   	ret    
