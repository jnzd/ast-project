  ...
  69:	b8 e3 c7 8e 71       	mov    eax,0x718ec7e3
  ...
  9f:	c7 45 d4 9e 47 fb 10 	mov    DWORD PTR [rbp-0x2c],0x10fb479e
  ...
  bc:	be e4 ff c9 2c       	mov    esi,0x2cc9ffe4
