  ...
  3e:	c7 45 dc 2c 00 00 00 	mov    DWORD PTR [rbp-0x24],0x2c
  45:	c7 45 e0 22 00 00 00 	mov    DWORD PTR [rbp-0x20],0x22
  4c:	8b 0d 00 00 00 00    	mov    ecx,DWORD PTR [rip+0x0]        # 52 <main+0x20>
  52:	b8 63 00 00 00       	mov    eax,0x63
  57:	99                   	cdq    
  58:	f7 f9                	idiv   ecx
  ...
  6f:	83 c0 12             	add    eax,0x12
  72:	89 45 ec             	mov    DWORD PTR [rbp-0x14],eax
  75:	b8 2a 00 00 00       	mov    eax,0x2a
  7a:	99                   	cdq    
  ...
  cd:	6b c0 8e             	imul   eax,eax,0xffffff8e
  ...
  ea:	83 7d f0 2b          	cmp    DWORD PTR [rbp-0x10],0x2b
  ...
  ff:	66 83 7d da f5       	cmp    WORD PTR [rbp-0x26],0xfff5
 104:	74 05                	je     10b <main+0xd9>
 106:	e8 00 00 00 00       	call   10b <main+0xd9>
 10b:	b8 71 00 00 00       	mov    eax,0x71
 110:	c9                   	leave  
 111:	c3                   	ret    
