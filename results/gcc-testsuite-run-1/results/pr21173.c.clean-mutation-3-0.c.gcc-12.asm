  ...
  5e:	83 7d fc 37          	cmp    DWORD PTR [rbp-0x4],0x37
  ...
  83:	c7 45 fc 6a 00 00 00 	mov    DWORD PTR [rbp-0x4],0x6a
  ...
  b2:	83 7d fc 27          	cmp    DWORD PTR [rbp-0x4],0x27
  b6:	7e d4                	jle    8c <main+0x24>
  b8:	b8 4e 00 00 00       	mov    eax,0x4e
  bd:	c9                   	leave  
  be:	c3                   	ret    
