  ...
  23:	c7 45 fc 46 00 00 00 	mov    DWORD PTR [rbp-0x4],0x46
  ...
  db:	b8 44 00 00 00       	mov    eax,0x44
  e0:	5d                   	pop    rbp
  e1:	c3                   	ret    
