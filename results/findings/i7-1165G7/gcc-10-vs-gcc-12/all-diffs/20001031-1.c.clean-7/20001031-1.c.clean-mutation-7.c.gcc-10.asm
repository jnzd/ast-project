   ...
   f:	83 7d fc 1d          	cmp    DWORD PTR [rbp-0x4],0x1d
  ...
  29:	c7 45 fc 67 00 00 00 	mov    DWORD PTR [rbp-0x4],0x67
  30:	8b 45 fc             	mov    eax,DWORD PTR [rbp-0x4]
  33:	83 c0 57             	add    eax,0x57
  ...
  71:	48 c7 45 f8 2c 00 00 	mov    QWORD PTR [rbp-0x8],0x2c
  78:	00 
  79:	bf 2b 00 00 80       	mov    edi,0x8000002b
