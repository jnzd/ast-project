 ...
 2ff:	83 f8 74             	cmp    eax,0x74
 302:	75 0b                	jne    30f <main+0x30f>
 304:	8b 05 00 00 00 00    	mov    eax,DWORD PTR [rip+0x0]        # 30a <main+0x30a>
 30a:	83 f8 69             	cmp    eax,0x69
 30d:	74 05                	je     314 <main+0x314>
 30f:	e8 00 00 00 00       	call   314 <main+0x314>
 314:	c6 45 d3 20          	mov    BYTE PTR [rbp-0x2d],0x20
 318:	c6 45 be 00          	mov    BYTE PTR [rbp-0x42],0x0
 31c:	c7 05 00 00 00 00 6b 	mov    DWORD PTR [rip+0x0],0x6b        # 326 <main+0x326>
 323:	00 00 00 
 326:	c7 05 00 00 00 00 43 	mov    DWORD PTR [rip+0x0],0x43        # 330 <main+0x330>
 32d:	00 00 00 
 ...
 353:	48 83 c0 21          	add    rax,0x21
 357:	ba 44 00 00 00       	mov    edx,0x44
 ...
 3a9:	ba 36 00 00 00       	mov    edx,0x36
 ...
 45f:	ba 36 00 00 00       	mov    edx,0x36
 ...
 499:	ba 39 00 00 00       	mov    edx,0x39
 ...
 4c0:	00 00 00 
 4c3:	ba 20 00 00 00       	mov    edx,0x20
 ...
 578:	ba 69 00 00 00       	mov    edx,0x69
 ...
 59c:	83 f8 1f             	cmp    eax,0x1f
 59f:	75 22                	jne    5c3 <main+0x5c3>
 5a1:	ba 39 00 00 00       	mov    edx,0x39
 ...
 608:	be 27 00 00 00       	mov    esi,0x27
 ...
 67f:	ba 5c 00 00 00       	mov    edx,0x5c
 684:	be 43 00 00 00       	mov    esi,0x43
