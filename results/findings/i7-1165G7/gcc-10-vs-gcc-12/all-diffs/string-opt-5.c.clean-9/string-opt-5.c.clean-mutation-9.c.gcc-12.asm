 ...
 31e:	83 f8 27             	cmp    eax,0x27
 321:	75 0b                	jne    32e <main+0x32e>
 323:	8b 05 00 00 00 00    	mov    eax,DWORD PTR [rip+0x0]        # 329 <main+0x329>
 329:	83 f8 49             	cmp    eax,0x49
 32c:	74 05                	je     333 <main+0x333>
 32e:	e8 00 00 00 00       	call   333 <main+0x333>
 333:	c6 45 94 20          	mov    BYTE PTR [rbp-0x6c],0x20
 337:	c6 45 d8 00          	mov    BYTE PTR [rbp-0x28],0x0
 33b:	c7 05 00 00 00 00 6d 	mov    DWORD PTR [rip+0x0],0x6d        # 345 <main+0x345>
 342:	00 00 00 
 345:	c7 05 00 00 00 00 6d 	mov    DWORD PTR [rip+0x0],0x6d        # 34f <main+0x34f>
 34c:	00 00 00 
 ...
 378:	48 83 c0 48          	add    rax,0x48
 37c:	ba 6c 00 00 00       	mov    edx,0x6c
 ...
 3d7:	ba 6d 00 00 00       	mov    edx,0x6d
 ...
 492:	48 8d 85 70 ff ff ff 	lea    rax,[rbp-0x90]
 499:	ba 6d 00 00 00       	mov    edx,0x6d
 49e:	be 20 00 00 00       	mov    esi,0x20
 4a3:	48 89 c7             	mov    rdi,rax
 4a6:	e8 00 00 00 00       	call   4ab <main+0x4ab>
 4ab:	48 8d 85 70 ff ff ff 	lea    rax,[rbp-0x90]
 4b2:	ba 3b 00 00 00       	mov    edx,0x3b
 ...
 4d8:	48 8d 85 70 ff ff ff 	lea    rax,[rbp-0x90]
 4df:	ba 3e 00 00 00       	mov    edx,0x3e
 ...
 506:	00 00 00 
 509:	ba 24 00 00 00       	mov    edx,0x24
 ...
 5be:	ba 57 00 00 00       	mov    edx,0x57
 ...
 5e2:	83 f8 23             	cmp    eax,0x23
 5e5:	75 22                	jne    609 <main+0x609>
 5e7:	ba 20 00 00 00       	mov    edx,0x20
 ...
 60e:	c7 05 00 00 00 00 45 	mov    DWORD PTR [rip+0x0],0x45        # 618 <main+0x618>
 615:	00 00 00 
 ...
 64e:	be 5a 00 00 00       	mov    esi,0x5a
 ...
 6c5:	ba 47 00 00 00       	mov    edx,0x47
 6ca:	be 4c 00 00 00       	mov    esi,0x4c
 ...
 715:	b8 4c 00 00 00       	mov    eax,0x4c
