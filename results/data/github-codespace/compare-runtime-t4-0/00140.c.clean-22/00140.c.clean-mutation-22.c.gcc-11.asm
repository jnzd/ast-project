  ...
  69:	b8 1e 86 3c 14       	mov    eax,0x143c861e
  ...
  9f:	c7 45 d4 b9 b3 d5 27 	mov    DWORD PTR [rbp-0x2c],0x27d5b3b9
  ...
  bc:	be ff 23 fd 09       	mov    esi,0x9fd23ff
