  ...
  6f:	83 c0 1c             	add    eax,0x1c
  72:	89 45 ec             	mov    DWORD PTR [rbp-0x14],eax
  75:	b8 6c 00 00 00       	mov    eax,0x6c
  7a:	99                   	cdq    
  ...
  f1:	83 7d f0 06          	cmp    DWORD PTR [rbp-0x10],0x6
 ...
 106:	66 83 7d da 89       	cmp    WORD PTR [rbp-0x26],0xff89
 10b:	74 05                	je     112 <main+0xe0>
 10d:	e8 00 00 00 00       	call   112 <main+0xe0>
 112:	b8 32 00 00 00       	mov    eax,0x32
 117:	c9                   	leave  
 118:	c3                   	ret    
