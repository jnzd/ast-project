 ...
 241:	66 0f 6f 05 00 00 00 	movdqa xmm0,XMMWORD PTR [rip+0x0]        # 249 <main+0x2d>
 248:	00 
 249:	0f 29 00             	movaps XMMWORD PTR [rax],xmm0
 24c:	0f 29 40 10          	movaps XMMWORD PTR [rax+0x10],xmm0
 250:	0f 29 40 20          	movaps XMMWORD PTR [rax+0x20],xmm0
 254:	0f 29 40 30          	movaps XMMWORD PTR [rax+0x30],xmm0
 258:	0f 29 40 40          	movaps XMMWORD PTR [rax+0x40],xmm0
 25c:	0f 29 40 50          	movaps XMMWORD PTR [rax+0x50],xmm0
 260:	0f 29 40 60          	movaps XMMWORD PTR [rax+0x60],xmm0
 264:	0f 29 40 70          	movaps XMMWORD PTR [rax+0x70],xmm0
 268:	0f 29 80 80 00 00 00 	movaps XMMWORD PTR [rax+0x80],xmm0
 26f:	48 8d 85 60 ff ff ff 	lea    rax,[rbp-0xa0]
 276:	48 89 c7             	mov    rdi,rax
 279:	b8 00 00 00 00       	mov    eax,0x0
 27e:	e8 96 fe ff ff       	call   119 <build_real_from_int_cst_1>
 283:	48 8b 45 a8          	mov    rax,QWORD PTR [rbp-0x58]
 287:	48 83 f8 4c          	cmp    rax,0x4c
 28b:	75 05                	jne    292 <main+0x76>
 28d:	e8 00 00 00 00       	call   292 <main+0x76>
 292:	b8 2a 00 00 00       	mov    eax,0x2a
 297:	48 8b 55 f8          	mov    rdx,QWORD PTR [rbp-0x8]
 29b:	64 48 2b 14 25 28 00 	sub    rdx,QWORD PTR fs:0x28
 2a2:	00 00 
 2a4:	74 05                	je     2ab <main+0x8f>
 2a6:	e8 00 00 00 00       	call   2ab <main+0x8f>
 2ab:	c9                   	leave  
 2ac:	c3                   	ret    
