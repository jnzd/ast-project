  ...
  31:	48 c7 45 f8 02 00 00 	mov    QWORD PTR [rbp-0x8],0x2
  38:	00 
  ...
  71:	ba 76 08 00 00       	mov    edx,0x876
  76:	be 78 00 00 00       	mov    esi,0x78
  7b:	48 8d 3d 00 00 00 00 	lea    rdi,[rip+0x0]        # 82 <foo+0x19>
  82:	e8 00 00 00 00       	call   87 <foo+0x1e>
  87:	c6 05 00 00 00 00 15 	mov    BYTE PTR [rip+0x0],0x15        # 8e <foo+0x25>
  ...
  a6:	c6 05 00 00 00 00 35 	mov    BYTE PTR [rip+0x0],0x35        # ad <foo+0x44>
  ad:	48 8d 3d 00 00 00 00 	lea    rdi,[rip+0x0]        # b4 <foo+0x4b>
  b4:	e8 00 00 00 00       	call   b9 <foo+0x50>
  b9:	b8 2a 00 00 00       	mov    eax,0x2a
  be:	5d                   	pop    rbp
  bf:	c3                   	ret    
  ...
  cd:	b8 79 00 00 00       	mov    eax,0x79
  d2:	5d                   	pop    rbp
  d3:	c3                   	ret    
