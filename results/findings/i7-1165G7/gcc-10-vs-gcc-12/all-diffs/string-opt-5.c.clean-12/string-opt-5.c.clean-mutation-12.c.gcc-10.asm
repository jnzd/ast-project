 ...
 2fc:	83 f8 7e             	cmp    eax,0x7e
 2ff:	75 0b                	jne    30c <main+0x30c>
 301:	8b 05 00 00 00 00    	mov    eax,DWORD PTR [rip+0x0]        # 307 <main+0x307>
 307:	83 f8 64             	cmp    eax,0x64
 30a:	74 05                	je     311 <main+0x311>
 30c:	e8 00 00 00 00       	call   311 <main+0x311>
 311:	c6 45 37 20          	mov    BYTE PTR [rbp+0x37],0x20
 315:	c6 45 f7 00          	mov    BYTE PTR [rbp-0x9],0x0
 319:	c7 05 00 00 00 00 3a 	mov    DWORD PTR [rip+0x0],0x3a        # 323 <main+0x323>
 320:	00 00 00 
 323:	c7 05 00 00 00 00 77 	mov    DWORD PTR [rip+0x0],0x77        # 32d <main+0x32d>
 32a:	00 00 00 
 ...
 37f:	48 8d 45 e5          	lea    rax,[rbp-0x1b]
 383:	48 83 c0 49          	add    rax,0x49
 ...
 39f:	48 8d 45 e5          	lea    rax,[rbp-0x1b]
 3a3:	ba 03 00 00 00       	mov    edx,0x3
 ...
 4b1:	00 00 00 
 4b4:	ba 7f 00 00 00       	mov    edx,0x7f
 ...
 55d:	ba 58 00 00 00       	mov    edx,0x58
 ...
 581:	83 f8 6f             	cmp    eax,0x6f
 584:	75 1c                	jne    5a2 <main+0x5a2>
 586:	ba 08 00 00 00       	mov    edx,0x8
 ...
 5a7:	c7 05 00 00 00 00 78 	mov    DWORD PTR [rip+0x0],0x78        # 5b1 <main+0x5b1>
 5ae:	00 00 00 
 ...
 5e7:	be 04 00 00 00       	mov    esi,0x4
 ...
 65b:	ba 35 00 00 00       	mov    edx,0x35
 660:	be 15 00 00 00       	mov    esi,0x15
 ...
 6a8:	b8 37 00 00 00       	mov    eax,0x37
