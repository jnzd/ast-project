  ...
  69:	b8 23 e0 af 5e       	mov    eax,0x5eafe023
  ...
  9f:	c7 45 d4 12 15 57 0e 	mov    DWORD PTR [rbp-0x2c],0xe571512
  ...
  d6:	be cc 93 60 48       	mov    esi,0x486093cc
 ...
 140:	ba 27 13 19 16       	mov    edx,0x16191327
 145:	be 5b 34 b3 10       	mov    esi,0x10b3345b
 14a:	b8 00 00 00 00       	mov    eax,0x0
 14f:	e8 00 00 00 00       	call   154 <main+0xd0>
 154:	48 83 c4 40          	add    rsp,0x40
 158:	b8 ff 86 1d 4a       	mov    eax,0x4a1d86ff
