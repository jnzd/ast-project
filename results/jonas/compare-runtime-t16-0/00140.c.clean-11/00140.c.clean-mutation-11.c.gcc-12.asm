  ...
  69:	b8 8d f8 7b 2d       	mov    eax,0x2d7bf88d
  ...
  9f:	c7 45 d4 73 b8 43 0b 	mov    DWORD PTR [rbp-0x2c],0xb43b873
  ...
  d6:	be a6 1a 72 64       	mov    esi,0x64721aa6
 ...
 140:	ba 69 07 f5 1f       	mov    edx,0x1ff50769
 145:	be 60 cd 51 17       	mov    esi,0x1751cd60
 14a:	b8 00 00 00 00       	mov    eax,0x0
 14f:	e8 00 00 00 00       	call   154 <main+0xd0>
 154:	48 83 c4 40          	add    rsp,0x40
 158:	b8 6b d1 aa 78       	mov    eax,0x78aad16b
