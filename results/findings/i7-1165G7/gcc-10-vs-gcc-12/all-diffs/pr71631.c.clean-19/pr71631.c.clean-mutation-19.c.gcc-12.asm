  ...
  3e:	c7 45 dc 57 00 00 00 	mov    DWORD PTR [rbp-0x24],0x57
  45:	c7 45 e0 29 00 00 00 	mov    DWORD PTR [rbp-0x20],0x29
  4c:	8b 0d 00 00 00 00    	mov    ecx,DWORD PTR [rip+0x0]        # 52 <main+0x20>
  52:	b8 3e 00 00 00       	mov    eax,0x3e
  57:	99                   	cdq    
  58:	f7 f9                	idiv   ecx
  ...
  75:	b8 1b 00 00 00       	mov    eax,0x1b
  7a:	99                   	cdq    
  ...
  cd:	6b c0 a4             	imul   eax,eax,0xffffffa4
  ...
  ea:	83 7d f0 03          	cmp    DWORD PTR [rbp-0x10],0x3
  ...
  ff:	66 83 7d da a9       	cmp    WORD PTR [rbp-0x26],0xffa9
 104:	74 05                	je     10b <main+0xd9>
 106:	e8 00 00 00 00       	call   10b <main+0xd9>
 10b:	b8 50 00 00 00       	mov    eax,0x50
 110:	c9                   	leave  
 111:	c3                   	ret    
