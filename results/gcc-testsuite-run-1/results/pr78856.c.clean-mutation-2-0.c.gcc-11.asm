  ...
  20:	c7 45 f8 34 00 00 00 	mov    DWORD PTR [rbp-0x8],0x34
  27:	e9 8a 00 00 00       	jmp    b6 <main+0xb6>
  2c:	c7 45 fc 4d 00 00 00 	mov    DWORD PTR [rbp-0x4],0x4d
  33:	c7 45 f4 59 00 00 00 	mov    DWORD PTR [rbp-0xc],0x59
  ...
  50:	c7 04 02 48 00 00 00 	mov    DWORD PTR [rdx+rax*1],0x48
  57:	83 45 f4 01          	add    DWORD PTR [rbp-0xc],0x1
  5b:	83 7d f4 1e          	cmp    DWORD PTR [rbp-0xc],0x1e
  ...
  8f:	c7 45 f8 50 00 00 00 	mov    DWORD PTR [rbp-0x8],0x50
  ...
  ac:	83 7d fc 1b          	cmp    DWORD PTR [rbp-0x4],0x1b
  b0:	7e b1                	jle    63 <main+0x63>
  b2:	83 45 f0 4b          	add    DWORD PTR [rbp-0x10],0x4b
  b6:	83 7d f0 58          	cmp    DWORD PTR [rbp-0x10],0x58
  ba:	0f 8e 6c ff ff ff    	jle    2c <main+0x2c>
  c0:	bf 2b 00 00 00       	mov    edi,0x2b
