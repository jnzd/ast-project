 ...
 31a:	83 f8 34             	cmp    eax,0x34
 31d:	75 0b                	jne    32a <main+0x32a>
 31f:	8b 05 00 00 00 00    	mov    eax,DWORD PTR [rip+0x0]        # 325 <main+0x325>
 325:	83 f8 05             	cmp    eax,0x5
 328:	74 05                	je     32f <main+0x32f>
 32a:	e8 00 00 00 00       	call   32f <main+0x32f>
 32f:	c6 45 c5 20          	mov    BYTE PTR [rbp-0x3b],0x20
 333:	c6 45 c6 00          	mov    BYTE PTR [rbp-0x3a],0x0
 337:	c7 05 00 00 00 00 54 	mov    DWORD PTR [rip+0x0],0x54        # 341 <main+0x341>
 33e:	00 00 00 
 341:	c7 05 00 00 00 00 34 	mov    DWORD PTR [rip+0x0],0x34        # 34b <main+0x34b>
 348:	00 00 00 
 ...
 371:	48 83 c0 2b          	add    rax,0x2b
 375:	ba 1e 00 00 00       	mov    edx,0x1e
 ...
 3c4:	ba 65 00 00 00       	mov    edx,0x65
 ...
 477:	ba 65 00 00 00       	mov    edx,0x65
 ...
 48d:	ba 3f 00 00 00       	mov    edx,0x3f
 ...
 4ae:	ba 0f 00 00 00       	mov    edx,0xf
 ...
 4d2:	00 00 00 
 4d5:	ba 32 00 00 00       	mov    edx,0x32
 ...
 57e:	ba 65 00 00 00       	mov    edx,0x65
 ...
 5a2:	83 f8 67             	cmp    eax,0x67
 5a5:	75 1c                	jne    5c3 <main+0x5c3>
 5a7:	ba 29 00 00 00       	mov    edx,0x29
 ...
 5c8:	c7 05 00 00 00 00 07 	mov    DWORD PTR [rip+0x0],0x7        # 5d2 <main+0x5d2>
 5cf:	00 00 00 
 ...
 608:	be 04 00 00 00       	mov    esi,0x4
 ...
 67c:	ba 04 00 00 00       	mov    edx,0x4
 ...
 6c9:	b8 60 00 00 00       	mov    eax,0x60
