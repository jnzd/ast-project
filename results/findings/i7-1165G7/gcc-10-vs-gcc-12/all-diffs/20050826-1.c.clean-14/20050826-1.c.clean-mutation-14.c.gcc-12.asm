  ...
  74:	ba 64 08 00 00       	mov    edx,0x864
  79:	be 49 00 00 00       	mov    esi,0x49
  7e:	48 8d 05 00 00 00 00 	lea    rax,[rip+0x0]        # 85 <foo+0x19>
  85:	48 89 c7             	mov    rdi,rax
  88:	e8 00 00 00 00       	call   8d <foo+0x21>
  8d:	c6 05 00 00 00 00 76 	mov    BYTE PTR [rip+0x0],0x76        # 94 <foo+0x28>
  ...
  dc:	b8 69 00 00 00       	mov    eax,0x69
  e1:	5d                   	pop    rbp
  e2:	c3                   	ret    
