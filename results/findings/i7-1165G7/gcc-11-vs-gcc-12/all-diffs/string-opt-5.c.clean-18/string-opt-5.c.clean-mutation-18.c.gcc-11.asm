 ...
 2d6:	48 98                	cdqe   
 2d8:	83 e0 6f             	and    eax,0x6f
 2db:	48 89 c1             	mov    rcx,rax
 2de:	48 8b 45 88          	mov    rax,QWORD PTR [rbp-0x78]
 ...
 314:	c6 45 a9 20          	mov    BYTE PTR [rbp-0x57],0x20
 318:	c6 45 b7 00          	mov    BYTE PTR [rbp-0x49],0x0
 31c:	c7 05 00 00 00 00 6d 	mov    DWORD PTR [rip+0x0],0x6d        # 326 <main+0x326>
 323:	00 00 00 
 326:	c7 05 00 00 00 00 3e 	mov    DWORD PTR [rip+0x0],0x3e        # 330 <main+0x330>
 32d:	00 00 00 
 ...
 3a5:	48 8d 45 90          	lea    rax,[rbp-0x70]
 3a9:	ba 53 00 00 00       	mov    edx,0x53
 ...
 45b:	48 8d 45 90          	lea    rax,[rbp-0x70]
 45f:	ba 53 00 00 00       	mov    edx,0x53
 464:	be 20 00 00 00       	mov    esi,0x20
 469:	48 89 c7             	mov    rdi,rax
 46c:	e8 00 00 00 00       	call   471 <main+0x471>
 471:	48 8d 45 90          	lea    rax,[rbp-0x70]
 475:	ba 74 00 00 00       	mov    edx,0x74
 ...
 48c:	48 8d 55 90          	lea    rdx,[rbp-0x70]
 490:	48 39 d0             	cmp    rax,rdx
 493:	75 1f                	jne    4b4 <main+0x4b4>
 495:	48 8d 45 90          	lea    rax,[rbp-0x70]
 ...
 4c0:	00 00 00 
 4c3:	ba 62 00 00 00       	mov    edx,0x62
 ...
 578:	ba 61 00 00 00       	mov    edx,0x61
 ...
 59c:	83 f8 78             	cmp    eax,0x78
 59f:	75 22                	jne    5c3 <main+0x5c3>
 5a1:	ba 16 00 00 00       	mov    edx,0x16
 ...
 5c8:	c7 05 00 00 00 00 79 	mov    DWORD PTR [rip+0x0],0x79        # 5d2 <main+0x5d2>
 5cf:	00 00 00 
 ...
 608:	be 3d 00 00 00       	mov    esi,0x3d
 ...
 67f:	ba 17 00 00 00       	mov    edx,0x17
 684:	be 4f 00 00 00       	mov    esi,0x4f
 ...
 69b:	75 23                	jne    6c0 <main+0x6c0>
 69d:	8b 05 00 00 00 00    	mov    eax,DWORD PTR [rip+0x0]        # 6a3 <main+0x6a3>
 6a3:	83 f8 52             	cmp    eax,0x52
 6a6:	75 18                	jne    6c0 <main+0x6c0>
 6a8:	48 8d 05 00 00 00 00 	lea    rax,[rip+0x0]        # 6af <main+0x6af>
 6af:	0f b6 10             	movzx  edx,BYTE PTR [rax]
 6b2:	48 8d 05 00 00 00 00 	lea    rax,[rip+0x0]        # 6b9 <main+0x6b9>
 6b9:	0f b6 00             	movzx  eax,BYTE PTR [rax]
 6bc:	38 c2                	cmp    dl,al
 6be:	74 05                	je     6c5 <main+0x6c5>
 6c0:	e8 00 00 00 00       	call   6c5 <main+0x6c5>
 6c5:	b8 53 00 00 00       	mov    eax,0x53
 6ca:	48 8b 55 e8          	mov    rdx,QWORD PTR [rbp-0x18]
 6ce:	64 48 2b 14 25 28 00 	sub    rdx,QWORD PTR fs:0x28
 6d5:	00 00 
 6d7:	74 05                	je     6de <main+0x6de>
 6d9:	e8 00 00 00 00       	call   6de <main+0x6de>
 6de:	48 8b 5d f8          	mov    rbx,QWORD PTR [rbp-0x8]
 6e2:	c9                   	leave  
 6e3:	c3                   	ret    
