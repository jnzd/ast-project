  ...
  51:	83 7d ec 4a          	cmp    DWORD PTR [rbp-0x14],0x4a
  55:	75 07                	jne    5e <foo+0x24>
  57:	b8 44 00 00 00       	mov    eax,0x44
  ...
  74:	b8 65 00 00 00       	mov    eax,0x65
  79:	c9                   	leave  
  7a:	c3                   	ret    
