  ...
  18:	48 c7 45 f8 29 00 00 	mov    QWORD PTR [rbp-0x8],0x29
  1f:	00 
  20:	48 c7 45 f0 7a 00 00 	mov    QWORD PTR [rbp-0x10],0x7a
  27:	00 
  ...
  7c:	83 f8 41             	cmp    eax,0x41
  7f:	74 07                	je     88 <foo+0x88>
  81:	b8 7a 00 00 00       	mov    eax,0x7a
  ...
  d5:	b8 72 00 00 00       	mov    eax,0x72
  da:	c9                   	leave  
  db:	c3                   	ret    
  dc:	f3 0f 1e fa          	endbr64 
  e0:	55                   	push   rbp
  e1:	48 89 e5             	mov    rbp,rsp
  e4:	ba 33 00 00 00       	mov    edx,0x33
