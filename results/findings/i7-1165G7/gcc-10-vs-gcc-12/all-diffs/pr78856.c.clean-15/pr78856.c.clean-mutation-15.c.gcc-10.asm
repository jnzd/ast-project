  ...
  19:	c7 45 f0 55 00 00 00 	mov    DWORD PTR [rbp-0x10],0x55
  20:	c7 45 f8 6e 00 00 00 	mov    DWORD PTR [rbp-0x8],0x6e
  27:	e9 8a 00 00 00       	jmp    b6 <main+0xb6>
  2c:	c7 45 fc 3b 00 00 00 	mov    DWORD PTR [rbp-0x4],0x3b
  33:	c7 45 f4 68 00 00 00 	mov    DWORD PTR [rbp-0xc],0x68
  ...
  50:	c7 04 02 0d 00 00 00 	mov    DWORD PTR [rdx+rax*1],0xd
  57:	83 45 f4 01          	add    DWORD PTR [rbp-0xc],0x1
  5b:	83 7d f4 3a          	cmp    DWORD PTR [rbp-0xc],0x3a
  ...
  8f:	c7 45 f8 4c 00 00 00 	mov    DWORD PTR [rbp-0x8],0x4c
  ...
  ac:	83 7d fc 0f          	cmp    DWORD PTR [rbp-0x4],0xf
  b0:	7e b1                	jle    63 <main+0x63>
  b2:	83 45 f0 74          	add    DWORD PTR [rbp-0x10],0x74
  b6:	83 7d f0 10          	cmp    DWORD PTR [rbp-0x10],0x10
  ba:	0f 8e 6c ff ff ff    	jle    2c <main+0x2c>
  c0:	bf 4b 00 00 00       	mov    edi,0x4b
