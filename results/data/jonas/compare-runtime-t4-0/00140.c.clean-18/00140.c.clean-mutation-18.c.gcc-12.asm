  ...
  69:	b8 b1 fa 60 73       	mov    eax,0x7360fab1
  ...
  9f:	c7 45 d4 b9 f2 09 5a 	mov    DWORD PTR [rbp-0x2c],0x5a09f2b9
  ...
  d6:	be ba 57 42 1d       	mov    esi,0x1d4257ba
 ...
 140:	ba 04 a0 f4 4c       	mov    edx,0x4cf4a004
 145:	be a8 e3 01 04       	mov    esi,0x401e3a8
 14a:	b8 00 00 00 00       	mov    eax,0x0
 14f:	e8 00 00 00 00       	call   154 <main+0xd0>
 154:	48 83 c4 40          	add    rsp,0x40
 158:	b8 a6 fa b0 5c       	mov    eax,0x5cb0faa6
