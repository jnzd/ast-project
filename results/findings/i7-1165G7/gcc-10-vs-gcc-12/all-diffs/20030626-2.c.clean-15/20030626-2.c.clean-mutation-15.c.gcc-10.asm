   ...
   c:	c7 45 f8 48 00 00 00 	mov    DWORD PTR [rbp-0x8],0x48
  ...
  4e:	83 7d fc e0          	cmp    DWORD PTR [rbp-0x4],0xffffffe0
  52:	75 06                	jne    5a <main+0x5a>
  54:	83 7d f8 02          	cmp    DWORD PTR [rbp-0x8],0x2
  58:	74 05                	je     5f <main+0x5f>
  5a:	e8 00 00 00 00       	call   5f <main+0x5f>
  5f:	b8 10 00 00 00       	mov    eax,0x10
  64:	c9                   	leave  
  65:	c3                   	ret    
