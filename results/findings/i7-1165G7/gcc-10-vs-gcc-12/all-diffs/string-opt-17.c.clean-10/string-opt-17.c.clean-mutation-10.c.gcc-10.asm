  ...
  ad:	48 83 ec 10          	sub    rsp,0x10
  b1:	64 48 8b 04 25 28 00 	mov    rax,QWORD PTR fs:0x28
  b8:	00 00 
  ba:	48 89 45 f8          	mov    QWORD PTR [rbp-0x8],rax
  be:	31 c0                	xor    eax,eax
  c0:	48 8d 45 f7          	lea    rax,[rbp-0x9]
  c4:	be 5e 00 00 00       	mov    esi,0x5e
  c9:	48 89 c7             	mov    rdi,rax
  cc:	e8 00 00 00 00       	call   d1 <main+0x2c>
  d1:	48 83 f8 5a          	cmp    rax,0x5a
  d5:	75 1c                	jne    f3 <main+0x4e>
  d7:	48 8d 45 f7          	lea    rax,[rbp-0x9]
  db:	ba 07 00 00 00       	mov    edx,0x7
  e0:	48 8d 35 00 00 00 00 	lea    rsi,[rip+0x0]        # e7 <main+0x42>
  e7:	48 89 c7             	mov    rdi,rax
  ea:	e8 00 00 00 00       	call   ef <main+0x4a>
  ef:	85 c0                	test   eax,eax
  f1:	74 05                	je     f8 <main+0x53>
  f3:	e8 00 00 00 00       	call   f8 <main+0x53>
  f8:	48 8d 45 f7          	lea    rax,[rbp-0x9]
  fc:	48 89 c7             	mov    rdi,rax
  ff:	e8 00 00 00 00       	call   104 <main+0x5f>
 104:	48 8d 45 f7          	lea    rax,[rbp-0x9]
 108:	ba 1b 00 00 00       	mov    edx,0x1b
 10d:	48 8d 35 00 00 00 00 	lea    rsi,[rip+0x0]        # 114 <main+0x6f>
 114:	48 89 c7             	mov    rdi,rax
 117:	e8 00 00 00 00       	call   11c <main+0x77>
 11c:	85 c0                	test   eax,eax
 11e:	74 05                	je     125 <main+0x80>
 120:	e8 00 00 00 00       	call   125 <main+0x80>
 125:	bf 56 00 00 00       	mov    edi,0x56
 12a:	e8 00 00 00 00       	call   12f <main+0x8a>
