  ...
  40:	c7 45 fc 17 00 00 00 	mov    DWORD PTR [rbp-0x4],0x17
  ...
  7d:	83 f8 6b             	cmp    eax,0x6b
  80:	76 d3                	jbe    55 <main+0x55>
  82:	83 45 fc 01          	add    DWORD PTR [rbp-0x4],0x1
  86:	83 7d fc 18          	cmp    DWORD PTR [rbp-0x4],0x18
  8a:	7e bd                	jle    49 <main+0x49>
  8c:	c7 45 fc 5e 00 00 00 	mov    DWORD PTR [rbp-0x4],0x5e
  93:	eb 04                	jmp    99 <main+0x99>
  95:	83 45 fc 01          	add    DWORD PTR [rbp-0x4],0x1
  99:	83 7d fc 25          	cmp    DWORD PTR [rbp-0x4],0x25
  ...
  bc:	bf 3f 00 00 00       	mov    edi,0x3f
