  ...
  69:	b8 76 82 8d 76       	mov    eax,0x768d8276
  ...
  9f:	c7 45 d4 de 7b f4 6e 	mov    DWORD PTR [rbp-0x2c],0x6ef47bde
  ...
  d6:	be 0d 73 fa 00       	mov    esi,0xfa730d
 ...
 140:	ba 5f 1f c1 61       	mov    edx,0x61c11f5f
 145:	be 8c 16 29 0d       	mov    esi,0xd29168c
 14a:	b8 00 00 00 00       	mov    eax,0x0
 14f:	e8 00 00 00 00       	call   154 <main+0xd0>
 154:	48 83 c4 40          	add    rsp,0x40
 158:	b8 48 d6 ce 4a       	mov    eax,0x4aced648
