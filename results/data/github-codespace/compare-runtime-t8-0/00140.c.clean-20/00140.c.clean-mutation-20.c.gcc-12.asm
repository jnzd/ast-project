  ...
  65:	b8 f9 f6 08 15       	mov    eax,0x1508f6f9
  ...
  88:	c7 45 e4 ab 69 67 20 	mov    DWORD PTR [rbp-0x1c],0x206769ab
  ...
  bf:	be 5d a2 73 5c       	mov    esi,0x5c73a25d
 ...
 129:	ba e9 10 56 29       	mov    edx,0x295610e9
 12e:	be 6c bd f1 5b       	mov    esi,0x5bf1bd6c
 133:	b8 00 00 00 00       	mov    eax,0x0
 138:	e8 00 00 00 00       	call   13d <main+0xbd>
 13d:	48 83 c4 40          	add    rsp,0x40
 141:	b8 42 2f 62 4a       	mov    eax,0x4a622f42
 146:	c9                   	leave
 147:	c3                   	ret
