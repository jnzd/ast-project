  ...
  1b:	c7 45 f0 0d 00 00 00 	mov    DWORD PTR [rbp-0x10],0xd
  22:	c7 45 f8 5f 00 00 00 	mov    DWORD PTR [rbp-0x8],0x5f
  29:	e9 8a 00 00 00       	jmp    b8 <main+0xb8>
  2e:	c7 45 fc 6d 00 00 00 	mov    DWORD PTR [rbp-0x4],0x6d
  35:	c7 45 f4 4a 00 00 00 	mov    DWORD PTR [rbp-0xc],0x4a
  ...
  52:	c7 04 02 23 00 00 00 	mov    DWORD PTR [rdx+rax*1],0x23
  ...
  b4:	83 45 f0 1e          	add    DWORD PTR [rbp-0x10],0x1e
