  ...
  19:	c7 45 f0 4d 00 00 00 	mov    DWORD PTR [rbp-0x10],0x4d
  20:	c7 45 f8 69 00 00 00 	mov    DWORD PTR [rbp-0x8],0x69
  27:	e9 8a 00 00 00       	jmp    b6 <main+0xb6>
  2c:	c7 45 fc 40 00 00 00 	mov    DWORD PTR [rbp-0x4],0x40
  33:	c7 45 f4 15 00 00 00 	mov    DWORD PTR [rbp-0xc],0x15
  ...
  50:	c7 04 02 60 00 00 00 	mov    DWORD PTR [rdx+rax*1],0x60
  57:	83 45 f4 01          	add    DWORD PTR [rbp-0xc],0x1
  5b:	83 7d f4 52          	cmp    DWORD PTR [rbp-0xc],0x52
  ...
  8f:	c7 45 f8 58 00 00 00 	mov    DWORD PTR [rbp-0x8],0x58
  ...
  ac:	83 7d fc 7d          	cmp    DWORD PTR [rbp-0x4],0x7d
  b0:	7e b1                	jle    63 <main+0x63>
  b2:	83 45 f0 7a          	add    DWORD PTR [rbp-0x10],0x7a
  b6:	83 7d f0 6c          	cmp    DWORD PTR [rbp-0x10],0x6c
  ba:	0f 8e 6c ff ff ff    	jle    2c <main+0x2c>
  c0:	bf 50 00 00 00       	mov    edi,0x50
