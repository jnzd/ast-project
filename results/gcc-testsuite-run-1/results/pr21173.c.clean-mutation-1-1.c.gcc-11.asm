  ...
  5b:	83 7d fc 2e          	cmp    DWORD PTR [rbp-0x4],0x2e
  ...
  80:	c7 45 fc 6c 00 00 00 	mov    DWORD PTR [rbp-0x4],0x6c
  ...
  af:	83 7d fc 49          	cmp    DWORD PTR [rbp-0x4],0x49
  b3:	7e d4                	jle    89 <main+0x24>
  b5:	b8 53 00 00 00       	mov    eax,0x53
  ba:	c9                   	leave  
  bb:	c3                   	ret    
