  ...
  31:	48 c7 45 f8 65 00 00 	mov    QWORD PTR [rbp-0x8],0x65
  38:	00 
  ...
  78:	be 48 00 00 00       	mov    esi,0x48
  ...
  a8:	c6 05 00 00 00 00 43 	mov    BYTE PTR [rip+0x0],0x43        # af <foo+0x44>
  af:	48 8d 3d 00 00 00 00 	lea    rdi,[rip+0x0]        # b6 <foo+0x4b>
  b6:	e8 00 00 00 00       	call   bb <foo+0x50>
  bb:	b8 64 00 00 00       	mov    eax,0x64
  c0:	5d                   	pop    rbp
  c1:	c3                   	ret    
  ...
  cf:	b8 5d 00 00 00       	mov    eax,0x5d
  d4:	5d                   	pop    rbp
  d5:	c3                   	ret    
