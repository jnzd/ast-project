  ...
  31:	48 c7 45 f8 3a 00 00 	mov    QWORD PTR [rbp-0x8],0x3a
  38:	00 
  ...
  46:	48 05 fe 00 00 00    	add    rax,0xfe
  ...
  73:	ba f7 08 00 00       	mov    edx,0x8f7
  78:	be 67 00 00 00       	mov    esi,0x67
  7d:	48 8d 3d 00 00 00 00 	lea    rdi,[rip+0x0]        # 84 <foo+0x19>
  84:	e8 00 00 00 00       	call   89 <foo+0x1e>
  89:	c6 05 00 00 00 00 77 	mov    BYTE PTR [rip+0x0],0x77        # 90 <foo+0x25>
  ...
  a8:	c6 05 00 00 00 00 2b 	mov    BYTE PTR [rip+0x0],0x2b        # af <foo+0x44>
  af:	48 8d 3d 00 00 00 00 	lea    rdi,[rip+0x0]        # b6 <foo+0x4b>
  b6:	e8 00 00 00 00       	call   bb <foo+0x50>
  bb:	b8 74 00 00 00       	mov    eax,0x74
  c0:	5d                   	pop    rbp
  c1:	c3                   	ret    
