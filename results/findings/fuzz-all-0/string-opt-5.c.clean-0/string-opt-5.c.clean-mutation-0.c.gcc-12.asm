 ...
 300:	83 f8 5d             	cmp    eax,0x5d
 303:	75 0b                	jne    310 <main+0x310>
 305:	8b 05 00 00 00 00    	mov    eax,DWORD PTR [rip+0x0]        # 30b <main+0x30b>
 30b:	83 f8 6e             	cmp    eax,0x6e
 30e:	74 05                	je     315 <main+0x315>
 310:	e8 00 00 00 00       	call   315 <main+0x315>
 315:	c6 45 d6 20          	mov    BYTE PTR [rbp-0x2a],0x20
 319:	c6 45 c7 00          	mov    BYTE PTR [rbp-0x39],0x0
 31d:	c7 05 00 00 00 00 7a 	mov    DWORD PTR [rip+0x0],0x7a        # 327 <main+0x327>
 324:	00 00 00 
 327:	c7 05 00 00 00 00 1c 	mov    DWORD PTR [rip+0x0],0x1c        # 331 <main+0x331>
 32e:	00 00 00 
 ...
 354:	48 83 c0 62          	add    rax,0x62
 358:	ba 61 00 00 00       	mov    edx,0x61
 ...
 3aa:	ba 29 00 00 00       	mov    edx,0x29
 ...
 460:	ba 29 00 00 00       	mov    edx,0x29
 ...
 476:	ba 2f 00 00 00       	mov    edx,0x2f
 ...
 49d:	ba 6b 00 00 00       	mov    edx,0x6b
 ...
 4c4:	00 00 00 
 4c7:	ba 4b 00 00 00       	mov    edx,0x4b
 ...
 57c:	ba 60 00 00 00       	mov    edx,0x60
 ...
 5a0:	83 f8 75             	cmp    eax,0x75
 5a3:	75 22                	jne    5c7 <main+0x5c7>
 5a5:	ba 1c 00 00 00       	mov    edx,0x1c
 ...
 5cc:	c7 05 00 00 00 00 40 	mov    DWORD PTR [rip+0x0],0x40        # 5d6 <main+0x5d6>
 5d3:	00 00 00 
 ...
 60c:	be 40 00 00 00       	mov    esi,0x40
 ...
 683:	ba 43 00 00 00       	mov    edx,0x43
 688:	be 42 00 00 00       	mov    esi,0x42
 ...
 6b3:	ba 29 00 00 00       	mov    edx,0x29
 ...
 6d3:	b8 42 00 00 00       	mov    eax,0x42
