  ...
  7d:	83 f8 67             	cmp    eax,0x67
  80:	76 d3                	jbe    55 <main+0x55>
  82:	83 45 fc 01          	add    DWORD PTR [rbp-0x4],0x1
  86:	83 7d fc 68          	cmp    DWORD PTR [rbp-0x4],0x68
  8a:	7e bd                	jle    49 <main+0x49>
  8c:	c7 45 fc 2b 00 00 00 	mov    DWORD PTR [rbp-0x4],0x2b
  93:	eb 04                	jmp    99 <main+0x99>
  95:	83 45 fc 01          	add    DWORD PTR [rbp-0x4],0x1
  99:	83 7d fc 66          	cmp    DWORD PTR [rbp-0x4],0x66
  ...
  bc:	bf 18 00 00 00       	mov    edi,0x18
