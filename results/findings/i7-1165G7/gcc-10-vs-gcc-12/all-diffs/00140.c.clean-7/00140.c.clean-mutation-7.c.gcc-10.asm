  ...
  69:	b8 3f 00 00 00       	mov    eax,0x3f
  ...
  9f:	c7 45 d4 77 00 00 00 	mov    DWORD PTR [rbp-0x2c],0x77
  ...
  bc:	be 1d 00 00 00       	mov    esi,0x1d
  ...
  f5:	ba 71 00 00 00       	mov    edx,0x71
  fa:	be 72 00 00 00       	mov    esi,0x72
  ff:	48 89 c7             	mov    rdi,rax
 102:	b8 00 00 00 00       	mov    eax,0x0
 107:	e8 00 00 00 00       	call   10c <main+0x88>
 10c:	48 83 c4 40          	add    rsp,0x40
 110:	b8 61 00 00 00       	mov    eax,0x61
 115:	48 8b 4d f8          	mov    rcx,QWORD PTR [rbp-0x8]
 119:	64 48 2b 0c 25 28 00 	sub    rcx,QWORD PTR fs:0x28
 120:	00 00 
