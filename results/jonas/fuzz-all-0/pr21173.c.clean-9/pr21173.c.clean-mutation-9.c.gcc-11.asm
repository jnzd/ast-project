  ...
  5b:	83 7d fc 1b          	cmp    DWORD PTR [rbp-0x4],0x1b
  ...
  80:	c7 45 fc 4a 00 00 00 	mov    DWORD PTR [rbp-0x4],0x4a
  ...
  af:	83 7d fc 12          	cmp    DWORD PTR [rbp-0x4],0x12
  b3:	7e d4                	jle    89 <main+0x24>
  b5:	b8 65 00 00 00       	mov    eax,0x65
  ba:	c9                   	leave  
  bb:	c3                   	ret    
