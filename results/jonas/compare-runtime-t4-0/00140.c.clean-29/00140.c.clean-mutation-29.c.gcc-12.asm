  ...
  69:	b8 a4 20 38 7b       	mov    eax,0x7b3820a4
  ...
  9f:	c7 45 d4 8b 6d 3a 24 	mov    DWORD PTR [rbp-0x2c],0x243a6d8b
  ...
  d6:	be 56 82 48 19       	mov    esi,0x19488256
 ...
 140:	ba 73 d0 0d 79       	mov    edx,0x790dd073
 145:	be 27 96 84 12       	mov    esi,0x12849627
 14a:	b8 00 00 00 00       	mov    eax,0x0
 14f:	e8 00 00 00 00       	call   154 <main+0xd0>
 154:	48 83 c4 40          	add    rsp,0x40
 158:	b8 84 7e cb 5e       	mov    eax,0x5ecb7e84
