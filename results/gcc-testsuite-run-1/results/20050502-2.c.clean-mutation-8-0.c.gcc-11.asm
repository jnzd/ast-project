  ...
  19:	83 7d fc 10          	cmp    DWORD PTR [rbp-0x4],0x10
  ...
  40:	c7 45 fc 5c 00 00 00 	mov    DWORD PTR [rbp-0x4],0x5c
  47:	eb 04                	jmp    4d <bar+0x19>
  49:	83 45 fc 01          	add    DWORD PTR [rbp-0x4],0x1
  4d:	83 7d fc 7e          	cmp    DWORD PTR [rbp-0x4],0x7e
  ...
  c3:	83 f8 6d             	cmp    eax,0x6d
  c6:	74 05                	je     cd <main+0x64>
  c8:	e8 00 00 00 00       	call   cd <main+0x64>
  cd:	c6 45 3c 4d          	mov    BYTE PTR [rbp+0x3c],0x4d
