  ...
  69:	b8 6f ec d1 07       	mov    eax,0x7d1ec6f
  ...
  9f:	c7 45 d4 04 3b a7 08 	mov    DWORD PTR [rbp-0x2c],0x8a73b04
  ...
  d6:	be 2f 60 50 57       	mov    esi,0x5750602f
 ...
 140:	ba 2f 30 b4 22       	mov    edx,0x22b4302f
 145:	be f0 f4 c7 4c       	mov    esi,0x4cc7f4f0
 14a:	b8 00 00 00 00       	mov    eax,0x0
 14f:	e8 00 00 00 00       	call   154 <main+0xd0>
 154:	48 83 c4 40          	add    rsp,0x40
 158:	b8 75 9b f1 46       	mov    eax,0x46f19b75
