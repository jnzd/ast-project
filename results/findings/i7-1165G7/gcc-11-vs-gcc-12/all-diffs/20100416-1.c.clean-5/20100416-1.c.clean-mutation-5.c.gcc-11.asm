  ...
  12:	c7 45 fc 73 00 00 00 	mov    DWORD PTR [rbp-0x4],0x73
  19:	c7 45 f8 65 00 00 00 	mov    DWORD PTR [rbp-0x8],0x65
  ...
  5d:	c7 45 fc 78 00 00 00 	mov    DWORD PTR [rbp-0x4],0x78
  ...
  80:	be 4f 00 00 00       	mov    esi,0x4f
  85:	bf d5 ff ff ff       	mov    edi,0xffffffd5
