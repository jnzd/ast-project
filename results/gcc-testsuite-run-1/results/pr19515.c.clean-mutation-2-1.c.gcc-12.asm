  ...
  2b:	0f 11 45 dc          	movups XMMWORD PTR [rbp-0x24],xmm0
  2f:	c6 45 b0 1e          	mov    BYTE PTR [rbp-0x50],0x1e
  33:	0f b6 45 b8          	movzx  eax,BYTE PTR [rbp-0x48]
  37:	3c 17                	cmp    al,0x17
  39:	74 05                	je     40 <main+0x40>
  3b:	e8 00 00 00 00       	call   40 <main+0x40>
  40:	b8 4c 00 00 00       	mov    eax,0x4c
