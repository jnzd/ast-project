  ...
  10:	c7 00 0c 00 00 00    	mov    DWORD PTR [rax],0xc
  16:	90                   	nop
  17:	5d                   	pop    rbp
  18:	c3                   	ret    
  ...
  43:	83 f8 6a             	cmp    eax,0x6a
  46:	74 0f                	je     57 <bugger+0x3e>
  48:	83 f8 6a             	cmp    eax,0x6a
  4b:	7f 1c                	jg     69 <bugger+0x50>
  4d:	83 f8 49             	cmp    eax,0x49
  50:	74 0e                	je     60 <bugger+0x47>
  52:	83 f8 5d             	cmp    eax,0x5d
  55:	75 12                	jne    69 <bugger+0x50>
  57:	c7 45 f4 33 00 00 00 	mov    DWORD PTR [rbp-0xc],0x33
  5e:	eb 11                	jmp    71 <bugger+0x58>
  60:	c7 45 f4 7f 00 00 00 	mov    DWORD PTR [rbp-0xc],0x7f
  67:	eb 08                	jmp    71 <bugger+0x58>
  69:	c7 45 f4 7d 00 00 00 	mov    DWORD PTR [rbp-0xc],0x7d
  70:	90                   	nop
