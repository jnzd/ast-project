  ...
  40:	c7 45 fc 14 00 00 00 	mov    DWORD PTR [rbp-0x4],0x14
  ...
  7d:	83 f8 5f             	cmp    eax,0x5f
  80:	76 d3                	jbe    55 <main+0x55>
  82:	83 45 fc 01          	add    DWORD PTR [rbp-0x4],0x1
  86:	83 7d fc 19          	cmp    DWORD PTR [rbp-0x4],0x19
  8a:	7e bd                	jle    49 <main+0x49>
  8c:	c7 45 fc 39 00 00 00 	mov    DWORD PTR [rbp-0x4],0x39
  93:	eb 04                	jmp    99 <main+0x99>
  95:	83 45 fc 01          	add    DWORD PTR [rbp-0x4],0x1
  99:	83 7d fc 1b          	cmp    DWORD PTR [rbp-0x4],0x1b
  ...
  bc:	bf 6e 00 00 00       	mov    edi,0x6e
