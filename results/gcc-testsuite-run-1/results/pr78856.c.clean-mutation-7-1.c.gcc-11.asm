  ...
  19:	c7 45 f0 79 00 00 00 	mov    DWORD PTR [rbp-0x10],0x79
  20:	c7 45 f8 0b 00 00 00 	mov    DWORD PTR [rbp-0x8],0xb
  27:	e9 8a 00 00 00       	jmp    b6 <main+0xb6>
  2c:	c7 45 fc 36 00 00 00 	mov    DWORD PTR [rbp-0x4],0x36
  33:	c7 45 f4 79 00 00 00 	mov    DWORD PTR [rbp-0xc],0x79
  ...
  50:	c7 04 02 57 00 00 00 	mov    DWORD PTR [rdx+rax*1],0x57
  57:	83 45 f4 01          	add    DWORD PTR [rbp-0xc],0x1
  5b:	83 7d f4 7b          	cmp    DWORD PTR [rbp-0xc],0x7b
  ...
  8f:	c7 45 f8 15 00 00 00 	mov    DWORD PTR [rbp-0x8],0x15
  ...
  ac:	83 7d fc 37          	cmp    DWORD PTR [rbp-0x4],0x37
  b0:	7e b1                	jle    63 <main+0x63>
  b2:	83 45 f0 1c          	add    DWORD PTR [rbp-0x10],0x1c
  b6:	83 7d f0 19          	cmp    DWORD PTR [rbp-0x10],0x19
  ba:	0f 8e 6c ff ff ff    	jle    2c <main+0x2c>
  c0:	bf 6c 00 00 00       	mov    edi,0x6c
