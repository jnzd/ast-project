 ...
 2ff:	83 f8 10             	cmp    eax,0x10
 302:	75 0b                	jne    30f <main+0x30f>
 304:	8b 05 00 00 00 00    	mov    eax,DWORD PTR [rip+0x0]        # 30a <main+0x30a>
 30a:	83 f8 51             	cmp    eax,0x51
 30d:	74 05                	je     314 <main+0x314>
 30f:	e8 00 00 00 00       	call   314 <main+0x314>
 314:	c6 45 b8 20          	mov    BYTE PTR [rbp-0x48],0x20
 318:	c6 45 c1 00          	mov    BYTE PTR [rbp-0x3f],0x0
 31c:	c7 05 00 00 00 00 3d 	mov    DWORD PTR [rip+0x0],0x3d        # 326 <main+0x326>
 323:	00 00 00 
 326:	c7 05 00 00 00 00 44 	mov    DWORD PTR [rip+0x0],0x44        # 330 <main+0x330>
 32d:	00 00 00 
 ...
 353:	48 83 c0 36          	add    rax,0x36
 357:	ba 04 00 00 00       	mov    edx,0x4
 ...
 3a9:	ba 2c 00 00 00       	mov    edx,0x2c
 ...
 45f:	ba 2c 00 00 00       	mov    edx,0x2c
 ...
 475:	ba 6b 00 00 00       	mov    edx,0x6b
 ...
 4c0:	00 00 00 
 4c3:	ba 29 00 00 00       	mov    edx,0x29
 ...
 57a:	ba 35 00 00 00       	mov    edx,0x35
 ...
 59e:	83 f8 0a             	cmp    eax,0xa
 5a1:	75 22                	jne    5c5 <main+0x5c5>
 5a3:	ba 41 00 00 00       	mov    edx,0x41
 ...
 5ca:	c7 05 00 00 00 00 4f 	mov    DWORD PTR [rip+0x0],0x4f        # 5d4 <main+0x5d4>
 5d1:	00 00 00 
 ...
 60a:	be 3a 00 00 00       	mov    esi,0x3a
 ...
 681:	ba 06 00 00 00       	mov    edx,0x6
 686:	be 12 00 00 00       	mov    esi,0x12
 ...
 6d1:	b8 3d 00 00 00       	mov    eax,0x3d
