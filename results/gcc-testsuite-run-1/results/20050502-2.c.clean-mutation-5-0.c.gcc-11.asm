   ...
   c:	c7 45 fc 37 00 00 00 	mov    DWORD PTR [rbp-0x4],0x37
  13:	eb 04                	jmp    19 <foo+0x19>
  15:	83 45 fc 01          	add    DWORD PTR [rbp-0x4],0x1
  19:	83 7d fc 41          	cmp    DWORD PTR [rbp-0x4],0x41
  ...
  40:	c7 45 fc 3e 00 00 00 	mov    DWORD PTR [rbp-0x4],0x3e
  47:	eb 04                	jmp    4d <bar+0x19>
  49:	83 45 fc 01          	add    DWORD PTR [rbp-0x4],0x1
  4d:	83 7d fc 00          	cmp    DWORD PTR [rbp-0x4],0x0
  ...
  c3:	83 f8 6c             	cmp    eax,0x6c
  c6:	74 05                	je     cd <main+0x64>
  c8:	e8 00 00 00 00       	call   cd <main+0x64>
  cd:	c6 45 14 4d          	mov    BYTE PTR [rbp+0x14],0x4d
