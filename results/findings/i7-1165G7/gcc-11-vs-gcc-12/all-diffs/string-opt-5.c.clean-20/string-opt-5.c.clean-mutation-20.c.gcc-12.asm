 ...
 300:	83 f8 12             	cmp    eax,0x12
 303:	75 0b                	jne    310 <main+0x310>
 305:	8b 05 00 00 00 00    	mov    eax,DWORD PTR [rip+0x0]        # 30b <main+0x30b>
 30b:	83 f8 26             	cmp    eax,0x26
 30e:	74 05                	je     315 <main+0x315>
 310:	e8 00 00 00 00       	call   315 <main+0x315>
 315:	c6 45 c2 20          	mov    BYTE PTR [rbp-0x3e],0x20
 319:	c6 45 c0 00          	mov    BYTE PTR [rbp-0x40],0x0
 31d:	c7 05 00 00 00 00 56 	mov    DWORD PTR [rip+0x0],0x56        # 327 <main+0x327>
 324:	00 00 00 
 327:	c7 05 00 00 00 00 70 	mov    DWORD PTR [rip+0x0],0x70        # 331 <main+0x331>
 32e:	00 00 00 
 ...
 358:	ba 51 00 00 00       	mov    edx,0x51
 ...
 476:	ba 15 00 00 00       	mov    edx,0x15
 ...
 49d:	ba 04 00 00 00       	mov    edx,0x4
 ...
 4c4:	00 00 00 
 4c7:	ba 71 00 00 00       	mov    edx,0x71
 ...
 535:	83 f8 65             	cmp    eax,0x65
 538:	75 22                	jne    55c <main+0x55c>
 53a:	ba 1d 00 00 00       	mov    edx,0x1d
 ...
 57c:	ba 30 00 00 00       	mov    edx,0x30
 ...
 5a5:	ba 1d 00 00 00       	mov    edx,0x1d
 ...
 5cc:	c7 05 00 00 00 00 76 	mov    DWORD PTR [rip+0x0],0x76        # 5d6 <main+0x5d6>
 5d3:	00 00 00 
 ...
 683:	ba 51 00 00 00       	mov    edx,0x51
 688:	be 24 00 00 00       	mov    esi,0x24
 ...
 6d3:	b8 6e 00 00 00       	mov    eax,0x6e
