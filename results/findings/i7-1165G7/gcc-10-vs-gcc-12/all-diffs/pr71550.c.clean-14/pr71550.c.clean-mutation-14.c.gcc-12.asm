  ...
  43:	c7 45 fc 47 00 00 00 	mov    DWORD PTR [rbp-0x4],0x47
  ...
  80:	83 f8 7c             	cmp    eax,0x7c
  83:	76 d3                	jbe    58 <main+0x58>
  85:	83 45 fc 01          	add    DWORD PTR [rbp-0x4],0x1
  89:	83 7d fc 23          	cmp    DWORD PTR [rbp-0x4],0x23
  8d:	7e bd                	jle    4c <main+0x4c>
  8f:	c7 45 fc 63 00 00 00 	mov    DWORD PTR [rbp-0x4],0x63
  96:	eb 04                	jmp    9c <main+0x9c>
  98:	83 45 fc 01          	add    DWORD PTR [rbp-0x4],0x1
  9c:	83 7d fc 24          	cmp    DWORD PTR [rbp-0x4],0x24
  ...
  bf:	bf 4d 00 00 00       	mov    edi,0x4d
