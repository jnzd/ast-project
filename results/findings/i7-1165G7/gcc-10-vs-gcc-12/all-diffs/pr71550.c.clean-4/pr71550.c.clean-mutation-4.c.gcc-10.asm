  ...
  40:	c7 45 fc 56 00 00 00 	mov    DWORD PTR [rbp-0x4],0x56
  ...
  7d:	83 f8 06             	cmp    eax,0x6
  80:	76 d3                	jbe    55 <main+0x55>
  82:	83 45 fc 01          	add    DWORD PTR [rbp-0x4],0x1
  86:	83 7d fc 1a          	cmp    DWORD PTR [rbp-0x4],0x1a
  8a:	7e bd                	jle    49 <main+0x49>
  8c:	c7 45 fc 55 00 00 00 	mov    DWORD PTR [rbp-0x4],0x55
  93:	eb 04                	jmp    99 <main+0x99>
  95:	83 45 fc 01          	add    DWORD PTR [rbp-0x4],0x1
  99:	83 7d fc 13          	cmp    DWORD PTR [rbp-0x4],0x13
  ...
  bc:	bf 22 00 00 00       	mov    edi,0x22
