   ...
   c:	c7 45 fc 5c 00 00 00 	mov    DWORD PTR [rbp-0x4],0x5c
  13:	eb 04                	jmp    19 <foo+0x19>
  15:	83 45 fc 01          	add    DWORD PTR [rbp-0x4],0x1
  19:	83 7d fc 68          	cmp    DWORD PTR [rbp-0x4],0x68
  ...
  40:	c7 45 fc 4f 00 00 00 	mov    DWORD PTR [rbp-0x4],0x4f
  47:	eb 04                	jmp    4d <bar+0x19>
  49:	83 45 fc 01          	add    DWORD PTR [rbp-0x4],0x1
  4d:	83 7d fc 13          	cmp    DWORD PTR [rbp-0x4],0x13
  ...
  c3:	83 f8 46             	cmp    eax,0x46
  c6:	74 05                	je     cd <main+0x64>
  c8:	e8 00 00 00 00       	call   cd <main+0x64>
  cd:	c6 45 55 4d          	mov    BYTE PTR [rbp+0x55],0x4d
