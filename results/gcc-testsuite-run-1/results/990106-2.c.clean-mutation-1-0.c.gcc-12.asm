   ...
   b:	c7 45 f8 bf ff ff ff 	mov    DWORD PTR [rbp-0x8],0xffffffbf
  ...
  27:	ba 23 00 00 00       	mov    edx,0x23
  ...
  39:	83 45 fc 55          	add    DWORD PTR [rbp-0x4],0x55
  ...
  5b:	c7 45 f8 4d 00 00 00 	mov    DWORD PTR [rbp-0x8],0x4d
  ...
  6f:	bf 73 00 00 00       	mov    edi,0x73
