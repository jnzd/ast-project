  ...
  18:	48 c7 45 f8 77 00 00 	mov    QWORD PTR [rbp-0x8],0x77
  1f:	00 
  20:	48 c7 45 f0 36 00 00 	mov    QWORD PTR [rbp-0x10],0x36
  27:	00 
  ...
  7c:	83 f8 14             	cmp    eax,0x14
  7f:	74 07                	je     88 <foo+0x88>
  81:	b8 46 00 00 00       	mov    eax,0x46
