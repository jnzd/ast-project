  ...
  73:	48 83 7d f8 19       	cmp    QWORD PTR [rbp-0x8],0x19
  78:	7e 07                	jle    81 <f+0x81>
  7a:	b8 40 00 00 00       	mov    eax,0x40
  7f:	eb 13                	jmp    94 <f+0x94>
  81:	48 83 7d f8 68       	cmp    QWORD PTR [rbp-0x8],0x68
  86:	7f 07                	jg     8f <f+0x8f>
  88:	b8 73 00 00 00       	mov    eax,0x73
  8d:	eb 05                	jmp    94 <f+0x94>
  8f:	b8 34 00 00 00       	mov    eax,0x34
  94:	5d                   	pop    rbp
  95:	c3                   	ret    
  ...
  a3:	48 c7 45 c0 94 ff ff 	mov    QWORD PTR [rbp-0x40],0xffffffffffffff94
  aa:	ff 
  ab:	48 c7 45 c8 5d 00 00 	mov    QWORD PTR [rbp-0x38],0x5d
  b2:	00 
  b3:	48 c7 45 d0 46 00 00 	mov    QWORD PTR [rbp-0x30],0x46
  ba:	00 
  bb:	48 c7 45 d8 a2 ff ff 	mov    QWORD PTR [rbp-0x28],0xffffffffffffffa2
  c2:	ff 
  c3:	48 c7 45 e0 ac ff ff 	mov    QWORD PTR [rbp-0x20],0xffffffffffffffac
  ca:	ff 
  cb:	48 c7 45 e8 bd ff ff 	mov    QWORD PTR [rbp-0x18],0xffffffffffffffbd
  d2:	ff 
  ...
  ff:	83 7d bc 14          	cmp    DWORD PTR [rbp-0x44],0x14
 103:	74 05                	je     10a <main+0x74>
 105:	e8 00 00 00 00       	call   10a <main+0x74>
 10a:	bf 5a 00 00 00       	mov    edi,0x5a
