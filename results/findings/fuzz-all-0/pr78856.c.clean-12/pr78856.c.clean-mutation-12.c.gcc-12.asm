  ...
  1b:	c7 45 f0 38 00 00 00 	mov    DWORD PTR [rbp-0x10],0x38
  22:	c7 45 f8 51 00 00 00 	mov    DWORD PTR [rbp-0x8],0x51
  29:	e9 8a 00 00 00       	jmp    b8 <main+0xb8>
  2e:	c7 45 fc 7f 00 00 00 	mov    DWORD PTR [rbp-0x4],0x7f
  ...
  52:	c7 04 02 74 00 00 00 	mov    DWORD PTR [rdx+rax*1],0x74
  59:	83 45 f4 01          	add    DWORD PTR [rbp-0xc],0x1
  5d:	83 7d f4 03          	cmp    DWORD PTR [rbp-0xc],0x3
  ...
  91:	c7 45 f8 52 00 00 00 	mov    DWORD PTR [rbp-0x8],0x52
  ...
  b8:	83 7d f0 63          	cmp    DWORD PTR [rbp-0x10],0x63
  bc:	0f 8e 6c ff ff ff    	jle    2e <main+0x2e>
  c2:	bf 0b 00 00 00       	mov    edi,0xb
