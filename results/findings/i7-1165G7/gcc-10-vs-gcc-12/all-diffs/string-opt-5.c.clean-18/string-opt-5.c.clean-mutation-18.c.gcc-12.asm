 ...
 300:	83 f8 16             	cmp    eax,0x16
 303:	75 0b                	jne    310 <main+0x310>
 305:	8b 05 00 00 00 00    	mov    eax,DWORD PTR [rip+0x0]        # 30b <main+0x30b>
 30b:	83 f8 16             	cmp    eax,0x16
 30e:	74 05                	je     315 <main+0x315>
 310:	e8 00 00 00 00       	call   315 <main+0x315>
 315:	c6 45 5b 20          	mov    BYTE PTR [rbp+0x5b],0x20
 319:	c6 45 53 00          	mov    BYTE PTR [rbp+0x53],0x0
 31d:	c7 05 00 00 00 00 24 	mov    DWORD PTR [rip+0x0],0x24        # 327 <main+0x327>
 324:	00 00 00 
 327:	c7 05 00 00 00 00 3b 	mov    DWORD PTR [rip+0x0],0x3b        # 331 <main+0x331>
 32e:	00 00 00 
 ...
 3a6:	48 8d 45 e2          	lea    rax,[rbp-0x1e]
 3aa:	ba 06 00 00 00       	mov    edx,0x6
 ...
 45c:	48 8d 45 e2          	lea    rax,[rbp-0x1e]
 460:	ba 06 00 00 00       	mov    edx,0x6
 465:	be 20 00 00 00       	mov    esi,0x20
 46a:	48 89 c7             	mov    rdi,rax
 46d:	e8 00 00 00 00       	call   472 <main+0x472>
 472:	48 8d 45 e2          	lea    rax,[rbp-0x1e]
 476:	ba 4a 00 00 00       	mov    edx,0x4a
 ...
 490:	48 8d 45 e2          	lea    rax,[rbp-0x1e]
 494:	48 39 c2             	cmp    rdx,rax
 497:	75 1f                	jne    4b8 <main+0x4b8>
 499:	48 8d 45 e2          	lea    rax,[rbp-0x1e]
 49d:	ba 29 00 00 00       	mov    edx,0x29
 ...
 4c4:	00 00 00 
 4c7:	ba 36 00 00 00       	mov    edx,0x36
 ...
 57c:	ba 13 00 00 00       	mov    edx,0x13
 ...
 5a0:	83 f8 70             	cmp    eax,0x70
 5a3:	75 22                	jne    5c7 <main+0x5c7>
 5a5:	ba 55 00 00 00       	mov    edx,0x55
 ...
 5cc:	c7 05 00 00 00 00 27 	mov    DWORD PTR [rip+0x0],0x27        # 5d6 <main+0x5d6>
 5d3:	00 00 00 
 ...
 60c:	be 75 00 00 00       	mov    esi,0x75
 ...
 683:	ba 2a 00 00 00       	mov    edx,0x2a
 688:	be 0c 00 00 00       	mov    esi,0xc
 ...
 6d3:	b8 34 00 00 00       	mov    eax,0x34
