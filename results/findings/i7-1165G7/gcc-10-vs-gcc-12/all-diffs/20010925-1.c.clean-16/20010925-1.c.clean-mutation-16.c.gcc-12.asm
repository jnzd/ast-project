  ...
  51:	83 7d ec 7d          	cmp    DWORD PTR [rbp-0x14],0x7d
  55:	75 07                	jne    5e <foo+0x24>
  57:	b8 18 00 00 00       	mov    eax,0x18
  ...
  74:	b8 1e 00 00 00       	mov    eax,0x1e
  79:	c9                   	leave  
  7a:	c3                   	ret    
