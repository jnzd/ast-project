  ...
  69:	b8 c8 74 e0 21       	mov    eax,0x21e074c8
  ...
  9f:	c7 45 d4 c6 d0 04 03 	mov    DWORD PTR [rbp-0x2c],0x304d0c6
  ...
  d6:	be 5d 5c c1 38       	mov    esi,0x38c15c5d
 ...
 140:	ba 19 a6 97 75       	mov    edx,0x7597a619
 145:	be 39 0a 75 71       	mov    esi,0x71750a39
 14a:	b8 00 00 00 00       	mov    eax,0x0
 14f:	e8 00 00 00 00       	call   154 <main+0xd0>
 154:	48 83 c4 40          	add    rsp,0x40
 158:	b8 d0 72 84 28       	mov    eax,0x288472d0
