 ...
 197:	48 8b 41 60          	mov    rax,QWORD PTR [rcx+0x60]
 19b:	48 89 44 24 60       	mov    QWORD PTR [rsp+0x60],rax
 1a0:	8b 41 68             	mov    eax,DWORD PTR [rcx+0x68]
 1a3:	89 44 24 68          	mov    DWORD PTR [rsp+0x68],eax
 1a7:	0f b7 41 6c          	movzx  eax,WORD PTR [rcx+0x6c]
 1ab:	66 89 44 24 6c       	mov    WORD PTR [rsp+0x6c],ax
 1b0:	49 8b 41 08          	mov    rax,QWORD PTR [r9+0x8]
 1b4:	49 8b 51 10          	mov    rdx,QWORD PTR [r9+0x10]
 1b8:	49 8b 49 18          	mov    rcx,QWORD PTR [r9+0x18]
 1bc:	49 8b 71 20          	mov    rsi,QWORD PTR [r9+0x20]
 1c0:	49 8b 79 28          	mov    rdi,QWORD PTR [r9+0x28]
 1c4:	f3 41 0f 6f 41 30    	movdqu xmm0,XMMWORD PTR [r9+0x30]
 1ca:	f3 41 0f 6f 49 40    	movdqu xmm1,XMMWORD PTR [r9+0x40]
 1d0:	f3 41 0f 6f 51 50    	movdqu xmm2,XMMWORD PTR [r9+0x50]
 1d6:	f3 41 0f 6f 59 60    	movdqu xmm3,XMMWORD PTR [r9+0x60]
 1dc:	f3 41 0f 6f 61 70    	movdqu xmm4,XMMWORD PTR [r9+0x70]
 1e2:	f3 41 0f 6f a9 80 00 	movdqu xmm5,XMMWORD PTR [r9+0x80]
 1e9:	00 00 
 1eb:	f3 41 0f 6f b1 90 00 	movdqu xmm6,XMMWORD PTR [r9+0x90]
 1f2:	00 00 
 1f4:	f3 41 0f 6f b9 a0 00 	movdqu xmm7,XMMWORD PTR [r9+0xa0]
 1fb:	00 00 
 1fd:	4d 8b 81 b0 00 00 00 	mov    r8,QWORD PTR [r9+0xb0]
 204:	4d 8b 89 b8 00 00 00 	mov    r9,QWORD PTR [r9+0xb8]
 20b:	b8 07 00 00 00       	mov    eax,0x7
 210:	e8 eb fd ff ff       	call   0 <foo>
 215:	48 89 85 a0 fe ff ff 	mov    QWORD PTR [rbp-0x160],rax
 21c:	48 89 95 a8 fe ff ff 	mov    QWORD PTR [rbp-0x158],rdx
 223:	48 89 b5 b0 fe ff ff 	mov    QWORD PTR [rbp-0x150],rsi
 22a:	48 89 bd b8 fe ff ff 	mov    QWORD PTR [rbp-0x148],rdi
 231:	db bd c0 fe ff ff    	fstp   TBYTE PTR [rbp-0x140]
 237:	db bd d0 fe ff ff    	fstp   TBYTE PTR [rbp-0x130]
 23d:	0f 29 85 e0 fe ff ff 	movaps XMMWORD PTR [rbp-0x120],xmm0
 244:	0f 29 8d f0 fe ff ff 	movaps XMMWORD PTR [rbp-0x110],xmm1
 24b:	b8 00 00 00 00       	mov    eax,0x0
 250:	f3 48 0f 1e c8       	rdsspq rax
 255:	48 2b 85 90 fe ff ff 	sub    rax,QWORD PTR [rbp-0x170]
 25c:	48 85 c0             	test   rax,rax
 25f:	74 2c                	je     28d <bar+0x270>
 261:	48 f7 d8             	neg    rax
 264:	48 c1 e8 03          	shr    rax,0x3
 268:	48 3d ff 00 00 00    	cmp    rax,0xff
 26e:	76 18                	jbe    288 <bar+0x26b>
 270:	ba ff 00 00 00       	mov    edx,0xff
 275:	f3 48 0f ae ea       	incsspq rdx
 27a:	48 2d ff 00 00 00    	sub    rax,0xff
 280:	48 3d ff 00 00 00    	cmp    rax,0xff
 286:	77 e8                	ja     270 <bar+0x253>
 288:	f3 48 0f ae e8       	incsspq rax
 28d:	48 8b a5 98 fe ff ff 	mov    rsp,QWORD PTR [rbp-0x168]
 294:	90                   	nop
 295:	48 8b 5d f8          	mov    rbx,QWORD PTR [rbp-0x8]
 299:	c9                   	leave  
 29a:	c3                   	ret    
 29b:	f3 0f 1e fa          	endbr64 
 29f:	55                   	push   rbp
 2a0:	48 89 e5             	mov    rbp,rsp
 2a3:	bf 3e 00 00 00       	mov    edi,0x3e
 2a8:	e8 70 fd ff ff       	call   1d <bar>
 2ad:	b8 0b 00 00 00       	mov    eax,0xb
 2b2:	5d                   	pop    rbp
 2b3:	c3                   	ret    
