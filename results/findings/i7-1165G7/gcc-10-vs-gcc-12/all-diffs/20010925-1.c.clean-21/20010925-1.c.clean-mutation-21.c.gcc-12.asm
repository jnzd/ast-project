  ...
  51:	83 7d ec 32          	cmp    DWORD PTR [rbp-0x14],0x32
  55:	75 07                	jne    5e <foo+0x24>
  57:	b8 3a 00 00 00       	mov    eax,0x3a
  ...
  74:	b8 63 00 00 00       	mov    eax,0x63
  79:	c9                   	leave  
  7a:	c3                   	ret    
