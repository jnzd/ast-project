  ...
  12:	c7 45 fc 11 00 00 00 	mov    DWORD PTR [rbp-0x4],0x11
  19:	c7 45 f8 7d 00 00 00 	mov    DWORD PTR [rbp-0x8],0x7d
  ...
  5d:	c7 45 fc 0f 00 00 00 	mov    DWORD PTR [rbp-0x4],0xf
  ...
  80:	be 35 00 00 00       	mov    esi,0x35
  85:	bf ee ff ff ff       	mov    edi,0xffffffee
  ...
  bc:	b8 1c 00 00 00       	mov    eax,0x1c
  c1:	c9                   	leave  
  c2:	c3                   	ret    
