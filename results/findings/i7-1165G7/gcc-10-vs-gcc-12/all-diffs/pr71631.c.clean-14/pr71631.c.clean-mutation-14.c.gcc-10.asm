  ...
  3e:	c7 45 dc 36 00 00 00 	mov    DWORD PTR [rbp-0x24],0x36
  45:	c7 45 e0 48 00 00 00 	mov    DWORD PTR [rbp-0x20],0x48
  4c:	8b 0d 00 00 00 00    	mov    ecx,DWORD PTR [rip+0x0]        # 52 <main+0x20>
  52:	b8 20 00 00 00       	mov    eax,0x20
  57:	99                   	cdq    
  58:	f7 f9                	idiv   ecx
  ...
  6f:	83 c0 70             	add    eax,0x70
  72:	89 45 ec             	mov    DWORD PTR [rbp-0x14],eax
  75:	b8 11 00 00 00       	mov    eax,0x11
  7a:	99                   	cdq    
  ...
  f0:	83 7d f0 64          	cmp    DWORD PTR [rbp-0x10],0x64
  f4:	75 0c                	jne    102 <main+0xd0>
  f6:	48 8d 3d 00 00 00 00 	lea    rdi,[rip+0x0]        # fd <main+0xcb>
  fd:	e8 00 00 00 00       	call   102 <main+0xd0>
 102:	66 83 7d da 8d       	cmp    WORD PTR [rbp-0x26],0xff8d
 107:	74 05                	je     10e <main+0xdc>
 109:	e8 00 00 00 00       	call   10e <main+0xdc>
 10e:	b8 2d 00 00 00       	mov    eax,0x2d
 113:	c9                   	leave  
 114:	c3                   	ret    
