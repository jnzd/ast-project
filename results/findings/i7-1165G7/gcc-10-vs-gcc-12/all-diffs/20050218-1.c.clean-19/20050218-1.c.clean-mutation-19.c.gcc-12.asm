  ...
  1f:	00 
  20:	48 c7 45 f0 0b 00 00 	mov    QWORD PTR [rbp-0x10],0xb
  27:	00 
  ...
  7c:	83 f8 7e             	cmp    eax,0x7e
  7f:	74 07                	je     88 <foo+0x88>
  81:	b8 0d 00 00 00       	mov    eax,0xd
